...
import KmfListWrapper from '../common/listView/KmfListWrapper';
...
const NoticeList = () => {
  ...
  const {scrollInfos, scrollRemove}= useScrollMove({page: 'notice-list', path: '/notice'});
  const services = useService();

  const getNotice = async () => {
      console.log('sefsef d')
