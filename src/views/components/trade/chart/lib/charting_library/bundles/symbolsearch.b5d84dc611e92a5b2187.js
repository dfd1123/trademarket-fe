  ...
  ['symbolsearch'],
  {
          ...
          L = (function () {
            ...
            (m.registerAutoFocus = function (t) {
              ...
              (m.prototype._renderSuggestList = function (t) {
                if (this.$list) {
                  (t = this._groupContracts(t)), (w = h('futures-descriptions'));
                  var i = this,
                    n = this._state;
                  this._clearSuggestList();
              ...
              (m.prototype._isEmptySuggestList = function () {
                return !Boolean(this._renderedResponse && this._renderedResponse.length);
              }),
                ...
                if (e) {
                  ...
                  e.connectionStatus() === CONNECTSTATUSES.CONNECTED &&
                    ...
                    tradingService().trackEvent(
                      ...
                      T() && this._state.tradableFilter ? 'on' : 'off',
                    );
                }
                return t;
              }),
              ...
              (m.createSuggestListRow = function (t, e, i, n) {
                ...
                var l = t.symbol.replace(e, '<strong>$&</strong>'),
                  c = n.nameContent || l;
                t.broker_symbol && (c = c + ' (' + t.broker_symbol.replace(e, '<strong>$&</strong>') + ')'),
                  (a.innerHTML = c);
                var p = document.createElement('td');
                p.setAttribute('class', 'symbol-edit-popup-td desc apply-overflow-tooltip');
                var u = t.description.toUpperCase();
                if (w && t.contractDescription) {
                  var h = R.exec(t.contractDescription);
                  u += h ? ' (' + C(i, h[1]) + ' ' + h[2] + ')' : ' (' + C(i, t.contractDescription) + ')';
                }
                p.innerHTML = e.test(t.symbol) ? u : u.replace(e, '<strong>$&</strong>');
                var d = document.createElement('td');
                d.setAttribute('class', 'symbol-edit-popup-td type apply-overflow-tooltip');
                var f = '';
                if (n.typeContent) f = n.typeContent;
                else {
                  t.params && ~t.params.indexOf('eod') && (f = '<i class="eod">eod</i>&nbsp;');
                  var g = t.typespecs && t.typespecs.includes('cfd'),
                    _ = r(t.type, g);
                  if (t.exchange) f += _ + (_.length ? ' - ' : '') + x(t);
                  else f += _;
                }
                d.innerHTML = f;
            ...
            return (
                ...
                if (!d.get('Symbol Search')) {
                  ...
                  if (
                    ...
                    t.ignoreInterval || ((n = m.getInputValueGetter(a)), (s = m.getInputValueSetter(a))),
                      (i = SymbolSearchInputParserMixin.addSpreadActions(o.find('.spread-actions'), a, n, s));
                  var l = new m({
                      input: a,
                      list: o.find('.results').get(0),
                      callback: function (e, i) {
                        t.callback && t.callback(e, i), d.destroy('Symbol Search');
                      },
                      onParse: i,
              ...
              (m.bindToInput = function (t, i) {
                ...
                var I,
                  T,
                  x = i.spreadActions && $(i.spreadActions).eq(0);
                x &&
                  x.size() &&
                  y() &&
                  (i.ignoreInterval || ((I = m.getInputValueGetter(t.get(0))), (T = m.getInputValueSetter(t.get(0)))),
                  (s = SymbolSearchInputParserMixin.addSpreadActions(x, t.get(0), I, T)));
                var C = new m({
                    input: t,
                          ...
                          n = (function (t, e, i) {
                            ...
                            var u = s.outerHeight(),
                              ...
                              f =
                                ...
                                (a.top - h) -
                                d / 2;
                            return o.css('maxHeight', f - d - u + 'px'), { popup: n, listWrapper: o };
                          })(C, t, i.position);
                        (_ = n.popup),
              ...
              (P.prototype.append = function (t) {
                ...
                if (P.isRoot(t)) {
                  ...
                  (e = m.createSuggestListRow(t, this._tickerRegExp, this._translationCache, {
                    ...
                    typeContent: C(this._translationCache, t.type) + (t.exchange && ' - ' + x(t)),
              ...
              (m.detachStoreInterval = function (t) {
                ...
                return e ? ((F = e.detached), (O = _.normalize(F)), e.rest) : (m.resetStoredInterval(), t);
              }),
    ...
    w3Pp: function (t, e, i) {
      ...
      function r(t, e) {
        ...
        var a = e ? window.t('{market_type} cfd', s).format({ market_type: t }) : o[t] || t;
        return n.set(i, a), a;
      }
    },
  },
