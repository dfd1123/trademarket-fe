  ...
  [0],
  {
    Nkvk: function (e, t, i) {
      ...
      var n,
        ...
        s = i.n(o),
        d = i('qocr'),
        a = { desktop: 1 / 0, desktopHd: 1919, phone: 767, 'phone-vertical': 479, tablet: 1019 },
        c = function () {
          var e;
          if (void 0 === n) {
            ...
            var s = o.offsetWidth;
            null === (e = t.parentNode) || void 0 === e || e.removeChild(t), (n = r - s);
          }
          return n;
        };
      function h(e, t, i) {
                  ...
                  var d,
                    ...
                    c =
                      ...
                      (a = s) === 1 / 0
                        ...
                        : window.matchMedia('(min-width: ' + d + 'px) and (max-width: ' + a + 'px)'));
      ...
      function w(e) {
        ...
        if (e && 1 == ++v) {
          ...
          'hidden' !== n.toLowerCase() &&
            ...
            (h(i, 'right', c() + 'px'), (t.style.paddingRight = r + c() + 'px'), (f = !0)),
            t.classList.add('i-no-scroll');
        } else if (!e && v > 0 && 0 == --v && (t.classList.remove('i-no-scroll'), f)) {
          h(i, 'right', '0px');
          var o = Boolean(window.widgetbar && window.widgetbar.resizerBridge.fullscreen.value())
            ? 0
            : (function (e) {
                if (null !== e) return l(e, 'width') - l(e, 'padding-left') - l(e, 'padding-right');
              })(i) || 0;
          t.scrollHeight <= t.clientHeight && (o -= c()), (t.style.paddingRight = (o < 0 ? 0 : o) + 'px'), (f = !1);
        }
      }
      var g = new p();
    },
