(window.webpackJsonp = window.webpackJsonp || []).push([
  ['lt-pane-views'],
  {
        ...
        c = (function (e) {
          ...
          return (
            ...
            (t.prototype.hitTest = function (e) {
              ...
              if (o.distance <= h) return new l.HitTestResult(l.HitTestResult.MOVEPOINT);
              ...
              return (o = Object(n.distanceToSegment)(r, d, e)).distance <= h ||
                ...
                : this._data.fillBackground && Object(a.pointInTriangle)(i, r, d, e)
            ...
            (t.prototype._drawImpl = function (e) {
              if (!(null === this._data || this._data.points.length < 2)) {
                (e.lineCap = 'butt'),
                  ...
                  void 0 !== this._data.linestyle && Object(d.setLineStyle)(e, this._data.linestyle);
                var t = this._data.points,
                  i = t[0],
                  r = t[1],
    ...
    '1SUO': function (e, t, i) {
      ...
      inherit(c, d),
        ...
        (c.prototype._updateImpl = function () {
          if (
            (d.prototype._updateImpl.call(this), (this._renderer = null), (this._levels = []), this._points.length < 3)
          )
            ...
            s.dotProduct(l) < 0 && (c = 2 * Math.PI - c),
              (this._edge2 = c),
              h < c && ((this._edge1 = Math.max(h, c)), (this._edge2 = Math.min(h, c) + 2 * Math.PI)),
              Math.abs(h - c) > Math.PI &&
                ((this._edge1 = Math.min(h, c)), (this._edge2 = Math.max(h, c) - 2 * Math.PI));
            for (var p = this._source.properties(), u = 1; u <= this._source.levelsCount(); u++) {
              var _ = p['level' + u];
              if (_.visible.value()) {
                var f = _.coeff.value(),
                  v = _.color.value(),
        ...
        (c.prototype._updateRenderer = function () {
          if (!((w = this._points).length < 2)) {
            ...
            if ((this._baseTrendRenderer.setData(n), e.append(this._baseTrendRenderer), w.length < 3))
            ...
            for (var _ = this._levels.length - 1; _ >= 0; _--) {
              ...
              var g = new l();
              if ((g.setData(v), g.setHitTest(new s(s.MOVEPOINT, null, f.index)), e.append(g), t.showCoeffs.value())) {
                var y = new a(this, _);
                e.append(y);
              }
            }
    ...
    '1oDZ': function (e, t, i) {
      ...
      function d(e, t) {
        r.call(this, e, t), (this._horzRayRenderer = new h()), (this._labelRenderer = new n()), (this._renderer = null);
      }
      (h.prototype.setData = function (e) {
        ...
        (h.prototype.hitTest = function (e) {
          ...
          return Math.abs(e.y - this._data.points[0].y) <= 3 ? new a(this._data.hitTestResult) : null;
        }),
        inherit(d, r),
        ...
        (d.prototype._updateImpl = function () {
          ...
          if (
            ...
            var n = e.vertLabelsAlign.value(),
              ...
              _ = e.fontsize.value();
            if ('right' === o) {
              this._labelRenderer.setData({ text: d, font: u, bold: c, italic: p, fontsize: _ });
              var f = this._labelRenderer.measure().width,
                v = this._model.timeScale().width();
              l.x + f + 3 >= v ? (l.x += f + 3) : ((l.x = v), (h = 3));
            } else 'center' === o && (l.x = (l.x + this._model.timeScale().width()) / 2);
            var g = {
              points: [l],
              text: d,
    ...
    '2hKl': function (e, t, i) {
      'use strict';
      function r(e, t, i, r) {
        for (var n = 3 / (i.subtract(e).length() + i.subtract(t).length()), a = 0; a <= 1; a += n) {
      ...
      function n(e, t, i, r, n) {
        for (
          var a = 3 / (i.subtract(e).length() + r.subtract(i).length() + t.subtract(r).length()), s = 0;
          s <= 1;
          s += a
        ) {
      ...
      function a(e, t, i, r, n) {
        ...
        var l = (function (e, t, i, r, n) {
          for (var a = [], l = s(e.y, t.y, i.y, 0).concat(s(e.y, t.y, i.y, n)), h = 0; h < l.length; h++) {
        ...
        for (var h = 3 / a, d = [], c = 0; c < l.length - 1; c += 2) {
          for (var p = h, u = l[c], _ = l[c + 1] + p, f = []; u <= _; ) {
            var v = e.scaled((1 - u) * (1 - u)),
              ...
              y = t.scaled(u * u),
              w = v.add(g).add(y);
            if (f.length > 0) f[f.length - 1].subtract(w).length() < 2 && ((_ += p), (p *= 2));
            f.push(w), (u += p);
          }
          f.length > 0 && d.push(f);
        }
      ...
      function s(e, t, i, r) {
        ...
        if (Math.abs(a) > 1e-8) {
          var l = s * s - 4 * a * o;
          l >= 0 && (n.push((-s + Math.sqrt(l)) / (2 * a)), n.push((-s - Math.sqrt(l)) / (2 * a)));
        } else n.push(-o / s);
        return n;
      }
      function o(e, t, i, r) {
    ...
    '2trc': function (e, t, i) {
          ...
          return (
            ...
            (t.prototype._drawImpl = function (e, t) {
              if (null !== this._data) {
                ...
                if (null !== i) {
                  ...
                  (e.fillStyle = Object(d.generateColor)(this._data.color, this._data.transparency, !0)), e.fill();
                }
              }
            }),
            (t.prototype._visiblePolygon = function (e) {
              ...
              if (
                ...
                (Object(o.distanceToLine)(i, r, s).distance < 1e-6 && Object(o.distanceToLine)(i, r, l).distance < 1e-6)
              )
                return null;
              ...
              return (
                (h = p(h, i, r, [l, s])),
                (h = p(h, l, s, [i, r])),
                Object(a.equalPoints)(s, i) || t.extendLeft || (h = p(h, s, i, [r, l])),
                h
              );
            }),
            t
      ...
      function p(e, t, i, r) {
        var n = Object(a.equalPoints)(i, r[0]) ? (Object(a.equalPoints)(i, r[1]) ? null : r[1]) : r[0];
        return null !== e && null !== n
          ? Object(l.intersectPolygonAndHalfplane)(
              e,
              Object(a.halfplaneThroughPoint)(Object(a.lineThroughPoints)(t, i), n),
            )
          : null;
      }
    },
        ...
        (f.prototype._updateImpl = function () {
          if (
            ...
            ((C = {}).points = [w, x]),
              ...
              (C.extendright = !1),
              (C.leftend = c.Normal),
              (C.rightend = Math.abs(w.x - x.x) >= 15 * C.linewidth ? c.Arrow : c.Normal),
    ...
    '4Ptp': function (e, t, i) {
      ...
      function f(e, t) {
        n.call(this, e, t), (this._bezierQuadroRenderer = new p()), (this._renderer = null);
      }
      inherit(p, c),
          ...
          if (null !== this._data) {
            ...
            if (
              ...
              this._data.fillBack &&
                ...
                ((e.fillStyle = l.generateColor(this._data.backcolor, this._data.transparency)),
                e.beginPath(),
                e.moveTo(i.x, i.y),
                ...
                e.stroke(),
                this._data.leftend === h.Arrow && a(o, i, e, e.lineWidth, t.pixelRatio),
                this._data.rightend === h.Arrow && a(d, r, e, e.lineWidth, t.pixelRatio);
            }
          }
        }),
        (p.prototype.hitTest = function (e) {
          if (null !== this._data && 3 === this._data.points.length) {
            ...
            if (d.quadroBezierHitTest(r, t, a, e) || d.quadroBezierHitTest(r, i, o, e)) return new s(s.MOVEPOINT);
            var l = _(e, 3, this._data.extendLeftSegments);
            return null === l && (l = _(e, 3, this._data.extendRightSegments)), l;
          }
          return null;
        }),
        inherit(f, n),
        (f.prototype._updateImpl = function () {
          if (
            ...
            var e = this._source.pointToScreenPoint(this._source.points()[0])[1],
            ...
            this._source.properties().extendLeft.value() &&
              ...
              this._source.properties().extendRight.value() &&
                (this._extendRightSegments = d.extendQuadroBezier(i, t, s, l, h));
          }
          if (!(this._points.length < 2)) {
            var c = [].concat(this._points);
            this._source._controlPoint && c.push(this._source.pointToScreenPoint(this._source._controlPoint)[0]);
            var p = {},
            ...
            var _ = new o();
            _.append(this._bezierQuadroRenderer), this.addAnchors(_), (this._renderer = _);
          }
        }),
        (f.prototype.renderer = function (e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
    ...
    '5/lF': function (e, t, i) {
      ...
      var f = (function () {
          function e(e, t) {
            ...
            (this._ready = !1),
              (this._img = (function (e, t) {
                var i = new Image();
                return (i.width = g), (i.height = g), (i.onload = t), (i.src = e), i;
              })(e, function () {
                (i._ready = !0), t();
              }));
          }
        ...
        v = new ((function () {
          function e(e) {
            var t = this;
            (this._icons = new Map()), (this._onAllIconsLoaded = new u.a()), (this._pendingLoading = e.length);
            var i = function () {
          ...
          return (
            (e.prototype.getIcon = function (e, t) {
              return Object(a.ensureDefined)(Object(a.ensureDefined)(this._icons.get(e)).get(t));
            }),
          ...
          return (
              ...
              if (this._rect) {
                if (
                  ...
                  for (
                    ...
                    this._drawIcon(e, u, _, p, Boolean(this._data.isDark), t), (n += 1);
                  }
              } else
            ...
            (e.prototype._preRender = function () {
              if (!this._preRendered) {
                var e = (function () {
                    if (null !== _) return _;
                    var e = Object(c.createDisconnectedCanvas)(document, new c.Size(0, 0));
                ...
                if (this._data.wordWrapWidth) {
                  ...
                  for (var u = 0; u < this._lines.length; u++) p.push(this._data.wordWrapWidth);
                } else {
                  d = 0;
                ...
                if (((i += v.left), (a += v.top), !s.isIE && this._data.icons)) {
                  var w = void 0 !== this._data.textPadding ? this._data.textPadding : Math.round(o / 2);
                  (i += g + w), (y.w += g + w);
                }
                if ('bottom' === this._data.vertAlign || 'middle' === this._data.vertAlign) {
                  var x = 'middle' === this._data.vertAlign ? n - y.h / 2 : n - y.h - (y.y - n);
                  (a += x - y.y), (y.y = x);
                }
                if ('right' === this._data.horzAlign || 'center' === this._data.horzAlign) {
                  var m = 'center' === this._data.horzAlign ? t - y.w / 2 : t - y.w - (y.x - t);
                  (i += m - y.x),
                    (y.x = m),
                    !0 !== this._data.doNotAlignText &&
                      ('right' === this._data.horzAlign
                ...
                y.w % 2 != 0 && y.w++,
                  (y.x += 0.5),
                  (y.y += 0.5),
                  (this._boundingBox = Object(r.box)(new r.Point(y.x, y.y), new r.Point(y.x + y.w, y.y + y.h))),
                  (this._rect = y),
                  (this._padding = v),
            ...
            (e.prototype._drawIcon = function (e, t, i, r, n, o) {
              var l = '' + r + this._data.isDark + o.pixelRatio,
                h = y.get(l);
              if (!h) {
                ((h = document.createElement('canvas')).width = g * o.pixelRatio),
                  (h.height = g * o.pixelRatio),
                  (h.style.width = g + 'px'),
                  (h.style.height = g + 'px');
                var d = Object(a.ensureNotNull)(h.getContext('2d'));
                d.setTransform(1, 0, 0, 1, 0, 0), s.isEdge || d.scale(o.pixelRatio, o.pixelRatio);
      ...
      inherit(d, r),
        ...
        (d.prototype._updateBaseData = function () {
          ...
          this._source.points().length >= 3 &&
            ...
            this._source.points().length >= 4 &&
              ...
              (this._BCRetracement = Math.round(1e3 * Math.abs((r.price - i.price) / (i.price - t.price))) / 1e3)),
        ...
        (d.prototype._updateImpl = function () {
          if (
            ...
            var e = this._source.properties(),
              t = new o(),
              i = [this._points[0], this._points[1], this._points.length < 3 ? this._points[1] : this._points[2]],
              n = this,
              a = function (t, i) {
                return {
                  points: [t],
            ...
            if (
              ...
              var l;
              i = [this._points[2], this._points[3], 5 === this._points.length ? this._points[4] : this._points[3]];
              ((l = {}).points = i),
                (l.color = e.color.value()),
                (l.linewidth = e.linewidth.value()),
                (l.backcolor = e.backgroundColor.value()),
            ...
            if (this._points.length >= 4) {
              ...
              this._bcRetracementTrend.setData(p), t.append(this._bcRetracementTrend);
            ...
            if (this._points.length >= 5) {
              ...
              this._xdRetracementTrend.setData(p), t.append(this._xdRetracementTrend);
              d = a(
    ...
    '6sSH': function (e, t, i) {
      ...
      inherit(u, p),
        ...
        (_.prototype.getCacheRects = function (e, t) {
          ...
          if (i) {
            var n = this._points[1],
              ...
              s = Math.min(n.x, a.x),
              o = Math.max(n.x, a.x);
            (n = new r(s, this._levels[t].y)), (a = new r(o, this._levels[t].y));
            var l,
            ...
            switch (h.horzLabelsAlign.value()) {
              case 'left':
                ...
                break;
              case 'center':
                ((l = n.add(a).scaled(0.5)).x += i.width / 2), (l.x = Math.round(l.x));
                break;
              case 'right':
                h.extendLines.value()
            ...
            var p = {
              ...
              u = { left: l.x - p.width, top: l.y, width: i.width, height: p.height },
        ...
        (_.prototype._createCache = function (e) {
          return new u(this._source.properties().fibLevelsBasedOnLogScale, this._source.levelsCount(), e);
        }),
        (_.prototype._updateImpl = function () {
          if ((c.prototype._updateImpl.call(this), (this._renderer = null), 3 === this._source.points().length)) {
            ...
            var i = this._source.points()[0],
              ...
              _ = !1;
            (M = this._source.properties()).reverse && M.reverse.value() && (_ = M.reverse.value()),
              (this._levels = []);
            var f,
              v,
              g = _ ? i.price : p.price,
            ...
            if (x) (f = e.priceToCoordinate(g, t) - e.priceToCoordinate(y, t)), (v = e.priceToCoordinate(u.price, t));
            for (
          ...
          if (!(this._points.length < 2)) {
            ...
            if ((M = this._source.properties()).trendline.visible.value()) {
              ...
              this._trendLineRendererPoints12.setData(O), I.append(this._trendLineRendererPoints12);
            }
            ...
            if (M.trendline.visible.value()) {
              ...
              this._trendLineRendererPoints23.setData(O), I.append(this._trendLineRendererPoints23);
            }
              ...
              for (T = 0; T < this._levels.length; T++)
                if (T > 0 && B) {
                  var E = this._levels[T - 1],
                    V = ((i = new r(D, this._levels[T].y)), (p = new r(k, E.y)), {});
                  (V.points = [i, p]),
            ...
            for (T = 0; T < this._levels.length; T++) {
              O = {
                points: [(i = new r(H, this._levels[T].y)), (p = new r(W, this._levels[T].y))],
                width: this._model.timeScale().width(),
                height: this._source.priceScale().height(),
      ...
      inherit(g, v),
        ...
        (g.prototype._drawImpl = function (e) {
          if (null != this._data) {
            ...
            e.translate(r.x, r.y), e.rotate(this._data.angle - Math.PI / 2), e.scale(this._data.scale, 1);
            ...
            (this._cache[n] = i),
              this._data.selected &&
                ...
                e.fillRect(-this._cache[n] / 2, -this._data.size / 2, this._cache[n], this._data.size)),
              (e.fillStyle = this._data.color),
        ...
        (g.prototype.hitTest = function (e) {
          ...
          return (
            (n = s(r, n)), Math.abs(n.y) <= i / 2 && Math.abs(n.x) <= this._data.size / 2 ? new d(d.MOVEPOINT) : null
          );
        }),
        inherit(y, o),
        ...
        (y.prototype._updateImpl = function () {
          if ((o.prototype._updateImpl.call(this), (this._renderer = null), !(this._points.length < 1))) {
            var e = new c(),
              t = this._source.properties(),
              i = {
            ...
            e.append(this.createLineAnchor({ points: [b, R, T, S], pointsCursorType: L })), (this._renderer = e);
          }
        }),
        (t.IconPaneView = y);
    },
      ...
      inherit(h, l),
        ...
        (h.prototype.hitTest = function (e) {
          ...
          for (var h = this._data.counterclockwise ? -1 : 1, d = r.length(), c = 0; c < 4; c++) {
            ...
            if (null !== (u = (u * i.length()) / 5) && Math.abs(u - d) < 5) return new a(a.MOVEPOINT);
          }
          return null;
        }),
        ...
        (d.prototype._updateImpl = function () {
          if ((r.prototype._updateImpl.call(this), (this._renderer = null), !(this._floatPoints.length < 2))) {
            var e,
              t = new s();
          ...
          if (
            ...
            if (
              ...
              if (s.isLog()) {
                ...
                (this._p3.y = this._source.priceScale().priceToCoordinate(i, l)),
                  (this._p4.y = this._source.priceScale().priceToCoordinate(n, l));
            }
            var u = { points: [] };
            ...
            var v = [];
            if ((this._points[0] && v.push(this._points[0]), this._points[1] && v.push(this._points[1]), this._p3)) {
            ...
            this._model.lineBeingCreated() !== this._source || y || v.pop(),
              f.append(this.createLineAnchor({ points: v, pointsCursorType: o })),
              (this._renderer = f);
          }
        }),
    ...
    Ay2m: function (e, t, i) {
      ...
      inherit(S, x),
        ...
        (S.prototype.drawTargetLabel = function (e) {
          ...
          this._targetRectLeftOffset = Math.max(20, Math.min(this._targetWidth - 15, m));
          var b = 'up' === this._data.direction ? 'down' : 'up',
            R = this.drawBalloon(e, x, this._targetWidth, this._targetHeight, b, this._targetRectLeftOffset);
          (e.fillStyle = _.generateColor(this._data.targetBackColor, this._data.transparency)),
            e.fill(),
            (e.lineWidth = 2),
            (e.strokeStyle = _.generateColor(this._data.targetStrokeColor, this._data.transparency)),
            e.stroke();
          e.beginPath(),
          ...
          if ((e.fillText(s, T + d + u + 2 * p + D, M), this._data.status)) {
            var k, B, N, A;
            switch (((e.font = w(this._targetFontSize1, this._font, 'bold')), this._data.status)) {
              case f.AlertStatus.Success:
                (k = $.t('SUCCESS')),
                  (B = _.generateColor(this._data.successBackground, this._data.transparency)),
                  (N = this._data.successTextColor),
                  (A = this._data.successIcon);
                break;
              case f.AlertStatus.Failure:
                (k = $.t('FAILURE')),
                  (B = _.generateColor(this._data.failureBackground, this._data.transparency)),
            ...
            (e.fillStyle = B),
              'up' === this._data.direction
                ? (y(e, R.x - 1, R.y - z - 2, this._targetWidth + 2, z, 5),
                  ...
                  e.drawImage(A, R.x + V - A.width - 4, R.y - z - 2 + Math.abs(z - A.height) / 2))
                : (y(e, R.x - 1, R.y + this._targetHeight + 2, this._targetWidth + 2, z, 5),
                  e.fill(),
                  (e.fillStyle = N),
                  e.fillText(k, R.x + V + j, R.y + this._targetHeight + 5),
                  e.drawImage(A, R.x + V - A.width - 4, R.y + this._targetHeight + 10 - Math.abs(z - A.height) / 2)),
              e.restore();
          } else e.restore();
        }),
        (S.prototype.drawStartLabel = function (e) {
          ...
          this._sourceRectLeftOffset = Math.max(20, Math.min(this._sourceWidth - 15, s));
          ...
          (e.fillStyle = _.generateColor(this._data.sourceBackColor, this._data.transparency)),
            e.fill(),
            (e.lineWidth = 2),
            (e.strokeStyle = _.generateColor(this._data.sourceStrokeColor, this._data.transparency)),
            e.stroke(),
        ...
        (S.prototype._drawImpl = function (e) {
          if (!(null === this._data || this._data.points.length < 2)) {
            ...
            e.fillStyle = this._data.color;
            var a = r.y < 0 ? 1 : -1;
            if (Math.abs(r.x) < 1 || Math.abs(r.y) < 1) var s = Math.atan(r.x / r.y);
            else {
              var o,
                l,
                h = Math.abs(r.x),
        ...
        (S.prototype.targetLabelHitTest = function (e) {
          ...
          var i = 'up' === this._data.direction ? -1 : 1,
            ...
            h = Math.min(o, l),
            d = Math.max(o, l);
          return e.x >= a && e.x <= a + this._targetWidth && e.y >= h && e.y <= d ? new s(s.MOVEPOINT) : null;
        }),
        (S.prototype.sourceLabelHitTest = function (e) {
          ...
          var t = 'up' === this._data.direction ? 1 : -1,
            ...
            l = Math.min(a, o),
            h = Math.max(a, o);
          return e.x >= n && e.x <= n + this._sourceWidth && e.y >= l && e.y <= h ? new s(s.MOVEPOINT) : null;
        }),
        ...
        (P.prototype._updateImpl = function () {
          if (
            ...
            this._targetLine1 = b(e.format(r) + ' (' + this._percentageFormatter.format(s) + ')');
            var l = this._model.timeScale().indexToUserTime(i.index),
              h = this._model.timeScale().indexToUserTime(t.index);
            i.time &&
              t.time &&
              ((l = TradingView.isString(i.time) ? new Date(Date.parse(i.time)) : i.time),
            ...
            if (h && l) {
              (this._targetLine4 = new c().format(h)),
                d || (this._targetLine4 = this._targetLine4 + '  ' + new p(_ ? '%h:%m:%s' : '%h:%m').format(h));
              var v = (h.valueOf() - l.valueOf()) / 1e3;
              this._targetLine2 = $.t('in', { context: 'dates' }) + ' ' + R(new u().format(v));
            }
            ...
            g &&
              ...
              d || (this._sourceLine2 = this._sourceLine2 + ' ' + new p(_ ? '%h:%m:%s' : '%h:%m').format(g))),
            ...
            (y.points = this._points),
              ...
              (y.targetBackColor = this._source.properties().targetBackColor.value()),
              (y.targetStrokeColor = this._source.properties().targetStrokeColor.value()),
              (y.targetTextColor = this._source.properties().targetTextColor.value()),
              (y.sourceBackColor = this._source.properties().sourceBackColor.value()),
              (y.sourceStrokeColor = this._source.properties().sourceStrokeColor.value()),
              (y.sourceTextColor = this._source.properties().sourceTextColor.value()),
              (y.successBackground = this._source.properties().successBackground.value()),
              (y.successTextColor = this._source.properties().successTextColor.value()),
              (y.failureBackground = this._source.properties().failureBackground.value()),
              (y.failureTextColor = this._source.properties().failureTextColor.value()),
              (y.intermediateBackColor = this._source.properties().intermediateBackColor.value()),
              (y.intermediateTextColor = this._source.properties().intermediateTextColor.value()),
            ...
            var w = new o();
            w.append(this._predictionRenderer), this.addAnchors(w), (this._renderer = w);
          }
        }),
      ...
      inherit(u, p),
          ...
          for (var a = [], s = 0; s < n.length; s++) {
            ...
            if ((h = r.measureText(o).width) <= t) a.push(o);
              ...
              for (var l = o.split(/([-)\]},.!?:;])|(\s+)/); l.length; ) {
                ...
                if (d > 0) a.push(l.slice(0, 3 * d - 1).join('')), l.splice(0, 3 * d);
                else {
                  var c = l[0] + (l[1] || ''),
                    p = 1 === p ? 1 : ~~((t / r.measureText(c)) * c.length);
                  if (r.measureText(c.substr(0, p)).width <= t)
                    for (; r.measureText(c.substr(0, p + 1)).width <= t; ) p++;
                  else for (; p > 1 && r.measureText(c.substr(0, --p)).width > t; );
                  p < 1 && (p = 1), a.push(c.substr(0, p)), (l[0] = c.substr(p)), (l[1] = '');
                }
        ...
        (u.prototype._drawImpl = function (e) {
          if (!(null === this._data || this._data.points.length < 2)) {
            ...
            var a = h.RoundRadius,
              ...
              o = n + 2 * s + 2 * a,
              p = r + 2 * s + 2 * a;
            (this._textSizeCache.totalWidth = o), (this._textSizeCache.totalHeight = p);
            var u = i.x - o / 2,
              _ = i.y - p / 2,
              f = 0,
              v = n + 2 * s > 2 * a,
            ...
            t.x > u + o ? (f = 20) : t.x > u && (f = 10),
              ...
              10 === f
                ? v
                  ? (e.lineTo(i.x - a, 0), e.lineTo(t.x, t.y), e.lineTo(i.x + a, 0), e.lineTo(o - a, 0))
                  : (e.lineTo(t.x, t.y), e.lineTo(o - a, 0))
                : e.lineTo(o - a, 0),
              20 === f ? (e.lineTo(t.x, t.y), e.lineTo(o, a)) : e.arcTo(o, 0, o, a, a),
              21 === f
                ? g
                  ? (e.lineTo(o, i.y - a), e.lineTo(t.x, t.y), e.lineTo(o, i.y + a), e.lineTo(o, p - a))
                  : (e.lineTo(t.x, t.y), e.lineTo(o, p - a))
                : e.lineTo(o, p - a),
              22 === f ? (e.lineTo(t.x, t.y), e.lineTo(o - a, p)) : e.arcTo(o, p, o - a, p, a),
              12 === f
                ? v
                  ? (e.lineTo(i.x + a, p), e.lineTo(t.x, t.y), e.lineTo(i.x - a, p), e.lineTo(a, p))
                  : (e.lineTo(t.x, t.y), e.lineTo(a, p))
                : e.lineTo(a, p),
              2 === f ? (e.lineTo(t.x, t.y), e.lineTo(0, p - a)) : e.arcTo(0, p, 0, p - a, a),
              1 === f
                ? g
                  ? (e.lineTo(0, i.y + a), e.lineTo(t.x, t.y), e.lineTo(0, i.y - a), e.lineTo(0, a))
                  : (e.lineTo(t.x, t.y), e.lineTo(0, a))
                : e.lineTo(0, a),
              0 === f ? (e.lineTo(t.x, t.y), e.lineTo(a, 0)) : e.arcTo(0, 0, a, 0, a),
              e.stroke(),
              (e.fillStyle = l.generateColor(this._data.backcolor, this._data.transparency)),
              e.fill(),
              (e.fillStyle = this._data.color),
        ...
        (_.prototype._updateImpl = function () {
          if (
            ...
            var s = t.points[1],
              l = [].concat(t.points);
            if ((l.splice(l.length - 1, 1), r.append(this.createLineAnchor({ points: l })), t.wordWrapWidth)) {
              var d = new n(s.x + (t.wordWrapWidth >> 1) + h.RoundRadius + h.TextMargins, s.y);
      ...
      var r = i('mrSG'),
        ...
        p = (function (e) {
          function t(t) {
            ...
            return (
              (i._data = null),
              (i._backHittest = new d.HitTestResult(d.HitTestResult.MOVEPOINT_BACKGROUND)),
              (i._points = []),
              (i._hittest = t || new d.HitTestResult(d.HitTestResult.MOVEPOINT)),
              i
            );
          }
          return (
            ...
            (t.prototype.hitTest = function (e) {
              if (null === this._data || (void 0 !== this._data.mouseTouchable && !this._data.mouseTouchable))
                return null;
              for (var t = Object(o.lastEventIsTouch)() ? 24 : 3, i = 1; i < this._points.length; i++) {
                var r = this._points[i - 1],
                  s = this._points[i];
                if (Object(a.distanceToSegment)(r, s, e).distance <= t) return this._hittest;
              }
              if (this._data.filled && this._data.fillBackground && this._points.length > 0) {
                (r = this._points[0]), (s = this._points[this._points.length - 1]);
                if (Object(a.distanceToSegment)(r, s, e).distance <= t) return this._hittest;
              }
              return this._data.filled && this._data.fillBackground && Object(n.pointInPolygon)(e, this._data.points)
                ? this._backHittest
                : null;
            }),
            (t.prototype._drawImpl = function (e, t) {
              if (null !== this._data && 0 !== this._points.length) {
                ...
                this._data.filled &&
                  this._data.fillBackground &&
                  ((e.fillStyle = Object(c.generateColor)(this._data.backcolor, this._data.transparency)), e.fill()),
                  ...
                  this._points.length > 1 &&
                    (this._data.leftend === h.LineEnd.Arrow &&
                      Object(l.drawArrow)(this._points[1], this._points[0], e, e.lineWidth, t.pixelRatio),
    ...
    BSCN: function (e, t, i) {
      ...
      function h(e, t) {
        n.call(this, e, t), (this._lineRenderer = new s()), (this._labelRenderer = new o()), (this._renderer = null);
      }
      inherit(h, n),
        (h.prototype.renderer = function (e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
        ...
        (h.prototype._updateImpl = function () {
          if ((n.prototype._updateImpl.call(this), (this._renderer = null), 0 !== this._points.length)) {
            var e = this._source.properties(),
              t = {};
            ...
            if ((i.append(this._lineRenderer), e.showLabel.value())) {
              ...
              if ('horizontal' === e.textOrientation.value()) {
                ...
                switch (((d = -Math.PI / 2), (c = 0), e.horzLabelsAlign.value())) {
                  case 'left':
                    o = 'bottom';
                    break;
                  case 'right':
            ...
            if (1 === this._points.length) {
              ...
              (_.data = 0), (_.square = !0), i.append(this.createLineAnchor({ points: [_], pointsCursorType: l }));
            }
            this._renderer = i;
          }
        }),
      ...
      var r = i('mrSG'),
        ...
        s = (function (e) {
          function t(t, i) {
            ...
            return (r._polygonRenderer = new n.PolygonRenderer(null)), (r._renderer = new a.CompositeRenderer()), r;
          }
          return (
            Object(r.__extends)(t, e),
        ...
        (u.prototype.getCacheRects = function (e, t) {
          ...
          switch (r.horzLabelsAlign.value()) {
            case 'left':
              ...
              break;
            case 'center':
              ((i = d.add(c).scaled(0.5)).x += a.width / 2), (i.x = Math.round(i.x));
              break;
            case 'right':
          ...
          var p = {
            ...
            u = { left: Math.round(i.x - p.width), top: Math.round(i.y), width: a.width, height: p.height },
        ...
        (u.prototype._updateImpl = function () {
          ...
          for (
            ...
            if ((S = t['level' + c]).visible.value()) {
              ...
              var R = new p();
              R.setData(b), e.append(R), (t.showCoeffs.value() || t.showPrices.value()) && o(g, y, c);
            }
          }
          var T = null;
          for (c = d; c >= 1; c--) {
    ...
    D4q4: function (e, t, i) {
      ...
      var r = i('aB9a').LineSourcePaneView,
        ...
        a = i('/S7V').TriangleRenderer;
      function s(e, t) {
        r.call(this, e, t), (this._triangleRenderer = new a()), (this._renderer = null);
      }
      inherit(s, r),
            ...
            (e.prototype._createSource = function (e, t, i) {
              (this._sourceCanvas = Object(p.createDisconnectedCanvas)(
                ...
                this._translate.x % 1 == 0 &&
                  (this._translate = new _.Point(this._translate.x + 0.5, this._translate.y));
              var r = Object(l.ensureNotNull)(this._sourceCanvas.getContext('2d'));
              Object(p.drawScaled)(r, this._renderParams.pixelRatio, function () {
                var n = 0.6 * e;
                (r.fillStyle = i),
                  r.beginPath(),
                  r.moveTo(e / 2, t),
          ...
          return (
            ...
            (e.prototype._drawTooltipOn = function (e, t) {
              ...
              v < 10 ? (v = s.y + 13) : (y = 'bottom'),
                f < 10 ? (f += Math.abs(f - 10)) : f + u + 10 > i.vpWidth && (f -= f + u + 10 - i.vpWidth),
                (e.fillStyle = Object(d.generateColor)(i.backgroundColor, i.backgroundTransparency)),
              ...
              e.moveTo(x, m),
                g || 'top' !== y || (e.lineTo(w - b, m), e.lineTo(w, m - b), e.lineTo(w + b, m)),
                e.lineTo(x + u, m),
                e.lineTo(x + u, m + _),
                g || 'bottom' !== y || (e.lineTo(w + b, m + _), e.lineTo(w, m + _ + b), e.lineTo(w - b, m + _)),
                e.lineTo(x, m + _),
                e.closePath(),
                e.fill(),
                e.stroke(),
              ...
              Object(p.drawScaled)(e, t.pixelRatio, function () {
                for (var t = 0; t < a.length; t++) e.fillText(a[t].replace(/^\s+/, ''), T, S), (S += i.fontSize + o);
              }),
                e.restore();
            }),
            e
        ...
        return (
          ...
          (e.prototype._repaintSource = function (e, t, i) {
            ...
            (i.points[0] = new n.Point(0, 0)),
              ...
              delete i.horzAlign,
              delete i.vertAlign,
              Object(h.drawScaled)(this._ctx, this._params.pixelRatio, function () {
                a._ctx.translate(0.5, a.topByRow(t) + 0.5), a._ctx.clearRect(0, 0, a._currentWidth, a.rowHeight(t));
                var n = new s.TrendLineStatsRenderer(i, { widths: [] }).draw(a._ctx, a._params);
                Object(r.ensureDefined)(a._sourcesToRow.get(e)).width = n.width;
              });
          }),
          (e.prototype._recreateCanvas = function () {
            (this._canvas = Object(r.ensureNotNull)(document.createElement('canvas'))),
              ...
              (this._canvas.height = this._rowHeight * this._actualCapacity * this._params.pixelRatio),
    ...
    Fx2Q: function (e, t, i) {
      ...
      inherit(c, n),
        (c.prototype._i18nCache = function () {
          return { leftShoulder: $.t('Left Shoulder'), rightShoulder: $.t('Right Shoulder'), head: $.t('Head') };
        }),
        (c.prototype.renderer = function (e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
        }),
          ...
          if (!(this._points.length < 2)) {
              ...
              var _ = this._source.properties(),
                ...
                y = function (e, t, i, r) {
                  return {
                    ...
                    color: h.generateColor(v._source.properties().color.value(), i),
            ...
            if (this._points.length >= 5) {
              var R,
                ...
                S = !1,
                P = !1;
              this._intersect1 ? (R = this._intersect1) : ((R = this._points[2]), (S = !0)),
                this._intersect2 ? (T = this._intersect2) : ((T = this._points[4]), (P = !0)),
              ...
              this._triangleRendererPoints234.setData(L), f.append(this._triangleRendererPoints234);
            }
            if (this._intersect1) {
              L = w(this._intersect1, this._points[1], this._points[2]);
              this._intersect1Renderer.setData(L), f.append(this._intersect1Renderer);
            }
            if (this._intersect2) {
              L = w(this._points[4], this._points[5], this._intersect2);
              this._intersect2Renderer.setData(L), f.append(this._intersect2Renderer);
            }
        ...
        (p.prototype._updateImpl = function () {
          if (
            ...
            var i = Math.abs(t.x - e.x),
              n = Math.abs(t.y - e.y);
            this._levels = [];
            for (var l = this._source.properties(), p = this._source.levelsCount(), u = 1; u <= p; u++) {
              var _ = l['level' + u];
              if (_.visible.value()) {
                var f = _.coeff.value(),
                  v = _.color.value(),
                  g = [];
                g.push(new r(this._center.x - 0.5 * i * f, this._center.y - 0.5 * n * f)),
                  g.push(new r(this._center.x + 0.5 * i * f, this._center.y + 0.5 * n * f));
            ...
            if (!(this._points.length < 2)) {
              ...
              if (l.trendline.visible.value()) {
                ...
                this._trendLineRenderer.setData(P), w.append(this._trendLineRenderer);
              }
    ...
    'GS+0': function (e, t, i) {
      ...
      var r = i('aO4+').Point,
        ...
        h = i('a7Ha').LineEnd;
      function d(e, t) {
        n.call(this, e, t), (this._lines = []), (this._trendRenderer = new s()), (this._renderer = null);
      }
      inherit(d, n),
        (d.prototype._updateImpl = function () {
          if ((n.prototype._updateImpl.call(this), (this._renderer = null), !(this._source.points().length < 2))) {
            ...
            if (this._source.priceScale() && !this._source.priceScale().isEmpty() && !e.isEmpty()) {
              ...
              if (((this._lines = []), 0 !== s)) {
                ...
                if (s > 0)
                  for (var c = t.index; c <= d.lastBar(); c += s) this._lines.push({ x: e.indexToCoordinate(c) });
                else for (c = t.index; c >= d.firstBar(); c += s) this._lines.push({ x: e.indexToCoordinate(c) });
                if (!(this._points.length < 2)) {
                  var p = new l(),
                    u = this._source.properties(),
                    _ = {
      ...
      var r = i('mrSG'),
        ...
        c = (function (e) {
          ...
          return (
            ...
            (t.prototype._updateImpl = function () {
              if ((e.prototype._updateImpl.call(this), (this._renderer = null), !(this._points.length < 2))) {
            ...
            (t.prototype._addAnchors = function (e, t, i) {
              ...
              var c = e.x - t.x,
                ...
                u = Math.sign(c * p),
                _ = [
                  u < 0 ? d.PaneCursorType.DiagonalNeSwResize : d.PaneCursorType.DiagonalNwSeResize,
                  u < 0 ? d.PaneCursorType.DiagonalNeSwResize : d.PaneCursorType.DiagonalNwSeResize,
                  u > 0 ? d.PaneCursorType.DiagonalNeSwResize : d.PaneCursorType.DiagonalNwSeResize,
                  u > 0 ? d.PaneCursorType.DiagonalNeSwResize : d.PaneCursorType.DiagonalNwSeResize,
              ...
              i.append(this.createLineAnchor({ points: [e, t, r, a, s, o, l, h], pointsCursorType: _ }));
            }),
            t
          );
    ...
    GzSs: function (e, t, i) {
      ...
      var r = i('aB9a').LineSourcePaneView,
        ...
        l = i('cPgM').ScaledPaneRenderer;
      function h(e, t) {
        l.call(this), (this._data = null), (this._cache = e), (this._adapter = t);
      }
      function d(e, t) {
        r.call(this, e, t), (this._rendererCache = {}), (this._renderer = new h(this._rendererCache, e._adapter));
      }
      inherit(h, l),
        (h.prototype.setData = function (e) {
          this._data = e;
        ...
        (h.prototype.hitTest = function (e) {
          return null === this._data ||
            ...
            ? new a(a.CUSTOM, {
                ...
                tooltip: {
                  text: this._adapter.getProtectTooltip() || window.t('Protect Position...'),
                  rect: {
    ...
    'Ht/7': function (e, t, i) {
      ...
      inherit(_, n),
        ...
        (_.prototype._updateImpl = function () {
          n.prototype._updateImpl.call(this), (this._renderer = null), (this._wave = []);
          var e = this._source.properties(),
          ...
          if (t && !t.isEmpty() && !i.isEmpty()) {
            ...
            if (e.showWave.value())
              for (
                var f = this._source.ownerSource().firstValue(), v = this._source.points(), g = 1;
                g < v.length;
                g++
              ) {
                var y = v[g - 1],
            ...
            for (_ = p(e.color.value()), g = 0; g < this._points.length - O; g++, I = -I)
              if (!(g < L)) {
      ...
      inherit(f, _),
        ...
        (f.prototype._drawImpl = function (e) {
          if (null !== this._data && 0 !== this._data.points.length) {
            ...
            this._measureCache && $.extend(this._measureCache, { innerWidth: n, innerHeight: 30, padding: r }),
        ...
        (f.prototype.hitTest = function (e) {
          if (null === this._data || 0 === this._data.points.length || !this._measureCache.padding) return null;
          var t = this._data.points[0].x - (this._measureCache.padding.left + 20),
            i = this._data.points[0].y - (this._measureCache.innerHeight + 9),
            r = a(new n(t, i), new n(t + this._measureCache.innerWidth, i + this._measureCache.innerHeight));
        ...
        (v.prototype._updateImpl = function () {
          ...
          if (
            ...
            (e.backgroundColor = this._source.properties().backgroundColor.value()),
            (e.transparency = this._source.properties().transparency.value()),
      ...
      inherit(c, n),
        ...
        (c.prototype._updateImpl = function () {
          if (
            ...
            (this._startPoint1 = new r(s, l)), (this._startPoint2 = new r(s, p));
            ...
            if (((this._valid = !0), u < s)) {
              ...
              (this._startPoint1 = new r(_, l)), (this._startPoint2 = new r(_, p));
            }
            var f = e.y + (u - e.x) * o;
          ...
          if (!(this._points.length < 2)) {
            ...
            if (
              ...
              this._trendLineRendererPoints12.setData(m), g.append(this._trendLineRendererPoints12);
            }
            if (4 === this._points.length) {
              ...
              if (
                ...
                var b = [this._startPoint1, this._startPoint2, this._intersectPoint];
                ((R = {}).points = b),
                ...
                var R;
                b = [this._startPoint1, this._startPoint2, this._intersectPoint2, this._intersectPoint1];
    ...
    LMGK: function (e, t, i) {
      ...
      function c(e, t) {
        d.call(this), (this._data = null), (this._cache = e), (this._adapter = t);
      }
      function p(e, t) {
        a.call(this, e, t),
      ...
      inherit(c, d),
        ...
        (c.prototype._drawMovePoints = function (e, t, i) {
          ...
          for (var r = t + 4, n = r + 2, a = Math.floor((this._height() - 10) / 2) + 1, s = 0; s < a; ++s) {
            var o = i + 5 + 2 * s;
        ...
        (c.prototype._drawQuantity = function (e, t, i, r) {
          ...
          e.fillRect(t + 0.5, i + 0.5, n - 1, a - 1),
            r && e.clip && (e.beginPath(), e.rect(t + 0.5, i - 0.5, n + 1, a + 1), e.clip()),
        ...
        (c.prototype._drawCancelButton = function (e, t, i, r) {
          ...
          e.fillRect(t + 0.5, i + 0.5, n - 1, a - 1),
            this._adapter._blocked &&
              ((e.fillStyle = 'rgba(140, 140, 140, 0.75)'), e.fillRect(t + 0.5, i + 0.5, n - 1, a - 1)),
            e.save(),
            r && e.clip && (e.beginPath(), e.rect(t + 0.5, i - 0.5, n + 1, a + 1), e.clip()),
            e.strokeRect(t, i, n, a),
            e.restore();
        ...
        (c.prototype._drawImpl = function (e) {
          if (null !== this._data && this._data.points && !(this._data.points.length < 1)) {
            ...
            0 !== i &&
              ...
              (c = !0)),
              0 !== r && (this._drawQuantity(e, l + i, d, c), this._drawQuantityText(e, l + i, d), (c = !0)),
              0 !== this._cancelButtonWidth() && this._drawCancelButton(e, l + i + r, d, c);
          }
        }),
        (c.prototype.hitTest = function (e) {
          if (null === this._data || 0 === this._data.points.length) return null;
          if (e.y < this._cache.top || e.y > this._cache.bottom) return null;
          if (this._adapter._blocked && e.x >= this._cache.left && e.x < this._cache.right) return new s(s.CUSTOM, {});
          if (this._adapter._editable && e.x >= this._cache.left && e.x < this._cache.bodyRight) {
          ...
          return this._adapter._editable && e.x >= this._cache.bodyRight && e.x < this._cache.quantityRight
            ? this._adapter.hasModifyCallback()
              ? new s(s.CUSTOM, {
                  clickHandler: this._adapter.callOnModify.bind(this._adapter),
                  tapHandler: this._adapter.callOnModify.bind(this._adapter),
                  tooltip: {
                    text: this._adapter.getModifyTooltip() || window.t('Modify Order...'),
                    rect: {
                      x: this._cache.bodyRight,
                      y: this._cache.top,
                      w: this._cache.quantityRight - this._cache.bodyRight,
              ...
              : new s(s.REGULAR)
            : this._adapter._cancellable && e.x >= this._cache.quantityRight && e.x < this._cache.right
            ? new s(s.CUSTOM, {
                clickHandler: this._adapter.callOnCancel.bind(this._adapter),
                tapHandler: this._adapter.callOnCancel.bind(this._adapter),
                tooltip: {
                  text: this._adapter.getCancelTooltip() || window.t('Cancel Order'),
                  rect: {
                    x: this._cache.quantityRight,
                    y: this._cache.top,
        ...
        (p.prototype._updateImpl = function (e) {
          if (
            ...
            var t = this._points[0].y,
              ...
              o = [new r(i, t)];
            this._selectionData = { points: o, bgColors: this._lineAnchorColors(o), hittestResult: n, visible: !0 };
          }
          this._orderRenderer.setData({ points: this._points, width: this._model.timeScale().width() }),
    ...
    NCfL: function (e, t, i) {
      ...
      var r = i('mrSG'),
        ...
        h = (function (e) {
          function t(t, i) {
            var r = e.call(this, t, i) || this;
            return (r._cache = null), (r._cacheDrawParams = null), (r._cacheInvalidated = !0), r;
          }
          return (
            Object(r.__extends)(t, e),
            (t.prototype.getCacheCanvas = function (e) {
              return this._createCacheIfRequired(e), Object(n.ensureNotNull)(this._cache).canvas();
            }),
            ...
            (t.prototype._createCache = function (e) {
              return new o.a(this._source.properties().fibLevelsBasedOnLogScale, this._source.levelsCount(), e);
            }),
      ...
      var r = i('mrSG'),
        ...
        p = (function (e) {
          function t(t, i) {
            ...
            return (
              (r._data = null),
              (r._hittestResult = t || new h.HitTestResult(h.HitTestResult.MOVEPOINT)),
              (r._backHittestResult = i || new h.HitTestResult(h.HitTestResult.MOVEPOINT_BACKGROUND)),
              r
            );
          }
          return (
            ...
            (t.prototype._drawImpl = function (e, t) {
              if (!(null === this._data || this._data.points.length < 2)) {
                ...
                var i = this._data.points,
                  ...
                  n = i[1];
                if (
                  (this._data.skipLines || this._extendAndDrawLineSegment(e, r, n, t), 4 === this._data.points.length)
                ) {
                  var a = this._data.points,
                    s = a[2],
                    o = a[3];
                  if (
                    (this._data.skipLines || this._data.skipTopLine || this._extendAndDrawLineSegment(e, s, o, t),
            ...
            (t.prototype._extendAndHitTestLineSegment = function (e, t, i, r) {
              var n = this._extendAndClipLineSegment(t, i, r);
              if (null !== n && Object(s.distanceToSegment)(n[0], n[1], e).distance <= 3) return this._hittestResult;
              return null;
            }),
            (t.prototype._extendAndClipLineSegment = function (e, t, i) {
              var r = Object(n.ensureNotNull)(this._data);
              return Object(d.extendAndClipLineSegment)(e, t, i.cssWidth, i.cssHeight, r.extendleft, r.extendright);
            }),
      ...
      function u(e, t, i, r) {
        return null !== e
          ? Object(o.intersectPolygonAndHalfplane)(
              e,
              Object(a.halfplaneThroughPoint)(Object(a.lineThroughPoints)(t, i), r),
            )
          : null;
      }
    },
    Ni7V: function (e, t, i) {
      ...
      function v(e, t) {
        f.call(this), (this._data = null), (this._measureCache = e), (this._chartModel = t), (this._points = null);
      }
      function g(e, t, r) {
        o.call(this, e, t),
      ...
      inherit(v, f),
        ...
        (v.prototype._drawImpl = function (e) {
          if (null !== this._data && null !== this._points && 0 !== this._points.length) {
            ...
            var l = u(e, t.width);
            this._measureCache &&
              Object.assign(this._measureCache, { innerWidth: n, innerHeight: a, tailLeft: -9, tailHeight: 15 }),
              e.translate(0.5 + s, 0.5 + o),
              e.beginPath(),
              e.moveTo(12, a),
              e.lineTo(-9, a + 15),
              ...
              e.arcTo(n, a, 0, a, 3),
              e.lineTo(12, a),
              (e.fillStyle = p.generateColor(this._data.backgroundColor, this._data.transparency)),
              e.fill(),
              (e.strokeStyle = this._data.borderColor),
              (e.lineWidth = 2),
              e.stroke(),
              ...
              (e.fillStyle = this._data.color),
              e.fillText(this._data.label, i + l, a / 2 + Math.floor(0.35 * this._data.fontSize)),
              e.translate(-0.5, -0.5),
              e.beginPath(),
              e.arc(-9, a + 15, 2.5, 0, 2 * Math.PI, !1),
              (e.fillStyle = p.generateColor(this._data.borderColor, this._data.transparency)),
              e.fill(),
        ...
        (g.prototype._updateImpl = function () {
          if ((o.prototype._updateImpl.call(this), (this._renderer = null), this._source.points().length > 0)) {
      ...
      var r = i('mrSG'),
        ...
        h = (function (e) {
          function t(t, i, r) {
            ...
            return (
              (a._data = t),
              (a._hitTest = i || new n.HitTestResult(n.HitTestResult.MOVEPOINT)),
              (a._backgroundHitTest = r || new n.HitTestResult(n.HitTestResult.MOVEPOINT_BACKGROUND)),
              a
            );
          }
          return (
                ...
                e.save(),
                  ...
                  this._data.fillBackground &&
                    (this._data.wholePoints &&
                      (e.translate(a.x, a.y), e.scale(1, n / r), e.arc(0, 0, s / 2, 0, 2 * Math.PI, !0)),
                    (e.fillStyle = Object(o.generateColor)(this._data.backcolor, this._data.transparency, !0)),
                    e.fill());
              }
            }),
            t
          ...
          return (
            (e.prototype.hitTest = function (e) {
              var t = this._center(),
                ...
                a = { min: new r.Point(t.x - i, t.y - i), max: new r.Point(t.x + i, t.y + i) };
            ...
            (e.prototype.draw = function (e, t) {
              ...
              if (this._data.showCircle) {
                var d = Math.round(l + this._data.circleRadius * r) - l - (this._data.circleBorderWidth * r) / 2;
                (e.strokeStyle = this._data.color),
              ...
              (e.font = Object(s.makeFont)(this._data.fontSize, this._data.font, this._data.bold ? 'bold' : void 0)),
                (e.textBaseline = 'middle'),
                (e.textAlign = 'center'),
                (e.fillStyle = this._data.color),
                Object(a.drawScaled)(e, r, function () {
                  e.fillText(i._data.letter, l / r, h / r + 0.05 * i._data.fontSize);
                }),
                e.restore();
            }),
    ...
    Qa6j: function (e, t, i) {
      ...
      function c(e) {
        if (e < 92) return 18;
        var t = 0.25 * e;
        return (t = Math.min(t, 106)), (t = Math.max(t, 18)), (t = Math.min(t, 0.9 * e));
      }
      var p = (function (e) {
          function t(t) {
            var i = e.call(this) || this;
          ...
          return (
            ...
            (t.prototype.hitTest = function (e) {
              ...
              var t = this._data.points[0],
                i = this._data.points[1].subtract(t),
                r = i.length();
              (i = this._data.points[1].subtract(this._data.points[0])).length() < 22 &&
              ...
              for (
                ...
                if (a >= _.x) {
                  var f = p[u + 1],
                    ...
                    y = (a - _.x) / v,
                    w = _.y + g * y;
                  return h.length() <= w + c ? new d.HitTestResult(d.HitTestResult.MOVEPOINT) : null;
                }
              }
              return h.length() < 3 ? new d.HitTestResult(d.HitTestResult.MOVEPOINT) : null;
            }),
            (t.prototype._drawImpl = function (e) {
              if (!(this._data.points.length < 2)) {
                ...
                var t = this._data.points[1].subtract(this._data.points[0]),
                  ...
                  r = this._data.points[0];
                i < 22 &&
                  ((r = this._data.points[1].addScaled(t.normalized(), -22)), (t = this._data.points[1].subtract(r)));
                var n,
                  a,
                  ...
                  h = t.normalized();
                (e.lineWidth =
                  ((n = t.length()), (a = Math.round(0.02 * n)), (a = Math.min(a, 5)), (a = Math.max(a, 2)))),
                  e.beginPath(),
                  e.moveTo(r.x, r.y);
      ...
      var _ = (function (e) {
        function t(t, i) {
          ...
          return (
            ...
            (r._ellipseRenderer = new u.EllipseRendererSimple(r._ellipseRendererData)),
            r
          );
        }
        return (
          ...
          (t.prototype.renderer = function (e, t) {
            ...
            return (
              this._textRendererData.points &&
                ...
                n.showLabel.value() &&
                (this._textRenderer.setData(Object(r.__assign)({}, this._textRendererData)),
    ...
    R7Bt: function (e, t, i) {
      ...
      function u(e, t) {
        p.call(this, e, t), (this._rendererCache = {}), (this._trendLineRenderer = new s()), (this._renderer = null);
      }
      inherit(u, p),
        (u.prototype.getCacheRects = function (e, t) {
          if ((p.prototype.getCacheRects.call(this, e, i), !this._cacheState.preparedCells)) return null;
          ...
          switch (c.horzLabelsAlign.value()) {
            case 'left':
              ...
              break;
            case 'center':
              ((d = s.add(o).scaled(0.5)).x += a.width / 2), (d.x = Math.round(d.x));
              break;
            case 'right':
              c.extendLines.value()
                ? (d = new n(u - 4, this._levels[t].y))
                : (((d = new n(u + 4, this._levels[t].y)).x += a.width), (d.x = Math.round(d.x)));
          }
          var f = {
              left: a.left,
            ...
            v = { left: d.x - f.width, top: d.y, width: a.width, height: f.height },
        ...
        (u.prototype._updateImpl = function () {
          if ((p.prototype._updateImpl.call(this), (this._renderer = null), !(this._source.points().length < 2))) {
            var e = this._source.priceScale();
            if (e && !e.isEmpty() && !this._model.timeScale().isEmpty()) {
              ...
              if (null != t) {
                var i = this._source.points()[0],
                  ...
                  u = !1;
                (C = this._source.properties()).reverse && C.reverse.value() && (u = C.reverse.value()),
                  (this._levels = []);
                var _,
                  f,
                  v = u ? i.price : r.price,
                ...
                if (w) (_ = e.priceToCoordinate(v, t)), (f = e.priceToCoordinate(g, t) - _);
                for (
                ...
                if (!(this._points.length < 2)) {
                  var C,
                    M = new h(),
                    I = ((i = this._points[0]), (r = this._points[1]), Math.min(i.x, r.x)),
                    O = Math.max(i.x, r.x),
                    ...
                    for (R = 0; R < this._levels.length; R++)
                      if (R > 0 && D) {
                        var A = this._levels[R - 1],
                          z = ((i = new n(I, this._levels[R].y)), (r = new n(O, A.y)), {});
                        (z.points = [i, r]),
                  ...
                  for (R = 0; R < this._levels.length; R++) {
                    var j,
                      H = {
                        points: [(i = new n(E, this._levels[R].y)), (r = new n(V, this._levels[R].y))],
                        width: this._model.timeScale().width(),
                        height: this._source.priceScale().height(),
                    ...
                    if (
                      ((j = new s()).setData(H),
                      j.setHitTest(new l(l.MOVEPOINT, null, this._levels[R].index)),
                      M.append(j),
                  ...
                  if (C.trendline.visible.value()) {
                    ...
                    this._trendLineRenderer.setData(H), M.append(this._trendLineRenderer);
                  }
      ...
      inherit(d, r),
        ...
        (d.prototype._updateImpl = function () {
          if (
            ...
            this._retrace1 = Math.round(100 * Math.abs((i.price - t.price) / (t.price - e.price))) / 100;
          }
          if (this._source.points().length >= 6) {
            i = this._source.points()[3];
            var a = this._source.points()[4],
              o = this._source.points()[5];
            this._retrace2 = Math.round(100 * Math.abs((o.price - a.price) / (a.price - i.price))) / 100;
          }
          if (!(this._points.length < 2)) {
            for (
              var d = this._source.properties(),
                ...
                _ = function (e, t, i, r) {
                  return {
                    ...
                    color: l.generateColor(p._source.properties().color.value(), i),
            ...
            if (this._retrace1) {
              ...
              this._retrace1LabelRenderer.setData(g), c.append(this._retrace1LabelRenderer);
            }
            if (this._retrace2) {
              var y;
              v = _(this._points[3], this._points[5], 70, 1);
              (y = new n()).setData(v), c.append(y);
              g = u(this._points[5].add(this._points[3]).scaled(0.5), this._numericFormatter.format(this._retrace2));
              this._retrace12LabelRenderer.setData(g), c.append(this._retrace12LabelRenderer);
            }
    ...
    SvjA: function (e, t, i) {
      ...
      inherit(p, a),
        (p.prototype._updateImpl = function () {
          if ((a.prototype._updateImpl.call(this), (this._renderer = null), 3 === this._source.points().length)) {
            ...
            for (var _ = 1; _ <= 11; _++) {
              ...
              if (f.visible.value()) {
                ...
                p.showCoeffs.value() && ((w.text = v), (w.y = this._source.priceScale().height())),
                  this._levels.push(w);
              }
            }
          }
          if (!(this._points.length < 2)) {
            ...
            if (b)
              for (_ = 1; _ < this._levels.length; _++) {
                var P = this._levels[_ - 1],
                  L = ((e = new r(P.x, 0)), (t = new r(this._levels[_].x, this._source.priceScale().height())), {});
                (L.points = [e, t]),
            ...
            for (_ = 0; _ < this._levels.length; _++) {
              if (void 0 !== this._levels[_].text) {
                ...
                switch (((M = 'left' === M ? 'right' : 'right' === M ? 'left' : 'center'), p.vertLabelsAlign.value())) {
                  case 'top':
        ...
        (g.prototype._updateImpl = function () {
          if (
            ...
            ((k = {}).points = [d, _]),
              ...
              (k.extendright = !1),
              (k.leftend = u.Normal),
              (k.rightend = Math.abs(i.x - a.x) >= 25 * k.linewidth ? u.Arrow : u.Normal),
            ...
            (d = new r(g, i.y + Math.sign(a.y - i.y) * o)), (_ = new r(g, a.y + Math.sign(i.y - a.y) * o));
            ((k = {}).points = [d, _]),
              (k.width = this._model.timeScale().width()),
              (k.height = this._source.priceScale().height()),
              (k.color = this._source.properties().linecolor.value()),
              ...
              (k.extendright = !1),
              (k.leftend = u.Normal),
              (k.rightend = Math.abs(d.y - _.y) >= 25 * k.linewidth ? u.Arrow : u.Normal),
            ...
            M &&
              ...
              ((this._pipFormatter = new p(M.pricescale, M.minmov, M.type, M.minmove2)), (this._lastSymbolInfo = M));
            var I,
              O =
              ...
              D = f(O) + '\n' + $.t('{0} bars').format(T) + L,
              k = {};
            if (w > y) ((I = a.clone()).y -= 2 * t.fontsize.value()), (I.x = 0.5 * (i.x + a.x)), (k.points = [I]);
            else ((I = a.clone()).x = 0.5 * (i.x + a.x)), (I.y += 0.7 * t.fontsize.value()), (k.points = [I]);
            var B = { x: 0, y: 10 };
            (k.text = D),
            ...
            this._textRenderer.setPoints([A]), e.append(this._textRenderer), this.addAnchors(e), (this._renderer = e);
          }
        }),
    ...
    UfPO: function (e, t, i) {
      ...
      e.exports = function (e, t) {
        var i = document.body,
          r = i[e];
        return r || (((r = document.createElement('img')).src = t), (i[e] = r)), r;
      };
    },
    V8bI: function (e, t, i) {
        ...
        (_.prototype._updateImpl = function () {
          if (
            ...
            ((M = {}).points = [x, m]),
              ...
              (M.extendright = !1),
              (M.leftend = p.Normal),
              (M.rightend = Math.abs(x.y - m.y) >= 15 * M.linewidth ? p.Arrow : p.Normal),
            ...
            P &&
              ...
              ((this._pipFormatter = new c(P.pricescale, P.minmov, P.type, P.minmove2)), (this._lastSymbolInfo = P));
            var L,
              C = u(
              ...
              M = {};
            if (R > b) ((L = l.clone()).y -= 2 * t.fontsize.value()), (L.x = 0.5 * (o.x + l.x)), (M.points = [L]);
            else ((L = l.clone()).x = 0.5 * (o.x + l.x)), (L.y += 0.7 * t.fontsize.value()), (M.points = [L]);
            var I = { x: 0, y: 10 };
            (M.text = C),
              ...
              t.drawBorder && t.drawBorder.value() && (M.borderColor = t.borderColor.value()),
              this._labelRenderer.setData(M);
            var O = this._labelRenderer.measure(),
              D = s(O, o, l, I, f._source.priceScale().height());
            this._labelRenderer.setPoints([D]), e.append(this._labelRenderer), this.addAnchors(e), (this._renderer = e);
          }
        }),
          ...
          return (
            ...
            (t.prototype._updateImpl = function () {
              ...
              var t = new l.CompositeRenderer(),
                i = this._getPoints();
              if (i.length < 2) return this.addAnchors(t), void (this._renderer = t);
              var r = i[0],
                n = i[1],
                a = this._getSource(),
                s = a.isReversed();
            ...
            (t.prototype._initRenderers = function () {
              for (var e = this._getSource(), t = e.levelsCount(), i = 0; i < t; i++)
              ...
              for (i = 0; i < r; i++) this._fanRenderers.push(new s.TrendLineRenderer());
              var n = e.arcsCount();
        ...
        (x.prototype._updateImpl = function () {
          ...
          if (((this._label = null), !(this._source.points().length < 2))) {
            ...
            if (this._source.properties().showPriceRange.value() && this._source.priceScale()) {
              ...
              o = this._source.ownerSource().formatter().format(m) + ' (' + new h().format(100 * b) + ') ';
              var R = this._model.mainSeries().symbolInfo();
              R &&
                R !== this._lastSymbolInfo &&
                ((this._pipFormatter = new c(R.pricescale, R.minmov, R.type, R.minmove2)), (this._lastSymbolInfo = R)),
                (o += this._pipFormatter ? ', ' + this._pipFormatter.format(m) : ''),
                x.push('priceRange');
            }
            ...
            if (this._secondPoint && this._points.length > 0) {
              ...
              this._angleLabelRenderer.setData(V), S.append(this._angleLabelRenderer);
            }
            0,
              this._secondPoint &&
                this._points.length > 0 &&
                S.append(this.createLineAnchor({ points: [this._points[0], this._secondPoint] })),
              (this._renderer = S);
          }
        }),
            ...
            for (var i = t.x - e.x, c = t.y - e.y, p = 1; p <= 9; p++) {
              ...
              if (_.visible.value()) {
                var f,
                  ...
                  x = _.color.value(),
                  m = g + '/' + y;
                g > y ? ((f = t.x), (v = e.y + c / w)) : ((f = e.x + i * w), (v = t.y)),
                  this._fans.push({
                    label: m,
                    color: x,
                    x: f,
    ...
    a6on: function (e, t, i) {
      ...
      function u(e, t) {
        n.call(this, e, t), (this._bezierCubicrenderer = new p()), (this._renderer = null);
      }
      inherit(p, c),
        (p.prototype.setData = function (e) {
          this._data = e;
          ...
          if (null !== this._data) {
            ...
            if (2 === this._data.points.length)
              e.beginPath(),
                ...
                e.lineTo(r.x, r.y),
                e.stroke(),
                this._data.leftend === h.Arrow && a(r, i, e, e.lineWidth, t.pixelRatio),
                this._data.rightend === h.Arrow && a(i, r, e, e.lineWidth, t.pixelRatio);
            else {
              var n = this._data.points[2],
              ...
              if (
                ...
                var f = this._data.extendLeftPoints[this._data.extendLeftPoints.length - 1];
                e.moveTo(f.x, f.y);
                for (var v = this._data.extendLeftPoints.length - 2; v >= 0; v--) {
              ...
              e.stroke(),
                this._data.leftend === h.Arrow && a(d, i, e, e.lineWidth, t.pixelRatio),
                this._data.rightend === h.Arrow && a(_, r, e, e.lineWidth, t.pixelRatio);
            }
          }
        }),
        (p.prototype.hitTest = function (e) {
          if (4 === this._data.points.length) {
            ...
            for (var _ = 1; _ < this._data.extendLeftPoints.length; _++) {
              (t = this._data.extendLeftPoints[_ - 1]), (i = this._data.extendLeftPoints[_]);
              if (r(t, i, e).distance < 3) return new s(s.MOVEPOINT);
            }
            for (_ = 1; _ < this._data.extendRightPoints.length; _++) {
              (t = this._data.extendRightPoints[_ - 1]), (i = this._data.extendRightPoints[_]);
              if (r(t, i, e).distance < 3) return new s(s.MOVEPOINT);
            }
          }
          return null;
        ...
        (u.prototype._updateImpl = function () {
          ...
          if (!(this._points.length < 2)) {
            ...
            this._source._controlPoints &&
              (u.push(this._source.pointToScreenPoint(this._source._controlPoints[0])[0]),
              u.push(this._source.pointToScreenPoint(this._source._controlPoints[1])[0]));
            var _ = {},
            ...
            var v = new o();
            v.append(this._bezierCubicrenderer), this.addAnchors(v), (this._renderer = v);
          }
        }),
        (u.prototype.renderer = function (e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
    ...
    aB9a: function (e, t, i) {
      ...
      function _(e, t, i, r) {
        var n = i + r / 2;
        Object(h.drawRoundRect)(e, t.x - n, t.y - n, 2 * n, 2 * n, (i + r) / 2), e.closePath(), (e.lineWidth = r);
      }
      function f(e, t, i, r) {
          ...
          return (
            (e.prototype.draw = function (e, t) {
              if (this._data.visible) {
                for (var i = [], r = [], n = [], a = [], s = 0; s < this._data.points.length; ++s) {
                  var o = this._data.points[s],
                    l = this._data.backgroundColors[s];
                  o.square ? (i.push(o), r.push(l)) : (n.push(o), a.push(l));
                }
                i.length && ((e.strokeStyle = this._data.color), this._drawPoints(e, t.pixelRatio, i, r, v, f)),
                  n.length && ((e.strokeStyle = this._data.color), this._drawPoints(e, t.pixelRatio, n, a, y, g));
              }
            }),
            (e.prototype.hitTest = function (e) {
              for (var t = this._data.radius || p(), i = 0; i < this._data.points.length; ++i) {
                var r = this._data.points[i];
                if (r.subtract(e).length() <= t + 2) {
                  var n =
                    void 0 !== this._data.pointsCursorType ? this._data.pointsCursorType[i] : c.PaneCursorType.Default;
                  return new s.HitTestResult(this._data.hittestResult, { pointIndex: r.data, cursorType: n });
                }
              }
              return null;
            }),
            ...
            (e.prototype._drawPoints = function (e, t, i, r, n, a) {
              ...
              for (var _ = (h % 2) / 2, f = 0; f < i.length; ++f) {
                var v = i[f];
                if (
                  ((e.fillStyle = r[f]), !(Object(d.isInteger)(v.data) && this._data.linePointBeingEdited === v.data))
                )
                  if (
                    (n(e, new u(Math.round(v.x * t) + _, Math.round(v.y * t) + _, v.data, v.square), c / 2, l),
                    v.subtract(s).length() <= o + 2)
                  ) {
                    var g = Math.max(1, Math.floor(this._data.selectedStrokeWidth * t)),
                      y = Math.round(o * t * 2);
                    y % 2 != h % 2 && (y += 1),
                      a(e, new u(Math.round(v.x * t) + _, Math.round(v.y * t) + _, v.data, v.square), y / 2, g);
                  }
              }
            }),
            e
      ...
      var b = (function () {
        ...
        return (
          ...
          (e.prototype._lineAnchorColors = function (e) {
            var t = this,
              i = Object(x.ensureNotNull)(this._model.paneForSource(this._source)).height();
    ...
    'am+t': function (e, t, i) {
      ...
      inherit(h, l),
        ...
        (h.prototype.hitTest = function (e) {
          ...
          i.y /= n;
          var s = i.length();
          return Math.abs(s - this._data.width / 2) < 3 ? new a(a.MOVEPOINT) : null;
        }),
        inherit(d, n),
        (d.prototype.renderer = function (e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
        ...
        (d.prototype._updateImpl = function () {
          if ((n.prototype._updateImpl.call(this), (this._renderer = null), !(this._points.length < 2))) {
            ...
            if (0 !== l) {
              for (var v = Math.min(d.x, c.x), g = [], y = a; v > -p; y -= l) (v = f.indexToCoordinate(y)), g.push(v);
              v = Math.max(d.x, c.x);
              for (y = o; v < f.width(); y += l) (v = f.indexToCoordinate(y)), g.push(v);
        ...
        h = (function (e) {
          function t(t, i) {
            ...
            return (
              ...
              r._horizLineRenderer.setHitTest(new l.HitTestResult(l.HitTestResult.MOVEPOINT)),
              r
            );
          }
          return (
            ...
            (t.prototype._updateImpl = function () {
              ...
              if (0 !== t.length) {
                ...
                this._horizLineRenderer.setData(i), this._vertLineRenderer.setData(i);
                var r = new o.CompositeRenderer();
          ...
          return (
            ...
            (t.prototype._drawImpl = function (e) {
              if (null !== this._data) {
                ...
                e.scale(1, i),
                  this._data.fillBack &&
                    (this._data.point.x < this._data.center.x && ((s = -s), (l = -l)),
                    e.beginPath(),
                    e.moveTo(l, 0),
                    e.lineTo(s, 0),
                    ...
                    (e.fillStyle = Object(a.generateColor)(this._data.color, this._data.transparency, !0)),
                    e.fill()),
                  e.beginPath(),
        ...
        (d.prototype._updateImpl = function () {
          ...
          if (this._points.length < 2) this._renderer = null;
            ...
            var a = this._source.properties(),
              ...
              u = function (e, t, i, r) {
                return {
                  ...
                  color: l.generateColor(c._source.properties().color.value(), i),
              ...
              _ = u(d[0], d[1], 0);
            if ((this._lineRendererPoints01.setData(_), o.append(this._lineRendererPoints01), d.length >= 3)) {
              _ = u(d[1], d[2], 0);
              this._lineRendererPoints12.setData(_), o.append(this._lineRendererPoints12);
            }
            if (4 === d.length) {
              _ = u(d[2], d[3], 0);
              this._lineRendererPoints23.setData(_), o.append(this._lineRendererPoints23);
            }
            ...
            if (this._points.length >= 3) {
              ...
              this._abRetracementTrend.setData(_), o.append(this._abRetracementTrend);
              f = p(v, this._numericFormatter.format(this._ABRetracement));
              this._abLabelRenderer.setData(f), o.append(this._abLabelRenderer);
            }
            if (this._points.length >= 4) {
              (v = this._points[1].add(this._points[3]).scaled(0.5)), (_ = u(this._points[1], this._points[3], 70, 1));
              this._cdRetracementTrend.setData(_), o.append(this._cdRetracementTrend);
    ...
    bcXK: function (e, t, i) {
      ...
      function _(e, t) {
        p.call(this, e, t), (this._rendererCache = {}), (this._trendLineRenderer = new a()), (this._renderer = null);
      }
      inherit(u, c),
        (u.prototype._drawImpl = function (e) {
          (e.lineCap = 'butt'),
        ...
        (_.prototype._updateImpl = function () {
          if (
            ...
            this._levels = [];
            for (var a = this._source.properties(), h = this._source.levelsCount(), c = 1; c <= h; c++) {
              var _ = a['level' + c];
              if (_.visible.value()) {
                var f = _.coeff.value(),
                  v = _.color.value(),
            ...
            if (!(this._floatPoints.length < 2)) {
              var x = new l(),
                m = ((e = this._floatPoints[0]), (a = this._source.properties()).fillBackground.value()),
              ...
              if (a.trendline.visible.value()) {
                ...
                this._trendLineRenderer.setData(L), x.append(this._trendLineRenderer);
              }
              this.addAnchors(x), (this._renderer = x);
            }
          }
          ...
          if (
            ...
            if (this._source._pattern && this._source._pattern.length > 0 && 2 === this._source.points().length) {
              var e = this._source.priceScale(),
                ...
                v = this._source.points()[0].index > this._source.points()[1].index ? 1 : 0,
                g = this._points[v],
                y = g.x,
                w = Math.abs((this._points[0].x - this._points[1].x) / (this._source._pattern.length - 1)),
                x = {
                  0: function (e) {
                    return { high: _(e[TradingView.HIGH_PLOT]), low: _(e[TradingView.LOW_PLOT]) };
                  },
                  1: function (e, t) {
                    return new r(y + t * w, _(e[TradingView.CLOSE_PLOT]) + g.y);
                  },
                  2: function (e) {
                    return { open: _(e[TradingView.OPEN_PLOT]), close: _(e[TradingView.CLOSE_PLOT]) };
                  },
                  3: function (e, t) {
                  ...
                  6: function (e, t) {
                    return new r(y + t * w, _((e[TradingView.HIGH_PLOT] + e[TradingView.LOW_PLOT]) / 2) + g.y);
                  },
                };
            ...
            if (this._pattern && 2 === this._source.points().length) {
              ...
              if (f === p.Bars || f === p.OpenClose) {
                for (
                  var b = new d(), R = f === p.Bars ? ['high', 'low'] : ['open', 'close'], T = R[0], S = R[1], P = 0;
                ...
                b.append(this.createLineAnchor({ points: this._points })), (this._renderer = b);
              } else {
                var O;
                b = new d();
                ((O = {}).barSpacing = w),
                  ...
                  (O.histogramBase = 0),
                  (O.lineIndex = 0),
                  (O.lineColor = c.generateColor(this._source.properties().color.value(), 10)),
              ...
              this._medianRenderer.setData(E), b.append(this._medianRenderer), (this._renderer = b);
            }
          }
        }),
    ...
    'cT+B': function (e, t, i) {
      ...
      var r = i('aO4+').Point,
        ...
        h = i('a7Ha').LineEnd;
      function d(e, t) {
        n.call(this, e, t), (this._medianRenderer = new a()), (this._sideRenderer = new a()), (this._renderer = null);
      }
      function c(e, t) {
      ...
      function u(e, t) {
        d.call(this, e, t), (this._backSideRenderer = new a()), (this._centerRenderer = new a());
      }
      inherit(d, n),
        (d.prototype._updateImpl = function () {
          n.prototype._updateImpl.call(this),
            ...
            for (
              ...
              if (f.visible.value()) {
                ...
                var b = {
                  ...
                  R = new a();
                R.setData(b), R.setHitTest(new o(o.MOVEPOINT, null, _)), t.append(R);
                var T = {
                    points: [x, m],
                    width: this._model.timeScale().width(),
                    height: this._source.priceScale().height(),
                  ...
                  S = new a();
                S.setData(T), S.setHitTest(new o(o.MOVEPOINT, null, _)), t.append(S);
              }
            }
            this.addAnchors(t), (this._renderer = t);
          }
            ...
            for (
              ...
              if (v.visible.value()) {
                ...
                var m = {
                  ...
                  b = new a();
                b.setData(m), b.setHitTest(new o(o.MOVEPOINT, null, f)), t.append(b);
                var R,
                  T = {
                    points: [w, x],
                    width: this._model.timeScale().width(),
                ...
                (R = new a()).setData(T), R.setHitTest(new o(o.MOVEPOINT, null, f)), t.append(R);
              }
            }
            this.addAnchors(t), (this._renderer = t);
          }
              ...
              for (var v = 0; v <= 8; v++) {
                ...
                if (g.visible.value()) {
                  ...
                  var b = {
                    ...
                    R = new a();
                  R.setData(b), R.setHitTest(new o(o.MOVEPOINT, null, v)), e.append(R);
                  var T,
                    S = {
                      points: [x, m],
                      width: this._model.timeScale().width(),
                  ...
                  (T = new a()).setData(S), T.setHitTest(new o(o.MOVEPOINT, null, v)), e.append(T);
                }
              }
              this.addAnchors(e), (this._renderer = e);
        ...
        s = (function () {
          ...
          return (
            ...
            (e.prototype.hitTest = function (e) {
              ...
              return Object(n.pointInBox)(e, Object(r.box)(t, i)) ? new a.HitTestResult(a.HitTestResult.REGULAR) : null;
            }),
            e
          );
        })();
      ...
      inherit(d, n),
        ...
        (d.prototype._updateImpl = function () {
          if ((n.prototype._updateImpl.call(this), (this._renderer = null), 0 !== this._points.length)) {
            ...
            if (
              (e.append(this._lineRenderer), this._source.properties().showLabel.value() && 1 === this._points.length)
            ) {
            ...
            if (1 === this._points.length) {
              var p = new r(this._model.timeScale().width() / 2, this._points[0].y);
              (p.data = 0), (p.square = !0), e.append(this.createLineAnchor({ points: [p], pointsCursorType: h }));
            }
            this._renderer = e;
          }
        }),
    ...
    'ct+2': function (e, t, i) {
        ...
        return (
          ...
          (e.prototype.hitTest = function (e) {
            ...
            switch (this._data.direction) {
              case 'up':
                (r = (t = this._data.point.x - 9.75) + 19.5), (n = (i = this._data.point.y) + 12 + 10);
                break;
              case 'down':
                (r = (t = this._data.point.x - 9.75) + 19.5), (i = (n = this._data.point.y) - 12 - 10);
                break;
              case 'left':
                (r = (t = this._data.point.x) + 12 + 10), (n = (i = this._data.point.y - 9.75) + 19.5);
                break;
              case 'right':
                (t = (r = this._data.point.x) - 12 - 10), (n = (i = this._data.point.y - 9.75) + 19.5);
            }
            return e.x < t || e.x > r || e.y < i || e.y > n ? null : new h.HitTestResult(h.HitTestResult.MOVEPOINT);
          }),
          (e.prototype.doesIntersectWithBox = function (e) {
            return null !== this._data && Object(d.pointInBox)(this._data.point, e);
          }),
          e
        );
      })();
      ...
      var u = (function (e) {
        ...
        return (
          ...
          (t.prototype._updateImpl = function () {
            if ((e.prototype._updateImpl.call(this), (this._renderer = null), 1 === this._points.length)) {
              var t = this._getSource(),
              ...
              var l = [this._anchorsOffset ? this._points[0].add(this._anchorsOffset) : this._points[0].clone()];
    ...
    dKqZ: function (e, t, i) {
      ...
      function y(e, t) {
        d.call(this, e, t), (this._arcRenderer = new g()), (this._renderer = null);
      }
      inherit(g, f),
        (g.prototype.setData = function (e) {
        ...
        (g.prototype._drawImpl = function (e) {
          if (!(null === this._data || this._data.points.length < 2)) {
            ...
            (w = h(x, w)),
              ...
              (w = h(x, w)),
              (x = o(1, f / (2 * d))),
              (w = h(x, w)).y < 0 ? (this._data.clockwise = !0) : (this._data.clockwise = !1),
              e.save(),
              e.beginPath(),
              e.translate(t.x, t.y),
              e.rotate(y);
        ...
        (g.prototype.hitTest = function (e) {
          ...
          var t = this._data.points[0],
            ...
            d = n(t, i, a).distance;
          if (d < 1) return (d = n(t, i, e).distance) < 5 ? new p(p.MOVEPOINT) : null;
          var c = i.subtract(t),
            u = c.length(),
          ...
          var x,
            m = 1 - Math.sqrt(3) / 2;
          if (((w = o(1, (u * m) / d)), (e = h(w, e)), (f = h(w, f)), e.y * f.y < 0)) return null;
          x = e.y < 0 ? new r(0.5 * u, (u * Math.sqrt(3)) / 2) : new r(0.5 * u, (-u * Math.sqrt(3)) / 2);
        ...
        (y.prototype._updateImpl = function () {
          if ((d.prototype._updateImpl.call(this), (this._renderer = null), 0 !== this._points.length)) {
            var e = {};
            (e.points = this._points),
              (e.color = this._source.properties().color.value()),
              (e.linewidth = this._source.properties().linewidth.value()),
            ...
            if (((p.data = 0), i.push(p), 1 !== e.points.length)) {
              ...
              if (((f.data = 1), 2 !== e.points.length)) {
                ...
                var L = e.points[2],
                  C = l(-x.x, -x.y);
                (L = h(C, L)), (C = s(-P)), (L = h(C, L)), (C = o(1, R / (2 * y)));
                var M = (L = h(C, L)).y >= 0 ? new r(g.x, g.y) : new r(b.x, b.y);
                (M.data = 2), i.push(M);
                var I = [v.Default, v.Default, c(a, _)];
                t.append(this.createLineAnchor({ points: i, pointsCursorType: I }));
    ...
    eg8N: function (e, t, i) {
      ...
      var r = i('aO4+').Point,
        ...
        d = i('a7Ha').LineEnd;
      function c(e, t) {
        n.call(this, e, t), (this._numericFormatter = new h()), (this._renderer = null);
      }
      inherit(c, n),
        (c.prototype.renderer = function (e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
        ...
        (c.prototype._updateImpl = function () {
          if (
            ...
            if (((this._hfans = []), (this._vfans = []), C.fans.visible.value()))
              for (u = 1; u <= 7; u++) {
                (m = Math.round(w + C['hlevel' + u].coeff.value() * y)), (v = c + C['vlevel' + u].coeff.value() * h);
                this._hfans.push(this._model.timeScale().indexToCoordinate(m)),
                  this._vfans.push(this._source.priceScale().priceToCoordinate(v, p));
              }
            var R = new l();
            ...
            for (u = 0; u < this._hlevels.length; u++) {
              ...
              var B = {
                points: [(e = new r(T, this._hlevels[u].y)), (t = new r(P, this._hlevels[u].y))],
                width: this._model.timeScale().width(),
                height: this._source.priceScale().height(),
              ...
              if (((V = new o()).setData(B), R.append(V), C.showLeftLabels.value())) {
                var N = {
                  points: [e],
            ...
            for (u = 0; u < this._vlevels.length; u++) {
              (e = new r(this._vlevels[u].x, S)), (t = new r(this._vlevels[u].x, L));
              if (u > 0 && O) {
                k = this._vlevels[u - 1];
                var z,
                  E = new r(k.x, S);
              ...
              if (((V = new o()).setData(B), R.append(V), C.showTopLabels.value())) {
                var j = {
                  points: [e],
            ...
            var W = this;
            F(R, this._hfans, !0), F(R, this._vfans, !1), this.addAnchors(R), (this._renderer = R);
          }
          function F(e, t, i) {
            var n = new r(T, S),
              a = new r(P, S),
          ...
          if (
            ...
            if (!(this._points.length < 2)) {
              ...
              if (
                ...
                (((n = this._points[2]).x = t.x), ((a = e.clone()).y = n.y), (a.data = 3), l.fillBackground.value())
              ) {
              ...
              g(this._p1LabelRenderer, this._p2LabelRenderer, e, t, this._price1, this._price2),
                ...
                g(this._p3LabelRenderer, this._p4LabelRenderer, n, a, this._price3, this._price3);
              var y = [e, t, n, a];
        ...
        s = (function (e) {
          function t() {
            ...
            return (
              ...
              (t._backHitTest = new n.HitTestResult(n.HitTestResult.MOVEPOINT_BACKGROUND)),
              t
            );
          }
          return (
            ...
            (t.prototype.hitTest = function (e) {
              ...
              if (Math.abs(i - this._data.radius) <= 4) {
                ...
                if (Math.max(r, n) <= this._data.p1.subtract(this._data.p2).length()) return this._hitTest;
              }
            ...
            (t.prototype._drawImpl = function (e) {
              if (
                ...
                if (
                  ...
                  t.addColorStop(0, Object(a.generateColor)(this._data.color1, this._data.transparency)),
                    t.addColorStop(1, Object(a.generateColor)(this._data.color2, this._data.transparency)),
                    (e.fillStyle = t);
                } else e.fillStyle = Object(a.generateColor)(this._data.color, this._data.transparency, !0);
                e.fill();
              }
            }),
            t
      ...
      inherit(l, n),
        ...
        (l.prototype._updateRenderer = function () {
          if (!(this._points.length < 2)) {
            ...
            if ((this._baseTrendRenderer.setData(a), e.append(this._baseTrendRenderer), this._points.length < 3))
              return this.addAnchors(e), void (this._renderer = e);
            var l = i[2],
              h = l.data,
    ...
    l5Au: function (e, t, i) {
      ...
      var r = i('aB9a').LineSourcePaneView,
        ...
        l = i('a7Ha').LineEnd;
      function h(e, t) {
        r.call(this, e, t), (this._medianRenderer = new a()), (this._sideRenderer = new a()), (this._renderer = null);
      }
      inherit(h, r),
        (h.prototype._updateImpl = function () {
          if (
            ...
            for (
              var h = 0,
                d = this._floatPoints[2].subtract(this._floatPoints[1]).scaled(0.5),
              ...
              if (f.visible.value()) {
                ...
                (x = new a()).setData(w), x.setHitTest(new s(s.MOVEPOINT, null, u)), e.append(x);
                var x,
                  m = {
                ...
                (x = new a()).setData(m), x.setHitTest(new s(s.MOVEPOINT, null, u)), e.append(x);
              }
            }
            this.addAnchors(e), (this._renderer = e);
          }
    ...
    lZ9F: function (e, t, i) {
      ...
      function p(e, t) {
        a.call(this, e, t), (this._poligonRenderer = new l()), (this._renderer = null);
      }
      inherit(p, a),
        (p.prototype._updateImpl = function () {
          if (
            ...
            if (3 === this._points.length) {
              (e.data = 2), (i.data = 2), (t.data = 2), (l.data = 2), m.push(e, i, t, l);
              var R = s(_, f);
              b.push(R, R, R, R);
            }
            p.append(this.createLineAnchor({ points: m, pointsCursorType: b })), (this._renderer = p);
          }
        }),
        (p.prototype.renderer = function (e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
      ...
      inherit(n, r),
        (n.prototype._updateBaseData = function () {
          ...
          this._source.points().length >= 3 &&
            ...
            this._source.points().length >= 4 &&
              ((r = this._source.points()[3]),
              (this._BCRetracement = Math.round(1e3 * Math.abs((r.price - e.price) / (t.price - e.price))) / 1e3)),
            this._source.points().length >= 5 &&
              ((n = this._source.points()[4]),
              (this._CDRetracement = Math.round(1e3 * Math.abs((n.price - r.price) / (r.price - i.price))) / 1e3),
              (this._XDRetracement = Math.round(1e3 * Math.abs((n.price - r.price) / (e.price - r.price))) / 1e3));
        }),
        (t.CypherPaneView = n);
    },
    mr3a: function (e, t, i) {
            ...
            (t.prototype._updateImpl = function () {
              ...
              if (i && !i.isEmpty()) {
                ...
                if (
                  ...
                  r.fillBackground && r.fillBackground.value() && (l.backgroundColor = r.backgroundColor.value()),
                  r.drawBorder && r.drawBorder.value() && (l.borderColor = r.borderColor.value()),
                  r.wordWrap && r.wordWrap.value() && (l.wordWrapWidth = r.wordWrapWidth.value()),
                  ...
                  t.isPriceDencityLog() &&
                    !i.isLog() &&
                    (f = i.height() / (Object(c.toLog)(u.maxValue()) - Object(c.toLog)(u.minValue()))),
                    !t.isPriceDencityLog() &&
                      i.isLog() &&
                      (f = i.height() / (Object(c.fromLog)(u.maxValue()) - Object(c.fromLog)(u.minValue())));
                  var v = t.priceDencity();
                  void 0 !== v && (l.scaleY = f / v),
                    (void 0 === v || void 0 === l.scaleY || l.scaleY <= 0) && delete l.scaleY;
                }
                if ((this._textRenderer.setData(l), 1 === l.points.length && !this._noSelection)) {
                  ...
                  if (l.wordWrapWidth) {
                    ...
                    (b.data = 0), g.append(this.createLineAnchor({ points: [b], pointsCursorType: _ }));
                  }
    ...
    'obU/': function (e, t, i) {
      ...
      function y(e, t) {
        d.call(this, e, t), (this._ellipseRenderer = new g()), (this._renderer = null);
      }
      inherit(g, v),
        (g.prototype.setData = function (e) {
        ...
        (g.prototype._drawImpl = function (e) {
          if (!(null === this._data || this._data.points.length < 2)) {
            ...
            (w = h(x, w)),
              ...
              e.stroke(),
              this._data.fillBackground &&
                ((e.fillStyle = u.generateColor(this._data.backcolor, this._data.transparency)), e.fill());
          }
        }),
        ...
        (g.prototype.hitTest = function (e) {
          ...
          (w = s(-y)), (e = h(w, e)), (x = h(w, x)), (w = o(1, f / (2 * d))), (e = h(w, e)), (x = h(w, x));
          var m = e.length();
          return this._additionalPointTest(e, x)
            ? Math.abs(m - 0.5 * f) <= 3
              ? new c(c.MOVEPOINT)
              : this._data.fillBackground && !this._data.noHitTestOnBackground && m <= 0.5 * f
        ...
        (y.prototype._updateImpl = function () {
          if ((d.prototype._updateImpl.call(this), (this._renderer = null), !(this._points.length < 2))) {
            var e = {};
            (e.points = this._points),
              (e.color = this._source.properties().color.value()),
              (e.linewidth = this._source.properties().linewidth.value()),
            ...
            t.append(this.createLineAnchor({ points: [v, g, y, w], pointsCursorType: m })), (this._renderer = t);
          }
        }),
        (t.EllipsePaneView = y);
    },
      ...
      function T(e, t) {
        a.call(this, e, t),
          ...
          x.onAllIconsReady().subscribe(this, function () {
            this._cache && (this._cache.destroy(), (this._cache = null)), t.lightUpdate();
          });
      }
      inherit(T, a),
        (T.prototype.update = function () {
        ...
        (T.prototype.getCacheRects = function (e, t) {
          ...
          var i = this._source.properties().statsPosition.value(),
            ...
            a = { left: Math.floor(r.x), top: Math.floor(r.y), width: n.width, height: n.height };
          return (
        ...
        (T.prototype._createCacheIfRequired = function (e) {
          (null != this._cache && null != this._cacheDrawParams && w(e, this._cacheDrawParams)) ||
        ...
        (T.prototype.destroy = function () {
          this._cache && (this._cache.destroy(), (this._cache = null)), x.onAllIconsReady().unsubscribeAll(this);
        }),
        (T.prototype._updateImpl = function () {
              ...
              if (!(r.length < 2)) {
                ...
                if (
                  (!(l.index < i.firstBar() && h.index < i.firstBar()) ||
                    d.extendLeft.value() ||
                    d.extendRight.value()) &&
                  (a.prototype._updateImpl.call(this), !(this._points.length < 2))
                ) {
                  ...
                  var m =
                    ...
                    b = (this.isHoveredSource() || this.isSelectedSource()) && d.showMiddlePoint.value();
                  ...
                  if (
                    ...
                    T = 'left' === C ? S.clone() : 'right' === C ? P.clone() : new n((l.x + h.x) / 2, (l.y + h.y) / 2);
                    ...
                    this._labelRenderer.setData(I), y.append(this._labelRenderer);
                  }
                  this._renderer = y;
                }
              }
        ...
        (T.prototype._statLabelData = function () {
          ...
          if (h.showPriceRange.value() && this._source.priceScale()) {
            ...
            e =
              this._source.ownerSource().formatter().format(r) + ' (' + this._percentageFormatter.format(100 * u) + ')';
            var _ = this._model.mainSeries().symbolInfo();
            _ &&
              _ !== this._lastSymbolInfo &&
              ((this._pipFormatter = new c(_.pricescale, _.minmov, _.type, _.minmove2)), (this._lastSymbolInfo = _)),
          ...
          if (g || y || w) {
            if (((t = ''), g && ((a = l.index - o.index), (t += $.t('{0} bars').format(b(a)))), y)) {
            ...
            if (w) {
              t && (t += ', '), void 0 === r && (r = l.price - o.price), void 0 === a && (a = l.index - o.index);
              var P = Math.round(1e5 * Math.sqrt(r * r + a * a)) / 1e5;
              t += $.t('distance: {0}').format(b(this._numericFormatter.format(P)));
            }
            t && p.push('barsRange');
          }
          if (h.showAngle.value()) {
            ...
            if (
              ...
              var I = M.subtract(C);
              I.length() > 0 && ((I = I.normalized()), (L = Math.acos(I.x)), I.y > 0 && (L = -L));
            }
            'number' != typeof L ||
              TradingView.isNaN(L) ||
        ...
        (d.prototype._updateImpl = function () {
          if (
            ...
            if (
              ...
              this._price4 = this._source.priceScale().formatPrice(n.price + a, i);
            }
            if (!(this._points.length < 2)) {
              var s,
                l = new o(),
              ...
              if (this._points.length >= 3) {
                ...
                var u = t.y - e.y;
                if ((((s = e.clone()).y = n.y + u), (s.data = 3), d.fillBackground.value())) {
              ...
              this._trendLineRendererPoints43.setData(y(s, n)),
                ...
                x(this._p3LabelRenderer, this._p4LabelRenderer, n, s, this._price3, this._price4);
              var m = [e, t, n, s];
              this._model.lineBeingCreated() === this._source && m.pop(),
                l.append(this.createLineAnchor({ points: m, pointsCursorType: h })),
                (this._renderer = l);
            }
          }
        }),
        ...
        (h.prototype._updateImpl = function () {
          if ((n.prototype._updateImpl.call(this), (this._renderer = null), !(this._points.length < 2))) {
            var e = this._source.points(),
              ...
              f = this._model.timeScale();
            if (0 !== o) {
              for (var v = f.indexToCoordinate(a), g = [], y = a; v > -c; y -= o)
                (v = f.indexToCoordinate(y)), g.push(v);
              v = v = f.indexToCoordinate(a + o);
              for (y = a + o; v < f.width(); y += o) (v = f.indexToCoordinate(y)), g.push(v);
              for (var w = 0; w < g.length; w++) {
                var x = new l({
                  point: new r(g[w], h.y),
                  width: c,
    ...
    tjxb: function (e, t, i) {
      ...
      inherit(l, o),
        ...
        (l.prototype._drawArrow = function (e, t, i) {
          ...
          e.translate(t, i), 'buy' !== n && e.rotate(Math.PI), CanvasEx.drawArrow(e, 0, 0, 0, r), e.restore();
        }),
        ...
        (l.prototype._drawImpl = function (e) {
          ...
          if (0 !== r) {
            var n = this._adapter.getArrowHeight(),
              ...
              l = 'buy' === this._adapter.getDirection() ? i + n + s : i - n - s - o;
        ...
        (l.prototype.hitTest = function (e) {
          ...
          if (
            ('buy' === this._adapter.getDirection() ? ((t = n), (i = n + a)) : ((t = n - a), (i = n)),
        ...
        (h.prototype._updateImpl = function () {
          n.prototype._updateImpl.call(this), (this._renderer = null), (this._rendererCached = !1);
        }),
        (h.prototype.renderer = function (e, t) {
            ...
            if (i) {
              ...
              if (
                ...
                var l = new h(),
                  ...
                  w = this._points[f.ActualEntry] ? this._points[f.ActualEntry].x : this._points[f.Close].x,
                  x = this._points[f.ActualClose] ? this._points[f.ActualClose].x : this._points[f.Close].x,
                ...
                if (
                  ...
                  (b = new r(w, this._entryLevel)), (R = new r(x, this._closeLevel));
                  ((C = {}).points = [b, R]),
                    (C.color = 'white'),
                    (C.linewidth = 0),
                    (C.backcolor = c.stopBackground.value()),
                    (C.fillBackground = !0);
                  var T = 100 - 100 * (1 - (S = 0.01 * c.stopBackgroundTransparency.value()) * S * S);
                  (C.transparency = T),
                    (C.extendLeft = !1),
                    (C.extendRight = !1),
                ...
                (b = new r(g, this._entryLevel)), (R = new r(m, this._profitLevel));
                if (
                  (((C = {}).points = [b, R]),
                  (C.color = 'white'),
                  (C.linewidth = 0),
                  ...
                  ((C = {}).points = [b, R]),
                    ...
                    (C.fillBackground = !0);
                  var S,
                    P = 100 - 100 * (1 - (S = 0.01 * c.profitBackgroundTransparency.value()) * S * S);
                  (C.transparency = P),
                    (C.extendLeft = !1),
                    (C.extendRight = !1),
                ...
                if (this._points[f.ActualEntry]) {
                  ...
                  (b = this._points[f.ActualEntry]),
                    (R = this._isClosed ? this._points[f.ActualClose] : new r(this._closeBar, this._closeLevel));
                  ((C = {}).points = [b, R]),
                ...
                (b = new r(g, this._points[f.Entry].y)), (R = new r(m, this._points[f.Entry].y));
                ...
                if (
                  (this._points[1] &&
                    void 0 !== this._pl &&
                    (j = this._source.ownerSource().formatter().format(this._pl)),
                  c.compact.value())
                )
                  (V += j ? j + ' ~ ' : ''), (V += c.qty.value() + '\n'), (V += H);
                else {
                ...
                this._pl < 0 ? (F = c.stopBackground.value()) : this._pl > 0 && (F = c.profitBackground.value()),
                  M(this._middleLabelRenderer, E, V, F, 'middle', 0, 'white');
                (b = new r(g, this._stopLevel)), (R = new r(m, this._stopLevel));
                L(this._stopLineRenderer, b, R, c.stopBackground.value());
                var Y = this._model.mainSeries().symbolInfo();
                Y &&
                  Y !== this._lastSymbolInfo &&
                  ((this._pipFormatter = new p(Y.pricescale, Y.minmov, Y.type, Y.minmove2)),
                ...
                (V = c.compact.value()
                  ...
                  M(this._stopLabelRenderer, E, V, c.stopBackground.value(), I < O ? 'bottom' : 'top', 0);
                (b = new r(g, this._profitLevel)), (R = new r(m, this._profitLevel));
                ...
                (V = c.compact.value()
                  ...
                  M(this._profitLabelRenderer, E, V, c.profitBackground.value(), I < O ? 'top' : 'bottom', 0);
    ...
    wacn: function (e, t, i) {
            ...
            (e.prototype.setData = function (e) {
              if (!(e.points.length < 4)) {
                ...
                if (
                  ...
                  null !==
                  Object(l.intersectLines)(Object(a.lineThroughPoints)(i, r), Object(a.lineThroughPoints)(n, s))
          ...
          return (
            ...
            (t.prototype.hitTest = function (e, t) {
              ...
              for (var i = 0, r = this._visiblePolygons(t); i < r.length; i++) {
                var n = r[i];
                if (Object(s.pointInPolygon)(e, n)) return new d.HitTestResult(d.HitTestResult.MOVEPOINT_BACKGROUND);
              }
              return null;
            }),
            (t.prototype._drawImpl = function (e, t) {
              if (!(null === this._data || this._data.points.length < 4)) {
                e.fillStyle = Object(p.generateColor)(this._data.backcolor, this._data.transparency);
                for (var i = 0, r = this._visiblePolygons(t); i < r.length; i++) {
                  var n = r[i];
            ...
            (t.prototype._visiblePolygons = function (e) {
              ...
              var d = Object(l.intersectLines)(Object(a.lineThroughPoints)(r, s), Object(a.lineThroughPoints)(o, h));
              if (null === d) return [];
              var c = [
                  new a.Point(0, 0),
                  new a.Point(e.cssWidth, 0),
              ...
              (u = v(u, d, _, [f, f])), null !== (u = v((u = y(u, t)), f, d, [_, _])) && p.push(u);
              u = c;
              var g = s.subtract(r).add(d),
                w = o.subtract(h).add(d);
              return (u = v(u, d, g, [w, w])), null !== (u = v((u = y(u, t)), w, d, [g, g])) && p.push(u), p;
            }),
            t
          );
      ...
      function g(e, t, i) {
        return null !== e
          ? Object(l.intersectPolygonAndHalfplane)(
              e,
              Object(a.halfplaneThroughPoint)(((r = t), Object(a.line)(1, 0, -r)), new a.Point(i, 0)),
            )
          : null;
        var r;
      }
      function y(e, t) {
        var i = t.points,
          r = i[0],
          n = i[1];
        return t.extendleft || (e = g(e, r.x, n.x)), t.extendright || (e = g(e, n.x, r.x)), e;
      }
    },
    wdUH: function (e, t, i) {
      'use strict';
          ...
          return (
            ...
            (t.prototype._updateImpl = function () {
              ...
              if (!(i.length < 2 || r.length < 2)) {
                ...
                if (s.length < 2) return this.addAnchors(l), void (this._renderer = l);
                var h = s[0],
                  ...
                  _ = d,
                  f = this._getModel(),
                  v = { barsCoordsRange: c, priceCoordsRange: p, startPoint: u, endPoint: _, p1: h, p2: d };
                this._prepareLevels(l, v), this._prepareFanLines(l, v), this._prepareArcs(l, v);
                var g = [h, s[1]];
    ...
    wgWl: function (e, t, i) {
      ...
      var r = i('aO4+').Point,
        ...
        c = i('a7Ha').LineEnd;
      function p(e, t) {
        n.call(this, e, t), (this._levels = []), (this._trendRenderer = new l()), (this._renderer = null);
      }
      inherit(p, n),
        (p.prototype._updateImpl = function () {
          if (
            ...
            if (null !== this._model.timeScale().visibleBarsStrictRange()) {
              ...
              for (var l = x ? x.index - e.index : 1, p = 1; p <= 11; p++) {
                ...
                if (u.visible.value()) {
                  ...
                  t.showLabels.value() && ((f.text = u.coeff.value()), (f.y = this._source.priceScale().height())),
                    this._levels.push(f);
                }
              }
              ...
              if ((t = this._source.properties()).fillBackground.value())
                for (p = 1; p < this._levels.length; p++) {
                  var w = this._levels[p - 1],
                    x = ((e = new r(this._levels[p].x, 0)), new r(w.x, this._source.priceScale().height())),
                    m = {};
                  (m.points = [e, x]),
              ...
              for (p = 0; p < this._levels.length; p++) {
                ...
                if (((R = new a()).setData(b), R.setHitTest(T), y.append(R), void 0 !== this._levels[p].text)) {
                  var S,
                    P = t.horzLabelsAlign.value();
                  switch (
                    ((P = 'left' === P ? 'right' : 'right' === P ? 'left' : 'center'), t.vertLabelsAlign.value())
                  ) {
                    case 'top':
    ...
    xp9B: function (e, t, i) {
      ...
      var r = i('aO4+').Point,
        ...
        c = i('a7Ha').LineEnd;
      function p(e, t) {
        n.call(this, e, t), (this._numericFormatter = new d()), (this._renderer = null);
      }
      inherit(p, n),
        (p.prototype._updateImpl = function () {
          if (
            ...
            if (!(this._floatPoints.length < 2)) {
              var S = new h(),
                P = ((e = this._floatPoints[0]), (t = this._floatPoints[1]), Math.min(e.x, t.x)),
                L = Math.min(e.y, t.y),
                C = Math.max(e.x, t.x),
                M = Math.max(e.y, t.y),
              ...
              for (f = 0; f < this._hlevels.length; f++) {
                (e = new r(P, this._hlevels[f].y)), (t = new r(C, this._hlevels[f].y));
              ...
              for (f = 0; f < this._vlevels.length; f++) {
                (e = new r(this._vlevels[f].x, L)), (t = new r(this._vlevels[f].x, M));
                if (i.grid.visible.value()) {
                  k = {
                    points: [e, t],
                    width: this._model.timeScale().width(),
              ...
              for (e = this._floatPoints[0], t = this._floatPoints[1], f = 0; f < this._hlevels.length; f++) {
                ...
                (Y = new o()).setData(k),
                  Y.setHitTest(new l(l.MOVEPOINT, null, { type: 'h', index: this._hlevels[f].index })),
                  S.append(Y);
              }
              for (f = 0; f < this._vlevels.length; f++) {
                ...
                (Y = new o()).setData(k),
                  Y.setHitTest(new l(l.MOVEPOINT, null, { type: 'v', index: this._vlevels[f].index })),
                  S.append(Y);
              }
    ...
    'y/56': function (e, t, i) {
        ...
        d = (function (e) {
          ...
          return (
            ...
            (t.prototype.doesIntersectWithBox = function (e) {
              return null !== this._data && Object(l.pointInBox)(this._data.point, e);
            }),
            (t.prototype._drawImpl = function (e) {
              null !== this._data &&
                (e.save(),
      ...
      var c = (function (e) {
        function t() {
          var t = (null !== e && e.apply(this, arguments)) || this;
          return (t._flagMarkRenderer = new d()), (t._renderer = null), (t._anchorsOffset = null), t;
        }
        return (
          Object(r.__extends)(t, e),
          ...
          (t.prototype._updateImpl = function () {
            if ((e.prototype._updateImpl.call(this), (this._renderer = null), 1 === this._points.length)) {
              ...
              (this._renderer = new a.CompositeRenderer()), this._renderer.append(this._flagMarkRenderer);
              var i = [this._anchorsOffset ? this._points[0].add(this._anchorsOffset) : this._points[0].clone()];
              this._renderer.append(
                new s.SelectionRenderer({
                  points: i,
                  bgColors: this._lineAnchorColors(i),
