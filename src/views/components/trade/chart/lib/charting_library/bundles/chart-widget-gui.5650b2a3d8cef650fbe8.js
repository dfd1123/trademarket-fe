(window.webpackJsonp = window.webpackJsonp || []).push([
  ['chart-widget-gui'],
  {
      ...
      function a(t, e) {
        ...
        return {
          ...
          availableValues: function () {
            return [
              { value: s.VisibleOnMouseOver, title: window.t('Visible on Mouse Over') },
    ...
    '0jws': function (t, e, i) {
      t.exports = { blockHidden: 'blockHidden-pECc1q1w', 'pane-button': 'pane-button-3IbFaPrJ' };
    },
    '1ANp': function (t, e, i) {
      'use strict';
      i.d(e, 'c', function () {
      ...
      function o(t, e, i, o, n) {
        ...
        (l.className = e),
          ...
          void 0 !== t.title &&
            ...
            void 0 !== t.hotKeyTitle && (l.dataset.tooltipHotkey = t.hotKeyTitle)),
    ...
    TGRH: function (t, e, i) {
      ...
      var s,
        ...
        M = Object(r.b)({ keys: ['Alt', 'Click', 'Alt', 'Enter'], text: '{0} + {1}, {2} + {3}' }),
        ...
        k =
          ...
          '\n</div>',
        T = u.CheckMobile.any(),
        x = (((s = {}).moving = 'wait_finishing'), (s.wait_finishing = 'stop'), (s.stop = 'moving'), s),
        L = { zoomInOut: !0, maximize: !0, scrollLeftRight: !0, resetScale: !0, goToRealtime: !0 },
        H = (function () {
          function t(t, e, i) {
            (this._widget = Object(o.ensureNotNull)(Object(a.a)(V).querySelector('.control-bar-wrapper'))),
              (this._controlBar = Object(o.ensureNotNull)(this._widget.querySelector('.control-bar'))),
              (this._back = Object(o.ensureNotNull)(Object(a.a)(k).querySelector('.control-bar__btn--back-present'))),
          ...
          return (
              ...
              (this._buttons = {
                ...
                this._chart.withModel(this, function () {
                  (t._chartModel = t._chart.model()),
                    (t._priceAxisChanged = t._chart.getPriceAxisWidthChangedByName(t._priceAxisName)),
                    (t._resetAvailabilityChanged = t._chartModel.model().isScalesResetAvailableChanged()),
                    t._priceAxisChanged.subscribe(t, t._updateBackBtnPosition),
                    t._resetAvailabilityChanged.subscribe(t, t._updateResetScalesButtonVisibility);
                  var e = t._chart.getResizerDetacher();
                  e.fullscreenable.subscribe(t._boundUpdateMaximizeButtonsVisibility),
            ...
            (t.prototype._initHandlers = function () {
              ...
              this._buttons.moveLeft.addEventListener(e, function (e) {
                ...
                this._buttons.moveRight.addEventListener(e, function (e) {
                  e.preventDefault(), t._moveByBar(-1), t._trackEvent('Move Right');
                });
            ...
            (t.prototype._updateBtnGroupVisibility = function () {
              for (
                var t = this._leftPriceScaleWidth + this._paneWidth,
                  ...
                  i = 2 * Math.min(t - e, e - this._leftPriceScaleWidth) - 50 - 50,
                  s = !1,
                  o = 0,
            ...
            (t.prototype._move = function (t) {
              ...
              if (
                ...
                this._finishingTimeout && (clearTimeout(this._finishingTimeout), (this._finishingTimeout = 0)),
                (this._startTime = Date.now()),
                0 === this._movingTimeout)
              ) {
                var i = this._startTime,
                  s = function () {
                    e._moveStep(i, 0, 50 * t, 1e3), (e._movingTimeout = setTimeout(s, 10));
                  };
            ...
            (t.prototype._moveStep = function (t, e, i, s) {
              if (null !== this._chartModel && !this._chartModel.timeScale().isEmpty()) {
                ...
                return (
                  (this._currentDistance = (i - e) * l + e), this._chartModel.scrollChart(this._currentDistance), n
                );
              }
            }),
            ...
            (t.prototype._moveByBar = function (t) {
              ...
              if (null !== this._chartModel) {
                ...
                if (i.isEmpty()) return;
                if (
                  ('stop' === this._state && this._chartModel.beginUndoMacro(1 === t ? 'Move Left' : 'Move Right'),
                  null !== i.visibleBarsStrictRange())
                ) {
                  var s = i.indexToCoordinate(i.visibleBarsStrictRange().lastBar()) + i.barSpacing() / 2;
                  Math.abs(i.width() - s) > i.barSpacing() / 6 && this._chartModel.scrollChart(i.width() - s);
                }
                if (
                  ((this._state = x.stop),
                  ...
                  var o = 0,
                    n = 150,
                    l = function () {
                      e._moveByBarStep(t), o++, n > 100 && (n -= (o / 5) * 20), (e._movingTimeout = setTimeout(l, n));
                    };
                  (this._movingTimeout = setTimeout(l, 400)), this._moveByBarStep(t);
                }
              }
            }),
            ...
            (t.prototype._keydownHandler = function (t) {
              ...
              (d.isMacKeyboard && o === d.Modifiers.Mod) ||
                (o !== d.Modifiers.Mod && o !== d.Modifiers.Alt && o !== d.Modifiers.None) ||
            ...
            (t.prototype._keyupHandler = function (t) {
              ...
              if (!Object(h.a)(e, t.target)) {
                ...
                (37 !== i && 39 !== i) ||
                  (s !== d.Modifiers.Mod && s !== d.Modifiers.Alt && s !== d.Modifiers.None) ||
                  ((this._pressedKey[i] = !1), 'by_bar' === this._moveType ? this._stopMoveByBar() : this._stopMove());
              }
            }),
    ...
    ZKFq: function (t, e, i) {
      t.exports = {
        ...
        'maximize-animation-up-bracket': 'maximize-animation-up-bracket-PKA42SoI',
        'maximize-animation-down-bracket': 'maximize-animation-down-bracket-6VpX9y4d',
        'minimize-animation-up-bracket': 'minimize-animation-up-bracket-1ZcEx180',
        'minimize-animation-down-bracket': 'minimize-animation-down-bracket-2sZM5-ln',
        up: 'up-3-Dp9Ytc',
    ...
    jrhZ: function (t, e, i) {
      t.exports = {
        'animation-minimize-corner-left-top': 'animation-minimize-corner-left-top-1QFR0TYG',
        'animation-minimize-corner-right-top': 'animation-minimize-corner-right-top-2OigqFDd',
        'animation-minimize-corner-right-bottom': 'animation-minimize-corner-right-bottom-171Xjuh0',
        'animation-minimize-corner-left-bottom': 'animation-minimize-corner-left-bottom-Gj_EWVOk',
        'animation-maximize-corner-left-top': 'animation-maximize-corner-left-top-1dOMET94',
        'animation-maximize-corner-right-top': 'animation-maximize-corner-right-top-X6SjWmdM',
        'animation-maximize-corner-right-bottom': 'animation-maximize-corner-right-bottom-2lZ_pYbV',
        'animation-maximize-corner-left-bottom': 'animation-maximize-corner-left-bottom-28bRbB5v',
      };
    },
    ku84: function (t, e) {
      t.exports =
          ...
          return (
            ...
            (t.prototype.updateWidgetModeByWidth = function (t) {
              ...
              i.classList.toggle(h.blockHidden, e),
                s.classList.toggle(h.blockHidden, !e || !this._actions.more.visible.value());
            }),
            (t.prototype._render = function () {
              this._renderActions(), this._parentEl.classList.add(d.paneControls), this._wrapEl.append(this._parentEl);
            }),
            (t.prototype._renderActions = function () {
              ...
              (this._listActionsElements.up = Object(u.a)(this._actions.up, d.button, d.buttonIcon, h.blockHidden, t)),
              ...
              for (var e = 0, i = Object.keys(this._listActionsElements); e < i.length; e++) {
                var s = i[e];
                Object(n.ensureNotNull)(this._listActionsElements[s]).classList.add(d.newButton);
              }
              this._parentEl.append(this._listActionsElements.more);
            }),
            (t.prototype._updateActionVisibilities = function (t, e) {
              Object(n.ensureNotNull)(this._listActionsElements[t]).classList.toggle(h.blockHidden, !e);
            }),
            ...
            (t.prototype._updatePaneControlsWidgetVisibility = function () {
              ...
              this._parentEl.classList.toggle(d.hidden, !t),
                this._parentEl.classList.toggle(d.forceHidden, !this._globalVisibility.value() || e);
            }),
            (t.prototype._updateThemedColor = function (t) {
              if (t.length > 0) {
                var e = Object(l.parseRgb)(t),
                  ...
                  s = e[1],
                  o = e[2];
                this._parentEl.style.color = Object(l.rgbaToString)([i, s, o, Object(l.normalizeAlphaComponent)(0.8)]);
        ...
        I = (function () {
          function t(t, e, i, o, n) {
            ...
            (this._actions = {}),
              ...
              (this._paneWidget = e),
              (this._callbacks = o),
              (this._closeButtonVisibility = new S.a(this._getCloseButtonVisibility())),
              (this._upButtonVisibility = new S.a(this._getUpButtonVisibility())),
              (this._downButtonVisibility = new S.a(this._getDownButtonVisibility())),
              (this._maximizeButtonVisibility = new S.a(this._getMaximizeButtonVisibility())),
              ...
              (this._visibilityType = new S.a(this._visibilityTypeProperty.value())),
          ...
          return (
            ...
            (t.prototype._getUpButtonVisibility = function () {
              var t = this._paneWidget.state();
              return this._model.model().panes().indexOf(t) > 0 && !t.isMaximized() && !B;
            }),
            ...
            (t.prototype._getMaximizeButtonVisibility = function () {
              var t = this._paneWidget.state();
              return this._model.model().panes().length > 1 && !t.isMaximized() && !B;
            }),
    ...
    rh3U: function (t, e, i) {
      t.exports = {
        ...
        'blinking-color-animation-notaccurate': 'blinking-color-animation-notaccurate-IBDzDS-b',
        delay: 'delay-NXuSKUfA',
        'blinking-color-animation-delay': 'blinking-color-animation-delay-37meAg0d',
        eod: 'eod-TNCDZArR',
    ...
    sAH5: function (t, e, i) {
      ...
      var M = (function () {
          function t(t, e, i) {
            ...
            (this._values = this._model.values().spawn()),
              ...
              (this._actionsSpawnArray = this._model.actions().map(function (t) {
            ...
            (this._withActions = i.withActions),
              ...
              this._withActions &&
                ((this._showActionsHandler = Object(_.c)(this._showActions.bind(this))),
                (this._hideActionsHandler = Object(_.c)(this._hideActions.bind(this))),
                (this._selectedSourceHandler = Object(_.c)(this._model.setSourceSelected.bind(this._model))),
                ...
                null === this._actionAdditionalWrapperEl ||
                  ...
                  this._actionsParentEl.addEventListener('contextmenu', function (t) {
          ...
          return (
            (t.prototype.destroy = function () {
              ...
              null !== this._el) &&
                (Object(o.ensureNotNull)(this._el.parentNode).removeChild(this._el), (this._el = null));
            }),
            ...
            (t.prototype._render = function () {
              this._renderTitle(),
                ...
                this._firstBlockWrapper.appendChild(Object(o.ensureNotNull)(this._titleParentEl)),
            ...
            (t.prototype._renderTitle = function () {
              ...
              for (var t = this._titleParentEl, e = 0; e < this._titlesSpawns.length; e++) {
                ...
                i.classList.add(m.title, S[e], 'apply-overflow-tooltip'), (i.dataset.name = 'legend-source-title');
            ...
            (t.prototype._renderActions = function () {
              if (this._withActions) {
                ...
                for (
                  var t = Object(o.ensureNotNull)(this._actionAdditionalWrapperEl),
                    e = d.a ? 'large' : 'small',
                    i = 0,
                  ...
                  var n = s[i],
                    l = Object(c.a)(n, m.button, m.buttonIcon, v.blockHidden, e);
                  t.appendChild(l);
                }
              }
            }),
            ...
            (t.prototype._updateTitlesHandler = function (t, e) {
              var i = Object(o.ensureNotNull)(this._titleElements[t]),
                s = 0 === e.length;
              i.classList.toggle(v.blockHidden, s), i.classList.toggle(m.withDot, !s), y(i, e);
            }),
            ...
            (t.prototype._updateValueColorHandler = function (t, e) {
              void 0 === e && (e = ''), (Object(o.ensure)(this._valuesElements[t].value).style.color = e);
            }),
            (t.prototype._updateValueVisibleHandler = function (t, e) {
              var i = Object(o.ensure)(this._valuesElements[t].value).closest('.' + m.valueItem);
              null !== i && i.classList.toggle(v.blockHidden, !e);
            }),
            (t.prototype._updateShowLine = function () {
              null !== this._el && this._el.classList.toggle(v.blockHidden, this._isRowHidden.value());
            }),
            ...
            (t.prototype._updateShowValues = function () {
              null !== this._valuesAdditionalWrapperEl &&
                this._valuesAdditionalWrapperEl.classList.toggle(v.blockHidden, this._isValuesShouldBeHidden());
            }),
            ...
            (t.prototype._addStatusesWidget = function (t, e, i) {
              (this._statusesWrapper = document.createElement('div')),
                ...
                Object(o.ensureNotNull)(this._firstBlockWrapper).appendChild(this._statusesWrapper),
                ...
                (this._resizeObserver = new h.default(this._handlerRestrictTitleWidth.bind(this))),
            ...
            (t.prototype._updateAllButtonsWidth = function () {
              (this._allButtonsWidth = this._getButtonsCount() * z), this._updateTitleMaxWidth();
            }),
            ...
            (t.prototype._handlerRestrictTitleWidth = function (t) {
              if (null !== this._actionsParentEl && null !== this._firstBlockWrapper) {
                for (var e = null, i = null, s = 0, o = t; s < o.length; s++) {
                  var n = o[s];
                  n.target === this._statusesWrapper && (e = n.contentRect.width),
                    n.target === this._actionsParentEl && (i = n.contentRect.width);
                }
                    ...
                    (this._disableTimeout = setTimeout(function () {
                      null !== t._el &&
                        (!t._loading.value() &&
                          ...
                          t._el.classList.toggle(m.disabled, t._disabled.value()),
            ...
            (t.prototype._updateShowTitles = function () {
              null !== this._titleParentEl &&
                (this._titleParentEl.classList.toggle(v.blockHidden, this._isTitleHidden.value()),
                null !== this._actionsParentEl &&
                  this._actionsParentEl.classList.toggle(v.blockHidden, this._isTitleHidden.value()));
            }),
            ...
            (t.prototype._updateActionVisibilities = function (t) {
              null !== this._actionsParentEl &&
                this._actionsParentEl
                  ...
                  [t].classList.toggle(v.blockHidden, !this._actionsSpawnArray[t].visible.value());
            }),
            ...
            (t.prototype._updateCustomTextColor = function () {
              ...
              for (
                var n = Object(o.ensureNotNull)(this._valuesParentEl).querySelectorAll('.' + m.valueTitle), l = 0;
                l < n.length;
                l++
              )
                n[l].style.color = t;
              Object(o.ensureNotNull)(this._el).classList.toggle(m.withCustomTextColor, Boolean(t));
            }),
            (t.prototype._updateStatusWidgetVisibility = function (t) {
              null !== this._statusesWrapper && this._statusesWrapper.classList.toggle(v.blockHidden, t);
            }),
            t
          );
        })(),
        C = (function (t) {
          function e(e, i, s) {
            ...
            return (
              ...
              o._updateStates(),
              s.statusWidgetEl && o._addStatusesWidget(s.statusWidgetEl, s.hideInvisibleHover, s.hideValues),
          ...
          return (
            ...
            (e.prototype._render = function () {
              ...
              e.classList.add(m.item, m.series),
                e.classList.toggle(m.onlyOneButtonCanBeStick, this._model.isOneButtonCanBeStick()),
            ...
            (e.prototype._renderValues = function () {
              ...
              for (
                var t = Object(o.ensureNotNull)(this._valuesAdditionalWrapperEl), e = 0, i = this._values.value();
                e < i.length;
                e++
              ) {
                var s = i[e],
                  n = document.createElement('div');
                n.classList.add(m.valueItem), n.classList.toggle(v.blockHidden, !s.visible.value());
                var l = document.createElement('div'),
                  a = s.title.value() || '';
            ...
            (e.prototype._updateValuesTitleHTMLElHandler = function (t, e) {
              ...
              y(i, e), i.classList.toggle(v.blockHidden, 0 === e.length), this._updateShowValues();
            }),
            ...
            (e.prototype._updateFlaggedState = function () {
              void 0 !== this._flagged &&
                (Object(o.ensureNotNull)(this._el).classList.toggle(m.flagged, Boolean(this._flagged.value())),
                this._updateTitleMaxWidth());
            }),
            e
          );
        ...
        V = (function (t) {
          function e(e, i, s) {
            ...
            return (
              ...
              o._globalRowVisibility.subscribe(o._updateShowLine.bind(o), { callWithLast: !0 }),
              ...
              s.withActions &&
                ...
                null !== o._titleParentEl && o._titleParentEl.addEventListener(E, o._wheelClickHandler)),
              o
            );
          }
          return (
            ...
            (e.prototype._updateShowLine = function () {
              if (null !== this._el && this._canUpdateRowVisibility) {
                ...
                e ? this._el.classList.toggle(v.blockHidden, e) : t.prototype._updateShowLine.call(this);
              }
            }),
            (e.prototype._getButtonsCount = function () {
              switch (this._mode) {
            ...
            (e.prototype._render = function () {
              t.prototype._render.call(this);
              var e = Object(o.ensureNotNull)(this._el);
              e.classList.add(m.item, m.study), (e.dataset.name = 'legend-source-item');
            }),
            (e.prototype._renderValues = function () {
              null === this._valuesParentEl &&
                ((this._valuesParentEl = document.createElement('div')),
        ...
        A = (function () {
          function t(t, e, i) {
            (this._el = null),
              ...
              (this._showObjectTreeHandler = Object(_.c)(i.onShowObjectsTreeDialog)),
              null !== this._el &&
          ...
          return (
            ...
            (t.prototype._updateObjectTreeVisibility = function (t) {
              Object(o.ensureNotNull)(this._el).classList.toggle(m.objectsTreeCanBeShown, t);
            }),
            t
          );
        })(),
        ...
        N = (function () {
          function t(t, e) {
            (this._renderToggler = null),
              ...
              this._parentEl.style.setProperty('--legend-source-item-button-width', z + 'px'),
          ...
          return (
            ...
            (t.prototype.addMainDataSource = function (t, e) {
              ...
              this._renderMainDataSourceEl(),
                (this._mainDataSourceRenderer = new C(t, Object(o.ensureNotNull)(this._mainDataSourceEl), {
                ...
                t.onDestroy().subscribe(
                  ...
                  function () {
                    null !== i._mainDataSourceRenderer &&
                      (i._mainDataSourceRenderer.destroy(), (i._mainDataSourceRenderer = null));
                  },
                  !0,
                );
            }),
                  ...
                  n = function (o) {
                    var n = t[o],
                      a = new V(n, s, {
                        ...
                        hideInvisibleHover: D(e[o].visibleWidgetsCount, function (t) {
                          return Boolean(t);
                        }),
            ...
            (t.prototype.addCustomWidget = function (t, e) {
              if (0 === e.block) {
                ...
                1 === e.position && i.insertBefore(t.getElement(), i.firstChild),
                  0 === e.position && i.appendChild(t.getElement());
              }
              if (1 === e.block) {
                this._renderDataSourcesEl();
                var s = Object(o.ensureNotNull)(this._dataSourcesAdditionalWrapperEl);
                1 === e.position && s.insertBefore(t.getElement(), s.firstChild),
            ...
            (t.prototype._renderToggle = function (t) {
              this._options.showToggleButton &&
                (this._renderToggler = new A(t, this._options.themedColor, this._togglerOptions));
            }),
            ...
            (t.prototype._addOutsideEventForHideTooltip = function () {
              ...
              null !== this._outsideEventForCollapsedTooltip && this._outsideEventForCollapsedTooltip(),
                (this._outsideEventForCollapsedTooltip = Object(P.a)(
                  ...
                  function () {
                    null !== t._outsideEventForCollapsedTooltip && t._outsideEventForCollapsedTooltip(),
                      Object(O.hide)();
                  },
                  window.document,
                  { touchEnd: !0 },
            ...
            (t.prototype._updateCollapsedSourcesCount = function (t) {
              if (null !== this._collapsedDataSourcesWrapperEl && null !== this._collapsedDataSourcesEl) {
                var e = 0 === t;
                this._collapsedDataSourcesWrapperEl.classList.toggle(v.blockHidden, e),
                  e ||
            ...
            (t.prototype._updateLegendVisibility = function () {
              this._parentEl.classList.toggle(v.blockHidden, this._isAllLegendHidden.value()),
                null !== this._dataSourcesEl &&
                  this._dataSourcesEl.classList.toggle(v.blockHidden, this._isStudiesLegendHidden.value());
            }),
            (t.prototype._setCustomBg = function () {
              ...
              if (t) {
                var o = Object(r.parseRgb)(e),
                  ...
                  l = o[1],
                  a = o[2];
                s = Object(r.rgbaToString)([n, l, a, Object(r.normalizeAlphaComponent)(1 - i / 100)]);
              }
          ...
          return (
            ...
            (t.prototype.onShowSettings = function () {
              this._source.userEditEnabled() &&
                ...
                this._callbacks.showChartPropertiesForSource(this._source, U.TabNames.style),
            ...
            (t.prototype._updateTitle = function () {
              ...
              if (null !== t)
                for (var e = t.getSplitTitle(), i = 0; i < this._titles.length; i++) {
                  var s = e[i],
                    o = Object(K.clean)(Array.isArray(s) ? s.join(' ') : s || '', !0);
            ...
            (t.prototype._calcNewPosition = function (t) {
              ...
              if (
                ...
                e = { clientX: Object(G.isRtl)() ? i.right : i.left, clientY: i.top + i.height + 3 };
              } else {
                var s = t;
        ...
        lt = (function (t) {
          function e(e, i, s, o, n) {
            ...
            (a._titles = [new l.a(''), new l.a(''), new l.a(''), new l.a('')]),
              ...
              a._model
                .model()
                .properties()
                .paneProperties.legendProperties.showSeriesTitle.subscribe(a, function () {
                  a._isTitleHidden.setValue(a._getTitleHiddenValue());
                });
            for (
              var r = 0,
                u = [
                  a._model.model().properties().paneProperties.legendProperties.showSeriesOHLC,
                  a._model.model().properties().paneProperties.legendProperties.showBarChange,
                ];
              r < u.length;
              r++
            ) {
          ...
          return (
            ...
            (e.prototype.onShowSettings = function () {
              this._source.userEditEnabled() && this._callbacks.showGeneralChartProperties(U.TabNames.style);
            }),
            ...
            (e.prototype._getMarkerTitle = function () {
              return null !== this._symbolMarker ? (this._symbolMarker.isMarked() ? ot : st) : '';
            }),
            (e.prototype._symbolActionHandler = function () {
              null !== this._symbolMarker && (this._updateSymbolMarker(), Ai('Change flag state'));
            }),
      ...
      var ut = i('z61+'),
        ...
        Mt = (function (t) {
          function e(e, i, s, o, n) {
            ...
            return (
              ...
              a._model
                .model()
                .properties()
                .paneProperties.legendProperties.showStudyTitles.subscribe(a, function () {
                  a._isTitleHidden.setValue(a._getTitleHiddenValue());
                }),
              a._model
                .model()
                .properties()
                .paneProperties.legendProperties.showStudyValues.subscribe(a, function () {
                  a._isValuesHidden.setValue(a._getValuesHiddenValue());
                }),
              a.update(),
              a
          ...
          return (
            ...
            (e.prototype.destroy = function () {
              t.prototype.destroy.call(this),
                this._model.model().properties().paneProperties.legendProperties.showStudyTitles.unsubscribeAll(this),
                this._model.model().properties().paneProperties.legendProperties.showStudyValues.unsubscribeAll(this),
                this._onDestroy.fire();
            }),
            ...
            (e.prototype.updateSource = function (e) {
              this._source !== e &&
                (this._values.setValue([]), t.prototype.updateSource.call(this, e), this._updateAbleShowSourceCode());
            }),
                ...
                (this._source.hasChildren()
                  ? ((t = this._model.removeSource.bind(this._model, this._source, !1)),
                    Object(rt.createConfirmDialog)({
                      ...
                      content: window.t("Do you really want to delete study and all of it's children?"),
                    }).then(function (e) {
              ...
              if (null !== t && 0 !== t.items().length) {
                ...
                if (0 === e.length) {
                  var i = t.items().map(function (t) {
                    return { value: new l.a(t.value()), color: new l.a(Z(t.color())), visible: new l.a(t.visible()) };
                  });
                  ...
                  for (var s = t.items(), o = 0; o < s.length; o++) {
                    var n = e[o],
                      a = s[o];
                    n.value.setValue(a.value()), n.color.setValue(Z(a.color())), n.visible.setValue(a.visible());
                  }
              }
            }),
            (e.prototype._updateStates = function () {
            ...
            (e.prototype._updateVisibilityPineAction = function (t) {
              null !== this._pineAction &&
                (this._pineAction.visible.setValue(t), this._isPineScriptDataSource.setValue(t));
            }),
            (e.prototype._createActions = function () {
              var t = this;
              if (!this._options.readOnlyMode) {
                ...
                yt &&
                  ft &&
                  (!Object(at.isStudy)(this._source) || new ut.a(this._source.metaInfo()).hasUserEditableOptions()) &&
                  this._actions.push({
                    iconMap: new Map([
                      ['large', ht],
                      ['small', ht],
      ...
      function xt(t, e, i, s, o, n) {
        return (function (t, e, i, s, o) {
          ...
          if (void 0 !== l) {
            var a = l.get(1);
            void 0 !== a && a.length > 0 && (n.push.apply(n, a), n.push(new Ct.Separator()));
          }
          ...
          n.push(
            new Ct.Action({
              ...
              onExecute: function () {
                return Tt(t, r.showSeriesTitle, 'Change Symbol Description Visibility');
              },
            }),
          ),
          ...
          if (
            (n.push(
              new Ct.Action({
                ...
                onExecute: function () {
                  return Tt(t, r.showSeriesOHLC, 'Change OHLC Values Visibility');
                },
              }),
            ),
            n.push(
            ...
            var u = l.get(0);
            void 0 !== u && u.length > 0 && (n.push.apply(n, u), n.push(new Ct.Separator()));
          }
          var d = s.get(1);
          if (void 0 !== d) {
            var h = d.get(1);
            void 0 !== h && h.length > 0 && (n.push.apply(n, h), n.push(new Ct.Separator()));
          }
          if (
            (n.push(
              new Ct.Action({
                ...
                onExecute: function () {
                  return Tt(t, r.showStudyTitles, 'Change Indicator Titles Visibility');
                },
              }),
            ),
            n.push(
              new Ct.Action({
                ...
                onExecute: function () {
                  return Tt(t, r.showStudyArguments, 'Change Indicator Arguments Visibility');
                },
              }),
            ),
            n.push(
              new Ct.Action({
                ...
                onExecute: function () {
                  return Tt(t, r.showStudyValues, 'Change Indicator Values Visibility');
                },
              }),
            ),
            void 0 !== d)
            ...
            var c = d.get(0);
            void 0 !== c && c.length > 0 && (n.push.apply(n, c), n.push(new Ct.Separator()));
          }
          0;
          e.settings &&
            (n.push(new Ct.Separator()),
        ...
        Rt = (function () {
          ...
          return (
              ...
              return Object(s.__awaiter)(this, void 0, void 0, function () {
                return Object(s.__generator)(this, function (s) {
                  return [
                    ...
                    null !==
                      (o =
                        null === (i = null === (e = this._infoMaps.htmlMap) || void 0 === e ? void 0 : e.get(t)) ||
                        void 0 === i
                          ? void 0
                          : i.map(Nt.b)) && void 0 !== o
                      ? o
            ...
            (t.prototype._updateIconClassName = function (t) {
              null !== t ? this._iconClassNames.setValue([It.statusItem, t]) : this._iconClassNames.setValue(null);
            }),
            t
          );
        })(),
      ...
      var Kt = Xt,
        ...
        ue = Object(Nt.b)(window.t('{symbolName} data is delayed by {time} minutes.')),
        de = Object(Nt.b)(window.t('{listedExchange} real-time data is available for free to registered users.')),
        he = Object(Nt.b)(window.t('To get real-time data for {description}, please buy the real-time data package.')),
        ce = Object(Nt.b)(
        ...
        be = Object(Nt.b)(window.t('Data is updated once per second, even if there are more updates on the market.')),
        ge = Object(Nt.b)(window.t('Paid plans feature faster data updates.')),
        me = Object(Nt.b)(window.t('Real-time data for {symbolName} is provided by {exchange} exchange.')),
        ve = Object(Nt.b)(
          window.t(
        ...
        we =
          ...
          (function (t) {
            function e(e, i, s) {
              var o = t.call(this, { iconMap: ie, classNameMap: se, titleColorMap: oe, size: i }) || this;
              return (
                (o._dataUpdatedMode = new l.a(null).spawn()),
                (o._options = s),
                (o._model = e),
                (o._dataModeBlinkingStatuses = Kt.spawn()),
                o._dataModeBlinkingStatuses.subscribe(o._updateBlinkingMode.bind(o)),
            ...
            return (
              ...
              (e.prototype.setModel = function (t) {
                if ((this._dataUpdatedMode.destroy(), null === t))
                  return (this._model = t), void (this._dataUpdatedMode = new l.a(null).spawn());
                    ...
                    switch (s.label) {
                      case 0:
                        return null === (t = this._dataUpdatedMode.value())
                          ...
                          : ((e = this._getShortTexts()), [4, this._getHtmls()]);
                      case 1:
              ...
              (e.prototype._getHtmls = function () {
                return Object(s.__awaiter)(this, void 0, void 0, function () {
                  ...
                  return Object(s.__generator)(this, function (s) {
                    switch (s.label) {
                      case 0:
                        if (null === (t = this._dataUpdatedMode.value()) || null === this._model)
                      ...
                      case 3:
                        return (
                          (l = s.sent()),
                          ee.logError("Can't get exchange description, reason: " + Object(Zt.a)(l)),
                          [3, 4]
                        );
                      case 4:
                        for (a = 0, r = t; a < r.length; a++)
                          (u = r[a]),
                            ...
                            ('DelayToRealtime' !== u &&
                              ...
                              'TFEXDelayForGuest' !== u &&
                              'MOEXDelayForGuest' !== u) ||
                              (e[u].push(ue.format({ symbolName: i, time: this._model.time().toString() })),
                              this._options.subscriptionFullInfo &&
                                null !== o &&
                                'DelayToRealtime' === u &&
                                e[u].push(he.format({ description: '<b>' + o + '</b>' })),
                              null !== o &&
                                'DelayNoRealtime' === u &&
                                e[u].push(ce.format({ description: '<b>' + o + '</b>' })),
                              this._options.subscriptionFullInfo &&
                                (u.includes('TFEXDelayForGuest') || u.includes('MOEXDelayForGuest')) &&
                                e[u].push(de.format({ listedExchange: this._model.listedExchange() }))),
                            'EOD' === u && (e[u] = [pe]),
                            'TickByTick' === u &&
                              (e[u].push(this._options.subscriptionFullInfo ? _e : be),
                              this._options.subscriptionFullInfo && e[u].push(ge)),
                            null !== n &&
                              'BATSToRealtime' === u &&
                              e[u].push(me.format({ symbolName: i, exchange: n }), ve);
              ...
              (e.prototype._getActions = function () {
                return Object(s.__awaiter)(this, void 0, void 0, function () {
                  ...
                  return Object(s.__generator)(this, function (s) {
                    switch (s.label) {
                      case 0:
                        return null === this._dataUpdatedMode.value() || null === this._model
                          ? [2, null]
                          : ((t = {}), [3, 4]);
                      case 1:
              ...
              (e.prototype._turnOffBlinking = function () {
                ...
                if (null !== i)
                  for (var s = 0, o = i; s < o.length; s++) {
                    ...
                    (t = n),
                      (e = void 0),
                      (e = Ft.getJSON('tv.alreadyBlinkedStatuses', Gt)).includes(t) ||
                        (e.push(t), Ft.setJSON('tv.alreadyBlinkedStatuses', e), Xt.setValue(Ut()));
                  }
              }),
              e
            );
            ...
            (e.prototype._getHtml = function (t) {
              return Object(s.__awaiter)(this, void 0, void 0, function () {
                ...
                return Object(s.__generator)(this, function (e) {
                  return null === (t = this._dataProblem.value()) ? [2, null] : [2, [Object(Nt.b)(t.text)]];
                });
              });
            }),
            (e.prototype._updateStatus = function (t) {
              var e,
                i = null !== (e = null == t ? void 0 : t.severity) && void 0 !== e ? e : null;
        ...
        Ke = (function () {
          ...
          return (
            ...
            (t.prototype._render = function (t) {
              this._el.classList.add(It.statusItem, It[this._size]), t.appendChild(this._el);
            }),
        ...
        Ze = (function () {
          function t(t, e, i, o) {
            ...
            d.a && l.push(It.touchMode),
              (n = this.element.classList).add.apply(n, Object(s.__spreadArrays)(l, [It[t]])),
                    ...
                    case 1:
                      return (
                        null !== (i = s.sent()) &&
                          ...
                          ('pre_market' === e && this._options.preMarketSolution && i.push(yi),
                          'post_market' === e && this._options.postMarketSolution && i.push(yi)),
                        [2, i]
                      );
                  }
                });
      ...
      var Mi = (function () {
          function t(t, e, i) {
            (this.visibleWidgetsCount = new l.a(0)),
              ...
              (this._renderer = new Ze(this._size, this.visibleWidgetsCount, this._tooltips, {
          ...
          return (
            ...
            (t.prototype._recreateWidgets = function () {
              ...
              if (this._options.sourceStatusesEnabled) {
                if (
                  ...
                  var i = this._source;
                  if (
                    ((this._isSymbolInvalid = Object(Dt.a)(i.isSymbolInvalid.bind(this._source), i.onStatusChanged())),
                    null === this._symbolInvalidViewModel)
                  ) {
                    this._symbolInvalidViewModel = new Oe(this._isSymbolInvalid, {
                      tooltipMap: Re,
                      iconMap: Ne,
                      classNameMap: Ie,
                      titleMap: Fe,
                      ...
                      (this._dataSourceHasErrorVisible = Object(X.a)(
                        function () {
                          return (
                            ...
                            Object(o.ensureNotNull)(e._dataSourceErrorStatusViewModel).visible().value()
                          );
                        },
              ...
              if (this._options.marketStatusEnabled) {
                ...
                if (null === this._marketStatusViewModel) {
                  this._marketStatusViewModel = new fi(a, this._size, this._options.marketStatus);
                  s = Object(X.a)(
                    function () {
                      return (
                        e._marketStatusCanBeShown.value() &&
                        Object(o.ensureNotNull)(e._marketStatusViewModel).visible().value()
                      );
                    },
              ...
              if (this._options.dataUpdateModeEnabled) {
                ...
                if (null === this._dataUpdatedModeViewModel) {
                  this._dataUpdatedModeViewModel = new we(u, this._size, this._options.dataUpdateMode);
                  s = Object(X.a)(
                    function () {
                      return (
                        e._dataUpdatedModeCanBeShown.value() &&
                        Object(o.ensureNotNull)(e._dataUpdatedModeViewModel).visible().value()
                      );
                    },
                  ...
                  s = Object(X.a)(
                    function () {
                      return (
                        ...
                        Object(o.ensureNotNull)(e._dataProblemViewModel).visible().value()
                      );
                    },
            ...
            (t.prototype._updateDropdownMenu = function () {
              var t = this;
              Promise.all([i.e('react'), i.e(4), i.e(24), i.e(92), i.e(0), i.e(2), i.e('full-tooltips-popup')])
        ...
        Vi = window.t("You're in Replay mode. You're in Replay mode. You're in Replay mode."),
        ki =
          (new Map([
            [
              !0,
          ...
          (function (t) {
            function e(e, i, s) {
              var o = t.call(this, e, i, s) || this;
              return (
                (o._isInReplay = new l.a(!1).readonly().spawn()), (o._isInReplayCanBeShown = null), (o._inited = !1), o
              );
            }
            return (
              Object(s.__extends)(e, t),
              ...
              (e.prototype._isPrimaryWidgetShown = function () {
                ...
                return (
                  ...
                  (null !== (i = null === (e = this._isInReplay) || void 0 === e ? void 0 : e.value()) &&
                    void 0 !== i &&
                    i)
                );
              }),
      ...
      var Hi = {
        ...
        Bi = (u.enabled('hide_legend_by_default'), u.enabled('fundamental_widget')),
      ...
      var Oi = (function () {
        function t(t, e, i, o, n, r) {
          ...
          var c = this._model.model().properties().paneProperties.legendProperties.showBackground,
            p = new l.a(c.value());
          c.subscribe(this, function () {
            p.setValue(c.value());
          });
          var _ = this._model.model().properties().paneProperties.legendProperties.backgroundTransparency,
            b = new l.a(_.value());
          _.subscribe(this, function () {
            ...
            this._hideNotMainSources.subscribe(this._updateVisibilityNotMainSources.bind(this)),
            (this._isPaneMain = new l.a(this._getIsPaneMainValue())),
            (this._updateCollapsedSourcesModeThrottle = xi()(this._updateCollapsedSourcesMode.bind(this), 100)),
        ...
        return (
          ...
          (t.prototype.addCustomWidgetToLegend = function (t, e) {
            var i = this._customLegendWidgetsFactoriesMap.get(e.block) || new Map(),
              s = i.get(e.position) || [];
            s.push(t),
              i.set(e.position, s),
          ...
          (t.prototype.onShowLegendWidgetContextMenu = function (t, e) {
            ...
            for (var i = new Map(), s = 0, n = Array.from(this._customLegendWidgetsMap.keys()); s < n.length; s++) {
              for (
                var l = n[s],
                  a = Object(o.ensureDefined)(this._customLegendWidgetsMap.get(l)),
                  r = new Map(),
                  u = 0,
                  d = Array.from(a.keys());
                u < d.length;
                ...
                for (
                  var h = d[u], c = Object(o.ensureDefined)(a.get(h)), p = r.get(h) || [], _ = 0, b = c;
                  _ < b.length;
                  _++
                ) {
                  var g = b[_];
            ...
            return xt(this._model, this._options.contextMenu, this._callbacks.showGeneralChartProperties, i, t, e);
          }),
            ...
            n > -1
              ? (i.splice(n, 1),
                Bi ||
                  ...
                  (this._mainSeriesStatusWidget = new ki(s, this._model.model(), this._options.statusesWidgets)),
            ...
            if (0 === r)
              for (var u = i.length - 1; u >= 0; u--)
                l.push(
                  ...
                  a.push(new Mi(i[u], this._model.model(), this._options.statusesWidgets));
            else {
              var d = 0;
              ...
              for (; this._dataSourceViewModels.length > d; )
                Object(o.ensureDefined)(this._dataSourceViewModels.pop()).destroy();
              for (; this._dataSourcesStatusesWidgets.length > d; )
                Object(o.ensureDefined)(this._dataSourcesStatusesWidgets.pop()).destroy();
            }
            0 !== l.length &&
              ...
              r !== this._dataSourceViewModels.length && this._updateCollapsedSourcesMode(),
          ...
          (t.prototype._updateCustomWidgetModeBySize = function () {
            if (null !== this._size)
              for (var t = 0, e = Array.from(this._customLegendWidgetsMap.values()); t < e.length; t++)
                for (var i = e[t], s = 0, o = Array.from(i.values()); s < o.length; s++)
                ...
                if (t > o + 1) {
                  for (var n = '', l = 0; l < t; l++) {
                    ...
                    this._dataSourceViewModels[l].setGlobalVisibility(a),
                      a || (n += (0 === n.length ? '' : ', ') + this._dataSourceViewModels[l].getFullTitle());
                  }
                  return (
                    this._collapsedDataSourcesTitle.setValue(n), void this._collapsedDataSourcesCount.setValue(t - o)
                  );
                }
              }
            }
          ...
          (t.prototype._recreateVisibilitiesSubscriptions = function () {
            ...
            for (var s = 0, o = Array.from(this._customLegendWidgetsMap.values()); s < o.length; s++)
              for (var n = o[s], l = 0, a = Array.from(n.values()); l < a.length; l++)
                for (var r = 0, u = a[l]; r < u.length; r++) {
                  var d = u[r].visibility().spawn();
                  this._customWidgetsVisibilities.push(d), d.subscribe(this._updateLegendVisibilities.bind(this));
                }
          ...
          (t.prototype._updateVisibilityNotMainSources = function () {
            this._updateLegendVisibilities(), this._hideNotMainSources.value() || this._updateCollapsedSourcesMode();
          }),
          ...
          (t.prototype._addCustomWidgetForLayerBlock = function (t) {
            ...
            if (void 0 !== e) {
              for (
                var i = this._customLegendWidgetsMap.get(t) || new Map(), s = !1, o = 0, n = Array.from(e.keys());
                o < n.length;
                o++
              ) {
                for (var l = n[o], a = i.get(l) || [], r = e.get(l) || [], u = a.length; u < r.length; u++) {
                  var d = r[u](this._model.model());
                  a.push(d), this._renderer.addCustomWidget(d, { block: t, position: l }), (s = !0);
                }
                s && i.set(l, a);
              }
