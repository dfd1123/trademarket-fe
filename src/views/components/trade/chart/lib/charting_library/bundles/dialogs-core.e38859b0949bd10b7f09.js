(window.webpackJsonp = window.webpackJsonp || []).push([
  ['dialogs-core'],
  {
    ...
    APlX: function (t, e, o) {
      'use strict';
      (function (t) {
        Object.defineProperty(e, '__esModule', { value: !0 }), (e.TVModal = void 0);
        var n =
            Object.assign ||
            function (t) {
        ...
        e.TVModal = (function (e) {
          function o() {
            ...
            h(this, o);
            var e = f(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, n({}, g, t)));
            if (
              ((e.$overlay = $(e.options.overlayTemplate)),
              (e.$modalWrap = $(e.options.containerTemplate)),
              (e.$body = e.$modalWrap.find('.tv-dialog__modal-body').append(e.$el)),
              e.options.closeOnOutsideClick &&
                e.$overlay.add(e.$modalWrap).click(function (t) {
                  e.isEventOut(t) && e.close();
                }),
              e.on('change:zIndex', function () {
                e.$overlay.css('z-index', e.zIndex), e.$modalWrap.css('z-index', e.zIndex);
              }),
              e.on('destroy', function () {
                var t = function () {
                  e.$overlay.remove(), e.$modalWrap.remove();
                };
                e.opened ? (e.close(), setTimeout(t, e.options.closingDuration)) : t();
              }),
              ...
              $.extend(e.options.ajax, {
                ...
                error: function () {
                  e.renderContent(e.options.ajaxErrorTemplate), r(e), e.trigger('errorLoading', [e]);
                },
              });
            }
            return (
              e.on('error', function (t, o) {
                e.$modalWrap[0].getBoundingClientRect().height < e.$content[0].getBoundingClientRect().height &&
          ...
          return (
            ...
            i(o, [
                  ...
                  if (!this.opened) {
                    ...
                    var e = function () {
                      t.focus(),
                        ...
                        $(t.$wrap)
                          .append(t.$overlay.addClass('i-hidden i-closed').css('z-index', t.zIndex))
                          .append(t.$modalWrap.addClass('i-hidden i-closed').css('z-index', t.zIndex)),
                        t.$overlay.removeClass('i-hidden'),
                        setTimeout(function () {
                          t.$overlay.removeClass('i-closed');
                        }, 20),
                        t.options.ajax.url ? (t.ajaxRequest = $.ajax(t.options.ajax)) : t.showContent();
                    };
                    return (
                      r.isSafari
                        ? setTimeout(function () {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (this.opened)
                    return (
                      (this.opened = !1),
                      this._keyboardBinderLockId && u.enable(this._keyboardBinderLockId),
                      ...
                      setTimeout(function () {
                        e.$modalWrap.addClass('i-hidden').detach(),
                          ...
                          (v = t.without(v, e)),
                          e.options.fixBodyState && (0, a.setFixedBodyState)(!1),
              ...
              },
              {
                key: 'startSpinner',
                value: function () {
                  return (this.spinner = new c.Spinner('large')), this.spinner.spin(this.$overlay[0]), this;
                },
              },
              {
                key: 'stopSpinner',
    ...
    nbyR: function (t, e, o) {
      'use strict';
      Object.defineProperty(e, '__esModule', { value: !0 }), (e.TVPopup = void 0);
      var n =
          Object.assign ||
          function (t) {
            for (var e = 1; e < arguments.length; e++) {
      ...
      e.TVPopup = (function (t) {
        function e() {
          var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          p(this, e);
          var o = h(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, n({}, g, t)));
          (o.$scrollWrap = o.$content.hasClass('js-dialog__scroll-wrap')
            ...
            o.$scrollWrap.length
              ...
              : ((o.$scrollWrap = o.$content.wrap($(o.options.scrollWrap)).parent()),
                (o.$scrollWrapInner = o.$content.wrap($(o.options.scrollWrapInner)).parent())),
            o.$actions && o.$scrollWrap.addClass('i-with-actions'),
            o.options.withScroll &&
              ((o.scroll = new l.SidebarCustomScroll(o.$scrollWrap, o.$scrollWrapInner)),
          ...
          return (
            ...
            o.options.width && o.$el.css({ width: 'calc(100% - 20px)', 'max-width': o.options.width }),
                  ...
                  o.opened &&
                    ...
                    $(document).on('click.tv-popup-' + i, function (t) {
                      if (!o._preventClick) {
                        ...
                        (o.options.closeOnClickAtOtherDialogs || 0 === e.length) && o.isEventOut(t) && o.close();
                      }
                    }));
                }, 0);
              }),
            ...
            },
            {
              ...
              value: function () {
                ...
                t.bottom > r.mediaState.height - 10 &&
                  ((e.top = r.mediaState.height - 10 - t.height), e.top < 10 && (e.top = 10)),
                  t.right > r.mediaState.width - 10 &&
                    ((e.left = r.mediaState.width - 10 - t.width), e.left < 10 && (e.left = 10)),
            ...
            },
            {
              ...
              value: function () {
                var t = this.$el[0].getBoundingClientRect(),
                  ...
                  n =
                    this.options.height && this.options.height < r.mediaState.height - 20
                      ? this.options.height
                ...
                (this.options.height || i.height > n) &&
                  ((n -= t.height - o.height) < 60 && (n = 60), this.$scrollWrap.css({ height: n })),
                  this.options.withScroll && this.scroll.resize();
                var s = n < e.height;
                s || this.$scrollWrapInner.css('top', 0),
                  this.$scrollWrap.toggleClass('i-scrollable', s),
                  this.$actions && this.$actions.toggleClass('tv-dialog__section--actions_with-border', s);
              },
            },
            {
              key: 'updateScroll',
    ...
    qNVo: function (t, e, o) {
      'use strict';
      Object.defineProperty(e, '__esModule', { value: !0 }), (e.ButtonLoader = void 0);
      var n = (function () {
        function t(t, e) {
          for (var o = 0; o < e.length; o++) {
            var n = e[o];
      ...
      $.fn.tvButtonLoader = (0, i.createTvBlockWithInstance)('tv-button-loader', function (t) {
        return new r(t);
      });
    ...
    v2PZ: function (t, e, o) {
      'use strict';
      (function (t, n) {
        Object.defineProperty(e, '__esModule', { value: !0 }), (e.TVDialogAbstract = void 0);
        var i = function (t, e) {
              ...
              return (function (t, e) {
                ...
                try {
                  for (
                    ...
                    !(n = (r = a.next()).done) && (o.push(r.value), !e || o.length !== e);
                    n = !0
                  );
                } catch (l) {
                  (i = !0), (s = l);
        ...
        var f = 0,
          ...
          k = (function (e) {
            function o() {
              ...
              if (
                ((n.manager = e.manager || (0, u.getRootOverlapManager)(e.ownerDocument)),
                (n._id = f++),
                (n.loadingActions = []),
                (n.disabledActions = []),
                ...
                (n.options = s({}, y, e)),
                (n.$el = $(
                  t.render(n.options.template, { title: n.options.title, closeButton: n.options.closeButton }),
                )),
                ...
                try {
                  for (
                    var d, g = Object.entries(n.options.dataset)[Symbol.iterator]();
                    !(r = (d = g.next()).done);
                    r = !0
                  ) {
                    var k = d.value,
              ...
              for (
                n.options.addClass && n.$el.addClass(n.options.addClass),
                  n.options.width && n.$el.css({ width: '100%', 'max-width': n.options.width }),
                  ...
                  n.options.title &&
                    (n.$title = $(t.render(n.options.titleTemplate, { title: n.options.title })).appendTo(n.$el)),
              ...
              if (
                ...
                (n.options.actions || n.options.help) &&
                  (n.$content.hasClass('tv-dialog__section') &&
                    n.$content.addClass('tv-dialog__section--no-padding_bottom'),
                  (n.$actions = $(n.options.actionsWrapTemplate).appendTo(n.$el))),
                n.options.actions)
              ) {
                (n.actions = {}),
                  n.$el.on('click touchend', '.js-dialog__action-click', function (t) {
                    t.preventDefault(), n.actionDispatcher($(t.currentTarget).data('name'));
                  });
                for (
                  var x = function (e) {
                      ...
                      if (
                        ...
                        o.class || (o.class = _[o.type] ? _[o.type] : _.default),
                        'checkbox' === o.type)
                      ) {
                        var i = new l.default({ labelRight: o.text, name: o.name, checked: o.checked });
                        ...
                        n.actions[o.name] = $(
                          t.render(o.template ? o.template : m[o.type] || m._default, o, o),
                        ).appendTo(n.$actions);
                      if (
                        (o.method && 'function' == typeof n[o.method] && n.on('action:' + o.name, n[o.method].bind(n)),
                        o.addClass && n.actions[o.name].addClass(o.addClass),
                        o.key)
                      ) {
                        var s = void 0;
                        if ('string' == typeof o.key && o.key.split('+').length > 1) {
                          var r = [],
                            a = o.key.split('+');
                          s = function (t) {
                            r = [];
                          ...
                          var c = function (t) {
                            ...
                            -1 !== a.indexOf(e) && r.indexOf(e) && r.push(e),
                              n._focused && r.length === a.length && ((r = []), n.actionDispatcher(o.name));
                          };
              ...
              if (
                (n.options.help &&
                  $(t.render(n.options.helpButtonTemplate, n.options.help)).prependTo(
                    n.$actions.addClass(n.options.helpActionsMod),
                  ),
                ...
                var I = n.$el;
                1 === n.$el.find('.js-close-button-place').length && (I = n.$el.find('.js-close-button-place')),
                  j.appendTo(I);
              }
              return (
                ...
                n.on('afterOpen', function () {
                  n.$el.focus(),
                    n.options.focusFirstControl &&
                      ...
                      (n.firstFocusControl || n.$el.find('input:not([type="hidden"]), textarea').first()).focus();
                }),
              ...
              r(o, [
                    ...
                    return (
                      ...
                      ($('>*', this.$el).each(function () {
                        n.get(0) === $(this).get(0) && (o = !1),
                          0 === n.closest('HTML', $(this).get(0)).length && (o = !1);
                      }),
                      o)
                    );
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    g && g !== this && g.unfocus(),
                      ...
                      setTimeout(function () {
                        b.on('mousedown.tv-dialog-unfocus-' + t._id, function (e) {
                          t.isEventOut(e) && (t.unfocus(), b.off('mousedown.tv-dialog-unfocus-' + t._id));
                        });
                      }, 20);
                  },
                },
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return (
                      this.$title.toggleClass('tv-dialog__section--one-line apply-overflow-tooltip', e),
                      this.$title.html(t),
                      this
                    );
                  },
                    ...
                    return (
                      e || this.disabledActions.includes(t)
                        ? e &&
                          ...
                          (this.disabledActions = n.without(this.disabledActions, t))
                ...
                },
                {
                  key: 'error',
                  value: function (e) {
                    var o = $(t.render(this.options.errorTemplate, { error: e, errorMod: this.errorMod })).appendTo(
                      this.$el,
                    );
                    return (
                      setTimeout(function () {
