  ...
  ['general-chart-properties-dialog'],
  {
    ...
    An2S: function (e, t, n) {
      ...
      function d(e) {
        ...
        return a.a.createElement('div', Object(o.__assign)({}, i, { className: d, 'data-role': 'dialog-sidebar' }));
      }
      function p(e) {
        return a.a.createElement('div', Object(o.__assign)({ className: m.wrapper }, e));
      }
      function h(e) {
        var t = e.mode,
          n = e.title,
          ...
          l = e.isActive,
          d = e.onClick,
          p = Object(o.__rest)(e, ['mode', 'title', 'icon', 'isActive', 'onClick']),
          h = u(t),
          b = h.isMobile,
          f = h.isTablet;
        return a.a.createElement(
          'div',
          Object(o.__assign)({}, p, {
            className: r()(m.tab, f && m.isTablet, b && m.isMobile, l && m.active),
            onClick: d,
          }),
      ...
      function E(e) {
            ...
            function () {
              return (function (e, t, n) {
                if (window.is_authenticated) {
                  ...
                  Object(C.createConfirmDialog)({ type: 'modal', content: o, manager: n || void 0 }).then(function (n) {
        ...
        return o.createElement(
          ...
          o.createElement(_.b, {
            ...
            label: t,
            onClick: u,
            toolbox: o.createElement(A.a, { hidden: !Modernizr.mobiletouch && !s, onClick: m }),
          }),
        );
      }
      var I = n('HWhk'),
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return o.createElement(S.b.Consumer, null, function (t) {
                return (
                  (e._manager = t),
                  o.createElement(b.a, { rule: 'screen and (max-width: 768px)' }, function (t) {
            ...
            (t.prototype._getThemeItems = function (e) {
                ...
                r =
                  e && i
                    ? Object(a.__spreadArrays)(
                        [this._applyToAllDropdownItem, this._getPlaceHolderItem(e)],
                        this._defaultDropdownItems,
                      )
                    : Object(a.__spreadArrays)([this._getPlaceHolderItem(e)], this._defaultDropdownItems),
                s = this.state.themes;
              ...
              return c.unshift({ readonly: !0, content: o.createElement(y.a, null) }), r.concat(c);
            }),
            (t.prototype._getPlaceHolderItem = function (e) {
              return {
                ...
                readonly: !0,
                content: '',
                selectedContent: e ? o.createElement(r.Icon, { className: P.themesButtonIcon, icon: I }) : B,
              };
            }),
            t
          );
        ...
        R = (function (e) {
          function t(t) {
            ...
            (n._renderChildren = function (e) {
              ...
              return (
                (n._requestResize = t),
                o.createElement('div', { className: q.content }, n._renderTabs(i), n._renderTabContent(i))
              );
            }),
              (n._renderApplyToAllButton = function () {
                return o.createElement(b.a, { rule: z.a.TabletNormal }, function (e) {
              ...
              (n._selectPage = function (e) {
                ...
                e !== t &&
                  (t && t.definitions.unsubscribe(n._onChangeActivePageDefinitions),
                  p.a.setValue('properties_dialog.last_page_id', e.id),
                  e.definitions.subscribe(n._onChangeActivePageDefinitions),
                  n.setState({ activePage: e, tableKey: Date.now() }, function () {
              ...
              (n._syncApplyToAllVisibility = function () {
                ...
                n.setState({ isApplyToAllVisible: Object(h.isMultipleLayout)(e.layout.value()) });
              }),
              (n._handleBackClick = function () {
                var e = n.state.activePage;
                e && e.definitions.unsubscribe(n._onChangeActivePageDefinitions), n.setState({ activePage: null });
              });
            var i = t.pages,
              a = t.activePageId,
              l = i.find(function (e) {
            ...
            return (
              (n.state = {
                activePage: l,
                isApplyToAllVisible: Object(h.isMultipleLayout)(t.chartWidgetCollection.layout.value()),
                tableKey: Date.now(),
              }),
              n
            );
          ...
          return (
                ...
                return o.createElement(
                  ...
                  o.createElement(
                    ...
                    o.createElement(
                      ...
                      a.map(function (e) {
                        return o.createElement(s.a, { key: e.id, definition: e });
                      }),
                    ),
                  ),
                );
            ...
            (t.prototype._renderTabs = function (e) {
              ...
              return o.createElement(b.a, { rule: z.a.TabletNormal }, function (e) {
                return o.createElement(b.a, { rule: z.a.TabletSmall }, function (a) {
          ...
          function e(e) {
            ...
            (this._container = document.createElement('div')),
              ...
              (this._handleClose = function () {
                i.unmountComponentAtNode(t._container), (t._isVisible = !1), t._onClose && t._onClose();
              }),
    ...
    swCq: function (e, t, n) {
      ...
      t.Icon = i.forwardRef(function (e, t) {
        var n = e.icon,
          a = void 0 === n ? '' : n,
          l = o.__rest(e, ['icon']);
        return i.createElement('span', o.__assign({}, l, { ref: t, dangerouslySetInnerHTML: { __html: a } }));
      });
    },
    utEQ: function (e, t, n) {
      e.exports = {
