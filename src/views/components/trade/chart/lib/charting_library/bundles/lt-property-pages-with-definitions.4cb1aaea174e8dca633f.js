  ...
  ['lt-property-pages-with-definitions'],
  {
      ...
      var n = i('mrSG'),
        ...
        k = (function (e) {
          function t(t, i) {
            ...
            if (((n._disabledBasedOnLog = null), 'fibLevelsBasedOnLogScale' in n._source.properties().childs())) {
              ...
              null !== o &&
                ...
                o.modeChanged().subscribe(n, function (e, t) {
                  null !== n._disabledBasedOnLog && n._disabledBasedOnLog.setValue(Boolean(!t.log));
                }));
            }
            return n;
          }
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              if ('trendline' in i) {
                var c = i.trendline.childs(),
                  k = Object(o.a)(
                    this._undoModel,
                    { showLine: c.visible, lineColor: c.color, lineStyle: c.linestyle, lineWidth: c.linewidth },
                    n,
                    'TrendLine',
                    { line: a },
                  );
              ...
              var x = i.levelsStyle.childs(),
                ...
                S = { line: h };
              'extendLines' in i && ((m.extendRight = i.extendLines), (S.extendRightTitle = w)),
                'extendLinesLeft' in i && ((m.extendLeft = i.extendLinesLeft), (S.extendLeftTitle = f)),
                'extendRight' in i && ((m.extendRight = i.extendRight), (S.extendRightTitle = b)),
                'extendLeft' in i && ((m.extendLeft = i.extendLeft), (S.extendLeftTitle = p));
              var P = Object(o.a)(this._undoModel, m, n, 'LevelsStyleLine', S);
              e.push(P);
              for (var T = [], V = this._source.levelsCount(), B = 1; B <= V; B++) {
                  ...
                  A = Object(r.g)(
                    {
                      ...
                      color: Object(r.u)(this._undoModel, D.color, null, 'Change ' + n + ' Level ' + B + ' Line Color'),
                      level: Object(r.b)(this._undoModel, D.coeff, 'Change ' + n + ' Level ' + B + ' Coeff'),
                    },
                    { id: l + 'LineLevel' + B },
                  );
                T.push(A);
              ...
              var W = Object(r.e)(
                { color: Object(r.u)(this._undoModel, t.collectibleColors, null, 'Change ' + n + ' All Lines Color') },
                { id: l + 'AllLineColor', title: C },
              );
              e.push(W);
              var G = Object(r.q)(
                {
                  checked: Object(r.b)(this._undoModel, i.fillBackground, 'Change ' + n + ' Background Visibility'),
              ...
              if ('reverse' in E) {
                var H = Object(r.c)(
                  { checked: Object(r.b)(this._undoModel, E.reverse, 'Change ' + n + ' Reverse') },
                  { id: l + 'Reverse', title: g },
                );
                e.push(H);
              }
              var F = Object(r.c)(
                { checked: Object(r.b)(this._undoModel, i.showPrices, 'Change ' + n + ' Prices Visibility') },
                { id: l + 'Prices', title: _ },
              );
              e.push(F);
              var z = Object(r.j)(
                {
                  checked: Object(r.b)(this._undoModel, i.showCoeffs, 'Change ' + n + ' Style'),
                  option: Object(r.b)(this._undoModel, i.coeffsAsPercents, 'Change ' + n + ' Style'),
                },
              ...
              var I = Object(r.s)(
                {
                  option1: Object(r.b)(this._undoModel, i.horzLabelsAlign, 'Change ' + n + ' Labels Alignment'),
                  option2: Object(r.b)(this._undoModel, i.vertLabelsAlign, 'Change ' + n + ' Labels Alignment'),
                },
                {
                  id: l + 'Alignment',
                  title: O,
              ...
              if ((e.push(I), 'fibLevelsBasedOnLogScale' in i && null !== this._disabledBasedOnLog)) {
                var U = Object(r.c)(
                  {
                    disabled: Object(r.a)(
                      this._undoModel,
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
                  ...
                  C = Object(o.g)(
                    {
                      ...
                      color: Object(o.u)(this._undoModel, O.color, null, 'Change ' + n + ' Level ' + j + ' Line Color'),
                      level: Object(o.b)(this._undoModel, O.coeff, 'Change ' + n + ' Level ' + j + ' Coeff'),
                    },
                    { id: r + 'HLineLevel' + j },
                  );
                g.push(C);
              ...
              var v = Object(o.l)(g, r + 'HLeveledLinesGroup'),
                y = Object(o.c)(
                  {
                    checked: Object(o.b)(this._undoModel, i.showLeftLabels, 'Change ' + n + ' Left Labels Visibility'),
                  },
              ...
              var m = Object(o.l)(k, r + 'VLeveledLinesGroup'),
                S = Object(o.c)(
                  { checked: Object(o.b)(this._undoModel, i.showTopLabels, 'Change ' + n + ' Top Labels Visibility') },
              ...
              e.push(T);
              var V = Object(o.e)(
                { color: Object(o.u)(this._undoModel, t.collectibleColors, null, 'Change ' + n + ' All Lines Color') },
                { id: r + 'AllLineColor', title: s },
              );
              e.push(V);
              var B = Object(o.q)(
                {
                  checked: Object(o.b)(this._undoModel, i.fillBackground, 'Change ' + n + ' Background Visibility'),
              ...
              var D = i.grid.childs(),
                A = Object(o.h)(
                  {
                    checked: Object(o.b)(this._undoModel, D.visible, 'Change ' + n + ' Grid Visibility'),
                    color: Object(o.u)(this._undoModel, D.color, null, 'Change ' + n + ' Grid Line Color'),
                    width: Object(o.b)(this._undoModel, D.linewidth, 'Change ' + n + ' Grid Line Width'),
                    style: Object(o.b)(this._undoModel, D.linestyle, 'Change ' + n + ' Grid Line Style'),
                  },
                  { id: r + 'GridLine', title: w },
                );
              e.push(A);
              var R = Object(o.c)(
                { checked: Object(o.b)(this._undoModel, i.reverse, 'Change ' + n + ' Reverse Mode') },
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              var A = i.fans.childs(),
                R = Object(o.e)(
                  {
                    checked: Object(o.b)(this._undoModel, A.visible, 'Change ' + n + ' Fans Visibility'),
                    color: Object(o.u)(this._undoModel, A.color, null, 'Change ' + n + ' Fans Line Color'),
                  },
                  { id: r + 'FansLines', title: w },
                );
              e.push(R);
              var W = Object(o.c)(
                { checked: Object(o.b)(this._undoModel, i.reverse, 'Change ' + n + ' Reverse') },
                { id: r + 'Reverse', title: f },
              );
              return e.push(W), e;
            }),
        ...
        d = (function (e) {
          ...
          return (
            ...
            (t.prototype._textPropertyDefinitions = function () {
              ...
              return [
                Object(o.a)(this._undoModel, { textColor: e.color, text: e.text }, this._source.name(), {
                  isEditable: !0,
                  isMultiLine: !0,
                  customTitles: { text: s },
                }),
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              return [
                Object(l.e)(
                  { color: Object(l.u)(this._undoModel, e.arrowColor, null, 'Change Arrow Color') },
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              var e = [],
                ...
                p = Object(o.a)(
                  this._undoModel,
                  { showLine: b.visible, lineColor: b.color, lineStyle: b.linestyle, lineWidth: b.linewidth },
                  n,
                  'TrendLine',
                  { line: c },
                );
                  ...
                  _ = Object(r.g)(
                    {
                      ...
                      color: Object(r.u)(this._undoModel, g.color, null, 'Change ' + n + ' Level ' + f + ' Line Color'),
                      width: Object(r.b)(this._undoModel, g.linewidth, 'Change ' + n + ' Level ' + f + ' Line Width'),
                      level: Object(r.b)(this._undoModel, g.coeff, 'Change ' + n + ' Level ' + f + ' Coeff'),
                    },
                    { id: l + 'LineLevel' + f },
                  );
                e.push(_);
              ...
              e.push(O);
              var C = Object(r.c)(
                { checked: Object(r.b)(this._undoModel, i.showCoeffs, 'Change ' + n + ' Levels Visibility') },
                { id: l + 'Levels', title: a },
              );
              e.push(C);
              var v = Object(r.c)(
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              var e = [],
                ...
                b = Object(o.a)(
                  this._undoModel,
                  { showLine: h.visible, lineColor: h.color, lineWidth: h.linewidth },
                  n,
                  'TrendLine',
                  { line: c },
                );
                  ...
                  g = Object(r.g)(
                    {
                      ...
                      color: Object(r.u)(this._undoModel, f.color, null, 'Change ' + n + ' Level ' + w + ' Line Color'),
                      width: Object(r.b)(this._undoModel, f.linewidth, 'Change ' + n + ' Level ' + w + ' Line Width'),
                      level: Object(r.b)(this._undoModel, f.coeff, 'Change ' + n + ' Level ' + w + ' Coeff'),
                    },
                    { id: l + 'LineLevel' + w },
                  );
                e.push(g);
        ...
        d = (function (e) {
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              return [
                Object(l.e)(
                  { color: Object(l.u)(this._undoModel, e.markerColor, null, 'Change ' + t + ' background color') },
    ...
    '78yF': function (e, t, i) {
      ...
      function j(e, t, i, l) {
        ...
        j.push(C);
        var v = Object(r.c)(
          { checked: Object(r.b)(e, t.showMiddlePoint, 'Change ' + i + ' Show Middle Point') },
          { id: c + 'MiddlePoint', title: (l && l.middlePoint) || a },
        );
        j.push(v);
        var y = Object(r.c)(
          { checked: Object(r.b)(e, t.showPriceRange, 'Change ' + i + ' Show Price Range') },
          { id: c + 'PriceRange', title: (l && l.priceRange) || b },
        );
        j.push(y);
        var L = Object(r.c)(
          { checked: Object(r.b)(e, t.showBarsRange, 'Change ' + i + ' Show Bars Range') },
          { id: c + 'BarsRange', title: (l && l.barRange) || p },
        );
        if ((j.push(L), 'showDateTimeRange' in t)) {
          var M = Object(r.c)(
            { checked: Object(r.b)(e, t.showDateTimeRange, 'Change ' + i + ' Show Date/Time Range') },
        ...
        if ('showDistance' in t) {
          var k = Object(r.c)(
            { checked: Object(r.b)(e, t.showDistance, 'Change ' + i + ' Show Distance') },
        ...
        if ('showAngle' in t) {
          var x = Object(r.c)(
            { checked: Object(r.b)(e, t.showAngle, 'Change ' + i + ' Show Angle') },
            { id: c + 'Angle', title: (l && l.angle) || g },
          );
          j.push(x);
        }
        var m = Object(r.c)(
          { checked: Object(r.b)(e, t.alwaysShowStats, 'Change ' + i + ' Always Show Stats') },
          { id: c + 'ShowStats', title: (l && l.showStats) || _ },
        );
        j.push(m);
        var S = Object(r.j)(
          { option: Object(r.b)(e, t.statsPosition, 'Change ' + i + ' Stats Position') },
          {
            id: c + 'StatsPosition',
    ...
    '8ioM': function (e, t, i) {
      ...
      var n = i('mrSG'),
        ...
        w = [
          ...
          { value: c.LineToolBarsPatternMode.OpenClose, title: window.t('OC Bars') },
          { value: c.LineToolBarsPatternMode.Line, title: window.t('Line - Close') },
          { value: c.LineToolBarsPatternMode.LineOpen, title: window.t('Line - Open') },
          { value: c.LineToolBarsPatternMode.LineHigh, title: window.t('Line - High') },
          { value: c.LineToolBarsPatternMode.LineLow, title: window.t('Line - Low') },
          { value: c.LineToolBarsPatternMode.LineHL2, title: window.t('Line - HL/2') },
        ],
        f = (function (e) {
          function t() {
            return (null !== e && e.apply(this, arguments)) || this;
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              return [
                Object(r.e)(
                  { color: Object(r.u)(this._undoModel, e.color, null, 'Change ' + t + ' color') },
                  { id: i + 'Color', title: a },
                ),
                Object(r.j)(
                  { option: Object(r.b)(this._undoModel, e.mode, 'Change ' + t + ' mode', [d.a]) },
                  { id: i + 'Mode', title: h, options: new s.a(w) },
                ),
                Object(r.c)(
                  { checked: Object(r.b)(this._undoModel, e.mirrored, 'Change ' + t + ' Mirrored') },
                  { id: i + 'Mirrored', title: b },
                ),
                Object(r.c)(
                  { checked: Object(r.b)(this._undoModel, e.flipped, 'Change ' + t + ' Flipped') },
        ...
        u = (function (e) {
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
                  ...
                  b = Object(o.g)(
                    {
                      ...
                      color: Object(o.u)(this._undoModel, h.color, null, 'Change ' + n + ' Level ' + a + ' Line Color'),
                      width: Object(o.b)(this._undoModel, h.linewidth, 'Change ' + n + ' Level ' + a + ' Line Width'),
                      style: Object(o.b)(this._undoModel, h.linestyle, 'Change ' + n + ' Level ' + a + ' Line Style'),
                    },
                    { id: r + 'LineLevel' + a, title: h.coeff1.value() + '/' + h.coeff2.value() },
                  );
                e.push(b);
              }
              var p = Object(o.e)(
              ...
              e.push(w);
              var f = Object(o.c)(
                { checked: Object(o.b)(this._undoModel, i.showLabels, 'Change ' + n + ' Labels Visibility') },
                { id: r + 'Labels', title: d },
              );
              return e.push(f), e;
            }),
        ...
        return (
          ...
          (t.prototype._stylePropertyDefinitions = function () {
            var e = [],
              ...
              i = this._source.name(),
              n = Object(c.c)(i),
              l = Object(o.a)(this._undoModel, { lineColor: t.linecolor, lineWidth: t.linewidth }, i, 'Line', {
                line: d,
              });
            ...
            if (
              ...
              var O = Object(s.c)(
                  { checked: Object(s.b)(this._undoModel, t.extendTop, 'Change ' + i + ' Extend top') },
                  { id: n + 'ExtendTop', title: h },
                ),
                C = Object(s.c)(
                  { checked: Object(s.b)(this._undoModel, t.extendBottom, 'Change ' + i + ' Extend bottom') },
            ...
            if (
              ...
              var v = Object(s.c)(
                  { checked: Object(s.b)(this._undoModel, t.extendLeft, 'Change ' + i + ' Extend left') },
                  { id: n + 'extendLeft', title: p },
                ),
                y = Object(s.c)(
                  { checked: Object(s.b)(this._undoModel, t.extendRight, 'Change ' + i + ' Extend bottom') },
            ...
            var L = Object(r.a)(
              ...
              i,
              { isEditable: !0, isMultiLine: !0, customTitles: { text: f, backgroundTitle: g } },
            );
            return e.push(L), e;
          }),
          t
    ...
    BDhr: function (e, t, i) {
      ...
      function c(e, t, i) {
        var c = Object(r.c)(i),
          d = [],
          u = Object(n.a)(e, { lineColor: t.linecolor, lineWidth: t.linewidth, lineStyle: t.linestyle }, c, 'Line');
        if ((d.push(u), 'showPrice' in t)) {
          var a = Object(o.c)(
            { checked: Object(o.b)(e, t.showPrice, 'Change ' + i + ' Price Label Visibility') },
        ...
        if ('showTime' in t) {
          var h = Object(o.c)(
            { checked: Object(o.b)(e, t.showTime, 'Change ' + i + ' Time Label Visibility') },
    ...
    CA9d: function (e, t, i) {
      ...
      var n = i('mrSG'),
        ...
        d = window.t('Bar#');
      function u(e, t, i) {
        return { property: Object(o.b)(e, t.price, 'Change ' + c + ' Y coordinate'), info: { typeY: 1, stepY: i } };
      }
      function a(e, t) {
        return {
          property: Object(o.b)(e, t.bar, 'Change ' + d + ' X coordinate'),
          info: { typeX: 0, minX: new l.a(-5e4), maxX: new l.a(15e3), stepX: new l.a(1) },
        };
      }
      function h(e, t, i, r, l, c) {
        ...
        return Object(o.f)(
          ...
          Object(n.__assign)(Object(n.__assign)({ id: Object(s.c)(c + 'Coordinates' + l), title: l }, d.info), h.info),
        );
      }
    },
    Cn8r: function (e, t, i) {
      ...
      var M = (function () {
        function e(e, t) {
          (this._yCoordinateStepWV = null),
            ...
            (this._source = t),
            (this._undoModel = e),
            (this._ownerSource = Object(n.ensureNotNull)(this._source.ownerSource())),
            ...
            return Object(r.a)(
              (function (e, t) {
                ...
                if (c.enabled('seconds_resolution')) {
                  var n = Object(o.m)(
                    {
                      checked: Object(o.b)(e, t.seconds, 'Change Line Tool Visibility On Seconds'),
                      from: Object(o.b)(e, t.secondsFrom, 'Change Line Tool Seconds From'),
                      to: Object(o.b)(e, t.secondsTo, 'Change Line Tool Seconds To'),
                    },
                    { id: 'IntervalsVisibilitiesSecond', title: d, min: new s.a(w[0]), max: new s.a(w[1]) },
                  );
                  i.push(n);
                }
                var r = Object(o.m)(
                    {
                      checked: Object(o.b)(e, t.minutes, 'Change Line Tool Visibility On Minutes'),
                      from: Object(o.b)(e, t.minutesFrom, 'Change Line Tool Minutes From'),
                      to: Object(o.b)(e, t.minutesTo, 'Change Line Tool Minutes To'),
                    },
                    { id: 'IntervalsVisibilitiesMinutes', title: u, min: new s.a(f[0]), max: new s.a(f[1]) },
                  ),
                  l = Object(o.m)(
                    {
                      checked: Object(o.b)(e, t.hours, 'Change Line Tool Visibility On Hours'),
                      from: Object(o.b)(e, t.hoursFrom, 'Change Line Tool Hours From'),
                      to: Object(o.b)(e, t.hoursTo, 'Change Line Tool Hours To'),
                    },
                    { id: 'IntervalsVisibilitiesHours', title: a, min: new s.a(g[0]), max: new s.a(g[1]) },
                  ),
                  j = Object(o.m)(
                    {
                      checked: Object(o.b)(e, t.days, 'Change Line Tool Visibility On Days'),
                      from: Object(o.b)(e, t.daysFrom, 'Change Line Tool Days From'),
                      to: Object(o.b)(e, t.daysTo, 'Change Line Tool Days To'),
                    },
                    { id: 'IntervalsVisibilitiesDays', title: h, min: new s.a(_[0]), max: new s.a(_[1]) },
                  );
                i.push(r, l, j);
                var O = Object(o.c)(
                    { checked: Object(o.b)(e, t.weeks, 'Change Line Tool Visibility On Weeks') },
                    { id: 'IntervalsVisibilitiesWeeks', title: b },
                  ),
                  C = Object(o.c)(
                    { checked: Object(o.b)(e, t.months, 'Change Line Tool Visibility On Months') },
          ...
          (e.prototype._getYCoordinateStepWV = function () {
            ...
            return (
              null === this._yCoordinateStepWV &&
                ...
                this._ownerSource.priceStepChanged().subscribe(this, function () {
                ...
                this._source.ownerSourceChanged().subscribe(this, function () {
                  e._ownerSource.priceStepChanged().unsubscribeAll(e),
                    (e._ownerSource = Object(n.ensureNotNull)(e._source.ownerSource())),
                ...
                l &&
                  n.push(
                    Object(j.c)(
                      ...
                      t,
                      o,
                      window.t('#{0} (price, bar)', { context: 'linetool point' }).format(r + 1),
                      e._source.name(),
                    ),
                  );
              }),
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              t.hasChild('extendLines') &&
                e.push(
                  Object(l.c)(
                    { checked: Object(l.b)(this._undoModel, i.extendLines, 'Toggle ' + n + ' Extend Lines') },
              ...
              var h = i.median.childs(),
                b = Object(o.a)(
                  this._undoModel,
                  { lineColor: h.color, lineStyle: h.linestyle, lineWidth: h.linewidth },
                  n,
                  'Median',
                  { line: c },
                );
                  ...
                  g = Object(l.g)(
                    {
                      checked: Object(l.b)(
                        this._undoModel,
                        f.visible,
                        'Change ' + n + ' Level ' + (w + 1) + ' Line Visibility',
                      ),
                      color: Object(l.u)(
                        this._undoModel,
                        f.color,
                      ...
                      level: Object(l.b)(this._undoModel, f.coeff, 'Change ' + n + ' Level ' + (w + 1) + ' Line Coeff'),
                    },
                    { id: r + 'LineLevel' + (w + 1) },
                  );
                e.push(g);
              ...
              var _ = Object(l.e)(
                { color: Object(l.u)(this._undoModel, t.collectibleColors, null, 'Change ' + n + ' All Lines Color') },
                { id: r + 'AllLineColor', title: d },
              );
              e.push(_);
              var j = Object(l.q)(
                {
                  checked: Object(l.b)(this._undoModel, i.fillBackground, 'Change ' + n + ' Background Visibility'),
    ...
    DSp8: function (e, t, i) {
      ...
      function c(e, t, i, c) {
        var d = {},
          u = { id: Object(o.c)(i) + 'Text', title: (c.customTitles && c.customTitles.text) || '' };
        if (
          (void 0 !== t.showText && (d.checked = Object(n.b)(e, t.showText, 'Change ' + i + ' Text Visibility')),
          void 0 !== t.textColor &&
            (d.color = Object(n.u)(e, t.textColor, t.transparency || null, 'Change ' + i + ' Text Color')),
          void 0 !== t.fontSize && (d.size = Object(n.b)(e, t.fontSize, 'Change ' + i + ' Text Font Size')),
          void 0 !== t.bold && (d.bold = Object(n.b)(e, t.bold, 'Change ' + i + ' Text Font Bold')),
          void 0 !== t.italic && (d.italic = Object(n.b)(e, t.italic, 'Change ' + i + ' Text Font Italic')),
          void 0 !== t.text &&
          ...
          void 0 !== t.vertLabelsAlign &&
            ((d.alignmentVertical = Object(n.b)(e, t.vertLabelsAlign, 'Change ' + i + ' Labels Alignment Vertical')),
          ...
          void 0 !== t.textOrientation &&
            (d.orientation = Object(n.b)(e, t.textOrientation, 'Change ' + i + ' Labels Direction')),
          void 0 !== t.backgroundVisible &&
            (d.backgroundVisible = Object(n.b)(e, t.backgroundVisible, 'Change ' + i + ' Text Background Visibility')),
          void 0 !== t.backgroundColor)
        ) {
          var a = null;
          void 0 !== t.backgroundTransparency && (a = t.backgroundTransparency),
            (d.backgroundColor = Object(n.u)(e, t.backgroundColor, a, 'Change ' + i + ' Text Background Color'));
        }
        return (
          (void 0 === t.backgroundVisible && void 0 === t.backgroundColor) ||
            (u.backgroundTitle = (c.customTitles && c.customTitles.backgroundTitle) || r),
          void 0 !== t.borderVisible &&
            (d.borderVisible = Object(n.b)(e, t.borderVisible, 'Change ' + i + ' Text Border Visibility')),
          void 0 !== t.borderWidth &&
            (d.borderWidth = Object(n.b)(e, t.borderWidth, 'Change ' + i + ' Text Border Width')),
          void 0 !== t.borderColor &&
            (d.borderColor = Object(n.u)(e, t.borderColor, null, 'Change ' + i + ' Text Border Color')),
          (void 0 === t.borderVisible && void 0 === t.borderColor && void 0 === t.borderWidth) ||
            (u.borderTitle = (c.customTitles && c.customTitles.borderTitle) || l),
          void 0 !== t.wrap &&
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              return [
                ...
                Object(o.a)(this._undoModel, { lineColor: e.color, lineWidth: e.linewidth }, t, 'Line', { line: u }),
                Object(s.e)(
                  {
        ...
        u = (function (e) {
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              return [
                Object(o.e)(
                  { color: Object(o.u)(this._undoModel, e.backgroundColor, null, 'Change ' + t + ' color') },
    ...
    HCdA: function (e, t, i) {
      ...
      var n = i('mrSG'),
        ...
        d = window.t('Style'),
        u = [
          { value: l.LineToolPitchforkStyle.Original, title: window.t('Original') },
          { value: l.LineToolPitchforkStyle.Schiff2, title: window.t('Schiff') },
          { value: l.LineToolPitchforkStyle.Schiff, title: window.t('Modified Schiff') },
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              var t = e.prototype._stylePropertyDefinitions.call(this),
                ...
                n = this._source.name(),
                r = Object(o.j)(
                  { option: Object(o.b)(this._undoModel, i.style, 'Change ' + n + ' Style') },
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              var t = this._source.properties().childs(),
                ...
                o = Object(r.c)(
                  { checked: Object(r.b)(this._undoModel, t.extendRight, 'Change ' + i + ' Extending Right') },
                  { id: i + 'ExtendRight', title: u },
                );
              n.push(o);
              var l = Object(r.c)(
                { checked: Object(r.b)(this._undoModel, t.extendLeft, 'Change ' + i + ' Extending Left') },
            ...
            (t.prototype._textPropertyDefinitions = function () {
              ...
              return [
                Object(s.a)(
                  ...
                  this._source.name(),
                  { isEditable: !0, isMultiLine: !0, alignmentVerticalItems: a, customTitles: { text: c } },
                ),
              ];
            }),
            t
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              return [
                ...
                Object(l.e)(
                  {
                    color: Object(l.u)(this._undoModel, e.sourceTextColor, null, 'Change ' + t + ' source text color'),
                  },
                ...
                Object(l.e)(
                  {
                    color: Object(l.u)(this._undoModel, e.targetTextColor, null, 'Change ' + t + ' target text color'),
                  },
      ...
      var m = (function (e) {
        function t(t, i) {
          ...
          return (
            ...
            n._undoModel.model().mainSeries().dataEvents().symbolResolved().subscribe(n, n._onSymbolInfoChanged),
            n
          );
        }
        return (
          ...
          (t.prototype._stylePropertyDefinitions = function () {
            ...
            return [
              ...
              Object(r.a)(this._undoModel, { textColor: e.textcolor, fontSize: e.fontsize }, t, {
                isEditable: !0,
                isMultiLine: !0,
                customTitles: { text: p },
              }),
              Object(s.c)(
                { checked: Object(s.b)(this._undoModel, e.showPriceLabels, 'Change ' + t + ' Show price labels') },
                { id: i + 'ShowPriceLabels', title: L },
              ),
              Object(s.c)(
                { checked: Object(s.b)(this._undoModel, e.compact, 'Change ' + t + ' Compact stats mode') },
                { id: i + 'CompactMode', title: w },
              ),
              Object(s.c)(
                { checked: Object(s.b)(this._undoModel, e.alwaysShowStats, 'Change ' + t + ' Always show stats') },
          ...
          (t.prototype._inputsPropertyDefinitions = function () {
            var e = this,
              ...
              o = this._getYCoordinateStepWV(),
              r = Object(s.i)(
                { value: Object(s.b)(this._undoModel, t.accountSize, 'Change ' + i + ' Account Size') },
                {
                  id: n + 'AccountSize',
                  title: C,
                  type: 1,
              ...
              l = Object(s.i)(
                {
                  value: Object(s.b)(this._undoModel, t.risk, 'Change ' + i + ' Risk', [
                    function (e) {
                      return parseFloat(e);
                    },
                  ]),
              ...
              c = Object(s.i)(
                { value: Object(s.b)(this._undoModel, t.entryPrice, 'Change ' + i + ' entry price') },
                { id: n + 'EntryPrice', title: _, type: 1, step: o },
              ),
              a = Object(s.k)([r, l, c], n + 'AccountRisk'),
              h = Object(s.i)(
                { value: Object(s.b)(this._undoModel, t.profitLevel, 'Change ' + i + ' profit level') },
                { id: n + 'ProfitLevelTicks', title: f, type: 0, min: new d.a(0), max: new d.a(1e9), step: new d.a(1) },
              ),
              b = Object(s.i)(
                {
                  value: Object(s.b)(this._undoModel, t.targetPrice, 'Change ' + i + ' profit price', [
                    function (e) {
                      return e;
                    },
                    function (t) {
              ...
              w = Object(s.i)(
                { value: Object(s.b)(this._undoModel, t.stopLevel, 'Change ' + i + ' stop level') },
                { id: n + 'StopLevelTicks', title: f, type: 0, min: new d.a(0), max: new d.a(1e9), step: new d.a(1) },
              ),
              y = Object(s.i)(
                {
                  value: Object(s.b)(this._undoModel, t.stopPrice, 'Change ' + i + ' stop price', [
                    function (e) {
                      return e;
                    },
                    function (t) {
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
                  ...
                  f = Object(o.g)(
                    {
                      ...
                      color: Object(o.u)(this._undoModel, w.color, null, 'Change ' + n + ' Level ' + p + ' Line Color'),
                      width: Object(o.b)(this._undoModel, w.linewidth, 'Change ' + n + ' Level ' + p + ' Line Width'),
                      style: Object(o.b)(this._undoModel, w.linestyle, 'Change ' + n + ' Level ' + p + ' Line Style'),
                      level: Object(o.b)(this._undoModel, w.coeff, 'Change ' + n + ' Level ' + p + ' Coeff'),
                    },
                    { id: r + 'LineLevel' + p },
                  );
                e.push(f);
              ...
              var j = Object(o.s)(
                {
                  checked: Object(o.b)(this._undoModel, i.showLabels, 'Change ' + n + ' Labels Visibility'),
                  option1: Object(o.b)(this._undoModel, i.horzLabelsAlign, 'Change ' + n + ' Labels Alignment'),
                  option2: Object(o.b)(this._undoModel, i.vertLabelsAlign, 'Change ' + n + ' Labels Alignment'),
                },
                { id: r + 'Labels', title: a, optionsItems1: new s.a(b), optionsItems2: new s.a(h) },
              );
              return e.push(j), e;
            }),
            t
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              return [
                Object(l.e)(
                  {
                    color: Object(l.u)(this._undoModel, e.color, null, 'Change ' + t + ' color'),
                  },
                ...
                Object(l.j)(
                  { option: Object(l.b)(this._undoModel, e.degree, 'Change ' + t + ' degree') },
                  { id: t + 'Degree', title: h, options: new c.a(this._source.availableDegreesValues()) },
                ),
              ];
            }),
            t
          ...
          (t.prototype._stylePropertyDefinitions = function () {
                ...
                y = Object(r.g)(
                  {
                    ...
                    color: Object(r.u)(this._undoModel, v.color, null, 'Change ' + n + ' Level ' + C + ' Line Color'),
                    width: Object(r.b)(this._undoModel, v.width, 'Change ' + n + ' Level ' + C + ' Line Width'),
                  },
            ...
            for (C = 0; C < k; C++) {
              var x = i.fanlines.childs()[C].childs(),
                m = Object(r.g)(
                  {
                    checked: Object(r.b)(this._undoModel, x.visible, 'Change ' + n + ' Fan ' + C + ' Line Visibility'),
                    color: Object(r.u)(this._undoModel, x.color, null, 'Change ' + n + ' Fan ' + C + ' Line Color'),
                    width: Object(r.b)(this._undoModel, x.width, 'Change ' + n + ' Fan ' + C + ' Line Width'),
                  },
                  { id: l + 'FanLineLevel' + C, title: x.x.value() + 'x' + x.y.value() },
                );
              M.push(m);
            }
            ...
            for (C = 0; C < T; C++) {
              var V = i.arcs.childs()[C].childs(),
                B = Object(r.g)(
                  {
                    checked: Object(r.b)(this._undoModel, V.visible, 'Change ' + n + ' Arcs ' + C + ' Line Visibility'),
                    color: Object(r.u)(this._undoModel, V.color, null, 'Change ' + n + ' Arcs ' + C + ' Line Color'),
                    width: Object(r.b)(this._undoModel, V.width, 'Change ' + n + ' Arcs ' + C + ' Line Width'),
                  },
                  { id: l + 'ArcsLineLevel' + C, title: V.x.value() + 'x' + V.y.value() },
                );
              P.push(B);
            }
            ...
            var R = i.arcsBackground.childs(),
              W = Object(r.q)(
                {
                  checked: Object(r.b)(this._undoModel, R.fillBackground, 'Change ' + n + ' Background Visibility'),
                  transparency: Object(r.b)(
                    this._undoModel,
                    R.transparency,
                    'Change ' + n + ' Background Transparency',
            ...
            e.push(W);
            var G = Object(r.c)(
              { checked: Object(r.b)(this._undoModel, i.reverse, 'Change ' + n + ' Reverse') },
            ...
            if ((e.push(G), O(this._source))) {
              var E = this._source,
                ...
                F = Object(r.i)(
                  {
                    value: Object(r.b)(this._undoModel, H.scaleRatio, 'Change Top Margin', [
                      Object(u.c)(7),
                      function (e) {
                        return null !== e ? parseFloat(E.getScaleRatioFormatter().format('' + e)) : null;
                      },
                    ]),
                  },
                  {
              ...
              var z = H.labelsStyle.childs(),
                I = Object(o.a)(
                  this._undoModel,
                  { showText: H.showLabels, fontSize: z.fontSize, bold: z.bold, italic: z.italic },
                  n,
                  { customTitles: { text: f } },
                );
              e.push(I);
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              var e = this._source.properties().childs(),
                t = this._source.name();
              return [
                Object(o.a)(this._undoModel, { lineColor: e.color, lineWidth: e.linewidth }, t, 'Line', { line: c }),
                Object(l.e)(
                  {
                    checked: Object(l.b)(this._undoModel, e.fillBackground, 'Change ' + t + ' background visibility'),
                    color: Object(l.u)(
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              return [
                Object(r.r)(
                  {
                    color1: Object(r.u)(this._undoModel, n.upColor, null, 'Change ' + t + ' Candle Up Color'),
                    color2: Object(r.u)(this._undoModel, n.downColor, null, 'Change ' + t + ' Candle Down Color'),
                  },
                  { id: i + 'Candle2Colors', title: d },
                ),
                Object(r.r)(
                  {
                    checked: Object(r.b)(this._undoModel, n.drawBorder, 'Change ' + t + ' Candle Border Visibility'),
                    color1: Object(r.u)(
                      this._undoModel,
                      n.borderUpColor,
                      null,
                ...
                Object(r.e)(
                  {
                    checked: Object(r.b)(this._undoModel, n.drawWick, 'Change ' + t + ' Candle Wick Visibility'),
                    color: Object(r.u)(this._undoModel, n.wickColor, null, 'Change ' + t + ' Candle Wick Color'),
                  },
                  { id: i + 'CandleWickColor', title: a },
                ),
                Object(r.q)(
                  { transparency: Object(r.b)(this._undoModel, e.transparency, 'Change ' + t + ' Transparency') },
            ...
            (t.prototype._inputsPropertyDefinitions = function () {
              ...
              return [
                Object(r.i)(
                  { value: Object(r.b)(this._undoModel, e.averageHL, 'Change ' + t + ' Average HL value') },
                  { id: i + 'AvgHL', title: b, type: 0, min: new s.a(1), max: new s.a(5e4), step: new s.a(1) },
                ),
                Object(r.i)(
                  { value: Object(r.b)(this._undoModel, e.variance, 'Change ' + t + ' Variance value') },
                  { id: i + 'Variance', title: p, type: 0, min: new s.a(1), max: new s.a(100), step: new s.a(1) },
                ),
              ];
            }),
            t
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              return [
                Object(o.h)(
                  {
                    color: Object(o.u)(this._undoModel, e.linecolor, null, 'Change ' + t + ' Line Color'),
          ...
          return (
            ...
            (t.prototype._coordinatesPropertyDefinitions = function () {
              ...
              var r = Object(o.i)(
                ...
                { id: 'TrendLineAngleCoordinate', title: u, min: new s.a(-360), max: new s.a(360), step: new s.a(1) },
              );
              return t.push(r), t;
            }),
            (t.prototype._stylePropertyDefinitions = function () {
              var e = this._source.properties().childs();
              return Object(d.a)(this._undoModel, e, this._source.name(), { text: a });
            }),
            t
          );
        })(r.a);
        ...
        b = (function (e) {
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              e.push(C);
              var v = Object(r.c)(
                { checked: Object(r.b)(this._undoModel, i.fullCircles, 'Change ' + n + ' Full Circles Visibility') },
        ...
        w = (function (e) {
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
                  ...
                  j = Object(r.g)(
                    {
                      ...
                      color: Object(r.u)(this._undoModel, _.color, null, 'Change ' + n + ' Level ' + g + ' Line Color'),
                      width: Object(r.b)(this._undoModel, _.linewidth, 'Change ' + n + ' Level ' + g + ' Line Width'),
                      style: Object(r.b)(this._undoModel, _.linestyle, 'Change ' + n + ' Level ' + g + ' Line Style'),
                      level: Object(r.b)(this._undoModel, _.coeff, 'Change ' + n + ' Level ' + g + ' Coeff'),
                    },
                    { id: l + 'LineLevel' + g },
                  );
                e.push(j);
              ...
              var v = Object(r.s)(
                {
                  checked: Object(r.b)(this._undoModel, i.showCoeffs, 'Change ' + n + ' Labels Visibility'),
                  option1: Object(r.b)(this._undoModel, i.horzLabelsAlign, 'Change ' + n + ' Labels Alignment'),
                  option2: Object(r.b)(this._undoModel, i.vertLabelsAlign, 'Change ' + n + ' Labels Alignment'),
                },
                {
        ...
        s = (function (e) {
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              return [
                Object(r.e)(
                  { color: Object(r.u)(this._undoModel, e.flagColor, null, 'Change Flag Color') },
    ...
    wm7x: function (e, t, i) {
      ...
      function c(e, t, i, c, d) {
        ...
        return (
          void 0 !== t.showLine && (u.checked = Object(n.b)(e, t.showLine, 'Change ' + i + ' Visibility')),
          void 0 !== t.lineWidth && (u.width = Object(n.b)(e, t.lineWidth, 'Change ' + i + ' Width')),
          void 0 !== t.lineStyle && (u.style = Object(n.b)(e, t.lineStyle, 'Change ' + i + ' Style')),
          void 0 !== t.lineColor && (u.color = Object(n.u)(e, t.lineColor, null, 'Change ' + i + ' Color')),
          void 0 !== t.extendLeft &&
            ((u.extendLeft = Object(n.b)(e, t.extendLeft, 'Change ' + i + ' Extending Left')),
            (a.extendLeftTitle = (d && d.extendLeftTitle) || l)),
          void 0 !== t.leftEnd && (u.leftEnd = Object(n.b)(e, t.leftEnd, 'Change ' + i + ' Left End')),
          void 0 !== t.extendRight &&
            ((u.extendRight = Object(n.b)(e, t.extendRight, 'Change ' + i + ' Extending Right')),
            (a.extendRightTitle = (d && d.extendRightTitle) || s)),
          void 0 !== t.rightEnd && (u.rightEnd = Object(n.b)(e, t.rightEnd, 'Change ' + i + ' Right End')),
          Object(n.h)(u, a)
        );
      }
    },
