  ...
  ['symbol-info-dialog-impl'],
  {
    ...
    '1Z/g': function (e, t, n) {
      ...
      (function (e, r) {
        var o,
          ...
          w = n('w3Pp').marketType,
          b = [m.MONDAY, m.TUESDAY, m.WEDNESDAY, m.THURSDAY, m.FRIDAY, m.SATURDAY, m.SUNDAY],
        ...
        function S(e) {
          if (E(e)) return new c(e.pricescale / e.minmove2).format(e.minmove2 / e.pricescale);
        }
        function N(e) {
        ...
        function x(e) {
          o || ((o = document.createElement('div')), document.body.appendChild(o)), l.render(s.createElement(p, e), o);
        }
        function k(e) {
          for (var t = u, n = 0; n < t.length; n++) if (t[n].id === e) return t[n].title;
          return e;
        }
        function T(e) {
          var t,
          ...
          return (
            (function (e, t) {
              for (var n = 0; n < t.length; n++) {
                var r = t[n];
                void 0 === r.visibility || r.visibility(e) || (t.splice(n, 1), n--);
              }
            })(e, t),
            n
          );
        ...
        t.showSymbolInfoDialog = function (e, t) {
          if ((x({ isOpened: !1 }), null == e && (e = i.symbol.value()), null != e)) {
            e += '';
            var n = t && t.symbolInfo,
              u = [
                { title: window.t('Symbol Name'), propName: r.enabled('charting_library_base') ? 'name' : 'pro_name' },
                { title: window.t('Symbol Description'), propName: 'description' },
                { title: window.t('Symbol Type'), propName: 'type', getter: D },
                { title: window.t('Current Contract'), propName: 'front_contract', visibility: C },
                ...
                { title: window.t('Pip Size'), propName: 'pip_size', getter: S, visibility: E },
                { title: window.t('Tick Size'), propName: 'tick_size', getter: N },
                { title: window.t('Sector'), propName: 'sector' },
                { title: window.t('Industry'), propName: 'industry' },
                { title: window.t('Timezone'), propName: 'timezone', formatter: k, visibility: _ },
                {
      ...
      var r = n('q1tI'),
        o = function (e, t) {
          var n = void 0 === t ? {} : t,
            ...
            a = void 0 === c ? null : c;
          try {
            return new window.CustomEvent(e, { bubbles: o, cancelable: u, detail: a });
          } catch (l) {
    ...
    AVTG: function (e, t, n) {
      ...
      var r = n('q1tI'),
        ...
        c = n('Iivm');
      function a(e) {
        var t = e.hideIcon ? null : r.createElement(c.Icon, { className: i.close, icon: u, onClick: e.onClose });
        return r.createElement(
          'div',
          { className: o(i.header, e.className), 'data-dragg-area': !0, ref: e.reference },
          e.children,
          t,
        );
      }
      ...
      var s = n('XYXm');
      function l(e) {
        return r.createElement('div', { className: o(s.body, e.className), ref: e.reference }, e.children);
      }
      var p = n('8Rai'),
        d = n('cJj4');
      function m(e) {
        ...
        e.text
          ...
          : e.html && (n = r.createElement('span', { dangerouslySetInnerHTML: { __html: e.html } }));
        var i = Object(p.a)({ mouseDown: !0, touchStart: !0, handler: e.onClickOutside });
        if (!n) return null;
        var u = o(d.message, e.className, (((t = {})[d.error] = e.isError), t));
        return r.createElement('div', { className: u, key: '0' }, r.createElement('span', { ref: i }, n));
      }
      n.d(t, 'b', function () {
        return a;
      }),
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return (
                ...
                i.createPortal(o.createElement(l.Provider, { value: this }, this.props.children), e)
              );
            }),
        ...
        d = (function (e) {
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              s.subscribe(l.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._close, null);
            }),
            (t.prototype.componentWillUnmount = function () {
              s.unsubscribe(l.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._close, null);
            }),
            (t.prototype.render = function () {
              return o.createElement(
                i.a,
                { className: p.popupDialog, isOpened: this.props.isOpened, onClickOutside: this.props.onClose },
                o.createElement(u.b, { onClose: this.props.onClose }, window.t('Symbol Info')),
                o.createElement(
                  u.a,
                  null,
                  o.createElement(a.a, { keyCode: 27, handler: this.props.onClose }),
                  o.createElement('div', { className: p.content }, this._renderFields()),
                ),
              );
            }),
                ...
                ? this.props.fields.map(function (e) {
                    return o.createElement(
                      ...
                      o.createElement(
                        ...
                        o.createElement('span', { className: p.title }, e.title),
                      ),
                      o.createElement(
                        'div',
    ...
    w3Pp: function (e, t, n) {
      ...
      function u(e, t) {
        ...
        var c = t ? window.t('{market_type} cfd', o).format({ market_type: e }) : i[e] || e;
        return r.set(n, c), c;
      }
    },
    'ycI/': function (e, t, n) {
