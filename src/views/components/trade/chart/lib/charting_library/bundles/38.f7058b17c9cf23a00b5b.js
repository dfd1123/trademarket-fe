(window.webpackJsonp = window.webpackJsonp || []).push([
  [38],
  {
    '4Cm8': function (t, e, i) {
      ...
      function f(t) {
        var e;
        return r.createElement('div', { className: n(p.fadeLeft, ((e = {}), (e[p.isVisible] = t.isVisible), e)) });
      }
      function w(t) {
        var e;
        return r.createElement('div', { className: n(p.fadeRight, ((e = {}), (e[p.isVisible] = t.isVisible), e)) });
      }
      function m(t) {
        return r.createElement(v, Object(s.__assign)({}, t, { className: p.scrollLeft }));
      }
      function b(t) {
        return r.createElement(v, Object(s.__assign)({}, t, { className: p.scrollRight }));
      }
      function v(t) {
        var e;
        return r.createElement(
          'div',
          { className: n(t.className, ((e = {}), (e[p.isVisible] = t.isVisible), e)), onClick: t.onClick },
          r.createElement('div', { className: p.iconWrap }, r.createElement(l.Icon, { icon: h, className: p.icon })),
        );
      }
      var _,
        R,
              ...
              return (
                ...
                (i._handleScrollRight = function () {
                  if (i.props.onScrollButtonClick) i.props.onScrollButtonClick('right');
                    ...
                    var t = i.props.scrollStepSize || i.state.widthWrap - 50;
                    i.animateTo(
                      Math.min((i.state.widthContent || 0) - (i.state.widthWrap || 0), i.currentPosition() + t),
                    );
                  }
                }),
                ...
                (i._handleResizeContent = function (t) {
                  ...
                  s && r ? i.setState({ widthContent: t.width + 2 * r }) : i.setState({ widthContent: t.width });
                }),
                ...
                (i._checkButtonsVisibility = function () {
                  var t = i.state,
                    ...
                    r = i.isAtLeft(),
                    n = i.isAtRight();
                  r || e ? r && e && i.setState({ isVisibleLeftButton: !1 }) : i.setState({ isVisibleLeftButton: !0 }),
                    n || s
                      ? n && s && i.setState({ isVisibleRightButton: !1 })
                      : i.setState({ isVisibleRightButton: !0 });
                }),
                (i.state = { widthContent: 0, widthWrap: 0, isVisibleRightButton: !1, isVisibleLeftButton: !1 }),
                i
              );
            }
            return (
              ...
              (e.prototype.animateTo = function (t, e) {
                ...
                i &&
                  (Object(u.isRtl)() && (t = Object(u.getLTRScrollLeftOffset)(i, t)),
                  e <= 0
              ...
              (e.prototype.render = function () {
                ...
                return r.createElement(
                  ...
                  r.createElement(
                    'div',
                    { className: p.wrapOverflow, onMouseOver: d, onMouseOut: f },
                    r.createElement(
                      'div',
                      ...
                      r.createElement(
                        'div',
                        {
                          className: n(p.scrollWrap, ((t = {}), (t[p.noScrollBar] = !s), t)),
                      ...
                      a && r.createElement(_, { onClick: this._handleScrollLeft, isVisible: b }),
                      a && r.createElement(R, { onClick: this._handleScrollRight, isVisible: m }),
                    ),
                  ),
                );
              }),
