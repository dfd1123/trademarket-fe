        ...
        (v.prototype.eos = function () {
          ...
          (g.prototype.lookup = function (e) {
            ...
            if (n.hasOwnProperty(e)) t = n[e];
              ...
              for (var i, a, s = this, u = !1; s; ) {
                if (e.indexOf('.') > 0)
                  for (t = s.view, i = e.split('.'), a = 0; null != t && a < i.length; )
            ...
            return (
              null == a &&
                (a = o[t] = (function (t, r) {
                  ...
                  function k(e) {
                    if (('string' == typeof e && (e = e.split(l, 2)), !n(e) || 2 !== e.length))
                  ...
                  for (var x, U, E, T, $, P, j = new v(t); !j.eos(); ) {
                    ...
                    if (
                      ...
                      '=' === U
                        ...
                        : '{' === U
                        ? ((E = j.scanUntil(s)), j.scan(h), j.scanUntil(a), (U = '&'))
                        : (E = j.scanUntil(a)),
                      !j.scan(a))
                    )
                      throw new Error('Unclosed tag at ' + j.pos);
                    if ((($ = [U, E, x, j.pos]), g.push($), '#' === U || '^' === U)) c.push($);
                    else if ('/' === U) {
                      if (!(P = c.pop())) throw new Error('Unopened section "' + E + '" at ' + x);
                      if (P[1] !== E) throw new Error('Unclosed section "' + P[1] + '" at ' + x);
                    } else 'name' === U || '{' === U || '&' === U ? (b = !0) : '=' === U && k(E);
                  }
                  if ((P = c.pop())) throw new Error('Unclosed section "' + P[1] + '" at ' + j.pos);
                  return (function (e) {
          ...
          (y.prototype.renderSection = function (e, t, i, o) {
            var a = this,
              ...
              u = t.lookup(e[1]);
            if (u) {
              if (n(u)) for (var c = 0, p = u.length; c < p; ++c) s += this.renderTokens(e[4], t.push(u[c]), i, o);
