  ...
  ['new-edit-object-dialog'],
  {
    ...
    CHgb: function (e, t, n) {
      ...
      function u(e) {
        var t = e.menuItemClassName,
          n = Object(r.__rest)(e, ['menuItemClassName']);
    ...
    KacW: function (e, t, n) {
      ...
      var r = n('mrSG'),
        ...
        h = n('J4oI'),
        m = [
          { type: s.LINESTYLE_SOLID, icon: p, label: window.t('Line') },
          { type: s.LINESTYLE_DASHED, icon: u, label: window.t('Dashed Line') },
      ...
      var v = (function (e) {
        ...
        return (
          ...
          (t.prototype.render = function () {
            ...
            return (
              u && (v = Object(r.__spreadArrays)([{ readonly: !0, content: u }], v)),
    ...
    Y5hB: function (e, t, n) {
      ...
      var A,
        ...
        U = (function (e) {
          function t(t) {
            ...
            if (((n._source = r), !Object(b.isStudy)(n._source)))
      ...
      var ke,
        ...
        Ve = n('972a'),
        Re =
          (((ke = {})[Ve.MarkLocation.AboveBar] = {
            value: Ve.MarkLocation.AboveBar,
            content: window.t('Above Bar'),
            order: 0,
          }),
          (ke[Ve.MarkLocation.BelowBar] = {
            value: Ve.MarkLocation.BelowBar,
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              if (Object(Q.isOhlcPlot)(t)) {
                ...
                return (
                  void 0 !== u &&
                    Object(Q.isOhlcPlotStyleCandles)(u) &&
                    (m = o.createElement(
                      o.Fragment,
                      null,
                      o.createElement(pt, {
          ...
          function t() {
            ...
            return (
              (t._findPlotPalette = function (e) {
                var n = t.props.study,
                  r = n.metaInfo(),
                  a = Object(i.ensureDefined)(r.palettes);
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return o.createElement(
                ...
                v &&
                  Object.keys(v).map(function (e, n) {
            ...
            if ((void 0 === e && (e = {}), p.enabled('property_pages'))) {
              ...
              if (
                (Object(nn.isLineTool)(this._source) &&
                  Object(d.trackEvent)('GUI', 'Drawing Properties', this._source.name()),
                Object(b.isStudy)(this._source))
              ) {
