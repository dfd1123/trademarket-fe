        ...
        var d = {
          ...
          showNotice: function (t, o, e) {
            ...
            var n = (e = e || {}).doNotCloseOnBgClick || !1,
              ...
              s = e.width || '400px',
              l = {};
            (l.noClose = e.noClose || null), (l.addClass = e.modalDialogClass || null), d.createModalDialog(t, l);
            ...
            return (
              ...
              d.positionDialog(),
              d.applyHandlers(!1, { doNotCloseOnBgClickIfShadowbox: n, beforeDestroy: e.onClose }),
              d.modalDialog
            );
          },
          ...
          createModalDialog: function (t, o) {
            (o = o || {}),
              ...
              o.width && d.modalDialog.find('._tv-dialog').css({ width: o.width }),
              o.content && d.modalDialog.find('._tv-dialog-content').html(o.content);
          ...
          _addMessageCloseButton: function (t) {
            var o = $(e('BhuR')).attr({ class: 'close', title: $.t('Close message') });
            t.append(o),
              $(o).on('click', function () {
          ...
          createDialog: function (t, o) {
            ...
            var e = (o = o || {}).ownerDocument || document,
              ...
              c = $(
                i.render(
                  ...
                  { addClass: o.addClass || '', hideTitle: o.hideTitle, hideCloseCross: o.hideCloseCross, title: t },
                ),
                e,
              ).appendTo(r);
            ...
            var u = {
              start: function (t, o) {
                for (var e = o.helper.css('z-index'), i = 0, n = null, a = 0; a < d.dialogs.length; a++) {
            ...
            return (
              o.dragHandle ? (u.handle = o.dragHandle) : o.hideTitle || (u.handle = '._tv-dialog-title'),
          ...
          positionDialog: function (t, o, e) {
            ...
            if (((o = o || e.position), t)) {
              var n,
                ...
                u = $(l).height();
              if (o && o.top && o.left)
                (a = e.forcePosition ? o.left : Math.max(2, Math.min(g - r - 4, o.left)) + 'px'),
                  (n = e.forcePosition ? o.top : Math.max(2, Math.min(u - c - 4, o.top)) + 'px');
              else if (o && o.considerScroll) {
                var p = $(s);
                (a = Math.round((g - r) / 2 + p.scrollLeft()) + 'px'),
                  (n = Math.round((u - c) / 2 + p.scrollTop()) + 'px');
              } else (a = Math.round((g - r) / 2) + 'px'), (n = Math.round((u - c) / 2) + 'px');
              e.fadeIn
          ...
          applyHandlers: function (t, o) {
            var e = !t || t === this.modalDialog,
              ...
              n = (t = t || d.modalDialog.find('._tv-dialog')).prop('ownerDocument');
              ...
              o.doNotCloseOnBgClick ||
                setTimeout(function () {
                  $(n).on('mousedown.closeDialog', function (e) {
                    ...
                    a.is(t) ||
                      (o.doNotCloseOnBgClickIfShadowbox && a.is('._tv-dialog-shadowbox, .tv-dialog__modal-wrap')) ||
                      a.is(
            ...
            Modernizr.mobiletouch || o.notFocusFirst || a.focus(),
              ...
              o.doNotCloseOnEsc ||
                $(n).bind('keyup.hideDialog', function (o) {
                  if (27 === o.keyCode) return t ? d.destroy(t.data('title')) : d.destroy(), !1;
                }),
              o.processEnterButton &&
                $(n).bind('keyup.confirmAndCloseDialog', function (t) {
                  13 === t.keyCode &&
                    'textarea' !== t.target.tagName.toLowerCase() &&
                    (o.processEnterButton.click(), $(n).unbind('keyup.confirmAndCloseDialog'));
                });
          },
          ...
          showMessage: function (t, o, e) {
            o || (o = $('._tv-dialog'));
            var i = (e = e || {}).isError ? '_tv-dialog-error' : '_tv-dialog-message',
              n = o.find('.' + i),
              a = n.find('.message');
            e.html ? a.html('string' == typeof e.html ? e.html : t) : a.text(t),
              a.css('width', o.width()).toggleClass('selectable', Boolean(e.selectable)),
              n
              ...
              e.withClose ||
                (e.hideWithoutAnimation
                  ...
                  : n.on('touchstartoutside mousedownoutside keydownoutside', function t() {
                      n.animate({ marginTop: d.NOTIFICATION_ANIMATION_START_OFFSET, opacity: 0 }, 'fast', function () {
                        n.hide();
                      }),
          ...
          isOpen: function (t) {
            for (var o = 0; o < d.dialogs.length; o++) if (d.dialogs[o].title === t) return !0;
            return !1;
          },
          get: function (t) {
            for (var o = 0; o < d.dialogs.length; o++) if (d.dialogs[o].title === t) return d.dialogs[o].dialog;
          },
    ...
    PVgW: function (t, o, e) {
      ...
      function s(t, o) {
        ...
        var e = t.data('TVTicker'),
          n = e && e.step,
          s = 0;
        (s = e.parser ? e.parser(t.val()) : Object(i.isInteger)(n) ? parseInt(t.val(), 10) : parseFloat(t.val())),
          isNaN(s) && (s = 0);
        var d = a(n),
          ...
          this.each(function () {
            ...
            if (
              ...
              var a = $('<div class="tv-ticker">').appendTo(e.parent()),
                ...
                r = $('<div class="tv-ticker__btn tv-ticker__btn--down">').html(n).appendTo(a);
          ...
          return (
            ...
            (t.prototype.ensureWindow = function (t, o) {
              ...
              if (
                ...
                else if (o.index <= 0) this._container.insertBefore(i, this._container.firstChild);
                else {
            ...
            (t.prototype.unregisterWindow = function (t) {
              ...
              void 0 !== o && (null !== o.parentElement && o.parentElement.removeChild(o), this._windows.delete(t));
            }),
