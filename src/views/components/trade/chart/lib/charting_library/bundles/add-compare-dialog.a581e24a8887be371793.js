(window.webpackJsonp = window.webpackJsonp || []).push([
  ['add-compare-dialog'],
  {
      ...
      (function (t) {
        Object.defineProperty(e, '__esModule', { value: !0 }),
          (e.createTabbedDialog = function (e) {
            ...
            !1 !== e.withScroll &&
              (n = $('<div class="js-dialog__scroll-wrap tv-dialog__scroll-wrap">').append(
                r.addClass('tv-dialog__scroll-wrap-inner'),
              ));
            var l = $('<div class="tv-tabbed-dialog">').append(i).append(n);
            e.customControls && i.find('.js-custom-controls').append(e.customControls);
            if (!0 !== e.doNotCreatePages)
              for (var c = 0; c < e.tabs.length; ++c)
                r.append($('<div class="tv-tabbed-dialog__tab-page">').append(e.tabs[c].page));
    ...
    UnpO: function (t, e, i) {
      'use strict';
      Object.defineProperty(e, '__esModule', { value: !0 }), (e.AddSymbolTab = void 0);
      var o = (function () {
          function t(t, e) {
    ...
    dKfe: function (t, e, i) {
      'use strict';
      Object.defineProperty(e, '__esModule', { value: !0 }), (e.AddSymbolCheckbox = void 0);
      var o,
        a = i('QwKQ'),
      ...
      e.AddSymbolCheckbox = (function (t) {
        function e(t) {
          !(function (t, e) {
            ...
            (t.checked = TVSettings.getBool('showAddSymbolDialog.checkboxState', !0));
          var i = (function (t, e) {
    ...
    ocUP: function (t, e, i) {
      'use strict';
      (function (t, o) {
        Object.defineProperty(e, '__esModule', { value: !0 }), (e.CompareTab = void 0);
        var a = (function () {
            function t(t, e) {
              for (var i = 0; i < e.length; i++) {
                var o = e[i];
            ...
            a(e, [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (i) {
                    var o = i.model();
                    o &&
                      ((this.selectedSymbols = this.selectedSymbols.filter(function (e) {
                        return e !== t;
                      })),
                      o.dataSources().forEach(function (i) {
                        if (i._metaInfo && 'Compare@tv-basicstudies' === i._metaInfo.id) {
                          ...
                          (a === t || (e._symbolAlias[a] && e._symbolAlias[a] === t)) && o.removeSource(i);
                        }
                      }));
                  }
                },
              },
              {
                ...
                value: function () {
                  ...
                  if (e) {
                    ...
                    if (i) {
                      var o = i.dataSources();
                      (this.$tab = $(r)), this._initSymbolSearch(), this._createPredefinesList();
                        ...
                        this._predefines.forEach(function (e) {
                          ...
                          o.forEach(function (e) {
                            if (e._metaInfo && 'Compare@tv-basicstudies' === e._metaInfo.id) {
                              ...
                              (o === i || (t._symbolAlias[o] && t._symbolAlias[o] === i)) &&
                                (n.attr('checked', !0), t.selectedSymbols.push(o));
                            }
                          });
                        });
                    }
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var a = $('<div class="tv-compare-tab__predefines js-compare-tab-predefines"></div>');
                  this._predefines.forEach(function (e) {
                    var s = e.symbol,
                      n = e.title,
                      r = $(
                        o.render(l, {
                          ...
                          label: n,
                          additionalClass: t._isBovespa ? 'tv-compare-tab__predefine-cell--wide' : '',
                        }),
                      );
                    r.find('.js-predefine-checkbox').change({ symbol: s }, i), r.appendTo(a);
                  }),
                    a.appendTo(this.$tab);
                },
              },
    ...
    pIOw: function (t, e, i) {
        ...
        _ = (function () {
          function t(t, e, i) {
            void 0 === i && (i = {}),
              ...
              (this._elTabs = t),
              (this._elPages = e),
              (this._elScrollWrap = y(this._options.scrollWrapClass || '', this._elTabs, 'wrapInner')),
              (this._elScrollBox = y(this._options.scrollBoxClass || '', this._elScrollWrap, 'wrapInner')),
              this._options.noSlider ||
                (this._elSlider = y(this._options.sliderClass || '', this._elScrollBox, 'append')),
              Modernizr.mobiletouch ||
                ((this._elArrowLeft = y(
                  this._options.lArrowClass || '',
                  this._elTabs,
                  'append',
                  '<div class="' + (this._options.lArrowClass || '') + ' i-slided">' + f + '</div>',
                )),
                (this._elArrowRight = y(
                  this._options.rArrowClass || '',
                  this._elTabs,
                  'append',
                  '<div class="' + (this._options.rArrowClass || '') + ' i-slided">' + v + '</div>',
                )),
          ...
          return (
            ...
            (t.prototype.checkScrollArrows = function (t) {
                ...
                C(t, 'i-slided'),
                  $.Velocity &&
                    $.Velocity.animate(
                      t,
                      { translateX: '0%' },
                      { duration: n.dur / 2, easing: 'easeOutCubic', queue: !1 },
                    );
              }
              function l(e, i) {
                if (t) return m(e, 'i-slided'), void e.setAttribute('style', '');
              ...
              this._elArrowLeft &&
                (e >= 1
                  ? r(this._elArrowLeft)
                  : (e <= 1 || this._elScrollWrap.scrollWidth <= i) && l(this._elArrowLeft, s.Left)),
                this._elArrowRight &&
                  (o - e > 1
                    ? r(this._elArrowRight)
                    : (e >= o || this._elScrollWrap.scrollWidth <= i) && l(this._elArrowRight, s.Right));
            }),
              ...
              if (!this._options.noSlider) {
                ...
                if (
                  !(
                    0 === s.clientWidth ||
                    0 === s.clientHeight ||
                    'none' === window.getComputedStyle(s).getPropertyValue('display')
                  )
                ) {
                  var r = window.getComputedStyle(s),
                    l = s.offsetLeft + parseInt(r.getPropertyValue('padding-left')),
                    c = g(s),
                    d = s.querySelector('.js-tabs__slider-pos');
                  if (d) {
                    var u = window.getComputedStyle(d);
                    (l += parseInt(u.getPropertyValue('padding-left')) + d.offsetLeft), (c -= c - g(d));
                  }
                  (i = i || -1 === t || (document.all && !window.atob))
                    ? ((this._elSlider.style.left = l + 'px'), (this._elSlider.style.width = c + 'px'))
                    : ((this._animating = !0),
                      a().then(function () {
                        $.Velocity.animate(
                          o._elSlider,
                          { left: l },
                          { duration: n.dur, easing: 'easeOutCubic', queue: !1 },
                        ),
                          $.Velocity.animate(
                            o._elSlider,
                            { width: c },
            ...
            (t.prototype.deselect = function () {
              var t = this.getElActiveTab();
              this._options.activeTabClass && t && C(t, this._options.activeTabClass);
              var e = this.getElActivePage();
              return (
                this._options.activePageClass && e && C(e, this._options.activePageClass),
            ...
            (t.prototype._bindEvents = function () {
                ...
                this._elArrowRight &&
                  this._bindOneEvent({
                    ...
                    listener: function () {
                      var e = t.getTabsArray(),
                        i = 0,
                        s = Object(h.isRtl)() ? 0 : t._elScrollWrap.scrollLeft + g(t._elScrollWrap);
                      Object(h.isRtl)() && e.reverse(),
                        e.forEach(function (t) {
                          if (0 === i) {
                            var e = t.offsetLeft + t.offsetWidth;
                        ...
                        a().then(function () {
                          $.Velocity.animate(t._elScrollWrap, 'scroll', {
                            ...
                            duration: n.dur / 2,
                            easing: 'easeInOutCubic',
                            offset: Math.ceil(i - s + g(Object(o.ensureDefined)(t._elArrowRight))),
                            queue: !1,
                          });
                        });
                    },
              ...
              var e = Array.prototype.slice.call(this._elTabs.querySelectorAll('.js-tabs__slider-hover') || []);
              e.length &&
                  ...
                  return t._bindOneEvent({
                    ...
                    listener: function (e) {
                      if (!t._animating) {
                        ...
                        i && t._options.activeTabClass && w(i, t._options.activeTabClass) && t._hoverSlider(i);
                      }
                    },
                    target: e,
                  });
              ...
              var i = null,
                s = function () {
                  (i = null), t.checkScrollArrows(!0), t._options.noSlider || t.resizeSlider();
                };
              this._bindOneEvent({
                eventName: 'resize',
                listener: function () {
            ...
            (t.prototype._bindTabEvents = function (t) {
              ...
              this._bindOneEvent({
                eventName: 'click',
                listener: function (t) {
                  'function' == typeof e._options.onTabClick ? e._options.onTabClick(t) : e.onTabClick(t);
                },
                target: t,
              });
            }),
            ...
            (t.prototype._isTabDisabled = function (t) {
              return (
                w(t, 'i-disabled') ||
                (this._options.tabDisabledClass && w(t, this._options.tabDisabledClass)) ||
            ...
            (t.prototype._hoverSlider = function (t) {
              ...
              a().then(function () {
                $.Velocity.animate(e._elSlider, { left: s }, r), $.Velocity.animate(e._elSlider, { width: i }, r);
              });
              var l = function () {
                e.getElActiveTab() === t && e._unhoverSlider(t), t.removeEventListener('mousleave', l);
              };
            ...
            (t.prototype._unhoverSlider = function (t) {
              ...
              a().then(function () {
                $.Velocity.animate(e._elSlider, { left: r }, d), $.Velocity.animate(e._elSlider, { width: c }, d);
              });
            }),
            t
          );
      ...
      function y(t, e, i, o) {
        ...
        if (!a) {
          ...
          if (((s.innerHTML = o || '<div class="' + t + '"></div>'), (a = s.firstElementChild), 'append' === i))
            e.appendChild(a);
          else {
            if ('wrapInner' !== i) throw new Error('Unknown insertMethod');
            for (var n = Array.prototype.slice.call(e.childNodes), r = 0; r < n.length; r++) a.appendChild(n[r]);
            e.appendChild(a);
          }
        }
        return a;
    ...
    tkV1: function (t, e, i) {
      'use strict';
      Object.defineProperty(e, '__esModule', { value: !0 }), (e.AddCompareDialog = void 0);
      var o = (function () {
          function t(t, e) {
            for (var i = 0; i < e.length; i++) {
              var o = e[i];
          ...
          o(t, [
            {
              ...
              value: function () {
                ...
                var t = new a.CompareTab(this._chartWidgetCollection, this),
                  ...
                  i = [];
                i.push({ name: $.t('Compare'), page: t.$tab.addClass('tv-compare-dialog__tab-page') }),
                  i.push({
                ...
                return (
                  ...
                  this._dialog.on('afterClose', function () {
                    (0, r.trackEvent)('GUI', 'Compare', t.selectedSymbols.sort().join(', '));
                  }),
                  this._dialog.open(),
                  this._dialog
                );
