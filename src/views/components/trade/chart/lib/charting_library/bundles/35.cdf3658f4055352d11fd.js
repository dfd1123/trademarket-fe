    ...
    DxCR: function (t, e, i) {
      ...
      (function (t) {
        ...
        function C(t, e, i, r, o, n, s) {
          v.call(this, t, e, r, o, n), (this._transformFunction = i), (this._setter = s), this._attachToControl(t, r);
        }
        ...
        function E(e, i, r, o, n, s) {
          isNumber(i.value()) ||
            (f.logWarn('Property cannot be binded to control, bad value (expect number): ' + i.value()), (i = new t())),
          ...
          function l(t, e) {
            var i = a.control().slider('option', 'min'),
              ...
              o = a._property.value();
            ((i <= o && o <= r) || (i < e.value && e.value < r)) && a.setValueToProperty(e.value);
          }
          function c(t, e) {
            a.setValueToProperty(e.value);
          }
          r && (s ? (e.bind('slidechange', l), e.bind('slide', l)) : (e.bind('slidechange', c), e.bind('slide', c))),
        ...
        function P(t, e, i, r, o, n, s, a) {
          ...
          var l = this;
          t.slider({ range: !0, min: i[0], max: i[1], values: [l._propFrom.value(), l._propTo.value()] }),
            ...
            n &&
              ...
              $(n).each(function () {
                $(this).on('keydown', function (t) {
                  parseInt($(n[0]).val()) < l._transformers[0]
                    ...
                    : parseInt($(n[1]).val()) > l._transformers[1] && $(n[1]).val(l._transformers[1]),
              ...
              $(n[0]).on('keyup', function (t) {
                parseInt($(this).val()) < l._transformers[0]
                  ...
                  parseInt($(this).val()) > parseInt($(n[1]).val()) && $(this).val(n[1].val()),
                  l._control.slider('values', 0, $(this).val()),
                  P.prototype.setValueToProperty.call(l, l._control.slider('values'), 'from');
              }),
              $(n[1]).on('keyup', function (t) {
                parseInt($(this).val()) < l._transformers[0]
                  ? $(this).val(l._transformers[0])
                  : parseInt($(this).val()) > l._transformers[1] && $(this).val(l._transformers[1]),
                  parseInt($(this).val()) < $(n[0]).val() && $(this).val(n[0].val()),
                  l._control.slider('values', 1, $(this).val()),
                  P.prototype.setValueToProperty.call(l, l._control.slider('values'), 'to');
              })),
            this._propFrom.listeners().subscribe(this, P.prototype.propertyChanged),
            ...
            t.slider({
              stop: function (t, e) {
                n && ($(n[0]).val(l._control.slider('values', 0)), $(n[1]).val(l._control.slider('values', 1))),
                  l.setValueToProperty(l._control.slider('values'), e.handle);
              },
              start: function (t, e) {
                n && ($(n[0]).val(l._control.slider('values', 0)), $(n[1]).val(l._control.slider('values', 1))),
        ...
        (_.prototype.model = function () {
          ...
          (_.prototype.createSeriesMinTickEditor = function () {
            var t = "<select><option value='default'>" + $.t('Default') + '</option>',
              e = [
          ...
          (_.prototype.createPrecisionEditor = function () {
            for (var t = "<select><option value='default'>" + $.t('Default') + '</option>', e = 0; e <= 8; e++)
          ...
          (_.prototype.createLabeledCell = function (t, e, i) {
            var r,
              o,
              n = null;
            'number' == typeof t.valueOf() ? ((n = t), (r = e), (o = i)) : ((r = t), (o = e)), (r += '');
          ...
          (_.prototype.addLabeledRow = function (t, e, i, r) {
            ...
            if ((r && ((r = parseInt(r)), n(r) && (r = 2), a.attr('colspan', r)), i)) {
          ...
          (_.prototype.addEditorRow = function (t, e, i, r) {
            ...
            return (i.row = this.addLabeledRow(t, e, i, r)), i.appendTo(o.appendTo(i.row)), i;
          }),
          ...
          (C.prototype.value = function () {
            ...
            if (this._transformFunction)
              if (Array.isArray(this._transformFunction))
                for (var e = 0; e < this._transformFunction.length; e++) t = this._transformFunction[e](t);
          ...
          (T.prototype.value = function () {
            ...
            return (
              i <= e && (e = i - 1),
              1e3 *
                o(this._mainSeries.bars().valueAt(o(this._mainSeries.bars().lastIndex()) - e))[TradingView.TIME_PLOT]
            );
          }),
          (T.prototype.setValue = function (t) {
            if (this._disabled || null == t) this._control.attr('disabled', !0);
              ...
              var e = this._mainSeries.data().plotValueToTimePointIndex(t / 1e3, TradingView.TIME_PLOT, u.FromRight);
              if (null !== e) {
          ...
          (x.prototype.destroy = function () {
            v.prototype.destroy.call(this),
              this._updateDelegate && this._updateDelegate.unsubscribe(this, this._updateDisplayedSymbol);
          }),
          inherit(M, v),
          ...
          (w.prototype.setValue = function (t) {
            if (
              (this.control().is('.visibility-checker') &&
                (t
                  ? (this.control().closest('tr').find('.slider-range').slider('enable'),
                    this.control()
                      .closest('tr')
              ...
              if (r) r.closest('td').css(e);
                ...
                o.parent()
                  ...
                  .filter(function () {
                    var t = $(this);
                    return !t.find('label').length && t.find(':checkbox').attr('id') !== o.attr('id');
                  })
                  .each(function () {
                    var r = $(this);
          ...
          (P.prototype.setValue = function (t, e) {
            void 0 === e && (t === this._propFrom && (e = 0), t === this._propTo && (e = 1)),
          ...
          (P.prototype.destroy = function () {
            this._propFrom &&
              this._propTo &&
              (this._propFrom.listeners().unsubscribe(this, v.prototype.propertyChanged),
          ...
          (e.SymbolInfoSymbolTransformer = function (t, e) {
            return function (i) {
              var r = t();
              return i === e.value() && r && (r.ticker || r.full_name) ? r.ticker || r.full_name : i;
            };
          }),
            ...
            typeof (r = function (t) {
              return t.widget('ui.slider', t.ui.mouse, {
                ...
                _mouseCapture: function (e) {
                  ...
                  return (
                    ...
                    this.handles.each(function (e) {
                      ...
                      (o > i || (o === i && (e === c._lastChangedValue || c.values(e) === u.min))) &&
                        ((o = i), (n = t(this)), (s = e));
                    }),
                    !1 !== this._start(e, s) &&
                ...
                _uiHash: function (t, e, i) {
                  var r = { handle: this.handles[t], handleIndex: t, value: void 0 !== e ? e : this.value() };
                  return (
                    this._hasMultipleValues() &&
                      ((r.value = void 0 !== e ? e : this.values(t)), (r.values = i || this.values())),
                    r
                  );
                },
                ...
                values: function (e, i) {
                  ...
                  for (r = this.options.values, o = arguments[0], n = 0; n < r.length; n += 1)
                ...
                _setOption: function (e, i) {
                  ...
                  switch (
                    ...
                    case 'value':
                      ...
                      break;
                    case 'values':
                      for (this._animateOff = !0, this._refreshValue(), r = o - 1; r >= 0; r--) this._change(null, r);
                      this._animateOff = !1;
                      break;
                    case 'step':
                    case 'min':
                ...
                _values: function (t) {
                  ...
                  if (this._hasMultipleValues()) {
                    for (i = this.options.values.slice(), r = 0; r < i.length; r += 1)
                ...
                _trimAlignValue: function (t) {
                  ...
                  var e = this.options.step > 0 ? this.options.step : 1,
                    ...
                    r = t - i;
                  return 2 * Math.abs(i) >= e && (r += i > 0 ? e : -e), parseFloat(r.toFixed(5));
                },
                ...
                _refreshValue: function () {
                  ...
                  this._hasMultipleValues()
                    ? this.handles.each(function (r) {
                        (i = ((l.values(r) - l._valueMin()) / (l._valueMax() - l._valueMin())) * 100),
                          (u['horizontal' === l.orientation ? 'left' : 'bottom'] = i + '%'),
                          t(this).stop(1, 1)[c ? 'animate' : 'css'](u, a.animate),
                          !0 === l.options.range &&
                            ('horizontal' === l.orientation
                              ? (0 === r && l.range.stop(1, 1)[c ? 'animate' : 'css']({ left: i + '%' }, a.animate),
                                1 === r &&
                    ...
                    : ((r = this.value()),
                      ...
                      'min' === s &&
                        ...
                        this.range.stop(1, 1)[c ? 'animate' : 'css']({ height: i + '%' }, a.animate),
                      'max' === s &&
                        'vertical' === this.orientation &&
                        this.range.stop(1, 1)[c ? 'animate' : 'css']({ height: 100 - i + '%' }, a.animate));
                },
                _handleEvents: {
                  keydown: function (e) {
                    var i,
                    ...
                    switch (
                      ((o = this.options.step),
                      (i = r = this._hasMultipleValues() ? this.values(n) : this.value()),
                      e.keyCode)
                    ) {
                      case t.ui.keyCode.HOME:
                        r = this._valueMin();
        ...
        return (
          ...
          (t.prototype.initEvents = function () {
            var t = this.$el.prop('ownerDocument'),
              ...
              i = function (r) {
                return $(t).off('mousemove mouseup', e), $(t).off('mouseup', i), this.mouseupHandler(r);
              }.bind(this);
            this.$el.on(
              'mousedown',
              function (r) {
                (this.mouseFlag = !0), $(t).on('mousemove mouseup', e), $(t).on('mouseup', i), r.preventDefault();
              }.bind(this),
            ),
              this.colorInput.on(
                'change',
      ...
      !(function (t) {
        ...
        function b(y) {
          ...
          function k(e, i, r) {
            ...
            (e = v(o(f(e), i))),
              T.call(this, e),
              n.removeData('tvcolorpicker').removeData('tvcolorpicker-custom-color'),
              r && (w.call(n), n.blur());
          }
          function T(e) {
            var i = t(this);
          ...
          function x(e) {
            '' !== e
              ? (t(this).removeClass('tvcolorpicker-gradient-widget'), t(this).css({ backgroundColor: e, color: e }))
            ...
            return (
              t.each(e, function (e, s) {
                ...
                var l = t('<td class="tvcolorpicker-cell"></td>').appendTo(r),
                  h = t('<div class="tvcolorpicker-transparency"><div class="tvcolorpicker-swatch"></div></div>')
                    .appendTo(l)
          ...
          function $(i) {
            var r = !1,
              ...
              y = t('<div class="tvcolorpicker-swatches-area"></div>').appendTo(b);
            y.append(
              M.call(this, [
                'rgb(0, 0, 0)',
                'rgb(66, 66, 66)',
            ...
            var x = t('<div class="tvcolorpicker-custom-area"></div>').css({ display: 'none' }).appendTo(b),
            ...
            function N(t) {
              var e = t.originalEvent,
                ...
                r = t.offsetY || t.layerY || (e && (e.offsetY || e.layerY)) || 0;
            ...
            function B(e) {
              1 == e.which && ((A = !1), b.is('.opened') && t(n).get(0).focus());
            }
            function U(e) {
              var i = (function (e) {
                var i = e.pageY,
              ...
              I.css({ top: i + 'px' }), (L[2] = c(1 - Math.max(0, Math.min(i, F)) / F)), j();
            }
            function W(e) {
              1 == e.which && ((H = !1), t(m).unbind('mouseup', W), b.is('.opened') && t(n).get(0).focus());
            }
            function j() {
              z && ((z = !1), b.find('.tvcolorpicker-swatch.active').removeClass('active'));
              var t = o(p(L), C.val());
            ...
            O.bind('mousedown', function (e) {
              1 == e.which && ((A = !0), t(m).bind('mouseup', B), N(e), e.preventDefault());
            }),
              ...
              t(C).on(
                'change',
                function () {
                  r ? j() : k.call(this, t(this).val() || 'rgb(14, 15, 16)', C.val());
                }.bind(this),
              ),
              t(C).on(
                'afterChange',
              ...
              E.bind('mousedown', function (e) {
                1 == e.which && ((H = !0), t(m).bind('mouseup', W), U(e), e.preventDefault());
              }),
              t(m).bind('mousemove', function (t) {
                H && (U(t), t.preventDefault());
              });
            t('<a class="tvcolorpicker-custom-button _tv-button">' + window.t('Custom color...') + '</a>')
              .appendTo(b)
              .bind('click', function () {
                var e = t(this).is('.active');
                if (
                  (e || x.css({ minWidth: y.width() + 'px', minHeight: y.height() + 'px' }),
                  ...
                  (L = h(i)),
                    S.css({ left: ~~(L[0] * R) + 'px', top: ~~((1 - L[1]) * F) + 'px' }),
          ...
          return (
            ...
            this.each(function () {
              ...
              var r = null,
                o = !1;
              e.addClass('tvcolorpicker-widget').attr('autocomplete', 'off').attr('readonly', !0);
              var n = function () {
