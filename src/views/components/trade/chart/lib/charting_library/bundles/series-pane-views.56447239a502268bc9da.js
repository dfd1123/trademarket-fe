        ...
        (_.prototype._drawImpl = function (t) {
          if (null !== this._data) {
            ...
            if (
              ...
              var u = r + 8 + (e - a) / 2,
                m = l(t, a);
              if ((t.fillText(this._data.dateString, u + m, h + 6.5 + 5), this._data.timeString)) {
                var f = l(t, s),
                  T = r + 8 + (e - s) / 2;
        ...
        (p.prototype.updateImpl = function () {
          ...
          if (
            ...
            if (null != s) {
              ...
              if (((this._point = new a(o, l)), this._gotoDateResult.eod)) this._eod = !0;
              else {
                var d = this._series.model().timeScale().indexToUserTime(t);
                (this._dateString = new n().format(d)), this._series.isDWM() || (this._timeString = new r().format(d));
              }
            }
          }
        }),
