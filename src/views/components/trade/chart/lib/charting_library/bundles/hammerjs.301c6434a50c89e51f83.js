      ...
      !(function (r, s, o, a) {
                ...
                (function (t, e) {
                  ...
                  if (8 != e.eventType && (a > 25 || void 0 === o.velocity)) {
                    var h = e.deltaX - o.deltaX,
                      u = e.deltaY - o.deltaY,
                      c = V(a, h, u);
                    (i = c.x), (r = c.y), (n = p(c.x) > p(c.y) ? c.x : c.y), (s = U(h, u)), (t.lastInterval = e);
        ...
        r.MSPointerEvent &&
          ...
          E(tt, k, {
            handler: function (t) {
              ...
              1 & r && (0 === t.button || o) ? a < 0 && (e.push(t), (a = e.length - 1)) : 12 & r && (n = !0),
                a < 0 ||
                  ((e[a] = t),
        ...
        (dt.prototype = {
          ...
          dropRecognizeWith: function (t) {
            return d(t, 'dropRecognizeWith', this) || ((t = yt(t, this)), delete this.simultaneous[t.id]), this;
          },
          ...
          E(Et, Tt, {
            ...
            directionTest: function (t) {
              ...
              return (
                r & e.direction ||
                  (6 & e.direction
                    ? ((r = 0 === s ? 1 : s < 0 ? 2 : 4), (n = s != this.pX), (i = Math.abs(t.deltaX)))
                    : ((r = 0 === o ? 1 : o < 0 ? 8 : 16), (n = o != this.pY), (i = Math.abs(t.deltaY)))),
                (t.direction = r),
            ...
            attrTest: function (t) {
              return (
                Tt.prototype.attrTest.call(this, t) && (2 & this.state || (!(2 & this.state) && this.directionTest(t)))
              );
            },
            emit: function (t) {
        ...
        function Pt(t, e) {
          ...
          i.style &&
            (m(t.options.cssProps, function (r, s) {
              (n = R(i.style, s)),
                e ? ((t.oldCssProps[n] = i.style[n]), (i.style[n] = r)) : (i.style[n] = t.oldCssProps[n] || '');
            }),
            e || (t.oldCssProps = {}));
        }
        (wt.prototype = {
