(window.webpackJsonp = window.webpackJsonp || []).push([
  ['study-template-dialog'],
  {
      ...
      var o = n('q1tI'),
        r = function (e, t) {
          var n = void 0 === t ? {} : t,
            ...
            u = void 0 === a ? null : a;
          try {
            return new window.CustomEvent(e, { bubbles: r, cancelable: s, detail: u });
          } catch (l) {
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return (
                ...
                i.createPortal(r.createElement(l.Provider, { value: this }, this.props.children), e)
              );
            }),
    ...
    IDfV: function (e, t, n) {
      ...
      var _ = (function (e) {
          function t(t) {
            ...
            if (
              ((n._setInputRef = function (e) {
                e &&
                  ...
                  n._inputElement.addEventListener('keyup', n._handleKeyUpEnter));
              }),
              ...
              (n._handleOutsideClick = function () {
                ...
                t ? r && i !== o && r(i) : n.setState(n._valueToQuery(o)), n._close();
              }),
              (n._handleFocus = function (e) {
                n.props.preventOnFocusOpen || n._open(), n.props.onFocus && n.props.onFocus(e);
              }),
              (n._handleChange = function (e) {
                ...
                if (o && '' === u) n.setState({ queryValue: u, isOpened: !1, active: void 0 }), a && a();
                else {
                  var c = n._suggestions(u),
                    l = Object.keys(c).length > 0;
                  n.setState({ queryValue: u, isOpened: l, active: r ? void 0 : n._getActiveKeyByValue(u) }),
                    l && s && s();
                }
                r && i && i(u);
              }),
              ...
              (n._handleKeyDown = function (e) {
                if (-1 !== [o.DownArrow, o.UpArrow, o.Enter, o.Escape].indexOf(e.which)) {
                  var t = n.props,
                    r = t.allowUserDefinedValues,
                    i = t.value,
                    s = t.onChange,
                  ...
                  switch (e.which) {
                    ...
                    case o.UpArrow:
                      ...
                      if (void 0 === c) {
                        ...
                        m = 0;
                      } else m = h.indexOf(c) + (e.which === o.UpArrow ? -1 : 1);
                    ...
                    case o.Enter:
                      ...
                      r && (l && b ? n.setState(n._valueToQuery(b)) : (b = p)),
                        void 0 !== b &&
                          (n._close(), l || n._blur(), b !== i ? s && s(b) : n.setState(n._valueToQuery(b)));
                  }
                }
              }),
            ...
            return (n.state = Object(r.__assign)({ isOpened: !1, active: t.value }, n._valueToQuery(t.value))), n;
          }
          return (
            ...
            (t.prototype.componentWillReceiveProps = function (e) {
              var t = e.allowUserDefinedValues,
                n = e.value,
                o = t ? n : '' === n ? '' : this._source()[n] || this.state.queryValue;
            ...
            (t.prototype.render = function () {
              var e = this;
              return a.createElement(m.a, { handler: this._handleOutsideClick, click: !0 }, function (t) {
                var n;
                return a.createElement(
                  ...
                  a.createElement(h.a, {
                    name: e.props.name,
                    rightComponent: Object.keys(e._suggestions(e.state.queryValue)).length
                      ? a.createElement(
                          'div',
                          { className: f.caret, onClick: e._handleCaretClick },
                          a.createElement(d.a, { className: f.icon, dropped: e.state.isOpened }),
                        )
                      : void 0,
            ...
            (t.prototype._renderSuggestions = function () {
              var e = this,
                ...
                n = Object.keys(t).map(function (n) {
                  var o,
                    r = l(f.suggestion, (((o = {})[f.selected] = e.state.active === n), o));
                  return a.createElement('li', { id: n, key: n, className: r, onClick: e._handleItemClick }, t[n]);
                }),
                o = a.createElement(
                  'li',
                  {
              ...
              return !n.length && this.props.noEmptyText
                ? null
                : a.createElement('ul', { className: f.suggestions, ref: this._setSuggestionsRef }, n.length ? n : o);
            }),
        ...
        return (
          ...
          u.a.createElement(
            ...
            u.a.createElement(
              ...
              u.a.createElement(
                ...
                u.a.createElement(p.Checkbox, {
                  label: u.a.createElement(
                    ...
                    I,
                    u.a.createElement(g.Icon, { icon: S, className: l(O.hintMark, 'apply-common-tooltip'), title: n }),
                  ),
                  onChange: function () {
              ...
              u.a.createElement(
                ...
                u.a.createElement(p.Checkbox, {
                  label: u.a.createElement(
                    ...
                    { className: O.hintLabel },
                    k,
                    u.a.createElement(g.Icon, { icon: S, className: l(O.hintMark, 'apply-common-tooltip'), title: o }),
                  ),
                  onChange: function () {
              ...
              u.a.createElement('div', { className: l(O.indicators, D && O.withSuggestions) }, r),
            ),
          )
        );
      }
          ...
          function e(e) {
            ...
            (this._container = document.createElement('div')),
              ...
              (this.unmount = function () {
                j.unsubscribe(T.CLOSE_POPUPS_AND_DIALOGS_COMMAND, t.unmount, null),
              ...
              j.subscribe(T.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this.unmount, null);
          }
          return (
      ...
      var q = Object(s.t)('Save Indicator Template'),
        ...
        P = Object(s.t)("Study Template '{templateName}' already exists. Do you really want to replace it?");
      function U(e, t, n) {
        L.backend.saveStudyTemplate(e).then(function () {
          L.backend.invalidateStudyTemplatesList(), L.backend.getStudyTemplatesList().then(t);
        });
      }
      var V = (function () {
        function e(e) {
              ...
              return Object(r.__awaiter)(t, void 0, void 0, function () {
                ...
                return Object(r.__generator)(this, function (o) {
                  switch (o.label) {
                    ...
                    case 1:
                      return (n = o.sent()), [4, this._showTemplateSaveRenameDialog(n, e, t)];
                    case 2:
                      return o.sent(), [2];
                  }
                });
        ...
        return (
          ...
          (e.prototype._prepareData = function (e, t, n) {
            ...
            return { name: e, content: JSON.stringify(o), meta_info: Object(R.a)(this._controller, o.interval) };
          }),
                ...
                (function (e, t) {
                  return new Promise(function (n) {
                    Object(A.createConfirmDialog)({
                      type: 'modal',
                      content: document.createTextNode(P.format({ templateName: e })),
                      manager: t,
                    }).then(function (e) {
                      var t = !1;
          ...
          (e.prototype._getActualTemplateList = function () {
            return L.backend.invalidateStudyTemplatesList(), L.backend.getStudyTemplatesList();
          }),
          (e.prototype._showTemplateSaveRenameDialog = function (e, t, n) {
            ...
            (this._dialog = new D({
              ...
              saveIntervalHintText: G.format({ interval: Object(B.translatedIntervalString)(n) }),
    ...
    Iivm: function (e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }), n('mrSG').__exportStar(n('swCq'), t);
    },
    L0Sj: function (e, t, n) {
      'use strict';
      n.d(t, 'a', function () {
          ...
          return (
            ...
            (t.prototype.render = function () {
              var e,
                ...
                y = i(
                  s.textInput,
                  this.props.strictLeftDirectionInput && u.textInputLeftDirection,
                  (((e = {})[s.error] = a), (e[s.success] = c), (e[s[l]] = Boolean(l)), e),
                ),
                w = i(s.inputWrapper, (((t = {})[b] = Boolean(b)), (t[s.grouped] = h), (t[s.column] = m), t)),
                C = [],
                S = r.createElement(
                  'input',
                  Object(o.__assign)({ ref: v, className: y, key: 'textInput', style: g }, _),
                );
              if (p) {
                var O = { className: i(s.leftComponent, p.props.className), key: 'leftComponent' };
                C.push(r.cloneElement(p, O));
              }
              if ((C.push(S), d)) {
                var x = { className: i(s.rightComponent, d.props.className), key: 'rightComponent' };
      ...
      function l(e) {
        var t,
          ...
          f = Object(o.__rest)(e, ['className', 'icon', 'clearable', 'onClear', 'size', 'strictLeftDirectionInput']),
          v = i(u.inputWrapper, (((t = {})[n] = Boolean(n)), (t[u.iconed] = Boolean(l)), (t[u.clearable] = p), t));
          ...
          Object(o.__assign)(
            {
              ...
              className: v,
              leftComponent: l
                ? r.createElement(s.Icon, { key: 'inputIcon', icon: l, className: u.inputIcon })
                : void 0,
              rightComponent: p
                ? r.createElement(s.Icon, { className: u.clearIcon, icon: a, key: 'clearIcon', onClick: d })
                : void 0,
              sizeMode: h,
    ...
    'ML8+': function (e, t, n) {
      ...
      function u(e) {
        var t,
          n = e.dropped,
          u = e.className;
        return o.createElement(i.Icon, { className: r(u, s.icon, ((t = {}), (t[s.dropped] = n), t)), icon: a });
      }
    },
    O6kz: function (e, t, n) {
      'use strict';
    ...
    QpNh: function (e, t, n) {
      'use strict';
      function o(e) {
        for (var t = {}, n = 0, o = Object.entries(e).filter(r); n < o.length; n++) {
          var i = o[n],
            s = i[0],
            a = i[1];
          t[s] = a;
          ...
          (t.prototype.render = function () {
            var e,
              ...
              n = i(
                ...
                u.checkbox,
                (((e = {})[u.reverse] = Boolean(this.props.labelPositionReverse)),
              ...
              c = null;
            return (
              this.props.label && (c = r.createElement('span', { className: s }, this.props.label)),
              r.createElement(
                'label',
                { className: n },
    ...
    swCq: function (e, t, n) {
      ...
      t.Icon = r.forwardRef(function (e, t) {
        var n = e.icon,
          i = void 0 === n ? '' : n,
          s = o.__rest(e, ['icon']);
        return r.createElement('span', o.__assign({}, s, { ref: t, dangerouslySetInnerHTML: { __html: i } }));
      });
    },
    uhCe: function (e, t, n) {
      'use strict';
                  ...
                  s.a.createElement(
                    ...
                    s.a.createElement(
                      ...
                      s.a.createElement(
                        ...
                        s.a.createElement(a.Button, { disabled: c, name: 'submit', onClick: l }, u || window.t('Ok')),
                      ),
                    ),
                  ),
                );
