          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return (
                ...
                i.createPortal(o.createElement(c.Provider, { value: this }, this.props.children), e)
              );
            }),
        ...
        b = (function (e) {
          function t(t) {
            ...
            return (
              ...
              (n._handleContainerRef = function (e) {
                (n._containerRef = e),
                  'function' == typeof n.props.reference && n.props.reference(e),
                  'object' == typeof n.props.reference && (n.props.reference.current = e);
              }),
              ...
              (n._handleMeasure = function (e) {
                if (!n.state.isMeasureValid) {
                  var t = n.props.position,
                    ...
                    c = o.height > s;
                  if (c)
                    (Object(a.ensureNotNull)(n._scrollWrapRef).style.overflowY = 'scroll'),
                      (o = r.getBoundingClientRect());
                  var p = o.width,
                    d = o.height,
                  ...
                  h.forbidCorrectYCoord && _ < h.y && ((s -= h.y - _), (_ = h.y)),
                    n.setState(
                      {
                        appearingMenuHeight: h.overrideHeight || (c ? s : void 0),
              ...
              (n._restoreScrollPosition = function () {
                ...
                else Object(a.ensureNotNull)(n._scrollWrapRef).scrollTop = n._scroll;
              }),
              (n._resize = function () {
                null === n._raf &&
          ...
          return (
            ...
            (t.prototype.componentWillUnmount = function () {
              ...
              (void 0 === e ? d.a : e).unsubscribe(this, this._handleGlobalClose),
                  ...
                  i.a.createElement(
                    ...
                    i.a.createElement(
                      'div',
                      {
                        ...
                        style: { height: f, left: g && g.x, minWidth: n, position: 'fixed', top: g && g.y, width: b },
                      ...
                      i.a.createElement(
                        'div',
                        {
                          className: s()(o.scrollWrap, !this.props.noMomentumBasedScroll && o.momentumBased),
                          style: { overflowY: void 0 !== f ? 'scroll' : 'auto' },
