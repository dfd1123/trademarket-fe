        ...
        (s = void 0 !== t ? t : this),
          (e.exports = (function (e) {
            ...
            var t = function (e) {
              ...
              for (var t, s = String(e), n = s.length, i = -1, o = '', l = s.charCodeAt(0); ++i < n; )
                0 != (t = s.charCodeAt(i))
                  ? (o +=
                      (t >= 1 && t <= 31) ||
                      127 == t ||
          ...
          function i(t, s, n, i) {
            function o() {
              s.removeClass(t.settings.customPrependSelectorClass),
                t._lastSelectorPrepend && (t._lastSelectorPrepend.remove(), delete t._lastSelectorPrepend),
                n.data('custom-option-prepend') &&
                  (t.settings.customPrependSelectorClass && s.addClass(t.settings.customPrependSelectorClass),
                  (t._lastSelectorPrepend = e(n.data('custom-option-prepend')).clone()),
                  s[t.settings.useCustomPrependWithSelector](t._lastSelectorPrepend));
            }
          ...
          e.extend(s.prototype, {
            ...
            _attachSelectbox: function (t, s) {
              ...
              c.attr('sb', d.uid),
                ...
                (r._state[d.uid] = !1),
                c.hide(),
                (i = e('<div>', { id: 'sbHolder_' + d.uid, class: d.settings.classHolder }));
              ...
              function b(s) {
                c.children().each(function (n) {
                  ...
                  if (e(this).is(':selected')) {
                    if (38 == s && n > 0)
                      return (i = e(c.children()[n - 1])), r._changeSelectbox(t, i.val(), i.text()), !1;
              ...
              u && i.css(u),
                (o = e('<a>', {
                  ...
                  click: function (s) {
                    s.preventDefault(), s.stopPropagation(), p.apply(e(this), []);
                    var n = e(this).attr('id').split('_')[1];
                    r._state[n] ? r._closeSelectbox(t) : (r._openSelectbox(t), l.focus());
                  },
                  keyup: function (e) {
                    b(e.keyCode);
                  },
                ...
                l.appendTo(i),
                (a = e('<ul>', { id: 'sbOptions_' + d.uid, class: d.settings.classOptions, css: { display: 'none' } })),
                (d.sbOptions = a),
                (d.sbToggle = l),
                (d.sbSelector = o),
                this._fillList(t, d),
                ...
                a.appendTo(i),
                i.insertAfter(c),
                d._onAttachCallback && (d._onAttachCallback(), delete d._onAttachCallback),
            ...
            _changeSelectbox: function (t, s, o) {
              ...
              if (
                ...
                d.text(o),
                  ...
                  r.attr('selected', !0),
                  c ? c.apply(a.input ? a.input[0] : null, [s, a]) : a.input && a.input.trigger('change');
              }
            },
                ...
                f && (h = f()),
                  'object' == typeof h && null !== h
                    ...
                    : (u > 50 && !s.settings.slidesUp
                        ? l.css({ bottom: 'auto', top: p + 2 + 'px', maxHeight: u - p + 'px' })
                        : l.css({ top: 'auto', bottom: p + 2 + 'px', maxHeight: r.top - d - p / 2 + 'px' }),
                      r.left + l.width() > c
                        ? l.css('left', '-' + (l.width() - l.parent().width() + 3) + 'px')
                        : l.css('left', '-1px')),
                  'fade' === s.settings.effect ? l.fadeIn(s.settings.speed) : l.slideDown(s.settings.speed),
                  i.find('#sbToggle_' + s.uid).addClass(s.settings.classToggleOpen),
                  i.find('#sbHolder_' + s.uid).addClass(s.settings.classHolderOpen),
                  (this._state[s.uid] = !0),
                  (s.isOpen = !0),
            ...
            _closeSelectbox: function (t) {
              ...
              if (s && s.isOpen) {
                ...
                n.find('#sbOptions_' + s.uid).hide(),
                  n.find('#sbToggle_' + s.uid).removeClass(s.settings.classToggleOpen),
                  n.find('#sbHolder_' + s.uid).removeClass(s.settings.classHolderOpen),
                  (this._state[s.uid] = !1),
                  (s.isOpen = !1),
            ...
            _getOptions: function (t, s, n, o, l) {
              ...
              arguments[0].each(function (t) {
                var s,
                  d = e(this),
                  p = e('<li>');
                d.is(':selected') && (n.sbSelector.text(d.text()), i(n, n.sbSelector, d, !0), (n.isSelected = !0)),
                  ...
                  (function () {
                    var t = d.text(),
                      ...
                      o = void 0 !== i ? i : t;
                    '__separator__' === d.val()
                      ? (s = e('<span>').addClass(n.settings.classSeparator)).appendTo(p)
                      : d.is(':disabled') || c
                      ? ((s = e('<span>', { text: o }).addClass(n.settings.classDisabled)),
                      ...
                      : ((s = e('<a>', {
                          ...
                          click: function (s) {
                            ...
                            var i = n.sbToggle;
                            i.attr('id').split('_')[1];
                            r._closeSelectbox(l), r._changeSelectbox(l, e(this).attr('rel'), t), i.focus();
                          },
                        })),
            ...
            _fillList: function (t, s, n) {
              ...
              n || (n = 0),
                ...
                s.isSelected ||
                  (s.sbSelector.text(a.first().text()), i(s, s.sbSelector, a.first(), !0), (s.isSelected = !0));
            },
          }),
            (e.fn.selectbox = function (t) {
              ...
              return ('string' == typeof t && 'isDisabled' == t) ||
                ...
                ? e.selectbox['_' + t + 'Selectbox'].apply(e.selectbox, [this[0]].concat(s))
                : this.each(function () {
                    'string' == typeof t
                      ? e.selectbox['_' + t + 'Selectbox'].apply(e.selectbox, [this].concat(s))
