(window.webpackJsonp = window.webpackJsonp || []).push([
  [28],
  {
    ...
    '7MId': function (e, t, n) {
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return o.createElement('div', {
                ...
                className: i(C.swatch, n && C.selected, !t && C.empty, String(t).toLowerCase() === f && C.white),
              ...
              return o.createElement(
                ...
                n.map(function (t, n) {
                  return o.createElement(y, {
                    key: String(t) + n,
                    color: t,
                    selected: s && Object(h.areEqualRgb)(s, Object(h.parseRgb)(String(t))),
            ...
            return (
              ...
              (t._handlePosition = function (e) {
                var n = t.props,
                  ...
                  r = n.onChange;
                if (r) {
                  var i = Object(c.ensureNotNull)(t._container).getBoundingClientRect(),
                    s = e.clientX - i.left,
                    a = e.clientY - i.top,
                    l = s / i.width;
                  l < 0 ? (l = 0) : l > 1 && (l = 1);
            ...
            return (
              ...
              (t._handlePosition = function (e) {
                var n = t.props,
                  ...
                  s = n.onChange;
                if (s) {
                  var a = Object(c.ensureNotNull)(t._container).getBoundingClientRect(),
                    l = e.clientY - a.top;
                  l >= a.top && (l = a.top - 1);
                  var u = l / a.height;
            ...
            (t.prototype.render = function () {
              ...
              return o.createElement(
                ...
                o.createElement(
                  ...
                  o.createElement('div', { className: I.pointer, style: { top: 100 * n + '%' } }),
                ),
              );
            }),
            t
        ...
        W = (function (e) {
          function t(t) {
            ...
            (n._handleHSV = function (e) {
              ...
              n.setState({ color: t, inputColor: t.replace(/^#/, ''), hsv: e }), n.props.onSelect(t);
            }),
              (n._handleInput = function (e) {
                ...
                try {
                  var o = N(t),
                    r = '#' + t;
                  n.setState({ color: r, inputColor: t, hsv: o }), n.props.onSelect(r);
                } catch (i) {
            ...
            return (n.state = { color: o, inputColor: o.replace(/^#/, ''), hsv: N(o) }), n;
          }
          return (
            Object(a.__extends)(t, e),
            (t.prototype.render = function () {
              ...
              return o.createElement(
                ...
                o.createElement(
                  'div',
                  { className: M.form },
                  o.createElement('div', { className: M.swatch, style: { backgroundColor: t } }),
                  o.createElement(
                    'div',
                  ...
                  o.createElement(
                    ...
                    o.createElement(k.Button, { size: 's', onClick: this._handleAddColor }, T),
                  ),
                ),
                o.createElement(
                  'div',
                  { className: M.hueSaturationWrap },
                  o.createElement(P, { className: M.saturation, hsv: n, onChange: this._handleHSV }),
                  o.createElement(j, { className: M.hue, hsv: n, onChange: this._handleHSV }),
                ),
              );
            }),
            t
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return this.state.isCustom
                ? o.createElement(W, { color: t, onSelect: this._handleSelectColor, onAdd: this._handleAddColor })
                : o.createElement(
                    'div',
                    { className: D.container },
                    o.createElement(w, { colors: b, color: t, onSelect: this._handleSelectColor }),
                    o.createElement(w, { colors: _, color: t, onSelect: this._handleSelectColor }),
                    o.createElement('div', { className: D.separator }),
                    o.createElement(
                      w,
                      { colors: a, color: t, onSelect: this._handleSelectColor },
                      r &&
                        o.createElement('div', {
                          className: s()(D.customButton, 'apply-common-tooltip'),
                    ...
                    i &&
                      o.createElement(
                        o.Fragment,
                        null,
                        o.createElement('div', { className: D.sectionTitle }, L),
                        o.createElement(E.a, { color: t, opacity: c, onChange: this._handleOpacity }),
                      ),
                  );
            }),
      ...
      function B(e) {
        var t = e.button,
          ...
          i = e.className,
          s = e.onPopupClose,
          h = Object(a.__rest)(e, ['button', 'children', 'className', 'onPopupClose']),
        ...
        return r.a.createElement(
          ...
          r.a.createElement(
            u.a,
            {
              ...
              onClose: N,
              position: function () {
                var e = Object(c.ensureNotNull)(w.current).getBoundingClientRect();
            ...
            r.a.createElement(U.a.Consumer, null, function (e) {
              return r.a.createElement(F, Object(a.__assign)({}, h, { onToggleCustom: m, menu: e }));
            }),
            !f && n,
          ),
        );
      ...
      function A() {
        ...
        var s = Object(o.useCallback)(
          function (e) {
            ...
            r.some(function (e) {
              return null !== e && null !== t && Object(h.areEqualRgb)(Object(h.parseRgb)(e), t);
            }) || (z.emit('add_new_custom_color', e), Object(G.setJSON)('pickerCustomColors', V(e, r)));
          },
          [r],
        );
        return [r, s];
            ...
            button: function (e, t) {
              ...
              return r.a.createElement(
                'div',
                {
                  ...
                  'data-role': 'button',
                  'data-name': i ? 'color-with-thickness-select' : 'color-select',
                },
                r.a.createElement(
                  'div',
      ...
      function te(e, t) {
        return e ? Object(q.generateColor)(e, Object(q.alphaToTransparency)(t)) : '#000000';
      }
      function ne(e) {
    ...
    '85uA': function (e, t, n) {
      e.exports = { thicknessContainer: 'thicknessContainer-1lrdH7bz', thicknessTitle: 'thicknessTitle-2nZV_6CD' };
    },
    '8d0Q': function (e, t, n) {
      'use strict';
      n.d(t, 'b', function () {
    ...
    O6kz: function (e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }), (t.makeSwitchGroupItem = void 0);
      var o = n('mrSG'),
        r = n('q1tI'),
        i = n('17x9');
      t.makeSwitchGroupItem = function (e) {
        ...
        return (
          ...
          })(r.PureComponent)).contextTypes = { switchGroupContext: i.any.isRequired }),
          t
        );
      };
    },
    OGHR: function (e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }), (t.SwitchGroup = void 0);
      var o = n('mrSG'),
        r = n('q1tI'),
        i = n('17x9'),
        s = (function (e) {
          ...
          return (
            ...
            (t.prototype.render = function () {
              return r.createElement(
                ...
                r.createElement(
                  'div',
                  { ref: this.props.reference, className: i(l.content, c.isIE && l.ie) },
                  this.props.children,
                ),
              );
            }),
        ...
        d = (function (e) {
          ...
          return (
            ...
            (t.prototype.render = function () {
              return r.createElement(
                h.Provider,
                { value: Object(s.ensureNotNull)(this.context).getRowIndex(this) },
                this.props.children,
              );
            }),
            (t.contextType = u),
        ...
        (p.Cell = function (e) {
          ...
          return r.createElement(h.Consumer, null, function (s) {
            return r.createElement(
              ...
              r.createElement('div', { className: i(l.inner, e.className) }, e.children),
            );
          });
        }),
        (p.Separator = function (e) {
          return r.createElement(
            ...
            r.createElement(h.Consumer, null, function (e) {
              return r.createElement('div', { className: i(l.cell, l.separator, l.fill), style: f(e) });
            }),
          );
        }),
          ...
          return r.createElement(
            ...
            r.createElement(h.Consumer, null, function (e) {
              return r.createElement('div', {
                className: i(l.cell, l.groupSeparator, l.fill, 1 === t && l.big),
                style: f(e),
              });
            }),
          );
        ...
        l = (function (e) {
          function t(t) {
            ...
            return (
              ...
              (n._handlePosition = function (e) {
                null === n._raf &&
                  (n._raf = requestAnimationFrame(function () {
                    ...
                    n.setState({ inputOpacity: Math.round(100 * l).toString() }), n.props.onChange(l), (n._raf = null);
                  }));
              }),
              ...
              (n._handleInput = function (e) {
                var t = e.currentTarget.value,
                  o = Number(t) / 100;
                n.setState({ inputOpacity: t }), Number.isNaN(o) || o > 1 || n.props.onChange(o);
              }),
          ...
          return (
              ...
              return r.createElement(
                ...
                !o &&
                  r.createElement(
                    ...
                    r.createElement('span', { className: c.opacityInputPercent }, '%'),
                  ),
              );
            }),
            ...
            (t.prototype._dragUnsubscribe = function () {
              var e = Object(s.ensureNotNull)(this._container).ownerDocument;
              e &&
                (e.removeEventListener('mousemove', this._mouseMove), e.removeEventListener('mouseup', this._mouseUp));
            }),
            t
          );
        })(r.PureComponent);
        ...
        d = (function (e) {
          function t(t) {
            ...
            return (
              ...
              (n._containerFocus = function (e) {
                ((!Modernizr.mobiletouch && n._buttons && n._buttons.contains(e.target)) ||
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              this.props.onWheelNoPassive && this._addPassiveListenerOnWheel(this.props.onWheelNoPassive);
            }),
            (t.prototype.componentDidUpdate = function (e) {
            ...
            (t.prototype.componentWillUnmount = function () {
              this.props.onWheelNoPassive && this._removePassiveListenerOnWheel(this.props.onWheelNoPassive);
            }),
            (t.prototype.render = function () {
              var e;
              this.props.error ? (e = p.error) : this.props.warning && (e = p.warning);
              var t = this.props,
                n = t.borderStyle,
                o = void 0 === n ? 'thick' : n,
                i = t.fontSizeStyle,
                ...
                h = s(p.innerInput, 'large' === a && p.largeFont, Object(l.isRtl)() && !u.isChrome && p.innerInputFix);
              return r.createElement(
                'div',
                { className: c },
                r.createElement(
                  ...
                  r.createElement(
                    'div',
                    { className: s(p.inputContainer, Object(l.isRtl)() && !u.isChrome && p.inputContainerFix) },
                    this.props.innerLabel &&
                      r.createElement(
                        'div',
                        { className: p.innerLabel, tabIndex: -1, ref: this._setInnerLabelRef },
                        this.props.innerLabel,
                      ),
                    r.createElement(
                      'div',
                    ...
                    r.createElement(
                      'div',
                      { className: p.iconBlock, tabIndex: -1, ref: this._setButtonsRef },
                      this.props.button,
                    ),
                  ),
                  this.props.children,
            ...
            (t.prototype._addPassiveListenerOnWheel = function (e) {
              Object(c.ensureNotNull)(this._container).addEventListener('wheel', e, { passive: !1 });
            }),
            (t.prototype._removePassiveListenerOnWheel = function (e) {
              Object(c.ensureNotNull)(this._container).removeEventListener('wheel', e);
            }),
            t
          );
        })(r.PureComponent),
      ...
      function b(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(f.Icon, { icon: m, className: v.increaseControlIcon }),
          ),
          r.createElement(
            'div',
            { className: n, onClick: e.decreaseValue },
            r.createElement(f.Icon, { icon: m, className: v.decreaseControlIcon }),
          ),
        );
      }
      var g = n('8d0Q'),
          ...
          Object(o.__assign)({}, a, {
            ...
            onKeyDown: function (t) {
              ...
              (o.includes(t.keyCode) || n.includes(t.keyCode)) &&
                (t.preventDefault(), e.onValueByStepChange(o.includes(t.keyCode) ? -1 : 1));
    ...
    Zzxg: function (e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }), (t.GroupedCheckbox = t.Checkbox = void 0);
      var o = n('mrSG'),
        r = n('q1tI'),
        i = n('TSYQ'),
        s = n('0W35'),
          ...
          (t.prototype.render = function () {
            var e,
              ...
              n = i(
                this.props.className,
                c.checkbox,
                (((e = {})[c.reverse] = Boolean(this.props.labelPositionReverse)),
              ...
              l = null;
            return (
              this.props.label && (l = r.createElement('span', { className: s }, this.props.label)),
              r.createElement(
                'label',
                { className: n },
    ...
    fV0y: function (e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }), n('mrSG').__exportStar(n('Zzxg'), t);
    },
    'jpE+': function (e, t, n) {
      e.exports = { hue: 'hue-2mlXxlkM', pointer: 'pointer-3fNcCimp', pointerContainer: 'pointerContainer-1T_sOwrr' };
    },
    lY1a: function (e, t, n) {
    ...
    nc0P: function (e, t, n) {
      ...
      !(function (r) {
        ...
        function p(e, t, n, o) {
          ...
          if (i < r.length) {
            if (1 === n) o = r[i] >= 5;
            else if (2 === n) o = r[i] > 5 || (5 == r[i] && (o || i < 0 || void 0 !== r[i + 1] || 1 & r[i - 1]));
            else if (3 === n) o = o || !!r[0];
            else if (((o = !1), 0 !== n)) throw Error('[big.js] Invalid rounding mode');
            if (i < 1) (r.length = 1), o ? ((e.e = -t), (r[0] = 1)) : (r[0] = e.e = 0);
            else {
              if (((r.length = i--), o)) for (; ++r[i] > 9; ) (r[i] = 0), i-- || (++e.e, r.unshift(1));
        ...
        function h(e, t, n, o) {
          var r,
            ...
            l = !e.c[0];
          if (void 0 !== n) {
            if (n !== ~~n || n < (3 == t) || n > 1e6) throw Error(3 == t ? a + 'precision' : c);
            for (
              n = o - (e = new s(e)).e, e.c.length > ++o && p(e, n, s.RM), 2 == t && (o = e.e + n + 1);
              e.c.length < o;
        ...
        (l.abs = function () {
          ...
          (l.div = function (e) {
            ...
            do {
              ...
              (C[y++] = h ? u : ++u), b[0] && h ? (b[g] = o[m] || 0) : (b = [o[m]]);
            } while ((m++ < v || void 0 !== b[0]) && i--);
            return C[0] || 1 == y || (C.shift(), _.e--), y > w && p(_, s, n.RM, void 0 !== b[0]), _;
          }),
          (l.eq = function (e) {
            return !this.cmp(e);
          }),
          ...
          (l.minus = l.sub = function (e) {
            ...
            var l = i.c.slice(),
              ...
              p = e.c,
              h = e.e;
            if (!l[0] || !p[0]) return p[0] ? ((e.s = -c), e) : new s(l[0] ? i : 0);
            if ((a = u - h)) {
              for ((r = a < 0) ? ((a = -a), (o = l)) : ((h = u), (o = p)), o.reverse(), c = a; c--; ) o.push(0);
              o.reverse();
            } else
              for (n = ((r = l.length < p.length) ? l : p).length, a = c = 0; c < n; c++)
                if (l[c] != p[c]) {
                  r = l[c] < p[c];
                  break;
                }
            if ((r && ((o = l), (l = p), (p = o), (e.s = -e.s)), (c = (n = p.length) - (t = l.length)) > 0))
              for (; c--; ) l[t++] = 0;
            for (c = t; n > a; ) {
              if (l[--n] < p[n]) {
                for (t = n; t && !l[--t]; ) l[t] = 9;
          ...
          (l.plus = l.add = function (e) {
            ...
            for (a.length - l.length < 0 && ((t = l), (l = a), (a = t)), r = l.length, i = 0; r; a[r] %= 10)
              i = ((a[--r] = a[r] + l[r] + i) / 10) | 0;
            for (i && (a.unshift(i), ++c), r = a.length; 0 === a[--r]; ) a.pop();
          ...
          (l.sqrt = function () {
            ...
            0 === (i = Math.sqrt(o + '')) || i === 1 / 0
              ? (((t = o.c.join('')).length + a) & 1 || (t += '0'),
                (a = (((a + 1) / 2) | 0) - (a < 0 || 1 & a)),
                (e = new r(
                  ((i = Math.sqrt(t)) == 1 / 0 ? '1e' : (i = i.toExponential()).slice(0, i.indexOf('e') + 1)) + a,
                )))
              : (e = new r(i)),
              (a = e.e + (r.DP += 4));
            do {
          ...
          (l.times = l.mul = function (e) {
            var t,
              ...
              c = n.e,
              l = e.e;
            if (((e.s = n.s == e.s ? 1 : -1), !r[0] || !i[0])) return new o(0 * e.s);
            for (
              e.e = c + l, s < a && ((t = r), (r = i), (i = t), (l = s), (s = a), (a = l)), t = new Array((l = s + a));
              l--;
            ...
            for (c = a; c--; ) {
              for (a = 0, l = s + c; l > c; )
                (a = t[l] + i[c] * r[l - c - 1] + a), (t[l--] = a % 10), (a = (a / 10) | 0);
              t[l] = (t[l] + a) % 10;
            }
            ...
            function t(n) {
              ...
              n instanceof t
                ...
                : (function (e, t) {
                    ...
                    (o = t.search(/e/i)) > 0
                      ? (n < 0 && (n = o), (n += +t.slice(o + 1)), (t = t.substring(0, o)))
                      : n < 0 && (n = t.length);
                    for (r = t.length, o = 0; o < r && '0' == t.charAt(o); ) ++o;
                    if (o == r) e.c = [(e.e = 0)];
                    else {
                      for (; r > 0 && '0' == t.charAt(--r); );
                      for (e.e = n - o - 1, e.c = [], n = 0; o <= r; ) e.c[n++] = +t.charAt(o++);
                    }
                  })(o, n),
                (o.constructor = t);
            }
            return (t.prototype = l), (t.DP = 20), (t.RM = 1), (t.NE = -7), (t.PE = 21), (t.version = '5.2.2'), t;
          })()).default = i.Big = i),
          void 0 ===
            (o = function () {
              return i;
    ...
    vCF3: function (e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }), (t.CheckboxInput = void 0);
      var o = n('q1tI'),
        r = n('TSYQ'),
        i = n('Iivm'),
        s = n('aJjg'),
      ...
      n('P4l+'),
        (t.CheckboxInput = function (e) {
          ...
          return o.createElement(
            ...
            o.createElement('div', { className: n }, o.createElement(i.Icon, { icon: s, className: a.icon })),
          );
        });
    },
  },
