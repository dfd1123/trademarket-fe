    ...
    MuC6: function (t, i, e) {
      ...
      function _(t) {
        (this._options = t || {}),
          ...
          (this._helpTooltipTrigger = $('<i class="help-tooltip-trigger apply-common-tooltip common-tooltip-below">')
            .text('?')
            .attr('title', v() ? d : u)),
      ...
      (_.prototype._setInput = function () {
        (this._input = $('<input type="text" class="change-interval-input" autocomplete="off" maxlength="7">')),
          this._input
        ...
        (_.prototype._validate = function () {
          ...
          (this._parsed = o(t)), (this._valid = !this._parsed.error), (this._supported = !this._parsed.error && a(t));
          var i = this._parsed.unit;
          if (this._supported)
            if ('R' === i && this._parsed.qty > l.getMaxResolutionValue('R')) this._supported = !1;
            else if (null === i || 'H' === i) {
              this._parsed.qty * ('H' === i ? 60 : 1) > 1440 && (this._supported = !1);
            } else 'S' !== i || c.includes(this._parsed.qty) || (this._supported = !1);
        }),
        (_.prototype._updateCaption = function () {
          ...
          if (this._valid && this._supported) {
            var i = this._parsed.qty || 1,
              e = this._parsed.unit || '';
            (t = l.getTranslatedResolutionModel(i + e).hint), this._input.add(this._caption).removeClass('error');
          } else
          ...
          if (p.isOpen(this._dialogTitle)) {
            if (this._valid && this._supported) {
              var t = h.normalize(this._input.val()),
                i = s.interval.value();
              t && i !== t && 'function' == typeof this._options.callback && this._options.callback(t);
            }
