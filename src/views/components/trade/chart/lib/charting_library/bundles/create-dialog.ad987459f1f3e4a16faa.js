  ...
  ['create-dialog'],
  {
              ...
              function (o, s, a) {
                ...
                return (
                  'get' === o
                    ? (u = s)
                    : ((l = s),
                      'object' === (void 0 === o ? 'undefined' : r(o)) && void 0 === s
                        ? ((l = o), (o = 'init'))
                  ...
                  'getInstance' === o
                    ...
                    ? (c = $(this).eq(0).data(t))
                      ? void ('function' == typeof c.destroy
                          ...
                          : i.logError('[Block Plugin] ' + t + ' does not support destroy command'))
                      : void console.warn(
                    ...
                    : $(this).each(function () {
                        var r = $(this),
                          s = r.data(t);
                        void 0 === s && ((s = void 0 === l ? e(r) : e(r, l)), r.data(t, s)),
                          'init' !== o &&
                            ('function' == typeof s[o]
                              ? n(s, o, l)
                              : i.logError('[Block Plugin] ' + t + ' does not support command ' + o));
                      })
                );
              }
            );
    ...
    'F/us': function (t, e, n) {
      ...
      (function () {
        ...
        var b = function (t, e, n) {
          ...
          y = function (t, e, n) {
            return null == t ? g.identity : g.isFunction(t) ? b(t, e, n) : g.isObject(t) ? g.matcher(t) : g.property(t);
          };
        ...
        (g.each = g.forEach = function (t, e, n) {
          var r, i;
          if (((e = b(e, n)), C(t))) for (r = 0, i = t.length; r < i; r++) e(t[r], r, t);
          else {
            var o = g.keys(t);
          ...
          (g.map = g.collect = function (t, e, n) {
            e = y(e, n);
            for (var r = !C(t) && g.keys(t), i = (r || t).length, o = Array(i), s = 0; s < i; s++) {
              var a = r ? r[s] : s;
              o[s] = e(t[a], a, t);
            }
            return o;
          ...
          (g.find = g.detect = function (t, e, n) {
            var r;
            if (void 0 !== (r = C(t) ? g.findIndex(t, e, n) : g.findKey(t, e, n)) && -1 !== r) return t[r];
          }),
          ...
          (g.every = g.all = function (t, e, n) {
            e = y(e, n);
            for (var r = !C(t) && g.keys(t), i = (r || t).length, o = 0; o < i; o++) {
              var s = r ? r[o] : o;
          ...
          (g.contains = g.includes = g.include = function (t, e, n, r) {
            return C(t) || (t = g.values(t)), ('number' != typeof n || r) && (n = 0), g.indexOf(t, e, n) >= 0;
          }),
          ...
          (g.max = function (t, e, n) {
            var r,
              ...
              s = -1 / 0;
            if (null == e && null != t)
              for (var a = 0, u = (t = C(t) ? t : g.values(t)).length; a < u; a++) (r = t[a]) > o && (o = r);
            else
              (e = y(e, n)),
          ...
          (g.shuffle = function (t) {
            for (var e, n = C(t) ? t : g.values(t), r = n.length, i = Array(r), o = 0; o < r; o++)
        ...
        (g.groupBy = B(function (t, e, n) {
          ...
          (g.toArray = function (t) {
            return t ? (g.isArray(t) ? l.call(t) : C(t) ? g.map(t, g.identity) : g.values(t)) : [];
          }),
          (g.size = function (t) {
          ...
          (g.first = g.head = g.take = function (t, e, n) {
            if (null != t) return null == e || n ? t[0] : g.initial(t, t.length - e);
          }),
          (g.initial = function (t, e, n) {
            return l.call(t, 0, Math.max(0, t.length - (null == e || n ? 1 : e)));
          }),
          (g.last = function (t, e, n) {
            if (null != t) return null == e || n ? t[t.length - 1] : g.rest(t, Math.max(0, t.length - e));
          }),
        ...
        function H(t) {
          return function (e, n, r) {
            n = y(n, r);
            for (var i = k(e), o = t > 0 ? 0 : i - 1; o >= 0 && o < i; o += t) if (n(e[o], o, e)) return o;
            return -1;
          };
        }
        function A(t, e, n) {
          return function (r, i, o) {
            ...
            if (i != i) return (o = e(l.call(r, s, a), g.isNaN)) >= 0 ? o + s : -1;
        ...
        (g.flatten = function (t, e) {
          ...
          (g.uniq = g.unique = function (t, e, n, r) {
            g.isBoolean(e) || ((r = n), (n = e), (e = !1)), null != n && (n = y(n, r));
          ...
          (g.object = function (t, e) {
            for (var n = {}, r = 0, i = k(t); r < i; r++) e ? (n[t[r]] = e[r]) : (n[t[r][0]] = t[r][1]);
            return n;
          }),
          (g.findIndex = H(1)),
          (g.findLastIndex = H(-1)),
        ...
        (g.bind = function (t, e) {
          ...
          (g.throttle = function (t, e, n) {
            ...
            n || (n = {});
            var u = function () {
              (a = !1 === n.leading ? 0 : g.now()), (s = null), (o = t.apply(r, i)), s || (r = i = null);
            };
            return function () {
              var l = g.now();
              a || !1 !== n.leading || (a = l);
        ...
        (g.keys = function (t) {
          ...
          (g.values = function (t) {
            for (var e = g.keys(t), n = e.length, r = Array(n), i = 0; i < n; i++) r[i] = t[e[i]];
            return r;
          }),
          (g.mapObject = function (t, e, n) {
            e = y(e, n);
            for (var r, i = g.keys(t), o = i.length, s = {}, a = 0; a < o; a++) s[(r = i[a])] = e(t[r], r, t);
            return s;
          }),
          (g.pairs = function (t) {
            for (var e = g.keys(t), n = e.length, r = Array(n), i = 0; i < n; i++) r[i] = [e[i], t[e[i]]];
            return r;
          }),
          (g.invert = function (t) {
            for (var e = {}, n = g.keys(t), r = 0, i = n.length; r < i; r++) e[t[n[r]]] = n[r];
            return e;
          }),
          ...
          (g.findKey = function (t, e, n) {
            e = y(e, n);
            for (var r, i = g.keys(t), o = 0, s = i.length; o < s; o++) if (e(t[(r = i[o])], r, t)) return r;
          }),
        ...
        var O = function (t, e, n, r) {
          ...
          if (!o) {
            ...
            if (
              s !== a &&
              !(g.isFunction(s) && s instanceof s && g.isFunction(a) && a instanceof a) &&
              'constructor' in t &&
              'constructor' in e
            )
              return !1;
          ...
          if ((n.push(t), r.push(e), o)) {
            ...
            for (; u--; ) if (((l = h[u]), !g.has(e, l) || !O(t[l], e[l], n, r))) return !1;
          }
        ...
        (g.isEqual = function (t, e) {
          ...
          (g.isEmpty = function (t) {
            return (
              null == t ||
              (C(t) && (g.isArray(t) || g.isString(t) || g.isArguments(t)) ? 0 === t.length : 0 === g.keys(t).length)
            );
          }),
    ...
    QwKQ: function (t, e, n) {
      ...
      (function (r) {
            ...
            function t(e) {
              ...
              if (_) {
                if (!i.is('input[type=checkbox]'))
                  return void s.logError('`$checkbox` need to be input[type=checkbox]');
              ...
              (this.$el = this.render({
                ...
                (this.$checkbox = _ ? i : this.$el.find('input[type=checkbox]'));
            }
            return (
              i(t, [
                {
        ...
        ($.fn.tvControlCheckbox = (0, o.createTvBlockWithInstance)('tv-control-checkbox', function (t) {
