  ...
  ['study-property-pages-with-definitions'],
  {
    WUYT: function (e, t, i) {
      ...
      var y = i('zqjM'),
        ...
        f = window.t('Style'),
        v = window.t('Inputs'),
        g = ['1', '3', '5', '15', '30', '45', '60', '120', '180', '240', '1D', '1W', '1M'].map(function (e) {
          return { value: e, title: Object(_.getTranslatedResolutionModel)(e).hint };
        }),
        S = (function () {
          function e(e, t) {
            var i = this;
            (this._inputSourceItems = null),
              ...
              (this._source = t),
              (this._undoModel = e);
            for (var n = 0, s = this._sortInputs(this._source.metaInfo().inputs); n < s.length; n++) {
              var o = s[n];
              ...
              null !== this._inputSourceItems &&
                this._undoModel
                  ...
                  .subscribe(this, function () {
                    null !== i._inputSourceItems && i._inputSourceItems.setValue(i._getInputSourceItems());
                  });
          }
          return (
            ...
            (e.prototype._inputsPropertyDefinitions = function () {
              ...
              return (
                null !== this._sourceInput && (this._inputSourceItems = new c.a(this._getInputSourceItems())),
                (function (e, t, i, n, o) {
                    ...
                    if (p(y, n)) {
                      ...
                      if ('resolution' === y.type)
                        _ = Object(r.j)(
                          ...
                          { id: 'StudyInput' + h, title: b, options: new c.a(o.resolutionItems) },
                        );
                        ...
                        for (var v = [], g = 0, S = y.options; g < S.length; g++) {
                          var j = S[g],
                            m = (y.optionsTitles && y.optionsTitles[j]) || j,
                            O = window.t(m);
                          v.push({ value: j, title: O });
                        }
                        _ = Object(r.j)(
                          { option: Object(r.b)(e, i[y.id], 'Change ' + h) },
                          { id: 'StudyInput' + h, title: b, options: new c.a(v) },
                        );
                        ...
                        _ = Object(r.o)(
                          { symbol: Object(r.y)(e, I, w, P, 'Change ' + b) },
                        ...
                        var C = { id: 'StudyInput' + h, title: b, type: 'float' === y.type ? 1 : 0, defval: y.defval };
                        y.min && (C.min = new c.a(y.min)),
                          y.max && (C.max = new c.a(y.max)),
                          void 0 !== y.step && isFinite(y.step) && y.step > 0 && (C.step = new c.a(y.step)),
                          (_ = Object(r.i)({ value: Object(r.b)(e, i[y.id], 'Change ' + b) }, C));
                      } else
                        _ = Object(r.p)(
                          { text: Object(r.b)(e, i[y.id], 'Change ' + b) },
                          { id: 'StudyInput' + h, title: b, isEditable: !0, isMultiLine: !1 },
                        );
                      u.push(_);
                    }
                  }
            ...
            (e.prototype._getInputSourceItems = function () {
              ...
              if (
                ...
                this._source &&
                (this._source.isChildStudy() || b.a.canBeChild(this._source.metaInfo()))
              ) {
                var p = new Set(Object(n.__spreadArrays)([this._source], this._source.getAllChildren()));
                this._undoModel
                  .model()
                  .allStudies()
                  .filter(function (e) {
                    ...
                    if (1 === l.length) e.push({ value: o, title: i });
                      ...
                      for (
                        var c = l.reduce(function (e, t, r) {
                            var l, c;
                            if (!b.a.canPlotBeSourceOfChildStudy(t.type)) return e;
                            try {
                              c = Object(s.ensureDefined)(Object(s.ensureDefined)(u)[t.id]).title;
                            } catch (a) {
                              c = t.id;
                            }
        ...
        P = (function (e) {
              ...
              n._source
                ...
                .style.subscribe(n, function (e) {
                  null !== n._stylesPropertyPage &&
                    ...
                    n._stylesPropertyPage.definitions.setValue(n._stylePropertyDefinitions()));
                }),
              n
            );
          }
          return (
            ...
            (t.prototype.destroy = function () {
              this._source.properties().childs().style.unsubscribeAll(this), e.prototype.destroy.call(this);
            }),
            (t.prototype._stylePropertyDefinitions = function () {
              var e = this._source.properties().childs(),
                t = Object(r.j)(
                  { option: Object(r.b)(this._undoModel, e.style, 'Change study overlay style') },
                  { id: 'StudyOverlayStyle', title: O, options: new c.a(m) },
                ),
                i = Object(r.c)(
                  { checked: Object(r.b)(this._undoModel, e.showPriceLine, 'Change Price Price Line') },
                  { id: 'StudyOverlayPriceLine', title: I },
                ),
                s = Object(r.j)(
                  { option: Object(r.b)(this._undoModel, e.minTick, 'Change study overlay style') },
                  { id: 'StudyOverlayMinTick', title: w, options: new c.a(Object(y.d)()) },
                ),
                o = Object(a.c)(this._source.title());
              return [
                Object(r.k)(Object(n.__spreadArrays)([t], this._getSeriesStylesDefinitions()), 'SeriesStyleGroup' + o),
                i,
                s,
              ];
            }),
            (t.prototype._getSeriesStylesDefinitions = function () {
              ...
              return Object(j.a)(
                ...
                e,
                e.style.value(),
                { seriesPriceSources: y.b, lineStyleTypes: y.c, isJapaneseChartsAvailable: !1 },
                'mainSeries',
              );
            }),
            t
