(window.webpackJsonp = window.webpackJsonp || []).push([
  [5],
  {
          ...
          return (
            ...
            (e.prototype.render = function () {
              var t = this.props,
                ...
                g = t.className,
                f = t.backdrop,
                m = r(g, c.dialog, n && c.rounded, d && c.shadowed, h && c.fullscreen, _ && c.darker),
              ...
              return i.createElement(
                ...
                i.createElement(
                  a.b.Provider,
                  { value: this._manager },
                  f && i.createElement('div', { onClick: this.props.onClickBackdrop, className: c.backdrop }),
                  i.createElement(
                    'div',
                    Object(o.__assign)({}, v, {
                      className: m,
    ...
    WXjp: function (t, e, n) {
      ...
      function h(t) {
        return {
          x: Object(d.clamp)(t.x, 20, document.documentElement.clientWidth - 20),
            ...
            void 0 === n && (n = { boundByScreen: !0 }),
              ...
              (this._onTouchDragStart = function (t) {
                (o._canBeTouchClick = !0),
                  t.preventDefault(),
                  o._header.addEventListener('touchmove', o._onTouchDragMove, { passive: !1 });
                var e = h(_(t));
                o._dragStart(e);
              }),
              (this._onMouseDragEnd = function (t) {
                t.target instanceof Node && o._header.contains(t.target) && t.preventDefault(),
          ...
          return (
            ...
            (t.prototype._moveDialog = function (t, e) {
              var n = this._dialog.getBoundingClientRect(),
                ...
                i = u(t, n.width, o ? 0 : -1 / 0, o ? window.innerWidth : 1 / 0),
                r = u(e, n.height, o ? 0 : -1 / 0, o ? window.innerHeight : 1 / 0);
          ...
          return (
            ...
            (t.prototype.centerAndFit = function () {
              ...
              o === i && (this._dialog.style.height = i + 'px'),
                ...
                (this._dialog.style.transform = 'translate(' + e + 'px, ' + n + 'px)');
            }),
            ...
            (t.prototype.recalculateBounds = function () {
              ...
              if (this._isFullscreen)
                ...
                (this._dialog.style.top = '0px'),
                  (this._dialog.style.left = '0px'),
                  (this._dialog.style.transform = 'translate(' + Math.round(a) + 'px, ' + Math.round(s) + 'px)'),
                  (this._dialog.style.height = r < i.height ? r + 'px' : this._initialHeight);
              }
            }),
            (t.prototype.destroy = function () {
                ...
                i.createElement(
                  ...
                  function (e) {
                    return i.createElement(
                      ...
                      i.createElement(
                        s.a,
                        Object(o.__assign)({ style: t._applyAnimationCSSVariables() }, t.props, {
            ...
            (e.prototype._applyAppearanceAnimation = function (t) {
              if (this._resize && this._dialog) {
                ...
                this._dialog.style.setProperty('--animationTranslateStartX', e + 'px'),
                  ...
                  this._dialog.style.setProperty('--animationTranslateEndX', i + 'px'),
                  this._dialog.style.setProperty('--animationTranslateEndY', r + 'px'),
          ...
          return (
            ...
            (n.prototype.render = function () {
              var e = this.props,
                ...
                a = e.root;
              if (!n) return null;
              var s = i.createElement(t, Object(o.__assign)({}, this.props, { zIndex: 150 }));
