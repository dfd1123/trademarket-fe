      ...
      !(function (e) {
          ...
          (t.isWindow = function (e) {
            ...
            (t.each = function (e, t, r) {
              ...
              if (r) {
                ...
                else for (a in e) if (e.hasOwnProperty(a) && !1 === t.apply(e[a], r)) break;
              } else if (n) for (; a < i && !1 !== t.call(e[a], a, e[a]); a++);
              else for (a in e) if (e.hasOwnProperty(a) && !1 === t.call(e[a], a, e[a])) break;
              return e;
            }),
                    ...
                    n.hasOwnProperty(i) &&
                      ...
                      s !== (a = n[i]) &&
                        (c && a && (t.isPlainObject(a) || (r = t.isArray(a)))
                          ? (r ? ((r = !1), (o = e && t.isArray(e) ? e : [])) : (o = e && t.isPlainObject(e) ? e : {}),
                            (s[i] = t.extend(c, o, a)))
                          : void 0 !== a && (s[i] = a)));
              return s;
            }),
            ...
            (t.fn = t.prototype = {
              ...
              position: function () {
                var e = this[0],
                  ...
                  a = this.offset(),
                  i = /^(?:body|html)$/i.test(r.nodeName) ? { top: 0, left: 0 } : t(r).offset();
                return (
        ...
        function l(e) {
          ...
          return (
            'function' !== a &&
            !t.isWindow(e) &&
            (!(1 !== e.nodeType || !r) || 'array' === a || 0 === r || ('number' == typeof r && r > 0 && r - 1 in e))
          );
        }
      })(window),
        (function (n) {
          ...
          'object' == typeof e.exports
            ? (e.exports = n())
            : void 0 === (i = 'function' == typeof (a = n) ? a.call(t, r, t, e) : a) || (e.exports = i);
        })(function () {
          'use strict';
          return (function (e, t, r, a) {
            ...
            var l = (function () {
                ...
                try {
                  ...
                  return function (t, r) {
                    var a = this.length;
                    if (('number' != typeof t && (t = 0), 'number' != typeof r && (r = a), this.slice))
                    ...
                    if (s > 0)
                      if (((n = new Array(s)), this.charAt)) for (i = 0; i < s; i++) n[i] = this.charAt(o + i);
            ...
            var d,
              ...
              f = !1;
            if ((e.fn && e.fn.jquery ? ((d = e), (f = !0)) : (d = t.Velocity.Utilities), n <= 8 && !f))
            ...
            if (!(n <= 7)) {
              var g = {
                ...
                pauseAll: function (e) {
                  ...
                  d.each(g.State.calls, function (t, r) {
                    if (r) {
                      if (void 0 !== e && (r[2].queue !== e || !1 === r[2].queue)) return !0;
                      r[5] = { resume: !1 };
                    }
                  }),
              ...
              void 0 !== t.pageYOffset
                ...
                : ((g.State.scrollAnchor = r.documentElement || r.body.parentNode || r.body),
              ...
              var m = (function () {
                ...
                function t(t, r, a) {
                  var i = { x: t.x + a.dx * r, v: t.v + a.dv * r, tension: t.tension, friction: t.friction };
                ...
                return function e(t, a, i) {
                  ...
                  for (
                    t = parseFloat(t) || 500,
                      ...
                      l.tension = t,
                      l.friction = a,
                      o = (n = null !== i) ? ((c = e(t, a)) / i) * 0.016 : 0.016;
                    (s = r(s || l, o)), u.push(1 + s.x), (c += 16), Math.abs(s.x) > 1e-4 && Math.abs(s.v) > 1e-4;
              ...
              var h = (g.CSS = {
                ...
                Hooks: {
                  ...
                  register: function () {
                    for (var e = 0; e < h.Lists.colors.length; e++) {
                      var t = 'color' === h.Lists.colors[e] ? '0 0 0 1' : '255 255 255 1';
                      h.Hooks.templates[h.Lists.colors[e]] = ['Red Green Blue Alpha', t];
                    }
                    var r, a, i;
                    if (n)
                      for (r in h.Hooks.templates)
                        if (h.Hooks.templates.hasOwnProperty(r)) {
                          ...
                          'Color' === i[0] &&
                            (i.push(i.shift()), o.push(o.shift()), (h.Hooks.templates[r] = [i.join(' '), o.join(' ')]));
                        }
                    for (r in h.Hooks.templates)
                      if (h.Hooks.templates.hasOwnProperty(r))
                  ...
                  fixColors: function (e) {
                    return e.replace(/(rgba?\(\s*)?(\b[a-z]+\b)/g, function (e, t, r) {
                      return h.Lists.colorNames.hasOwnProperty(r)
                        ? (t || 'rgba(') + h.Lists.colorNames[r] + (t ? '' : ',1)')
                        : t + r;
                    });
                  },
                  cleanRootPropertyValue: function (e, t) {
                    return (
                      h.RegEx.valueUnwrap.test(t) && (t = t.match(h.RegEx.valueUnwrap)[1]),
                      h.Values.isCSSNullValue(t) && (t = h.Hooks.templates[e][1]),
                      t
                    );
                  },
                  extractValue: function (e, t) {
                    ...
                    if (r) {
                      var a = r[0],
                        i = r[1];
                      return (t = h.Hooks.cleanRootPropertyValue(a, t)).toString().match(h.RegEx.valueSplit)[i];
                    }
                    return t;
                  },
                  injectValue: function (e, t, r) {
                    ...
                    if (a) {
                      var i,
                        ...
                        o = a[1];
                      return (
                        ((i = (r = h.Hooks.cleanRootPropertyValue(n, r)).toString().match(h.RegEx.valueSplit))[o] = t),
                        i.join(' ')
                      );
                    }
                    return r;
                ...
                Normalizations: {
                  registered: {
                    clip: function (e, t, r) {
                      switch (e) {
                        ...
                        case 'extract':
                          var a;
                          return (a = h.RegEx.wrappedValueAlreadyExtracted.test(r)
                            ? r
                  ...
                  register: function () {
                    (n && !(n > 9)) ||
                      ...
                      (h.Lists.transformsBase = h.Lists.transformsBase.concat(h.Lists.transforms3D));
                        ...
                        h.Normalizations.registered[t] = function (e, r, a) {
                          switch (e) {
                            case 'name':
                              return 'transform';
                            case 'extract':
                              return void 0 === x(r) || void 0 === x(r).transformCache[t]
                                ? /^scale/i.test(t)
                                  ? 1
                                  : 0
                            ...
                            case 'inject':
                              ...
                              switch (t.substr(0, t.length - 1)) {
                                ...
                                case 'scal':
                                case 'scale':
                                  g.State.isAndroid && void 0 === x(r).transformCache[t] && a < 1 && (a = 1),
                                    (i = !/(\d)$/i.test(a));
                                  break;
                                case 'skew':
                                case 'rotate':
                              ...
                              return i || (x(r).transformCache[t] = '(' + a + ')'), x(r).transformCache[t];
                          }
                        };
                      })();
                      ...
                      !(function () {
                        ...
                        h.Normalizations.registered[e] = function (t, r, a) {
                          switch (t) {
                            ...
                            case 'extract':
                              var i;
                              if (h.RegEx.wrappedValueAlreadyExtracted.test(a)) i = a;
                              else {
                                var o,
                                  s = {
                                    black: 'rgb(0, 0, 0)',
                                ...
                                /^[A-z]+$/i.test(a)
                                  ...
                                  ? (o = 'rgb(' + h.Values.hexToRgb(a).join(' ') + ')')
                              ...
                              return (!n || n > 8) && 3 === i.split(' ').length && (i += ' 1'), i;
                            case 'inject':
                              return /^rgb/.test(a)
                                ? a
                                : (n <= 8
                                    ? 4 === a.split(' ').length && (a = a.split(/\s+/).slice(0, 3).join(' '))
                    ...
                    function r(e, t, r) {
                      if (
                        ('border-box' === h.getPropertyValue(t, 'boxSizing').toString().toLowerCase()) ===
                        (r || !1)
                      ) {
                        var a,
                          i,
                        ...
                        for (a = 0; a < s.length; a++)
                          (i = parseFloat(h.getPropertyValue(t, s[a]))), isNaN(i) || (n += i);
                        return r ? -n : n;
                      }
                      return 0;
                    }
                    ...
                    (h.Normalizations.registered.innerWidth = a('width', !0)),
                      (h.Normalizations.registered.innerHeight = a('height', !0)),
                ...
                Names: {
                  ...
                  SVGAttribute: function (e) {
                    ...
                    return (
                      (n || (g.State.isAndroid && !g.State.isChrome)) && (t += '|transform'),
                  ...
                  removeClass: function (e, t) {
                    if (e)
                      if (e.classList) e.classList.remove(t);
                        ...
                        e.setAttribute(
                          'class',
                          r.replace(new RegExp('(^|s)' + t.split(' ').join('|') + '(s|$)', 'gi'), ' '),
                        );
                      }
                  },
                },
                getPropertyValue: function (e, r, a, i) {
                  function o(e, r) {
                    ...
                    if (n <= 8) a = d.css(e, r);
                      ...
                      /^(width|height)$/.test(r) &&
                        ...
                        ((s = !0), h.setPropertyValue(e, 'display', h.Values.getDisplayType(e)));
                      var l,
                        u = function () {
                      ...
                      if (!i) {
                        if (
                          'height' === r &&
                          'border-box' !== h.getPropertyValue(e, 'boxSizing').toString().toLowerCase()
                        ) {
                          var c =
                            e.offsetHeight -
                            (parseFloat(h.getPropertyValue(e, 'borderTopWidth')) || 0) -
                            (parseFloat(h.getPropertyValue(e, 'borderBottomWidth')) || 0) -
                            (parseFloat(h.getPropertyValue(e, 'paddingTop')) || 0) -
                            (parseFloat(h.getPropertyValue(e, 'paddingBottom')) || 0);
                          return u(), c;
                        }
                        if (
                          'width' === r &&
                          ...
                          var p =
                            e.offsetWidth -
                            (parseFloat(h.getPropertyValue(e, 'borderLeftWidth')) || 0) -
                            (parseFloat(h.getPropertyValue(e, 'borderRightWidth')) || 0) -
                            (parseFloat(h.getPropertyValue(e, 'paddingLeft')) || 0) -
                            (parseFloat(h.getPropertyValue(e, 'paddingRight')) || 0);
                          return u(), p;
                        }
                      }
                      (l =
                        ...
                        ('' !== (a = 9 === n && 'filter' === r ? l.getPropertyValue(r) : l[r]) && null !== a) ||
                          (a = e.style[r]),
                        u();
                    }
                    if ('auto' === a && /^(top|right|bottom|left)$/i.test(r)) {
                      var f = o(e, 'position');
                      ('fixed' === f || ('absolute' === f && /top|left/i.test(r))) && (a = d(e).position()[r] + 'px');
                    }
                    return a;
                  }
                  var s;
                  if (h.Hooks.registered[r]) {
                    var l = r,
                      u = h.Hooks.getRoot(l);
                    void 0 === a && (a = h.getPropertyValue(e, h.Names.prefixCheck(u)[0])),
                      h.Normalizations.registered[u] && (a = h.Normalizations.registered[u]('extract', e, a)),
                      (s = h.Hooks.extractValue(l, a));
                  } else if (h.Normalizations.registered[r]) {
                    var c, p;
                    'transform' !== (c = h.Normalizations.registered[r]('name', e)) &&
                      ((p = o(e, h.Names.prefixCheck(c)[0])),
                      h.Values.isCSSNullValue(p) && h.Hooks.templates[r] && (p = h.Hooks.templates[r][1])),
                  ...
                  return h.Values.isCSSNullValue(s) && (s = 0), g.debug >= 2 && console.log('Get ' + r + ': ' + s), s;
                },
                setPropertyValue: function (e, r, a, i, o) {
                  ...
                  else if (h.Normalizations.registered[r] && 'transform' === h.Normalizations.registered[r]('name', e))
                    h.Normalizations.registered[r]('inject', e, a), (s = 'transform'), (a = x(e).transformCache[r]);
                  else {
                    if (h.Hooks.registered[r]) {
                      var l = r,
                        u = h.Hooks.getRoot(r);
                      (i = i || h.getPropertyValue(e, u)), (a = h.Hooks.injectValue(l, a, i)), (r = u);
                    }
                    if (
                      ...
                      try {
                        ...
                        g.debug && console.log('Browser does not support [' + a + '] for [' + s + ']');
                      }
                    else {
                      var c = x(e);
                      c && c.isSVG && h.Names.SVGAttribute(r) ? e.setAttribute(r, a) : (e.style[s] = a);
                    }
                    g.debug >= 2 && console.log('Set ' + r + ' (' + s + '): ' + a);
                  }
                  return [s, a];
                },
                flushTransformCache: function (e) {
                  var t = '',
                    r = x(e);
                  if ((n || (g.State.isAndroid && !g.State.isChrome)) && r && r.isSVG) {
                    var a = function (t) {
                    ...
                    d.each(x(e).transformCache, function (r) {
                      if (((o = x(e).transformCache[r]), 'transformPerspective' === r)) return (s = o), !0;
                      9 === n && 'rotateZ' === r && (r = 'rotate'), (t += r + o + ' ');
                    }),
                      s && (t = 'perspective' + s + ' ' + t);
                  }
                ...
                (g.hook = function (e, t, r) {
                  ...
                  return (
                    ...
                    d.each(e, function (e, i) {
                      if ((void 0 === x(i) && g.init(i), void 0 === r)) void 0 === a && (a = h.getPropertyValue(i, t));
                      else {
                        var n = h.setPropertyValue(i, t, r);
                        'transform' === n[0] && g.CSS.flushTransformCache(i), (a = n);
                      }
                    }),
                    a
                  );
              ...
              var y = function () {
                ...
                p.isWrapped(this)
                  ...
                  : ((i = !0), (o = 1), (s = m ? arguments[0].elements || arguments[0].e : arguments[0]));
                ...
                if (
                  ...
                  m
                    ? ((l = arguments[0].properties || arguments[0].p), (f = arguments[0].options || arguments[0].o))
                  ...
                  var b,
                    P = s.length,
                    k = 0;
                  if (!/^(stop|finish|finishAll|pause|resume)$/i.test(l) && !d.isPlainObject(f)) {
                    var A = o + 1;
                    f = {};
                    for (var F = A; F < arguments.length; F++)
                      p.isArray(arguments[F]) ||
                      (!/^(fast|normal|slow)$/i.test(arguments[F]) && !/^\d/.test(arguments[F]))
                        ? p.isString(arguments[F]) || p.isArray(arguments[F])
                          ? (f.easing = arguments[F])
                          : p.isFunction(arguments[F]) && (f.complete = arguments[F])
                        ...
                        d.each(g.State.calls, function (e, t) {
                          ...
                          t &&
                            d.each(t[1], function (e, a) {
                              var i = void 0 === f ? '' : f;
                              return (
                                (!0 !== i && t[2].queue !== i && (void 0 !== f || !1 !== t[2].queue)) ||
                                (d.each(s, function (e, i) {
                                  if (i === a) return (t[5] = { resume: !1 }), (r = !0), !1;
                                }),
                                !r && void 0)
                              );
                            });
                          ...
                          t &&
                            d.each(t[1], function (e, a) {
                              ...
                              return (
                                ...
                                !t[5] ||
                                (d.each(s, function (e, i) {
                                  if (i === a) return (t[5].resume = !0), (r = !0), !1;
                                }),
                                !r && void 0)
                              );
                            });
                    ...
                    case 'stop':
                      d.each(s, function (e, t) {
                        x(t) &&
                          ...
                          'finishAll' !== l ||
                            (!0 !== f && !p.isString(f)) ||
                            (d.each(d.queue(t, p.isString(f) ? f : ''), function (e, t) {
                              p.isFunction(t) && t();
                            }),
                            ...
                            d.each(t[1], function (r, a) {
                              ...
                              d.each(s, function (r, n) {
                                if (n === a)
                                  if (
                                    ((!0 === f || p.isString(f)) &&
                                      (d.each(d.queue(n, p.isString(f) ? f : ''), function (e, t) {
                                    ...
                                    o &&
                                      o.tweensContainer &&
                                      !1 !== i &&
                                      d.each(o.tweensContainer, function (e, t) {
                                        t.endValue = t.currentValue;
                                      }),
                                      N.push(e);
                                  } else ('finish' !== l && 'finishAll' !== l) || (t[2].duration = 1);
                              });
                            });
                        }),
                        'stop' === l &&
                      ...
                      if (!d.isPlainObject(l) || p.isEmptyObject(l)) {
                        if (p.isString(l) && g.Redirects[l]) {
                          var H = (e = d.extend({}, f)).duration,
                            O = e.delay || 0;
                          return (
                            !0 === e.backwards && (s = d.extend(!0, [], s).reverse()),
                            d.each(s, function (t, r) {
                              parseFloat(e.stagger)
                                ? (e.delay = O + parseFloat(e.stagger) * t)
                                : p.isFunction(e.stagger) && (e.delay = O + e.stagger.call(r, t, P)),
                                e.drag &&
                                  ((e.duration = parseFloat(H) || (/^(callout|transition)/.test(l) ? 1e3 : 400)),
                                  (e.duration = Math.max(
                                    e.duration * (e.backwards ? 1 - t / P : (t + 1) / P),
                                    0.75 * e.duration,
                                    200,
                                  ))),
                                g.Redirects[l].call(r, r, e || {}, t, P, s, v.promise ? v : void 0);
                            }),
                            a()
                          );
                        }
                        ...
                        return v.promise ? v.rejecter(new Error(j)) : t.console && console.log(j), a();
                      }
                      b = 'start';
                  }
                  var q = {
                  ...
                  d.each(s, function (e, t) {
                    ...
                    ((e = d.extend({}, g.defaults, f)).loop = parseInt(e.loop, 10));
                  var L = 2 * e.loop - 1;
                  if (e.loop)
                    for (var R = 0; R < L; R++) {
                ...
                function W(e, a) {
                    ...
                    parseFloat(o.delay) &&
                      ...
                      d.queue(e, o.queue, function (t) {
                        ...
                        (x(e).delayBegin = new Date().getTime()),
                          ...
                          (x(e).delayTimer = { setTimeout: setTimeout(t, parseFloat(o.delay)), next: i });
                      }),
                  ...
                  function m(n) {
                    ...
                    if ('scroll' === b) {
                      ...
                      o.container
                        ? p.isWrapped(o.container) || p.isNode(o.container)
                          ? ((o.container = o.container[0] || o.container),
                            (C = (w = o.container['scroll' + A]) + d(e).position()[A.toLowerCase()] + F))
                          : (o.container = null)
                        : ((w = g.State.scrollAnchor[g.State['scrollProperty' + A]]),
                          (S = g.State.scrollAnchor[g.State['scrollProperty' + ('Left' === A ? 'Top' : 'Left')]]),
                        ...
                        (c = {
                          scroll: {
                            ...
                            unitType: '',
                            easing: o.easing,
                            scrollData: { container: o.container, direction: A, alternateValue: S },
                          },
                          element: e,
                        }),
                      ...
                      for (var E in ('none' === m.opts.display && (m.opts.display = 'auto'),
                      'hidden' === m.opts.visibility && (m.opts.visibility = 'visible'),
                      (m.opts.loop = !1),
                      (m.opts.begin = null),
                      ...
                      (y = d.extend(!0, {}, m ? m.tweensContainer : null))))
                        if (y.hasOwnProperty(E) && 'element' !== E) {
                          ...
                          (y[E].startValue = y[E].currentValue = y[E].endValue),
                            ...
                            g.debug && console.log('reverse tweensContainer (' + E + '): ' + JSON.stringify(y[E]), e);
                        }
                      c = y;
                    } else if ('start' === b) {
                      (m = x(e)) && m.tweensContainer && !0 === m.isAnimating && (y = m.tweensContainer);
                      var H = function (t, r) {
                          var i, n, s;
                          return (
                            ...
                            p.isArray(t)
                              ? ((i = t[0]),
                                ...
                                h.RegEx.isHex.test(t[1])
                                  ? (s = t[1])
                                  : (p.isString(t[1]) && !h.RegEx.isHex.test(t[1]) && g.Easings[t[1]]) ||
                                    p.isArray(t[1])
                                  ? ((n = r ? t[1] : V(t[1], o.duration)), (s = t[2]))
                                  : (s = t[1] || t[2]))
                              : (i = t),
                            r || (n = n || o.easing),
                        ...
                        O = function (a, n) {
                          ...
                          if (
                            ...
                            ((void 0 !== o.display && null !== o.display && 'none' !== o.display) ||
                              (void 0 !== o.visibility && 'hidden' !== o.visibility)) &&
                              /opacity|filter/.test(a) &&
                              !b &&
                              0 !== f &&
                              (b = 0),
                              o._cacheValues && y && y[a]
                                ? (void 0 === b && (b = y[a].endValue + y[a].unitType),
                                  (u = m.rootPropertyValueCache[l]))
                                : h.Hooks.registered[a]
                                ? void 0 === b
                                  ? ((u = h.getPropertyValue(e, l)), (b = h.getPropertyValue(e, a, u)))
                                  : (u = h.Hooks.templates[l][1])
                                : void 0 === b && (b = h.getPropertyValue(e, a));
                            var x,
                              w,
                              S,
                              P = !1,
                            ...
                            if (b !== f && p.isString(b) && p.isString(f)) {
                              ...
                              var V = 0,
                                ...
                                E = 0,
                                N = 0;
                              for (b = h.Hooks.fixColors(b), f = h.Hooks.fixColors(f); V < b.length && T < f.length; ) {
                                var H = b[V],
                                  O = f[T];
                                if (/[\d\.-]/.test(H) && /[\d\.-]/.test(O)) {
                                  for (var j = H, z = O, L = '.', R = '.'; ++V < b.length; ) {
                                    if ((H = b[V]) === L) L = '..';
                              ...
                              (V === b.length && T === f.length) ||
                                (g.debug &&
                                  console.error(
                                    'Trying to pattern match mis-matched strings ["' + f + '", "' + b + '"]',
                                  ),
                                (s = void 0)),
                                s &&
                                  (C.length
                                    ? (g.debug &&
                                        console.log('Pattern found "' + s + '" -> ', C, A, '[' + b + ',' + f + ']'),
                                      (b = C),
                                      (f = A),
                                      (w = S = ''))
                                    : (s = void 0));
                            ...
                            s ||
                              ((b = (x = k(a, b))[0]),
                              (S = x[1]),
                              (f = (x = k(a, f))[0].replace(/^([+-\/*])=/, function (e, t) {
                                return (P = t), '';
                              })),
                              (w = x[1]),
                              (b = parseFloat(b) || 0),
                              ...
                              '%' === w &&
                                (/^(fontSize|lineHeight)$/.test(a)
                                  ...
                                  : /^scale/.test(a)
                                  ? ((f /= 100), (w = ''))
                                  : /(Red|Green|Blue)$/i.test(a) && ((f = (f / 100) * 255), (w = ''))));
                            if (/[\/*]/.test(P)) w = S;
                            else if (S !== w && 0 !== b)
                              if (0 === f) w = S;
                              else {
                                i =
                                  ...
                                  (function () {
                                    var a = {
                                        ...
                                        position: h.getPropertyValue(e, 'position'),
                                        fontSize: h.getPropertyValue(e, 'fontSize'),
                                      },
                                      i = a.position === q.lastPosition && a.myParent === q.lastParent,
                                    ...
                                    if (n && i)
                                      ...
                                      g.init(s),
                                        ...
                                        g.CSS.setPropertyValue(s, 'position', a.position),
                                        g.CSS.setPropertyValue(s, 'fontSize', a.fontSize),
                                        g.CSS.setPropertyValue(s, 'boxSizing', 'content-box'),
                                        d.each(
                                          ['minWidth', 'maxWidth', 'width', 'minHeight', 'maxHeight', 'height'],
                                          function (e, t) {
                                            g.CSS.setPropertyValue(s, t, '100%');
                                          },
                                        ),
                                        g.CSS.setPropertyValue(s, 'paddingLeft', '100em'),
                                        (o.percentToPxWidth = q.lastPercentToPxWidth =
                                          (parseFloat(h.getPropertyValue(s, 'width', null, !0)) || 1) / 100),
                                        (o.percentToPxHeight = q.lastPercentToPxHeight =
                                          (parseFloat(h.getPropertyValue(s, 'height', null, !0)) || 1) / 100),
                                        (o.emToPx = q.lastEmToPx =
                                          (parseFloat(h.getPropertyValue(s, 'paddingLeft')) || 1) / 100),
                                        a.myParent.removeChild(s);
                                    }
                                    return (
                                      null === q.remToPx &&
                                        (q.remToPx = parseFloat(h.getPropertyValue(r.body, 'fontSize')) || 16),
                                      null === q.vwToPx &&
                                        ((q.vwToPx = parseFloat(t.innerWidth) / 100),
                                        (q.vhToPx = parseFloat(t.innerHeight) / 100)),
                                      (o.remToPx = q.remToPx),
                                      (o.vwToPx = q.vwToPx),
                                      (o.vhToPx = q.vhToPx),
                                      g.debug >= 1 && console.log('Unit ratios: ' + JSON.stringify(o), e),
                                      o
                                    );
                                  })();
                                var I =
                                ...
                                switch (S) {
                                  case '%':
                                    b *= 'x' === I ? i.percentToPxWidth : i.percentToPxHeight;
                                    break;
                                  case 'px':
                                    break;
                                  default:
                                ...
                                switch (w) {
                                  case '%':
                                    b *= 1 / ('x' === I ? i.percentToPxWidth : i.percentToPxHeight);
                                    break;
                                  case 'px':
                                    break;
                                  default:
                            ...
                            (c[a] = {
                              ...
                              s && (c[a].pattern = s),
                              g.debug && console.log('tweensContainer (' + a + '): ' + JSON.stringify(c[a]), e);
                          } else g.debug && console.log('Skipping [' + l + '] due to a lack of browser support.');
                        };
                      for (var j in l)
                          ...
                          if (u(h.Lists.colors)) {
                            ...
                            if (h.RegEx.isHex.test(M)) {
                              for (
                                ...
                                var Q = [I[G]];
                                W && Q.push(W), void 0 !== D && Q.push(D[G]), O(L + B[G], Q);
                              }
                              continue;
                            }
                          }
                    ...
                    c.element &&
                      ...
                      z.push(c),
                      (m = x(e)) && ('' === o.queue && ((m.tweensContainer = c), (m.opts = o)), (m.isAnimating = !0)),
                      k === P - 1
                        ? (g.State.calls.push([z, s, o, null, v.resolver, null, 0]),
                          !1 === g.State.isTicking && ((g.State.isTicking = !0), T()))
                        : k++);
                  }
                  if (
                    (!1 !== g.mock &&
                      (!0 === g.mock
                        ...
                        : ((o.duration *= parseFloat(g.mock) || 1), (o.delay *= parseFloat(g.mock) || 1))),
                    (o.easing = V(o.easing, o.duration)),
                    o.begin && !p.isFunction(o.begin) && (o.begin = null),
                    o.progress && !p.isFunction(o.progress) && (o.progress = null),
                    o.complete && !p.isFunction(o.complete) && (o.complete = null),
                    void 0 !== o.display &&
                      null !== o.display &&
                      ((o.display = o.display.toString().toLowerCase()),
                      'auto' === o.display && (o.display = g.CSS.Values.getDisplayType(e))),
                    void 0 !== o.visibility &&
                      null !== o.visibility &&
                    ...
                    if (o.delay) {
                      ...
                      (x(e).delayBegin = new Date().getTime()),
                        (x(e).delay = parseFloat(o.delay)),
                        (x(e).delayTimer = { setTimeout: setTimeout(m, parseFloat(o.delay)), next: w });
                    } else m();
                  else
                ...
                v.promise && (l && f && !1 === f.promiseRejectEmpty ? v.resolver() : v.rejecter());
              };
              ...
              return (
                (e.Velocity = g),
                e !== t && ((e.fn.velocity = y), (e.fn.velocity.defaults = g.defaults)),
                ...
                d.each(['In', 'Out'], function (e, t) {
                  g.Redirects['fade' + t] = function (e, r, a, i, n, o) {
                    ...
                    0 !== a && (s.begin = null),
                      ...
                      void 0 === s.display && (s.display = 'In' === t ? 'auto' : 'none'),
                      g(this, u, s);
                  };
                }),
                g
            ...
            function k(e, r, a, i) {
              ...
              function w(t, r, i) {
                var n,
                  ...
                  u = 0;
                do {
                  (n = y((o = r + (i - r) / 2), e, a) - t) > 0 ? (i = o) : (r = o);
                } while (Math.abs(n) > s && ++u < l);
                return o;
              }
              function S(t) {
                for (var r = 0, i = 1, n = u - 1; i !== n && f[i] <= t; ++i) r += c;
                --i;
              ...
              var V = function (t) {
                return P || k(), e === r && a === i ? t : 0 === t ? 0 : 1 === t ? 1 : y(S(t), r, i);
              };
                ...
                p.isString(e)
                  ...
                  : (r =
                      p.isArray(e) && 1 === e.length
                        ...
                        : !(!p.isArray(e) || 4 !== e.length) && k.apply(null, e)),
                !1 === r && (r = g.Easings[g.defaults.easing] ? g.defaults.easing : 'swing'),
                r
              );
            }
            function T(e) {
              if (e) {
                ...
                for (var a = 0; a < r; a++)
                  if (g.State.calls[a]) {
                    ...
                    y = i[6] = t - u;
                    for (var b = Math.min(y / l.duration, 1), w = 0, S = o.length; w < S; w++) {
                      var P = o[w],
                        k = P.element;
                      if (x(k)) {
                        var V = !1;
                        ...
                        P))
                          if (P.hasOwnProperty(A) && 'element' !== A) {
                            var F,
                              E = P[A],
                              N = p.isString(E.easing) ? g.Easings[E.easing] : E.easing;
                            ...
                            if (((E.currentValue = F), 'tween' === A)) f = F;
                              ...
                              var z = h.setPropertyValue(
                                k,
                                A,
                                E.currentValue + (n < 9 && 0 === parseFloat(F) ? '' : E.unitType),
                                E.rootPropertyValue,
                                E.scrollData,
                              );
                              h.Hooks.registered[A] &&
                                (h.Normalizations.registered[j]
                                  ? (x(k).rootPropertyValueCache[j] = h.Normalizations.registered[j](
                                      'extract',
                                      null,
                                      z[1],
                                    ))
                        ...
                        l.mobileHA &&
                          ...
                          ((x(k).transformCache.translate3d = '(0px, 0px, 0px)'), (V = !0)),
                          V && h.flushTransformCache(k);
                      }
                    }
                    void 0 !== l.display && 'none' !== l.display && (g.State.calls[a][2].display = !1),
                      void 0 !== l.visibility && 'hidden' !== l.visibility && (g.State.calls[a][2].visibility = !1),
                      l.progress && l.progress.call(i[1], i[1], b, Math.max(0, u + l.duration - t), u, f),
                      1 === b && C(a);
                  }
              }
            ...
            function C(e, t) {
              ...
              for (
                ...
                t ||
                  i.loop ||
                  ('none' === i.display && h.setPropertyValue(u, 'display', i.display),
                  'hidden' === i.visibility && h.setPropertyValue(u, 'visibility', i.visibility));
                var c = x(u);
                if (
                  !0 !== i.loop &&
                  (void 0 === d.queue(u)[1] || !/\.velocityQueueEntryFlag/i.test(d.queue(u)[1])) &&
                  c
                ) {
                  ...
                  d.each(h.Lists.transforms3D, function (e, t) {
                    ...
                    i.mobileHA && ((p = !0), delete c.transformCache.translate3d),
              ...
              !1 === o && ((g.State.isTicking = !1), delete g.State.calls, (g.State.calls = []));
            }
