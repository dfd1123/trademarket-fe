  ...
  ['study-market'],
  {
      ...
      var i = n('q1tI'),
        r = function (e, t) {
          var n = void 0 === t ? {} : t,
            ...
            s = void 0 === c ? null : c;
          try {
            return new window.CustomEvent(e, { bubbles: r, cancelable: o, detail: s });
          } catch (u) {
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return (
                ...
                a.createPortal(r.createElement(u.Provider, { value: this }, this.props.children), e)
              );
            }),
    ...
    An2S: function (e, t, n) {
      ...
      function p(e) {
        ...
        return a.a.createElement('div', Object(i.__assign)({}, r, { className: p, 'data-role': 'dialog-sidebar' }));
      }
      function h(e) {
        return a.a.createElement('div', Object(i.__assign)({ className: u.wrapper }, e));
      }
      function f(e) {
        var t = e.mode,
          n = e.title,
          ...
          o = e.isActive,
          p = e.onClick,
          h = Object(i.__rest)(e, ['mode', 'title', 'icon', 'isActive', 'onClick']),
          f = d(t),
          m = f.isMobile,
          v = f.isTablet;
        return a.a.createElement(
          'div',
          Object(i.__assign)({}, h, {
            className: c()(u.tab, v && u.isTablet, m && u.isMobile, o && u.active),
            onClick: p,
          }),
    ...
    PMRz: function (e, t, n) {
      e.exports = {
        ...
        'highlight-animation-theme-light': 'highlight-animation-theme-light-1TIZ6Gga',
        dark: 'dark-1FO6oC-E',
        'highlight-animation-theme-dark': 'highlight-animation-theme-dark-3xWPfm4R',
        main: 'main-34wD0nIh',
    ...
    QHWU: function (e, t, n) {
      ...
      function p(e) {
        ...
        return a.a.createElement(
          ...
          r && a.a.createElement('div', { className: d.cancel, onClick: r }, Object(s.t)('Cancel')),
        );
      }
      function h(e) {
        var t = e.className,
    ...
    QpNh: function (e, t, n) {
      'use strict';
      function i(e) {
        for (var t = {}, n = 0, i = Object.entries(e).filter(r); n < i.length; n++) {
          var a = i[n],
            o = a[0],
            c = a[1];
          t[o] = c;
    ...
    jPOK: function (e, t, n) {
      ...
      n('SzKR');
      function o(e) {
        var t = r('tv-spinner', 'tv-spinner--shown', 'tv-spinner--size_' + (e.size || a.a));
    ...
    pr86: function (e, t, n) {
      ...
      function d(e) {
        var t = e.className,
          ...
          d = e.isActive,
          p = e.onClick,
          h = Object(i.__rest)(e, ['className', 'isFilled', 'isActive', 'onClick']);
    ...
    swCq: function (e, t, n) {
      ...
      t.Icon = r.forwardRef(function (e, t) {
        var n = e.icon,
          a = void 0 === n ? '' : n,
          o = i.__rest(e, ['icon']);
        return r.createElement('span', i.__assign({}, o, { ref: t, dangerouslySetInnerHTML: { __html: a } }));
      });
    },
    uhCe: function (e, t, n) {
      'use strict';
    ...
    zbLM: function (e, t, n) {
      ...
      var g = { earning: new RegExp('EPS'), earnings: new RegExp('EPS'), 'trailing twelve months': new RegExp('TTM') };
      function b(e) {
        var t,
          n = e.id,
          i = e.description,
      ...
      function j(e) {
        ...
        return a.a.createElement(
          'div',
          Object(i.__assign)({ ref: t, className: y()(S.container, n) }, r, { 'data-role': 'dialog-content' }),
        );
      }
      var k = n('cu5P');
      function N(e) {
        var t = e.children,
          n = e.className,
          i = e.disabled;
        return a.a.createElement('span', { className: y()(k.title, i && k.disabled, n) }, t);
      }
                        ...
                        if (e.fuzzyHighlight)
                          for (var s = c.index, l = 1; l < c.length; l++) {
                            var u = c[l],
                              d = c[l].length;
                            if (l % 2) {
                              var p = u.startsWith(' ') || u.startsWith('/') || u.startsWith('-');
                              i[p ? s + 1 : s] = !0;
                            }
                            s += d;
                          }
                        else for (var h = 0; h < c[0].length; h++) i[c.index + h] = !0;
                    }),
                    i)
                  : i;
              })(t, i, n);
          ...
          c.length
            ? i.split('').map(function (e, t) {
                return a.a.createElement(
                  ...
                  { key: t },
                  c[t]
                    ? a.a.createElement('span', { className: _(P.highlighted, o) }, e)
      ...
      function W(e) {
        var t = Object(r.useContext)(I),
          ...
          b = (null == t ? void 0 : t.toggleFavorite) ? z(t.toggleFavorite, o) : void 0,
          _ = C.CheckMobile.any() && A.isMobile,
          w = Object(D.a)({ watchedValue: T.watchedTheme }) === q.a.Dark ? A.dark : A.light,
          E = y()(A.container, o.isGrayed && A.disabled, l && A.selected, u && A.highlighted, u && w);
        return a.a.createElement(
          'div',
          {
            ref: d,
          ...
          a.a.createElement(
            ...
            m && a.a.createElement(L.a, { className: y()(A.favorite, h && A.isActive, _), isFilled: h, onClick: b }),
            a.a.createElement(
              N,
              { disabled: o.isGrayed },
          ...
          f &&
            a.a.createElement(
              'a',
              { href: f.authorLink, className: A.author, target: '_blank', onClick: g },
              f.authorName,
            ),
          'mobile' !== i && f && a.a.createElement('span', { className: A.likes }, f.likesCount),
          !1,
        );
      }
      function z(e, t) {
      ...
      function B(e) {
        ...
        return a.a.createElement(
          'h3',
          {
            className: y()(K.title, 'Small' === n && K.small, 'Normal' === n && K.normal, 'Large' === n && K.large, i),
          },
          t,
        );
      }
      ...
      function H(e) {
        var t = e.style,
          n = e.children;
        return a.a.createElement('div', { style: t, className: G.container }, n);
      }
      var U = n('Iivm'),
        Y = n('mwqF'),
        J = n('idtP');
            ...
            i(
              (function () {
                var t,
                  i = a(e),
                  r = i === e.length - 1;
                return null === n || -1 === i ? (null !== (t = e[0]) && void 0 !== t ? t : null) : r ? e[i] : e[i + 1];
              })(),
            );
          },
          function () {
            i(
              (function () {
                var t,
                  i = a(e);
                return null === n || 0 === i || -1 === i ? (null !== (t = e[0]) && void 0 !== t ? t : null) : e[i - 1];
              })(),
            );
          },
        ];
      ...
      function X(e) {
            ...
            function () {
              return (function (e, t) {
                ...
                return (
                  ...
                  t && t.hasOwnProperty(i) && n.push({ fullMatch: t[i], re: t[i], fuzzyHighlight: !1 }),
                  n
                );
              })(u, g);
            },
            ...
            function () {
              return u
                ? (function (e) {
                          ...
                          n.forEach(function (e) {
                            ...
                            return (
                              ...
                              r.toLowerCase() === i.toLowerCase()
                                ? ((s = 3), void (t = null === (n = r.match(d)) || void 0 === n ? void 0 : n.index))
                                : d.test(r)
                                ? ((s = 2), void (t = null === (a = r.match(d)) || void 0 === a ? void 0 : a.index))
                                : d.test(o)
                                ? ((s = 1), void (t = null === (c = r.match(d)) || void 0 === c ? void 0 : c.index))
                                : void (
                                    u.test(o) &&
                                    ((s = 1), (t = null === (l = r.match(u)) || void 0 === l ? void 0 : l.index))
                                  )
                            );
                          }),
                  ...
                  })({ data: n, rules: p, queryString: u, primaryKey: 'shortDescription', secondaryKey: 'title' })
                : n;
            },
            [u, p, n],
          ),
              ...
              ),
              {
                ...
                handleKeyDown: function (e) {
                  var t = (function (e, t) {
                    ...
                    i = t[0],
                    r = t[1];
                  40 === Object(F.hashFromEvent)(e) && (e.preventDefault(), f(), g(r));
                  38 === Object(F.hashFromEvent)(e) && (e.preventDefault(), m(), g(i));
        ...
        return (
          Object(r.useEffect)(
            function () {
              var e;
              i || d(''), C.CheckMobile.any() || null === (e = S.current) || void 0 === e || e.focus();
            },
            [i],
          ),
          a.a.createElement(E.a, {
            ...
            render: function () {
              return a.a.createElement(
                a.a.Fragment,
                null,
                a.a.createElement(x.a, { reference: S, placeholder: Object(s.t)('Search'), onChange: P, onFocus: M }),
                a.a.createElement(
                  O.c,
                  null,
                  a.a.createElement(
                    ...
                    I
                      ...
                      ? a.a.createElement(
                          a.a.Fragment,
                          null,
                          a.a.createElement(H, null, a.a.createElement(B, { title: Object(s.t)('Script name') })),
                          h.map(function (e) {
                      ...
                      : a.a.createElement(V, {
                          ...
                          description: Object(s.t)('No indicators matched your criteria.'),
                        }),
                  ),
                ),
              );
        ...
        ne = (function () {
          ...
          return (
            ...
            (e.prototype.hide = function () {
              (this._parentSource = null), this._setProps({ isOpened: !1 }), this._visibilityChanged.fire(!1);
            }),
            (e.prototype.destroy = function () {
              (this._isDestroyed = !0), c.a.unmountComponentAtNode(this._container);
            }),
            (e.prototype._shouldPreventRender = function () {
              return this._isDestroyed || (!this._isForceRender && !this.isVisible());
            }),
            ...
            (e.prototype._applyStudy = function (e) {
              var t,
                ...
                r = this;
              e.isGrayed
                ? te.emit('onGrayedObjectClicked', { type: 'study', name: e.shortDescription })
                : (C.CheckMobile.any() || null === (t = this._searchInputRef.current) || void 0 === t || t.select(),
                  (function (e, t, n) {
                    return Object(i.__awaiter)(this, void 0, void 0, function () {
                      ...
                      return Object(i.__generator)(this, function (i) {
                        return 'java' === (r = t.descriptor).type &&
                          null !== (a = Object(u.tryFindStudyLineToolNameByStudyId)(r.studyId))
                          ? (l.tool.setValue(a), [2, null])
                          : (o = e.activeChartWidget.value())
                          ? [2, o.insertStudy(t.descriptor, n, t.shortDescription)]
                          : [2, null];
                      });
                    });
                  })(
                    ...
                    e,
                    null !== (n = this._parentSource) && void 0 !== n ? n : void 0,
                  ).then(function () {
                    var e;
                    C.CheckMobile.any() || null === (e = r._searchInputRef.current) || void 0 === e || e.focus();
                  }));
            }),
            ...
            return Object(i.__awaiter)(this, void 0, void 0, function () {
              ...
              return Object(i.__generator)(this, function (a) {
                switch (a.label) {
                  ...
                  case 1:
                    return (e = a.sent()), (this._studies = m(f(e.map(b)))), [3, 3];
                  case 2:
                    (t = a.sent().pineBuiltInStudies),
                      (n = m(f(t.map(mapPineStudy), !1))),
                      (this._studies = Object(i.__assign)(Object(i.__assign)({}, this._studies), n)),
                      (a.label = 3);
                  case 3:
                    return (
                      (r = Object(i.__spreadArrays)(this._getStudies('tv-basicstudies'), this._getStudies('Script$STD'))
                        .filter(function (e) {
                          return !e.isStrategy;
                        })
                        .sort(v)),
