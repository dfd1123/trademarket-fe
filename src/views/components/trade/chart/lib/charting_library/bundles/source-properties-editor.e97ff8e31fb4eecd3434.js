(window.webpackJsonp = window.webpackJsonp || []).push([
  ['source-properties-editor'],
  {
    ...
    '2mql': function (e, t, n) {
      ...
      s[o.ForwardRef] = { $$typeof: !0, render: !0, defaultProps: !0, displayName: !0, propTypes: !0 };
    ...
    CbZh: function (e, t, n) {
      ...
      function E(e) {
        ...
        return o.createElement(
          ...
          o.createElement(_.b, {
            ...
            label: t,
            onClick: l,
            toolbox: n && o.createElement(y.a, { hidden: !Modernizr.mobiletouch && !a, onClick: u }),
          }),
        );
      }
      var P = n('HWhk');
      function O(e) {
        var t = e.model,
          n = e.source;
        return i.a.createElement(g.a, { rule: 'screen and (max-width: 768px)' }, function (e) {
            ...
            items: [
              {
                ...
                content: '',
                selectedContent: e
                  ? i.a.createElement(v.Icon, { className: C.themesButtonIcon, icon: P })
                  : window.t('Template'),
              },
              { readonly: !0, content: i.a.createElement(E, { onClick: o, name: window.t('Apply Defaults') }) },
            ],
            hideArrowButton: e,
            value: 'defaults',
          });
            ...
            (n._activePageRef = o.createRef()),
              ...
              (n._renderFooterLeft = function () {
                ...
                return Object(D.isLineTool)(t)
                  ...
                  : o.createElement(g.a, { rule: 'screen and (max-width: 419px)' }, function (e) {
                      return (
                        Object(j.isStudy)(t) &&
                        o.createElement(k.a, { model: i, source: t, mode: e ? 'compact' : 'normal' })
                      );
                    });
              }),
              ...
              (n._unsubscribe = function (e) {
                e && e.definitions.unsubscribe(n._onChangeActivePageDefinitions);
              }),
              ...
              (n._handleSelectPage = function (e) {
                ...
                t !== e &&
                  ...
                  r && d.a.setValue(r, e),
                  n._subscribe(i),
                  n.setState({ activePageId: e, tableKey: Date.now() }, function () {
                    n._requestResize && n._requestResize(), n._focusActivePageFirstTextInput();
                  }));
              }),
              ...
              (n._closePopupDialog = function () {
                window.lineToolPropertiesToolbar && window.lineToolPropertiesToolbar.refresh(), n.props.onClose();
              });
            var i,
              r = n.props.pages;
            if (n._getActionPageById(n.props.activePageId)) i = Object(c.ensureDefined)(n.props.activePageId);
            else {
          ...
          return (
            ...
            (t.prototype.render = function () {
              var e,
                ...
                a = (null === (e = n.properties().title) || void 0 === e ? void 0 : e.value()) || n.title();
            ...
            (t.prototype._renderChildren = function (e) {
              ...
              return function (n) {
                ...
                var r = t.props.pages,
                  a = {
                    ...
                    byId: r.reduce(function (e, t) {
                      var n;
                      return Object(s.__assign)(Object(s.__assign)({}, e), (((n = {})[t.id] = { title: t.title }), n));
                    }, {}),
                  },
                  c = r.find(function (t) {
                    return t.id === e;
                ...
                return o.createElement(
                  o.Fragment,
                  null,
                  o.createElement(h.a, { activeTabId: e, onSelect: t._handleSelectPage, tabs: a }),
                  o.createElement(
                    I.a,
                    { className: F.scrollable, onScroll: t._handleScroll },
                    o.createElement(W, { page: c, pageRef: t._activePageRef, tableKey: t.state.tableKey }),
                  ),
                );
              };
            }),
            (t.prototype._focusActivePageFirstTextInput = function () {
              if (!l.CheckMobile.any() && this._activePageRef.current) {
                var e = this._activePageRef.current.querySelector('input[type=text],textarea');
                e &&
        ...
        return r.a.createElement(
          ...
          Object(o.__assign)({}, N, {
            className: a(
              ...
              A.item,
              _ && A.withIcon,
              ((t = {}), (t[A.isActive] = y), (t[A.isDisabled] = w || E), (t[A.hovered] = C), t),
            ),
            title: m,
            href: O,
            target: T,
            ...
            onContextMenu: function (t) {
              var n = e.trackEventObject,
                o = e.trackRightClick;
              n && o && Object(c.trackEvent)(n.category, n.event, n.label + '_rightClick');
            },
            onMouseUp: function (t) {
              ...
              if (1 === t.button && O && n) {
                var i = n.label;
                o && (i += '_mouseWheelClick'), Object(c.trackEvent)(n.category, n.event, i);
              }
            },
            onMouseOver: k,
            onMouseOut: D,
          }),
          void 0 !== _ && r.a.createElement('div', { className: A.icon, dangerouslySetInnerHTML: { __html: _ } }),
          r.a.createElement(
            'div',
          ...
          (void 0 !== b || g) &&
            r.a.createElement('div', { className: A.shortcut }, (d = b) && d.split('+').join(' + ')),
          void 0 !== x &&
            r.a.createElement('div', { onClick: f, className: a(A.toolbox, ((n = {}), (n[A.showOnHover] = S), n)) }, x),
        );
      }
    },
    QpNh: function (e, t, n) {
      'use strict';
      function o(e) {
        for (var t = {}, n = 0, o = Object.entries(e).filter(i); n < o.length; n++) {
          var r = o[n],
            a = r[0],
            s = r[1];
          t[a] = s;
                    ...
                    (r = [].concat(t(r), [p])),
                      ...
                      (e.ontouchmove = function (t) {
                        ...
                        1 === t.targetTouches.length &&
                          ...
                          !u(n.target) &&
                            ((o && 0 === o.scrollTop && 0 < r) ||
                            ((i = o) && i.scrollHeight - i.scrollTop <= i.clientHeight && r < 0)
                              ? d(n)
                              : n.stopPropagation()));
                      }),
