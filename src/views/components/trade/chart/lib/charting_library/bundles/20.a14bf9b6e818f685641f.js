            ...
            (e.prototype.render = function () {
              var t,
                ...
                u = n.map(function (t, e) {
                  return i.createElement('div', { className: a.error, key: e }, t);
                }),
                m = {
                  position: 'absolute',
                  top: this.props.top,
              ...
              if (Object(p.isRtl)()) {
                var f = m.left,
                  g = m.right;
                m = Object(r.__assign)(Object(r.__assign)({}, m), { left: g, right: f });
              }
            ...
            return (
              ...
              (e.prototype._calcProps = function (t) {
                if (t.target && t.attachment && t.targetAttachment) {
                  var e = this._calcTargetProps(t.target, t.attachment, t.targetAttachment);
                  if (null === e) return {};
                  var o = this.props,
                    r = o.width,
                    ...
                    h = void 0 !== n && n,
                    a = { width: s ? e.width : r, maxWidth: h ? e.width : void 0 };
              ...
              (e.prototype._calcTargetProps = function (t, e, o) {
                var r = t.getBoundingClientRect(),
                  ...
                  s =
                    'parent' === this.props.root ? this._getCoordsRelToParentEl(t, r) : this._getCoordsRelToDocument(r);
                ...
                return (
                  'number' == typeof this.props.attachmentOffsetY && (p += this.props.attachmentOffsetY),
