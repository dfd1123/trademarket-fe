(window.webpackJsonp = window.webpackJsonp || []).push([
  ['ds-property-pages'],
  {
    '/4PT': function (t, e, i) {
        ...
        n = (function () {
          function t(t) {
            ...
            (this._disabled = !1),
              ...
              this._jqWrapper.data({ disable: this.disable.bind(this), enable: this.enable.bind(this) }),
              this._jqWrapper.selectable(!1),
              (this._jqSwitcher = $('<div class="switcher">').appendTo(this._jqWrapper)),
              this._jqSwitcher.on('click', function () {
                e.toggleItems();
              }),
              (this._jqTitle = $('<span class="title">').appendTo(this._jqSwitcher)),
              $('<span class="icon">').appendTo(this._jqSwitcher),
              (this._jqItems = $('<div class="items js-hidden">').appendTo(this._jqWrapper)),
              (this._callback = null),
              t && this.addItems(t);
          }
          return (
            ...
            (t.prototype.setValue = function (t) {
              if (this._value !== t) {
                ...
                e && ((this._value = t), this._jqTitle.html(e.html), this.change());
              }
            }),
            (t.prototype.change = function (t) {
              t ? (this._callback = t) : this._callback && this._callback.call(this);
            }),
            ...
            (t.prototype._open = function () {
              ...
              this._disabled ||
                ...
                this._closeCb ||
                  ...
                  this._closeCb.host.addEventListener('mousedown', this._closeCb.cb, !1)));
            }),
            (t.prototype._close = function () {
              this._jqItems.addClass('js-hidden'),
                ...
                (this.opened = !1),
                this._closeCb &&
                  (this._closeCb.host.removeEventListener('mousedown', this._closeCb.cb, !1), (this._closeCb = null));
            }),
            t
          );
        })(),
      ...
      function s() {
        return new n([
          { html: '<div class="tv-line-style-option tv-line-style-option--solid"/>', value: a.LINESTYLE_SOLID },
          { html: '<div class="tv-line-style-option tv-line-style-option--dotted"/>', value: a.LINESTYLE_DOTTED },
          { html: '<div class="tv-line-style-option tv-line-style-option--dashed"/>', value: a.LINESTYLE_DASHED },
        ]);
      }
    ...
    A3Hk: function (t, e, i) {
      ...
      function a() {
        var t = $('<select />');
        return (
          $('<option value="' + o.LeftToRight + '">' + $.t('Left') + '</option>').appendTo(t),
          $('<option value="' + o.RightToLeft + '">' + $.t('Right') + '</option>').appendTo(t),
          t
        );
      }
      !(function (t) {
        (t.LeftToRight = 'left_to_right'), (t.RightToLeft = 'right_to_left');
      })(o || (o = {})),
        (function (t) {
    ...
    ICcj: function (t, e, i) {
      ...
      inherit(r, a),
        ...
        (r.prototype._symbolInfoBySymbolProperty = n.prototype._symbolInfoBySymbolProperty),
        (r.prototype._sortInputs = n.prototype._sortInputs),
        (r.prototype.prepareLayout = function () {
          var t = $('<table class="property-page" cellspacing="0" cellpadding="0">'),
            e = $('<table class="property-page" cellspacing="0" cellpadding="0">').data({
          ...
          for (var i = this._linetool.points(), o = 0; o < i.length; o++) {
            ...
            this.bindBarIndex(d.bar, l, this.model(), 'Change ' + this._linetool.title() + ' point bar index');
          }
          var h = this._model
            .model()
        ...
        inherit(T, p),
          (T.prototype._addSessionEditor = function (t, e, i, o) {
            if ('session' === i.type) {
              var n = function (t, e) {
                  var i = $('<td/>');
                  i.appendTo(t), i.css('padding-left', '0px'), i.css('padding-right', '0px');
                  var o = $('<input>');
                  o.attr('type', 'text'), o.addClass('ticker'), o.css('width', '40px'), o.attr('id', e), o.appendTo(i);
                },
                a = function (t, e, i) {
                  var o = $('<td/>');
                  o.css('padding-left', i), o.css('padding-right', i), o.appendTo(t);
                  var n = $('<div/>');
              ...
              var p = $('<tr/>');
              p.appendTo(s);
              var l = ['start_hours', 'start_minutes', 'end_hours', 'end_minutes'];
              n.call(this, p, l[0]),
                a.call(this, p, ':', 0),
                n.call(this, p, l[1]),
                a.call(this, p, '-', 4),
            ...
            } else m.logError('Session editor adding FAILED: wrong input type.');
          }),
          (T.prototype.prepareControl = function (e, i, o) {
            ...
            if ('resolution' === e.type)
              ...
              (a = $('<input class="symbol-edit single">')),
                ...
                i.attr('colspan', 5);
            else if ('session' === e.type) this._addSessionEditor(i, this._property.inputs[e.id], e, o);
              ...
              if (c) {
                var u = this._study.source().title(!0, null, !0),
                  y = C.getChildSourceInputTitles(e, this._study.source().metaInfo(), u);
                for (var v in p) y[v] && (p[v] = 1 === Object.keys(y).length ? u : y[v]);
              }
              if (
                ...
                for (var f = this._model.model().allStudies(), T = 0; T < f.length; ++T) {
                  var g = f[T];
                  if (-1 === b.indexOf(g) && g.canHaveChildren()) {
                    var w = g.title(!0, null, !0),
                      k = g.sourceId() || '#' + g.id(),
                      P = g.metaInfo(),
                      L = P.styles,
                      x = P.plots || [];
                    if (1 === x.length) p[k + '$0'] = w;
                    else {
                      var S;
                      for (h = 0; h < x.length; ++h)
                        (S = x[h]),
                          ~C.CHILD_STUDY_ALLOWED_PLOT_TYPES.indexOf(S.type) &&
                            (p[k + '$' + h] = w + ': ' + ((L && L[S.id] && L[S.id].title) || S.id));
                    }
                  }
                }
                (s = (function (t) {
                  return function (e) {
                    ...
                    if (0 === e.indexOf('#')) {
                      ...
                      if (null === a) return void m.logError('Can not get Study by id ' + o);
                      a.isStarted() || a.start(null, !0);
                      var s = a.sourceId();
                      if (!s) return void m.logError('Can not get source id for ' + a.metaInfo().id);
                      i = e.replace(/^[^$]+/, s);
                    }
                    (!~e.indexOf('$') && !~e.indexOf('#')) || n._study.isStarted() || n._study.start(null, !0),
                  ...
                  (r = (function (t) {
                    return function (e) {
                      ...
                      for (
                        var i = e.slice(0, e.indexOf('$')), o = n._model.model().allStudies(), a = 0;
                        a < o.length;
                        ++a
                      ) {
                        var s = o[a];
            ...
            } else (a = $('<input/>')), 'bool' === e.type ? a.attr('type', 'checkbox') : a.attr('type', 'text');
            return (
              a && (a.appendTo(i), a.is(':checkbox') || 'symbol' === e.type || a.css('width', '100px')),
          ...
          (T.prototype.prepareLayoutImpl = function (t, e) {
            ...
            for (var o = this._sortInputs(t.inputs), r = 0; r < o.length; r++) {
              ...
              if (
                ...
                _.appendTo(e);
                var T = $('<td/>');
                T.appendTo(_), T.addClass('propertypage-name-label'), T.text(window.t(F, { context: 'input' }));
                var g = $('<td/>');
                g.appendTo(_);
                var w = this.prepareControl(p, g, m),
                  k = w.valueEditor,
                  P = w.valueSetter,
                  L = w.propertyChangedHook;
                if (p.options) this.bindControl(new y(k, this._property.inputs[C], null, !0, this.model(), m, P, L));
                else if ('bar_time' === p.type) {
                  this.bindControl(
                    new s(k, this._property.inputs[C], !0, this.model(), m, this.model().mainSeries(), 10),
                  ),
                    k.addClass('ticker');
                } else if ('integer' === p.type) {
                  var x = [h(p.defval)];
                  (0 === p.min || p.min) && x.push(l(p.min)),
                    (0 === p.max || p.max) && x.push(d(p.max)),
                    this.bindControl(new b(k, this._property.inputs[C], x, !1, this.model(), m)),
                    k.addClass('ticker'),
                    isFinite(p.step) && p.step > 0 && k.attr('data-step', p.step);
                } else if ('float' === p.type) {
                  x = [c(p.defval)];
                  (0 === p.min || p.min) && x.push(l(p.min)), (0 === p.max || p.max) && x.push(d(p.max));
                  var S = new b(k, this._property.inputs[C], x, !1, this.model(), m);
                  S.addFormatter(i),
                    this.bindControl(S),
                    k.addClass('ticker'),
                    isFinite(p.step) && p.step > 0 && k.attr('data-step', p.step);
                } else if ('text' === p.type)
                  this.bindControl(new b(k, this._property.inputs[C], null, !1, this.model(), m));
                else if ('bool' === p.type) this.bindControl(new v(k, this._property.inputs[C], !0, this.model(), m));
                else if ('resolution' === p.type)
                  this.bindControl(new y(k, this._property.inputs[C], n, !0, this.model(), 'Change Interval'));
                else if ('symbol' === p.type) {
                  var I = this._symbolInfoBySymbolProperty.bind(this, this._property.inputs[C]),
            ...
            if (this._property.offset) {
              var F = this._property.offset.title ? this._property.offset.title.value() : window.t('Offset');
              (k = this.addOffsetEditorRow(e, F)),
                (x = [h(this._property.offset.val)]).push(l(this._property.offset.min)),
                x.push(d(this._property.offset.max)),
                this.bindControl(new b(k, this._property.offset.val, x, !1, this.model(), 'Undo ' + F));
            }
                ...
                function (t, i) {
                  if (this._property.offsets[i.id]) {
                    ...
                    if (void 0 === o.isHidden || !o.isHidden.value()) {
                      ...
                      a.push(l(o.min)),
                        a.push(d(o.max)),
                        this.bindControl(new b(k, o.val, a, !1, this.model(), 'Undo ' + n));
                    }
                  }
                }.bind(this),
              );
    ...
    PVgW: function (t, e, i) {
      ...
      function a(t) {
        return (
          (t = Math.abs(t)),
          !Object(o.isInteger)(t) && t > 1 && (t = parseFloat(t.toString().replace(/^.+\./, '0.'))),
          0 < t && t < 1
            ? Math.pow(
                10,
                (function (t) {
      ...
      function s(t, e) {
        ...
        var i = t.data('TVTicker'),
          n = i && i.step,
          s = 0;
        (s = i.parser ? i.parser(t.val()) : Object(o.isInteger)(n) ? parseInt(t.val(), 10) : parseFloat(t.val())),
          isNaN(s) && (s = 0);
        var r = a(n),
          ...
          this.each(function () {
            ...
            if (
              ...
              var a = $('<div class="tv-ticker">').appendTo(i.parent()),
                s = $('<div class="tv-ticker__btn tv-ticker__btn--up">').html(n).appendTo(a),
                l = $('<div class="tv-ticker__btn tv-ticker__btn--down">').html(n).appendTo(a);
              a.on('mousedown', function (t) {
                ...
                i.keydown(function (t) {
                  i.is(':disabled') ||
                    (38 === t.keyCode ? s.addClass('i-active') : 40 === t.keyCode && l.addClass('i-active'));
                }),
                i.keyup(function (t) {
                  i.is(':disabled') ||
                    (38 === t.keyCode
        ...
        (l.prototype.prepareLayout = function () {
          ...
          if (r.enabled('seconds_resolution')) {
            var e = $('<tr>').appendTo(this._block),
              ...
              o = $("<input type='checkbox'>").addClass('visibility-checker').prependTo(i);
            $('<td>').css('padding-right', '15px').append(i).appendTo(e);
            var n = $("<input type='text'>").addClass('ticker-text');
            $('<td>').append(n).appendTo(e);
            var l = $('<div>').addClass('slider-range ui-slider-horizontal').slider();
            $('<td>').append(l).appendTo(e);
            var d = $("<input type='text'>").addClass('ticker-text');
            $('<td>').append(d).appendTo(e),
              this.bindControl(new a(o, t.seconds, !0, this.model(), 'Change Line Tool Visibility On Seconds')),
              this.bindControl(
                new s(
                  l,
          ...
          (e = $('<tr>').appendTo(this._block)), (i = $('<label>').append($.t('Minutes')));
          var h = $("<input type='checkbox'>").addClass('visibility-checker').prependTo(i),
          ...
          $('<td>').append(d).appendTo(e),
            this.bindControl(new a(h, t.minutes, !0, this.model(), 'Change Line Tool Visibility On Minutes')),
            this.bindControl(
              new s(
                l,
          ...
          (e = $('<tr>').appendTo(this._block)), (i = $('<label>').append($.t('Hours')));
          var u = $("<input type='checkbox'>").addClass('visibility-checker').prependTo(i);
          ...
          d = $("<input type='text'>").addClass('ticker-text');
          $('<td>').append(d).appendTo(e),
            this.bindControl(new a(u, t.hours, !0, this.model(), 'Change Line Tool Visibility On Hours')),
            this.bindControl(
              new s(
                l,
          ...
          (e = $('<tr>').appendTo(this._block)), (i = $('<label>').append($.t('Days')));
          var y = $("<input type='checkbox'>").addClass('visibility-checker').prependTo(i);
          $('<td>').append(i).appendTo(e);
          n = $("<input type='text'>").addClass('ticker-text');
          $('<td>').append(n).appendTo(e);
          l = $('<div>').addClass('slider-range ui-slider-horizontal').slider();
          ...
          d = $("<input type='text'>").addClass('ticker-text');
          $('<td>').append(d).appendTo(e),
            this.bindControl(new a(y, t.days, !0, this.model(), 'Change Line Tool Visibility On Days')),
            this.bindControl(
              new s(
                l,
                [t.daysFrom, t.daysTo],
          ...
          (e = $('<tr>').css('height', '29px').appendTo(this._block)), (i = $('<label>').append($.t('Weeks')));
          var v = $("<input type='checkbox'>").prependTo(i);
          $('<td>').append(i).appendTo(e),
            this.bindControl(new a(v, t.weeks, !0, this.model(), 'Change Line Tool Visibility On Weeks'));
          (e = $('<tr>').css('height', '29px').appendTo(this._block)), (i = $('<label>').append($.t('Months')));
          var b = $("<input type='checkbox'>").prependTo(i);
          $('<td>').append(i).appendTo(e),
            this.bindControl(new a(b, t.months, !0, this.model(), 'Change Line Tool Visibility On Months')),
            this.loadData();
        }),
    ...
    a0Rg: function (t, e, i) {
      ...
      function n() {
        var t = $('<select />');
        return (
          $('<option value="' + o.LineStudyPlotStyle.Line + '">' + $.t('Line') + '</option>').appendTo(t),
          $(
            '<option value="' + o.LineStudyPlotStyle.LineWithBreaks + '">' + $.t('Line With Breaks') + '</option>',
          ).appendTo(t),
          $('<option value="' + o.LineStudyPlotStyle.StepLine + '">' + $.t('Step Line') + '</option>').appendTo(t),
          $('<option value="' + o.LineStudyPlotStyle.Histogram + '">' + $.t('Histogram') + '</option>').appendTo(t),
          $(
            '<option value="' +
          ...
          $('<option value="' + o.LineStudyPlotStyle.Area + '">' + $.t('Area') + '</option>').appendTo(t),
          $(
            '<option value="' + o.LineStudyPlotStyle.AreaWithBreaks + '">' + $.t('Area With Breaks') + '</option>',
          ).appendTo(t),
          $('<option value="' + o.LineStudyPlotStyle.Columns + '">' + $.t('Columns') + '</option>').appendTo(t),
          $('<option value="' + o.LineStudyPlotStyle.Circles + '">' + $.t('Circles') + '</option>').appendTo(t),
          t
        );
      }
    },
    ...
    n3Kh: function (t, e, i) {
      ...
      i('PVgW'),
        ...
        (l.prototype.bindBarIndex = function (t, e, i, o) {
          var n = [r(t.value()), a(l.BarIndexPastLimit), s(l.BarIndexFutureLimit)];
        ...
        (l.prototype._createPointRow = function (t, e, i) {
          ...
          return (
            p.appendTo(r),
            p.addClass('ticker'),
            this.bindBarIndex(e.bar, p, this.model(), 'Change ' + this._linetool.title() + ' point bar index'),
            o
          );
        }),
        (l.prototype.prepareLayoutForTable = function (t) {
          for (var e = this._linetool.points(), i = e.length, o = 0; o < e.length; o++) {
            var n = e[o],
    ...
    o6hY: function (t, e, i) {
      ...
      function x(t, e, i) {
        n.call(this, t, e), (this._study = i), (this._property = t), this.prepareLayout();
      }
      inherit(L, n),
        (L.prototype.prepareLayout = function () {
          (this._table = $('<table/>')),
          ...
          for (var o = 0; o < t.plots.length; ++o)
            if (
              ...
              if (this._study.isLinePlot(o) || this._study.isBarColorerPlot(o) || this._study.isBgColorerPlot(o))
                this._prepareLayoutForPlot(o, s);
              else if (this._study.isPlotArrowsPlot(o)) this._prepareLayoutForArrowsPlot(o, s);
              else if (this._study.isPlotCharsPlot(o)) this._prepareLayoutForCharsPlot(o, s);
              else if (this._study.isPlotShapesPlot(o)) this._prepareLayoutForShapesPlot(o, s);
              else if (this._study.isOHLCSeriesPlot(o)) {
                var r = { id: a, type: 'ohlc' };
                this._study.isOHLCBarsPlot(o)
                  ? this._prepareLayoutForBarsPlot(o, r)
                  : this._study.isOHLCCandlesPlot(o) && this._prepareLayoutForCandlesPlot(o, r);
            ...
            for (o = 0; o < h.childCount(); o++) {
              if (!(R = h[o]).isHidden || !R.isHidden.value()) {
                (W = $('<tr class="line"/>')).appendTo(this._table),
                  (Y = $('<td/>')).appendTo(W),
                  (V = $("<input type='checkbox' class='visibility-switch'/>")).appendTo(Y);
                var f = $.t(R.name.value(), { context: 'input' }),
                  C = this.createLabeledCell(f, V).appendTo(W).addClass('propertypage-name-label'),
                  m = $('<td/>');
                ...
                P.appendTo(T);
                var x = $('<td colspan="4">').css({ whiteSpace: 'nowrap' });
                x.appendTo(W);
                var S = b();
                S.render().appendTo(x);
                var I = $("<input class='property-page-bandwidth' type='text'/>");
                I.appendTo(x);
                ...
                F.addFormatter(i),
                  ...
                  this.bindControl(new l(S, R.linestyle, parseInt, !0, this.model(), E)),
          ...
          if (this._study.properties().bandsBackground) {
            ...
            (W = this._prepareFilledAreaBackground(R.fillBackground, R.backgroundColor, R.transparency, O, E)).appendTo(
              this._table,
            );
          }
          if (this._study.properties().areaBackground) {
            (R = this._study.properties().areaBackground), (O = $.t('Background')), (E = $.t('Change area background'));
            (W = this._prepareFilledAreaBackground(R.fillBackground, R.backgroundColor, R.transparency, O, E)).appendTo(
              this._table,
            );
          }
            ...
            for (o = 0; o < j.length; ++o) {
              ...
              if (!D.isHidden) {
                ...
                if (D.palette) {
                  ...
                  (Y = $('<td/>')).appendTo(W),
                    (V = $("<input type='checkbox' class='visibility-switch'/>")).appendTo(Y),
                    this.bindControl(new d(V, R.visible, !0, this.model(), E + ' visibility'));
                  var A = $.t(O, { context: 'study' });
                  this.createLabeledCell(A, V).appendTo(W).addClass('propertypage-name-label'), W.appendTo(this._table);
                  var H = this._findPlotPalette(o, D),
                    M = H.palette,
                    q = H.paletteProps;
                  this._prepareLayoutForPalette(0, D, M, q, E);
                } else {
                  (W = this._prepareFilledAreaBackground(R.visible, R.color, R.transparency, O, E)).appendTo(
                    this._table,
                  );
                }
              }
          ...
          for (var z in t.graphics) {
            ...
            for (var U in N) {
              ...
              L['_createRow_' + z].call(this, this._table, R);
            }
          }
          var Y,
          ...
          1 === K.length &&
            ...
            1 === (C = this._table.find('.propertypage-plot-with-palette')).length
              ? C.css('display', 'none')
              : ((C = this._table.find('.propertypage-name-label')).css('padding-left', 0),
                C.find('label').attr('for', '')));
          var G = this._prepareStudyPropertiesLayout();
          if (((this._table = this._table.add(G)), w.isScriptStrategy(t))) {
            var Q = this._prepareOrdersSwitches();
            this._table = this._table.add(Q);
          }
          this.loadData();
        }),
        (L.prototype._prepareOrdersSwitches = function () {
          var t = $('<table class="property-page study-strategy-properties" cellspacing="0" cellpadding="2">'),
            e = 'chart-orders-switch_' + Date.now().toString(36),
            i = $('<tr>').appendTo(t),
            o = $('<input id="' + e + '" type="checkbox">').appendTo($('<td>').appendTo(i));
          $('<label for="' + e + '">' + $.t('Trades on Chart') + '</label>').appendTo($('<td>').appendTo(i));
          var n = 'chart-orders-labels-switch_' + Date.now().toString(36),
            a = $('<tr>').appendTo(t),
            s = $('<input id="' + n + '" type="checkbox">').appendTo($('<td>').appendTo(a));
          $('<label for="' + n + '">' + $.t('Signal Labels') + '</label>').appendTo($('<td>').appendTo(a));
          var r = 'chart-orders-qty-switch_' + Date.now().toString(36),
            p = $('<tr>').appendTo(t),
            l = $('<input id="' + r + '" type="checkbox">').appendTo($('<td>').appendTo(p));
          $('<label for="' + r + '">' + $.t('Quantity') + '</label>').appendTo($('<td>').appendTo(p));
          var c = this._study.properties();
          return (
            this.bindControl(new d(o, c.strategy.orders.visible, !0, this.model(), 'Trades on chart visibility')),
            this.bindControl(new d(s, c.strategy.orders.showLabels, !0, this.model(), 'Signal labels visibility')),
            this.bindControl(new h(s, c.strategy.orders.visible, !0, this.model(), 'Signal labels visibility', !0)),
            this.bindControl(new d(l, c.strategy.orders.showQty, !0, this.model(), 'Quantity visibility')),
            this.bindControl(new h(l, c.strategy.orders.visible, !0, this.model(), 'Quantity visibility', !0)),
            t
          );
        }),
        (L.prototype._prepareLayoutForPlot = function (t, e) {
          var i = e.id,
          ...
          if (a) {
            (h = $('<tr class="line"/>')).appendTo(this._table),
              ...
              (b = $("<input type='checkbox' class='visibility-switch plot-visibility-switch'/>")).appendTo(y),
              this.bindControl(new d(b, o.visible, !0, this.model(), r));
            var p = $.t(o.title.value(), { context: 'input' });
            this.createLabeledCell(p, b).appendTo(h).addClass('propertypage-name-label propertypage-plot-with-palette'),
            ...
            (h = $('<tr class="line"/>')).appendTo(this._table),
              ...
              y.addClass('visibility-cell'),
              (b = $("<input type='checkbox' class='visibility-switch plot-visibility-switch'/>")).appendTo(y);
            p = $.t(this._study.properties().styles[i].title.value(), { context: 'input' });
            this.createLabeledCell(p, b).appendTo(h).addClass('propertypage-name-label');
            var f = $('<td/>');
            ...
            P.on('change', this._trackPriceLine.bind(this)).appendTo(k),
              ...
              this.bindControl(new d(b, o.visible, !0, this.model(), r)),
              this.bindControl(new c(C, o.color, !0, this.model(), r, o.transparency)),
              this.bindControl(new u(_, o.linewidth, !0, this.model(), r, this._study.metaInfo().isTVScript)),
              this.bindControl(new l(w, o.plottype, parseInt, !0, this.model(), r)),
              this.bindControl(new d(P, o.trackPrice, !0, this.model(), 'Change Price Line'));
          }
        }),
        (L.prototype._prepareLayoutForBarsPlot = function (t, e) {
          var i = e.id,
          ...
          h.appendTo(l), this.bindControl(new d(h, o.visible, !0, this.model(), r));
          var u = o.title.value();
          if ((this.createLabeledCell(u, h).appendTo(p).addClass('propertypage-name-label'), a)) {
        ...
        (L.prototype._prepareLayoutForCandlesPlot = function (t, e) {
          ...
          r.appendTo(s), this.bindControl(new d(r, o.drawWick, !0, this.model(), n));
        ...
        (L.prototype._prepareLayoutForShapesPlot = function (t, e) {
          var i = e.id,
            o = this._study.properties().styles[i],
            n = this._findPlotPalette(t, e),
            a = n.palette,
          ...
          var h = $("<input type='checkbox' class='visibility-switch'/>");
          h.appendTo(p), this.bindControl(new d(h, o.visible, !0, this.model(), r));
          var u = $.t(this._study.properties().styles[i].title.value(), { context: 'input' });
          this.createLabeledCell(u, h).appendTo(T).addClass('propertypage-name-label');
          var y = $('<td/>');
          y.appendTo(T);
          var b = C();
          b.appendTo(y), this.bindControl(new l(b, o.plottype, null, !0, this.model(), r));
          var m = $('<td/>');
          m.appendTo(T);
          var _ = f();
          if ((_.appendTo(m), this.bindControl(new l(_, o.location, null, !0, this.model(), r)), a))
            this._prepareLayoutForPalette(t, e, a, s, r);
          else {
            var T;
            (T = $('<tr class="line"/>')).appendTo(this._table), $('<td/>').appendTo(T), $('<td/>').appendTo(T);
            var g = $('<td/>');
            g.appendTo(T), g.addClass('colorpicker-cell');
            var w = v(g);
            this.bindControl(new c(w, o.color, !0, this.model(), r, o.transparency));
          }
        }),
        (L.prototype._prepareLayoutForCharsPlot = function (t, e) {
          var i = e.id,
            o = this._study.properties().styles[i],
            n = this._findPlotPalette(t, e),
            a = n.palette,
        ...
        (L.prototype._prepareLayoutForPalette = function (t, e, i, o, n, a) {
          var s = t,
            r = e.id,
            p = null,
            h = r.startsWith('fill');
          ...
          for (var b in i.colors) {
            ...
            var m = $('<td/>');
            m.appendTo(C), m.addClass('propertypage-name-label'), m.html($.t(f.name.value(), { context: 'input' }));
            var _ = $('<td/>');
            _.appendTo(C), _.addClass('colorpicker-cell');
            var g = v(_);
            if (
              (this.bindControl(new c(g, f.color, !0, this.model(), n, p.transparency)),
              ...
              k.appendTo(w),
                this.bindControl(new u(k, f.width, !0, this.model(), n, this._study.metaInfo().isTVScript));
              var P = $('<td>');
              if ((P.appendTo(C), 0 === y)) {
                var L = T();
                L.appendTo(P), this.bindControl(new l(L, p.plottype, parseInt, !0, this.model(), n));
                var x = $('<td>');
                x.appendTo(C);
                var S = $("<input type='checkbox'>");
                S.on('change', this._trackPriceLine.bind(this)).appendTo(x),
                  this.createLabeledCell('Price Line', S).appendTo(C),
                  this.bindControl(new d(S, p.trackPrice, !0, this.model(), 'Change Price Line'));
              }
            }
            y++;
          }
        }),
        (L.prototype._trackPriceLine = function () {
          P('GUI', 'Add Price Line', this._study.properties().description.value());
        }),
        (L.prototype._prepareLayoutForArrowsPlot = function (t, e) {
          var i = e.id,
            o = this._study.properties().styles[i],
            n = 'Change ' + i,
            a = $('<tr class="line"/>');
          ...
          var r = $("<input type='checkbox' class='visibility-switch'/>");
          r.appendTo(s);
          var p = $.t(this._study.properties().styles[i].title.value(), { context: 'input' });
          this.createLabeledCell(p, r).appendTo(a).addClass('propertypage-name-label');
          var l = $('<td/>');
          ...
          this.bindControl(new d(r, o.visible, !0, this.model(), n)),
            this.bindControl(new c(h, o.colorup, !0, this.model(), n, o.transparency)),
            this.bindControl(new c(y, o.colordown, !0, this.model(), n, o.transparency));
        }),
        (L.prototype._findPlotPalette = function (t, e) {
          var i = t,
            o = e.id,
            n = null,
            a = null,
          ...
          if (this._study.isBarColorerPlot(i) || this._study.isBgColorerPlot(i))
            (n = this._study.metaInfo().palettes[e.palette]), (a = this._study.properties().palettes[e.palette]);
          else
            for (var r = 0; r < s.length; r++)
              if (s[r].target === o && (this._study.isSelfColorerPlot(r) || this._study.isOHLCColorerPlot(r))) {
        ...
        (L.prototype._prepareStudyPropertiesLayout = function () {
          var t = $('<table class="property-page study-properties" cellspacing="0" cellpadding="2">'),
            e = this.createPrecisionEditor();
          if (
            ((i = $('<tr>')).appendTo(t),
            $('<td>' + $.t('Precision') + '</td>').appendTo(i),
            $('<td>').append(e).appendTo(i),
            this.bindControl(new l(e, this._study.properties().precision, null, !0, this.model(), 'Change Precision')),
            ...
            (i = $('<tr>')).appendTo(t),
              ...
              $('<td>').append(e).appendTo(i),
              this.bindControl(new l(e, this._study.properties().minTick, null, !0, this.model(), 'Change MinTick'));
          }
          return this._putStudyDefaultStyles(t), t;
        }),
        (L.prototype._putStudyDefaultStyles = function (t, e) {
          var i = null,
            o = this._study;
          return (
            (!o.properties().linkedToSeries || !o.properties().linkedToSeries.value()) &&
        ...
        (L.prototype._prepareFilledAreaBackground = function (t, e, i, o, n) {
          var a = $('<tr class="line"/>'),
            s = $('<td/>');
          s.appendTo(a);
          var r = $("<input type='checkbox' class='visibility-switch'/>");
          r.appendTo(s), this.createLabeledCell(o, r).appendTo(a).addClass('propertypage-name-label');
          var p = $('<td/>');
          p.appendTo(a), p.addClass('colorpicker-cell');
          var l = v(p);
          return (
        ...
        (x.prototype.prepareLayout = function () {
          this._study.properties().linkedToSeries && this._study.properties().linkedToSeries.value(),
            (this._table = $());
        }),
        (x.prototype.widget = function () {
          return this._table;
        }),
        (L._createRow_horizlines = function (t, e) {
          var i = this.addRow(t),
            o = e.name.value(),
          ...
          $('<td>').append(n).appendTo(i),
            ...
            this.bindControl(new d(n, e.visible, !0, this.model(), 'Change ' + o + ' visibility')),
            this.bindControl(new c(a, e.color, !0, this.model(), 'Change ' + o + ' color')),
            this.bindControl(new l(r, e.style, parseInt, !0, this.model(), 'Change ' + o + ' style')),
            this.bindControl(new u(s, e.width, !0, this.model(), 'Change ' + o + ' width'));
        }),
        (L._createRow_vertlines = function (t, e) {
          var i = this.addRow(t),
            o = e.name.value(),
            n = $("<input type='checkbox' class='visibility-switch'/>"),
            a = this.createColorPicker(),
        ...
        (L._createRow_lines = function (t, e) {
          var i = this.addRow(t),
            o = e.title.value(),
            n = $("<input type='checkbox' class='visibility-switch'/>"),
            a = this.createColorPicker(),
        ...
        (L._createRow_hlines = function (t, e) {
          var i = this.addRow(t),
            o = e.name.value(),
            n = $("<input type='checkbox' class='visibility-switch'/>"),
            a = this.createColorPicker(),
          ...
          if (
            ...
            this.bindControl(new l(r, e.style, parseInt, !0, this.model(), 'Change ' + o + ' style')),
            this.bindControl(new u(s, e.width, !0, this.model(), 'Change ' + o + ' width')),
            this.bindControl(new d(p, e.showPrice, !0, this.model(), 'Change ' + o + ' show price')),
            e.enableText.value())
          ) {
            i = this.addRow(t);
            ...
            $('<td class="text-center">').append(h).appendTo(i),
              ...
              this.bindControl(new d(h, e.showText, !0, this.model(), 'Change ' + o + ' show text'));
            var y = TradingView.createTextPosEditor();
            $('<td>').append(y.render()).appendTo(i),
              this.bindControl(new l(y, e.textPos, parseInt, !0, this.model(), 'Change ' + o + ' text position'));
            var v = this.createFontSizeEditor();
            $('<td colspan="2">').append(v).appendTo(i),
              this.bindControl(new l(v, e.fontSize, parseInt, !0, this.model(), 'Change ' + o + ' font size'));
          }
        }),
        (L._createRow_hhists = function (t, e) {
          var i = e.title.value(),
            o = [],
            n = [],
            p = this.addRow(t),
          ...
          $('<td>').append(h).appendTo(p),
            ...
            this.bindControl(new d(h, e.visible, !0, this.model(), 'Change ' + i + ' Visibility'));
          p = this.addRow(t);
          var u = $('<input/>');
          u.attr('type', 'text'),
            u.addClass('ticker'),
          ...
          v.push(a(0)),
            v.push(s(100)),
            this.bindControl(new y(u, e.percentWidth, v, !1, this.model(), 'Change Percent Width'));
          p = this.addLabeledRow(t, 'Placement');
          var b = _();
          $('<td>').append(b).appendTo(p),
            this.bindControl(new l(b, e.direction, null, !0, this.model(), 'Change ' + i + ' Placement'));
          p = this.addRow(t);
          var f = $("<input type='checkbox'>");
          $('<td>').append(f).appendTo(p),
            this.createLabeledCell($.t('Show Values'), f).appendTo(p),
            this.bindControl(new d(f, e.showValues, !0, this.model(), 'Change ' + i + ' Show Values'));
          p = this.addRow(t);
          var C = this.createColorPicker();
          for (var T in (this.createLabeledCell($.t('Text Color'), C).appendTo(p),
          $('<td>').append(C).appendTo(p),
          this.bindControl(new c(C, e.valuesColor, !0, this.model(), 'Change ' + i + ' Text Color')),
          e.colors))
            if (isNumber(parseInt(T, 10))) {
              ...
              (o[T] = e.titles[T].value()),
                ...
                this.bindControl(new c(n[T], e.colors[T], !0, this.model(), 'Change ' + o[T] + ' color'));
            }
        }),
        (L._createRow_backgrounds = function (t, e) {
          var i = this.addRow(t),
          ...
          $('<td>').append(o).appendTo(i),
            ...
            $('<td>').append(a).appendTo(i),
            this.bindControl(new d(o, e.visible, !0, this.model(), 'Change ' + n + ' visibility')),
            this.bindControl(new c(a, e.color, !0, this.model(), 'Change ' + n + ' color', e.transparency));
        }),
        (L._createRow_polygons = function (t, e) {
          var i = this.addRow(t),
            o = e.name.value(),
            n = this.createColorPicker();
          $('<td>').append(o).appendTo(i),
            $('<td>').append(n).appendTo(i),
            this.bindControl(new c(n, e.color, !0, this.model(), 'Change ' + o + ' color'));
        }),
        (L._createRow_trendchannels = function (t, e) {
          var i = this.addRow(t),
            o = e.name.value(),
            n = this.createColorPicker();
          $('<td>').append(o).appendTo(i),
            $('<td>').append(n).appendTo(i),
            this.bindControl(new c(n, e.color, !0, this.model(), 'Change ' + o + ' color', e.transparency));
        }),
        (L._createRow_textmarks = function (t, e) {
          var i = this.addLabeledRow(t),
            ...
            p = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-bold"></span></span>'),
            h = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-italic"></span></span>');
          $('<td>').append(o).appendTo(i),
            ...
            this.bindControl(new c(n, e.color, !0, this.model(), 'Change ' + o + ' color', e.transparency)),
            this.bindControl(new c(a, e.fontColor, !0, this.model(), 'Change ' + o + ' text color', e.transparency)),
            this.bindControl(new l(r, e.fontSize, parseInt, !0, this.model(), 'Change ' + o + ' font size')),
            this.bindControl(new l(s, e.fontFamily, null, !0, this.model(), 'Change ' + o + ' font')),
            this.bindControl(new d(p, e.fontBold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new d(h, e.fontItalic, !0, this.model(), 'Change Text Font Italic'));
        }),
        (L._createRow_shapemarks = function (t, e) {
          var i = this.addRow(t),
            o = $("<input type='checkbox' class='visibility-switch'/>"),
            n = e.name.value(),
            a = this.createColorPicker(),
          ...
          s.attr('type', 'text'),
            ...
            $('<td>').append(s).appendTo(i),
            this.bindControl(new d(o, e.visible, !0, this.model(), 'Change ' + n + ' visibility')),
            this.bindControl(new c(a, e.color, !0, this.model(), 'Change ' + n + ' back color', e.transparency)),
            this.bindControl(new y(s, e.size, null, !1, this.model(), 'Change size'));
        }),
        (e.StudyStylesPropertyPage = L),
        (e.StudyDisplayPropertyPage = x);
    },
    qbxA: function (t, e, i) {},
    'y1L/': function (t, e, i) {},
  },
