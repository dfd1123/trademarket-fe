  ...
  [53],
  {
    ...
    K3s3: function (e, t, r) {
      ...
      function l(e) {
        ...
        return a.createElement('div', { className: r, onClick: e.onClick, ref: e.reference }, e.children);
      }
      function u(e) {
        return (function (t) {
          function r() {
          ...
          return (
            ...
            (r.prototype.render = function () {
              ...
              return a.createElement(
                'div',
                { className: o(r, c.tabs), 'data-name': this.props['data-name'] },
                n,
                a.createElement(e, {
                  ...
                  var r = t,
                    ...
                    o = {
                      reference: function (t) {
                        n && (e.activeTab.current = t), r.props.reference && r.props.reference(t);
                      },
                    };
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement('div', { className: d.tabsWrap }, a.createElement(p, { className: d.tabs }, e)),
                ),
              );
            }),
            (t.prototype._generateDialogTabs = function () {
              ...
              return n.allIds.map(function (t) {
                ...
                return a.createElement(
                  s.b,
                  { key: t, className: o(d.tab, !c && d.withHover), isActive: c, onClick: e._createClickHandler(t) },
                  n.byId[t].title,
                );
              });
            }),
    ...
    nPPD: function (e, t, r) {
      ...
      function n(e, t, r) {
        void 0 === r && (r = {});
        for (var n = Object.assign({}, t), a = 0, o = Object.keys(t); a < o.length; a++) {
          var s = o[a],
            c = r[s] || s;
          ...
          function t(t) {
            ...
            return (
              (r._getItems = function () {
                var e = r.props.mode;
                return [r._getPlaceHolderItem('compact' === e)].concat(r._propertyItems);
              }),
          ...
          return (
            ...
            (t.prototype._getPlaceHolderItem = function (e) {
              return {
                ...
                readonly: !0,
                content: '',
                selectedContent: e ? a.createElement(c.Icon, { className: d.defaultsButtonIcon, icon: u }) : p.defaults,
              };
            }),
            t
          );
