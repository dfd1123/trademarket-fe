          ...
          return (
            ...
            (t.prototype.hide = function (t) {
              ...
              if ((void 0 === t && (t = !1), this.isVisible())) {
                ...
                if ((this._widget.classList.add('i-closed'), this._visibility.setValue(!1), t || o))
                  this._setHiddingTimeout(null), this._widget.classList.add('i-hidden');
                else {
                  var i = setTimeout(function () {
                    e._setHiddingTimeout(null), e._widget.classList.add('i-hidden');
                  }, this.hideDuration());
            ...
            (t.prototype.raise = function () {
              t._toolbars.length + t._startZIndex !== this._zIndex() &&
                (t._toolbars.splice(t._toolbars.indexOf(this), 1), t._toolbars.push(this), t._updateAllZIndexes());
            }),
            ...
            (t.prototype._findWrapperForWidget = function (t) {
              for (var e = this._content.getElementsByClassName('js-widget'), o = 0; o < e.length; ++o) {
                var i = e.item(o);
            ...
            (t.prototype._preventWidgetTouchEndEvent = function () {
              var t = this,
                e = function (o) {
                  o.preventDefault(), t._widget.removeEventListener('touchend', e);
                };
            ...
            (t.prototype._loadPosition = function () {
              ...
              if ('device' === this._options.positionStorageType) {
                var e = _.TVLocalStorage.getItem(this._options.positionSettingsKey);
              ...
              (function (e) {
                ...
                return (
                  ...
                  (o.prototype.hide = function () {
                    c.setValue('ChartFavoriteDrawingToolbarWidget.visible', !1), e.prototype.hide.call(this);
                  }),
                  ...
                  (o.prototype._onFavoriteRemoved = function (t) {
                    this.removeWidget(this._linetoolsWidgets[t]),
                      ...
                      0 === r.a.favoritesCount() && (this._canBeShownValue.setValue(!1), this.hide());
                  }),
                  ...
                  (o.prototype._onSelectedLinetoolChanged = function (t) {
                    ...
                    Object.keys(this._linetoolsWidgets).forEach(function (o) {
                      e._linetoolsWidgets[o].classList.toggle('i-active', t === o);
                    });
                  }),
                  (o.prototype._createLinetoolWidget = function (e) {
                    var o = $(
                      t.render(
                        ...
                        { icon: d.a[e].icon, isActive: e === l.tool.value(), title: d.a[e].localizedName },
                      ),
                    )[0];
                    return (
                      o.addEventListener('click', function (t) {
                        t.preventDefault(), l.tool.value() !== e && l.tool.setValue(e);
                      }),
                  ...
                  (o.prototype._attachHandlers = function () {
                    ...
                    r.a.favoriteAdded.subscribe(this, this._onFavoriteAdded),
                      r.a.favoriteRemoved.subscribe(this, this._onFavoriteRemoved),
                      ...
                      this.onWidgetsReordered().subscribe(this, function (e, o) {
                        if (
                          (r.a.favoriteMoved.unsubscribe(t, t._onFavoriteMoved), !r.a.moveFavorite(r.a.favorite(e), o))
                        )
          ...
          (function (t) {
            ...
            return (
              ...
              (e.prototype.show = function () {
                t.prototype.show.call(this), document.addEventListener('mousedown', this._onWindowClickedListener);
              }),
              (e.prototype.hide = function () {
                t.prototype.hide.call(this), document.removeEventListener('mousedown', this._onWindowClickedListener);
              }),
              ...
              (e.prototype.addGroupedWidget = function (t, o) {
                void 0 === o && (o = {}),
                  Object(n.assert)(
                    t.states.length > 0 && -1 !== e._getStateIndexById(t, t.currentStateId),
                ...
                for (var e = this._statedWidgets.length, o = 0; o < e; ++o) {
                  ...
                  if (i.statedWidget.id === t)
                    return (
                      ...
                      void 0 !== i.clickListener && i.toolbarWidget.removeEventListener('click', i.clickListener),
              ...
              (e.prototype.setGroupedWidgetState = function (t, o) {
                ...
                Object(n.assert)(-1 !== e._getStateIndexById(i.statedWidget, o), 'Unknown stateId (' + o + ')'),
              ...
              (e.prototype._createPopup = function (t) {
                ...
                o.element.className += 'tv-grouped-floating-toolbar__popup js-popup';
                ...
                t.statedWidget.states.forEach(function (n, r) {
                  ...
                  s.addEventListener('click', a),
                    o.widgets.push({ clickListener: a, stateWidget: n, widget: s }),
                    s.classList.add('tv-grouped-floating-toolbar__sub-widget--slide-right-' + r),
                    s.classList.add('tv-grouped-floating-toolbar__sub-widget--slide-left-' + (i - r + 1)),
                  ...
                  Promise.resolve().then(function () {
                    e._currentPopup && e._currentPopup.element.classList.add('i-opened');
                  }),
                  this._updatePopupPosition();
              }),
              ...
              (e.prototype._updateWidgetPreview = function (t) {
                var o = e._getStateIndexById(t.statedWidget, t.statedWidget.currentStateId);
                Object(n.assert)(-1 !== o, 'Unknown state id: ' + t.statedWidget.currentStateId);
                ...
                t.toolbarWidget.firstChild
                  ...
                  : (t.toolbarWidget.appendChild(i), t.toolbarWidget.appendChild(e._createCaret()));
              }),
              (e.prototype._updateSubWidgetsState = function (t) {
                this._currentPopup &&
                  ...
                  this._currentPopup.widgets.forEach(function (o) {
                    o.widget.classList.toggle(e._activeSubWidgetClass, o.stateWidget.id === t.currentStateId);
                  });
              }),
                ...
                if (this._currentPopup) {
                  ...
                  if (this.isVertical())
                    ...
                    i.left + n.width > window.innerWidth
                      ? e.left + n.width > window.innerWidth && (s = e.width - n.width)
                      : (s = i.left - e.left + 1),
                      (r.style.left = s + 'px'),
                      e.bottom + n.height > window.innerHeight
                        ? r.classList.add('tv-grouped-floating-toolbar__popup--at-top')
                        : (r.classList.remove('tv-grouped-floating-toolbar__popup--at-top'), (r.style.top = ''));
                  }
                }
              }),
              ...
              (e.prototype._createSubWidget = function (t, e) {
                ...
                return (
                  ...
                  t.statedWidget.stateWidgetAddClass && o.classList.add(t.statedWidget.stateWidgetAddClass),
              ...
              (e.prototype._onWindowClicked = function (t) {
                if (this.isVisible() && this._currentPopup && !e._isEventInElement(t, this._currentPopup.element)) {
                  for (var o = 0; o < this._statedWidgets.length; ++o)
                    if (e._isEventInElement(t, this._statedWidgets[o].toolbarWidget)) return;
                  this._closePopup();
                }
              }),
              (e._getStateIndexById = function (t, e) {
                for (var o = 0; o < t.states.length; ++o) if (t.states[o].id === e) return o;
                return -1;
              }),
              (e._createCaret = function () {
                var t = document.createElement('div');
                return (
                  (t.className = 'tv-caret tv-caret--small tv-caret--colored tv-grouped-floating-toolbar__caret'), t
                );
              }),
              ...
              (e._activeSubWidgetClass = 'tv-grouped-floating-toolbar__sub-widget--current'),
              e
            );
          })(r.a));
    },
    ...
    tPkB: function (t, e, o) {
      ...
      (function (e, i) {
        var n = o('ogJP').notNull,
          ...
          g = o('yMne'),
          v = o('CW80'),
          _ = v.createLineToolProperties,
          f = v.isLineTool,
          y = o('JWMC').trackEvent,
          b = o('ytGH').MultipleLineWidthsProperty;
        function w(t) {
        ...
        function m(t, e) {
          t.push({ id: e, widget: $('<div class="tv-linetool-properties-toolbar__text">' + e + '</div>')[0] });
        }
        function C(t, e) {
          t.push({ id: e.value, widget: $(e.iconSvgCode)[0], readonly: e.readonly });
        }
        function x(t) {
          return (function (t, e) {
        ...
        o('m/4m'),
          o('nSyy'),
          (w.prototype.activeChartWidget = function () {
            return this._chartWidgetCollection.activeChartWidget.value();
          }),
          (w.prototype.selectedSources = function () {
          ...
          (w.prototype._init = function () {
            (this._floatingToolbar = new p({
              ...
              defaultPosition: { top: g.HEADER_TOOLBAR_HEIGHT_EXPANDED + 15, left: window.innerWidth / 2 },
              positionSettingsKey: 'properties_toolbar.position',
              positionStorageType: 'server',
            })),
              this._floatingToolbar.onWidgetStateChanged().subscribe(this, this._onPropertyChangedInToolbar),
          ...
          (w.prototype._bindPopupMenuDirection = function () {
            return this._floatingToolbar.isVertical() ? 'right' : 'down';
          }),
          (w.prototype._onPropertyChangedInToolbar = function (t, e) {
            if (('linewidth' === t || t.endsWith('.linewidth')) && this._lineWidthsProperty) {
            ...
            this._currentProperties && this.activeChartWidget().model().setProperty(this._currentProperties[t], e);
          }),
          (w.prototype._onPropertyChanged = function (t, e) {
            ('linewidth' === t && e !== this._lineWidthsProperty) ||
              this._floatingToolbar.setGroupedWidgetState(t, e.value());
          }),
          (w.prototype._hideAllSourceActions = function () {
            this._sourceActions.forEach(function (t) {
              this._floatingToolbar.hideWidget(t.button);
            }, this),
              (this._sourceActionsVisible = !1);
          }),
          (w.prototype._updateSourceActionsVisibility = function (t) {
            (this._sourceActionsVisible = !1),
          ...
          (w.prototype.attachHandlers = function () {
            l.tool.subscribe(this.onToolChanged.bind(this), { callWithLast: !0 }),
          ...
          (w.prototype._updateCloneButtonTitle = function () {
            this._setButtonTitle(this._cloneButton, this._cloneButtonTitle());
          }),
          (w.prototype.onToolChanged = function (t, e) {
            if (t && -1 !== t.toLowerCase().indexOf('linetool')) {
              e = e instanceof c ? e : _(t);
              this._hideAllSourceActions(),
                this.showPropertiesOf(t, e),
                this.showTemplatesOf({ tool: t, properties: e }),
                this._updateVisibility();
            } else this.selectedSources() ? this.onSourceChanged(this.selectedSources()) : this.hide();
          }),
          (w.prototype.findSourceOnWidget = function (t) {
            for (var e = 0; e < this.activeChartWidget().model().panes().length; e++)
              for (var o = this.activeChartWidget().model().panes()[e].orderedSources(), i = 0; i < o.length; i++)
                if (o[i] === t) return o[i];
          }),
          (w.prototype.onSourceChanged = function (t) {
            if (
              ...
              if (1 === t.length) {
                var e = t[0];
                f(e) && e.isAvailableInFloatingWidget() && this.findSourceOnWidget(e)
                  ? (!e.userEditEnabled() ||
                    ('LineToolBrush' !== e.toolname && this.activeChartWidget().model().lineBeingCreated())
                      ? this._hideAllSourceActions()
                      : (this._updateSourceActionsVisibility(t),
                        e.canHasAlert() &&
                          ((this._hasAlertWathcedValue = e.hasAlert.spawn()),
                          this._hasAlertWathcedValue.subscribe(this._updateSourceActionsVisibility.bind(this, t)))),
                    this.showPropertiesOf(e.toolname, e.properties()),
                ...
                this._clearProperties(),
                  this._$templatesButton && this._floatingToolbar.removeWidget(this._$templatesButton[0]),
                  this._updateSourceActionsVisibility(t),
                  this._setupToggleLockButton(t[0]),
                  this._updateVisibility(),
                  this._showWidthsButton();
            else this.hide();
          }),
          (w.prototype._createWidthsButton = function (t) {
            if ((t = t || this.selectedSources().filter(f)).length < 1 || !b.canCreateForSources(t)) return !1;
            this._lineWidthsProperty && (this._lineWidthsProperty.destroy(), (this._lineWidthsProperty = null));
            var e = t
              .map(function (t) {
                return t.widthsProperty();
              })
              .filter(n);
            (this._lineWidthsProperty = new b(e)),
              this._lineWidthsProperty.subscribe(
                this,
                function () {
                  this._floatingToolbar.setGroupedWidgetState('linewidth', this._lineWidthsProperty.value());
                }.bind(this),
              );
            var o = [];
            return (
              [
                { value: 'mixed', iconSvgCode: W, readonly: !0 },
                { value: 1, iconSvgCode: P },
                { value: 2, iconSvgCode: S },
                { value: 3, iconSvgCode: T },
                { value: 4, iconSvgCode: L },
              ].forEach(C.bind(null, o)),
              this._floatingToolbar.addGroupedWidget(
                {
                  ...
                  tooltip: 1 === t.length ? window.t('Line tool width') : window.t('Line tool widths'),
                },
          ...
          (w.prototype._showWidthsButton = function () {
            var t = this.selectedSources().filter(f);
            b.canCreateForSources(t) && this._createWidthsButton(t);
          }),
          (w.prototype.showTemplatesOf = function (t) {}),
          (w.prototype.templatesList = function () {
            return this._templatesList;
          }),
          (w.prototype._createButton = function (t) {
            t = t || {};
            ...
            if (
              ...
              var o = document.createElement('div');
              o.classList.add('tv-linetool-properties-toolbar__icon'), o.appendChild(t.svgIcon), e.appendChild(o);
            }
            if (t.addCaret) {
              var i = document.createElement('div');
              (i.className = 'tv-caret tv-caret--small tv-caret--colored tv-linetool-properties-toolbar__caret'),
                e.appendChild(i);
            }
            return t.name && ((e.dataset.name = t.name), (e.dataset.role = 'button')), e;
          }),
          (w.prototype._setButtonTitle = function (t, e) {
            t.setAttribute('title', e);
          }),
          (w.prototype._createSettingsButton = function () {
            var t = this;
            return this._createButton({
              ...
              callback: function () {
                t._trackContextAction('Settings'),
                  t.activeChartWidget().showChartPropertiesForSource(t.selectedSources()[0], null, {
          ...
          (w.prototype._createZOrderButton = function () {
            var t = this._createButton({
              name: 'visual-order',
              title: $.t('Visual Order'),
              callback: function () {
                t.classList.contains('i-dropped') ||
                  (this._trackContextAction('Visual order'), $(t).trigger('button-popup', [this._getZOrderActions()]));
              }.bind(this),
              svgIcon: $(o('tzjn'))[0],
              addCaret: !0,
            });
          ...
          (w.prototype._isSyncOperationAvailable = function () {
            return (
              !!h(this._chartWidgetCollection.layout.value()) &&
              (this.selectedSources() || []).filter(f).some(function (t) {
                return t.isSynchronizable();
              })
            );
          }),
          (w.prototype._cloneButtonTitle = function () {
            var t = $.t('Clone');
            return (
          ...
          (w.prototype._createCloneButton = function () {
            var t = this._createButton({
              name: 'clone-copy-sync',
              title: this._cloneButtonTitle(),
              callback: function () {
                t.classList.contains('i-dropped') ||
                  (this._trackContextAction('Clone'), $(t).trigger('button-popup', [this._getCloneActions()]));
              }.bind(this),
              svgIcon: $(o('WRHa'))[0],
              addCaret: !0,
            });
          ...
          (w.prototype._createLockButton = function () {
            var t = this._createButton({
              name: 'lock',
              title: $.t('Lock'),
              callback: function () {
                this._trackContextAction('Lock'), this.activeChartWidget().toggleLockSelectedObject();
              }.bind(this),
              svgIcon: $(o('gPdB'))[0],
            });
            return (
          ...
          (w.prototype._createHideButton = function () {
            return this._createButton({
              name: 'hide',
              title: $.t('Hide'),
              callback: function () {
                this._trackContextAction('Hide'), this.activeChartWidget().hideSelectedObject();
              }.bind(this),
              svgIcon: $(o('nApS'))[0],
            });
          }),
          (w.prototype._createRemoveButton = function () {
            return this._createButton({
              name: 'remove',
              title: $.t('Remove'),
              callback: function () {
                this._trackContextAction('Remove'), this.activeChartWidget().removeSelectedSources();
              }.bind(this),
              svgIcon: $(o('RRhU'))[0],
            });
          }),
          (w.prototype._createSourceActions = function () {
            var t = [];
            return (
          ...
          (w.prototype._getCloneActions = function () {
          ...
          (w.prototype._getZOrderActions = function () {
            var t = [],
              e = this.selectedSources(),
            ...
            return (
              1 === e.length && e[0].zorder() === a.minZOrder && ((n.disabled = !0), (s.disabled = !0)),
              1 === e.length && e[0].zorder() === a.maxZOrder && ((r.disabled = !0), (i.disabled = !0)),
              t.push(i, n, r, s),
              t
            );
          }),
          (w.prototype._getPossibleProperty = function (t) {
          ...
          (w.prototype.showPropertiesOf = function (t, e) {
            ...
            if ((this._clearProperties(), (this._propertiesVisible = !1), o.length)) {
              for (var i = {}, n = o.length - 1; n >= 0; --n) {
                for (var r = o[n], s = e, a = r.name.split('.'), l = 0; l < a.length; ++l) s = s && s[a[l]];
                var d = r.showIf;
                if ('function' != typeof d || d(s, e)) {
                  var c = r.factory;
                  if (c && c.call(this)) continue;
                  if (!s) continue;
                  this._propertiesVisible = !0;
                  var p = [];
                  if ('combobox' !== r.inputType) {
                    var u = this.colorPropertyControl(s, r, e);
                    this._floatingToolbar.addWidget(u[0], { index: this._$templatesButton ? 1 : 0 }),
                      this._toolbarWidgets.push(u);
                    continue;
                  }
                  r.simple ? r.comboboxOptions.forEach(m.bind(null, p)) : r.comboboxOptions.forEach(C.bind(null, p)),
                    r.propertyProxy && (s = r.propertyProxy(e, this.activeChartWidget().model())),
                    (i[r.name] = s),
                    s.subscribe(this, this._onPropertyChanged.bind(this, r.name, s)),
                    this._floatingToolbar.addGroupedWidget(
                      {
                        id: r.name,
                        currentStateId: s.value(),
                        stateWidgetAddClass: 'tv-linetool-properties-toolbar__sub-widget',
                        states: p,
                        widgetAddClass: 'tv-linetool-properties-toolbar__grouped-button',
                        tooltip: r.title,
          ...
          (w.prototype._updateVisibility = function () {
            this._propertiesVisible || this._sourceActionsVisible || this._templatesVisible
              ? this._show()
              : this.hide();
          }),
          (w.prototype._clearProperties = function () {
            -1 !== this._floatingToolbar.findGroupedWidget('linewidth') &&
              ...
              this._currentProperties &&
                (this._clearPropertiesOnHideTimeoutId &&
                  (clearTimeout(this._clearPropertiesOnHideTimeoutId), (this._clearPropertiesOnHideTimeoutId = null)),
                Object.keys(this._currentProperties).forEach(function (t) {
                  'linewidth' !== t &&
                    (this._currentProperties[t].unsubscribeAll(this), this._floatingToolbar.removeGroupedWidget(t));
                }, this),
                (this._currentProperties = null),
          ...
          (w.prototype._setupToggleLockButton = function (t) {
            t !== this._selectedSourceBk &&
              (this._selectedSourceBk &&
                this._selectedSourceBk.properties().frozen &&
                this._selectedSourceBk.properties().frozen.unsubscribe(this, this._lockChangeListener),
              t &&
                t.properties().frozen &&
          ...
          (w.prototype.bindControl = function (t) {
            this._bindings.push(t);
          }),
          (w.prototype.clearBindings = function (t) {
            for (var e = this._bindings.length; e--; ) this._bindings[e].destroy();
            this._bindings.length = 0;
          }),
          (w.prototype.colorPropertyControl = function (t, e, o) {
            ...
            return (
              ...
              $(document).on('click', function (t) {
                n.data('tvcolorpicker') ? n.addClass('i-active') : n.removeClass('i-active');
              }),
              n.after(r),
              this.bindControl(new a(i, t, !0, this.activeChartWidget().model(), null, w.getTransparency(e, o))),
              'string' == typeof e.addClass && i.addClass(e.addClass),
              i
            );
          }),
          (w.getTransparency = function (t, e) {
            if (t.transparency) return t.transparencyField ? e[t.transparencyField].value() : e.transparency.value();
          }),
          (w.prototype.createLineEndPropertyProxy = function (t, e) {
            return function (o, n) {
              var r;
              r = o[e] && o[e].value() ? w.LINE_EXTEND : o[t].value();
              var s = new i(r);
              return (
                s.subscribe(this, function (i) {
                  var r = i.value();
                  r < 2
                    ? (n.beginUndoMacro(''), o[t].setValue(r), o[e] && o[e].setValue(!1), n.endUndoMacro())
                    : (n.beginUndoMacro(''), o[t].setValue(u.Normal), o[e] && o[e].setValue(!0), n.endUndoMacro());
                }),
                s
              );
            };
        ...
        var W = $(o('noRL'))[0],
          ...
          O = o('2JFs'),
          H = o('Kjbl');
        (w.prototype._defaultToolProperties = function () {
          return [
            { name: 'color', inputType: 'colorPicker', iconSvgCode: I, title: $.t('Color') },
            { name: 'linecolor', inputType: 'colorPicker', iconSvgCode: I, title: $.t('Color') },
            {
            ...
            },
            {
              ...
              inputType: 'combobox',
              comboboxOptions: [
                { value: 0, iconSvgCode: P },
                { value: 1, iconSvgCode: E },
                { value: 2, iconSvgCode: k },
              ],
            },
            {
              name: 'leftEnd',
              ...
              inputType: 'combobox',
              comboboxOptions: [
                { value: u.Normal, iconSvgCode: B },
                { value: u.Arrow, iconSvgCode: z },
                { value: w.LINE_EXTEND, iconSvgCode: V },
              ],
            ...
            },
            {
              ...
              inputType: 'combobox',
              comboboxOptions: [
                { value: u.Normal, iconSvgCode: M },
                { value: u.Arrow, iconSvgCode: A },
                { value: w.LINE_EXTEND, iconSvgCode: F },
              ],
              propertyProxy: this.createLineEndPropertyProxy('rightEnd', 'extendRight'),
            },
          ];
        }),
          (w.prototype._riskPropertiesExceptionCases = function () {
            return [
              { name: 'textcolor', title: $.t('Text color'), inputType: 'colorPicker', iconSvgCode: H },
              {
              ...
              { name: 'linecolor', title: $.t('Border color'), inputType: 'colorPicker', iconSvgCode: I },
            ];
          }),
          (w.prototype._elliottPropertiesExceptionCases = function () {
            return [{ name: 'color', title: $.t('Color'), inputType: 'colorPicker', iconSvgCode: I }];
          }),
          (w.prototype._rangeExceptionCases = function () {
            return [
              { name: 'linecolor', inputType: 'colorPicker', iconSvgCode: I, title: $.t('Color') },
              {
                name: 'backgroundColor',
          ...
          (w.prototype._textPropertiesExceptionCases = function () {
            return [
              { name: 'color', title: $.t('Text color'), inputType: 'colorPicker', iconSvgCode: H },
              {
                name: 'backgroundColor',
                title: $.t('Background Color'),
                inputType: 'colorPicker',
              ...
              { name: 'borderColor', title: $.t('Border Color'), inputType: 'colorPicker', iconSvgCode: I },
              { name: 'bordercolor', title: $.t('Border Color'), inputType: 'colorPicker', iconSvgCode: I },
              {
                name: 'fontsize',
                title: $.t('Font Size'),
          ...
          (w.prototype._notePropertiesExceptionCases = function () {
            return [
              { name: 'markerColor', title: $.t('Marker Color'), inputType: 'colorPicker', iconSvgCode: I },
              { name: 'textColor', title: $.t('Text color'), inputType: 'colorPicker', iconSvgCode: H },
              {
                name: 'fontSize',
                title: $.t('Font Size'),
          ...
          (w.prototype._arrowMarkPropertiesExceptionCases = function () {
            return [
              { name: 'arrowColor', title: $.t('Arrow color'), inputType: 'colorPicker', iconSvgCode: O },
              { name: 'color', title: $.t('Text color'), inputType: 'colorPicker', iconSvgCode: H },
            ];
          }),
          (w.prototype._brushPropertiesExceptionCases = function () {
            return [
              { name: 'linecolor', inputType: 'colorPicker', iconSvgCode: I, title: $.t('Color') },
              {
                name: 'backgroundColor',
          ...
          (w.prototype._pathPropertiesExceptionCases = function () {
            return [
              { name: 'lineColor', inputType: 'colorPicker', iconSvgCode: I, title: $.t('Color') },
              {
                name: 'lineWidth',
          ...
          (w.prototype._buttonsForGrouppedProperties = function (t, e) {
            var o = [];
            return (
              t &&
                o.push({
          ...
          (w.prototype._trackContextAction = function (t) {
            y('GUI', 'Context action on drawings', t);
          }),
          (w.prototype._createToolExceptionCases = function () {
            return {
              LineToolRegressionTrend: [],
              LineToolGannSquare: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolFibTimeZone: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolBrush: w.prototype._brushPropertiesExceptionCases(),
              LineToolPolyline: w.prototype._brushPropertiesExceptionCases(),
              LineToolPath: w.prototype._pathPropertiesExceptionCases(),
              ...
              LineToolArrowMarker: [
                { name: 'backgroundColor', title: $.t('Color'), inputType: 'colorPicker', iconSvgCode: O },
                { name: 'textColor', title: $.t('Text color'), inputType: 'colorPicker', iconSvgCode: H },
              ],
              LineToolArrowMarkLeft: w.prototype._arrowMarkPropertiesExceptionCases(),
              ...
              LineToolArrowMarkDown: w.prototype._arrowMarkPropertiesExceptionCases(),
              LineToolFlagMark: [
                { name: 'flagColor', title: $.t('Flag color'), inputType: 'colorPicker', iconSvgCode: O },
              ],
              LineToolElliottCircle: w.prototype._elliottPropertiesExceptionCases(),
              LineToolElliottSubminuette: w.prototype._elliottPropertiesExceptionCases(),
              LineToolElliottMinor: w.prototype._elliottPropertiesExceptionCases(),
              LineToolElliottMinorRetr: w.prototype._elliottPropertiesExceptionCases(),
              LineToolElliottMajorRetr: w.prototype._elliottPropertiesExceptionCases(),
              ...
              LineToolIcon: [{ name: 'color', title: $.t('Color'), inputType: 'colorPicker', iconSvgCode: O }],
              ...
              LineToolThreeDrivers: [
                { name: 'color', title: $.t('Text color'), inputType: 'colorPicker', iconSvgCode: I },
              ],
              ...
              LineToolBarsPattern: [{ name: 'color', title: $.t('Color'), inputType: 'colorPicker', iconSvgCode: O }],
              LineToolProjection: [
                {
                  name: 'color1',
              ...
              LineToolAnchoredVWAP: [
                { name: 'styles.VWAP.color', title: $.t('Color'), inputType: 'colorPicker', iconSvgCode: I },
                {
                  name: 'styles.VWAP.linewidth',
                  title: $.t('Width'),
                  inputType: 'combobox',
                  comboboxOptions: [
                    { value: 1, iconSvgCode: P },
              ...
              LineToolFibCircles: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolFibChannel: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolFibSpeedResistanceArcs: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolFibRetracement: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolFibSpeedResistanceFan: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolTrendBasedFibTime: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolFibWedge: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolGannComplex: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolGannFixed: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolGannFan: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolPitchfan: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolPitchfork: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolSchiffPitchfork2: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolSchiffPitchfork: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolInsidePitchfork: w.prototype._buttonsForGrouppedProperties(!0, !0),
              LineToolTrendBasedFibExtension: w.prototype._buttonsForGrouppedProperties(!0, !0),
            };
          }),
          (t.exports = w);
