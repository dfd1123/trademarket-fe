(window.webpackJsonp = window.webpackJsonp || []).push([
  ['load-chart-dialog'],
  {
    ...
    AMW5: function (e, t, n) {
      ...
      function w(e) {
        ...
        return r.a.createElement(
          ...
          Object(a.__assign)({}, i, {
            ref: c,
            className: f(O.sortButton, 'apply-common-tooltip', 'common-tooltip-vertical'),
            onClick: function () {
              u(!s);
            },
          }),
          r.a.createElement(b.Icon, { className: O.icon, icon: 0 === t ? p : g }),
          r.a.createElement(
            v.a,
            {
              ...
              position: Object(h.c)(c.current, { verticalMargin: -35, verticalAttachEdge: 0 }),
            },
            n,
          ),
        );
        ...
        return o.createElement(
          ...
          Object(a.__assign)({}, u, {
            ...
            label: o.createElement(
              ...
              o.createElement(b.Icon, { className: E.icon, icon: 0 === c ? p : g }),
        ...
        Object(o.useEffect)(
          function () {
            if (E) {
              ...
              e && (e.addEventListener('mousemove', M), e.addEventListener('mouseup', I));
            } else b && b();
            return function () {
              var e = Object(c.ensureNotNull)(O.current).ownerDocument;
        ...
        return r.a.createElement(
          'div',
          {
            ...
            onMouseDown: function (e) {
              ...
              e.preventDefault();
              var t = Object(c.ensureNotNull)(w.current).getBoundingClientRect();
              _.current = (d ? t.width : t.height) / 2;
              var n = a - i,
                o = A(e.nativeEvent, Object(c.ensureNotNull)(O.current)) - _.current;
              o < 0
                ? ((o = 0), (_.current = A(e.nativeEvent, Object(c.ensureNotNull)(O.current))))
                : o > n * y * T &&
                  ((o = n * y * T), (_.current = A(e.nativeEvent, Object(c.ensureNotNull)(O.current)) - o));
              u(o / y / T), j(!0);
            },
          },
          r.a.createElement(
            'div',
            {
              ...
              style:
                ...
                (n[d ? 'width' : 'height'] = S),
                (n.transform = 'translate' + (d ? 'X' : 'Y') + '(' + (F * y * T || 0) + 'px)'),
                n),
              onMouseDown: function (e) {
                e.preventDefault(), (_.current = A(e.nativeEvent, Object(c.ensureNotNull)(w.current))), j(!0);
              },
            },
            r.a.createElement('div', { className: m()(v.barInner, d && v['barInner--horizontal']) }),
          ),
        );
        function M(e) {
            ...
            function () {
              var e = [
                ...
                r = function (e) {
                  ...
                  (a = t.length - m > 0 ? n(r, { timeout: 500 }) : null), f.current && f.current();
                },
                a = n(r, { timeout: 500 });
              return function () {
                null !== a && o(a);
      ...
      function z(e) {
            ...
            var t = Object(o.useRef)(null),
              ...
              s = Object(o.useState)({
                ...
                onVerticalChange: function (e) {
                  f(function (t) {
                    return Object(a.__assign)(Object(a.__assign)({}, t), { scrollPosTop: e });
                  }),
                    (Object(c.ensureNotNull)(n.current).scrollTop = e);
                },
                onHorizontalChange: function (e) {
                  f(function (t) {
                    return Object(a.__assign)(Object(a.__assign)({}, t), { scrollPosLeft: e });
                  }),
            ...
            return (
              Object(o.useEffect)(
                function () {
                  i && m(),
                    f(function (e) {
                      return Object(a.__assign)(Object(a.__assign)({}, e), { visible: i });
                    });
                },
                [i],
              ),
        ...
        return r.a.createElement(
          ...
          r.a.createElement('div', { className: R.overlapScrollWrap }, r.a.createElement(I, Object(a.__assign)({}, v))),
          r.a.createElement(A, { key: n, initCount: 10, items: g, onUpdate: p }),
        );
      }
      var P = n('ldgD'),
        W = n.n(P),
      ...
      function K(e) {
        ...
        var a = Object(o.useMemo)(
          function () {
            return n.split(new RegExp('(' + Object(H.regExpEscape)(t) + ')', 'i'));
          },
          [t],
        );
        return r.a.createElement(
          ...
          a.map(function (e, t) {
            return t % 2
              ? r.a.createElement('span', { key: t, className: m()(Y.highlight, i && Y.active) }, e)
        ...
        return r.a.createElement(
          ...
          g &&
            ...
            r.a.createElement(Q.a, {
              className: m()(Y.favoriteButton, v && Y.favorite, u.CheckMobile.any() && Y.mobile),
              isActive: f,
              isFilled: v,
          ...
          r.a.createElement(
            ...
            r.a.createElement(
              'div',
              { className: m()(Y.title, f && Y.active, b && Y.mobile), 'data-name': 'list-item-title' },
              o || n,
            ),
            r.a.createElement('div', { className: m()(Y.details, f && Y.active, b && Y.mobile) }, i),
          ),
      ...
      function ne(e) {
        ...
        return (
          ...
          r.a.createElement(G, {
            url: m,
            title: r.a.createElement(K, { searchString: c, isActive: d, text: t.title }),
            subtitle: r.a.createElement(
              r.a.Fragment,
              null,
              r.a.createElement(K, { searchString: c, isActive: d, text: t.symbol }),
              ', ',
              r.a.createElement(K, { searchString: c, isActive: d, text: te(t.interval) }),
              ' ',
              '(',
            ...
            onClickRemove: function () {
              !(function (e, t, n, o) {
                Object(V.createConfirmDialog)({ content: Object($.b)(e), manager: o || void 0 }).then(function (e) {
      ...
      function ae(e) {
        ...
        var L = Object(o.useMemo)(
          function () {
            return Object(a.__spreadArrays)(t)
              ...
              .filter(function (e) {
                return !O.includes(e.id) && (Q(e.title) || Q(e.symbol) || Q(te(e.interval)));
              });
            var e;
          },
          [m, T, O, k],
          ...
          render: function (e) {
            ...
            return (
              ...
              r.a.createElement(
                r.a.Fragment,
                null,
                r.a.createElement(_.a, { reference: M, onChange: R, placeholder: window.t('Search') }),
                r.a.createElement(
                  N,
                  null,
        ...
        function U(e, t) {
          ...
          F(n), s.setValue('loadChartDialog.viewState', JSON.stringify(n), { forceFlush: !0 }), P();
        }
      }
      function ce(e, t, n) {
    ...
    Iksw: function (e, t, n) {
      ...
      function s(e, t) {
        return function (n, s) {
          ...
          return { x: _ - (g === a.FromRightToLeft ? n : 0) + w, y: y - (v === i.FromBottomToTop ? s : 0) + j };
        };
      }
    },
    ItnF: function (e, t, n) {
      e.exports = { dialog: 'dialog-2QwUBM-N', wrapper: 'wrapper-3ePvQMAQ', separator: 'separator-1L40XQyb' };
    },
    MyWJ: function (e, t, n) {
      e.exports = {
        ...
        return i.a.createElement(
          ...
          Object(o.__assign)({}, I, {
            className: a(
              ...
              M.item,
              O && M.withIcon,
              ((t = {}), (t[M.isActive] = w), (t[M.isDisabled] = C || j), (t[M.hovered] = E), t),
            ),
            title: h,
            href: y,
            target: S,
            ...
            onMouseUp: function (t) {
              ...
              if (1 === t.button && y && n) {
                var r = n.label;
                o && (r += '_mouseWheelClick'), Object(l.trackEvent)(n.category, n.event, r);
              }
            },
            onMouseOver: T,
            onMouseOut: x,
          }),
          void 0 !== O && i.a.createElement('div', { className: M.icon, dangerouslySetInnerHTML: { __html: O } }),
          i.a.createElement(
            'div',
          ...
          (void 0 !== p || g) &&
            i.a.createElement('div', { className: M.shortcut }, (d = p) && d.split('+').join(' + ')),
          void 0 !== k &&
            i.a.createElement('div', { onClick: m, className: a(M.toolbox, ((n = {}), (n[M.showOnHover] = N), n)) }, k),
        );
      }
    },
    QHWU: function (e, t, n) {
      ...
      function f(e) {
        ...
        return i.a.createElement(
          ...
          r && i.a.createElement('div', { className: d.cancel, onClick: r }, Object(l.t)('Cancel')),
        );
      }
      function m(e) {
        var t = e.className,
    ...
    g89m: function (e, t, n) {
      ...
      function C(e) {
        ...
        return i.a.createElement(
          ...
          i.a.createElement(
            ...
            n && i.a.createElement('div', { className: l()(w.ellipsis, w.subtitle) }, n),
          ),
          a,
      ...
      var j = { vertical: 20 },
        ...
        y = (function (e) {
          function t() {
            ...
            return (
              ...
              (t._renderChildren = function (e, n) {
                return (
                  (t._controller = e),
                  t.props.render({ requestResize: t._requestResize, centerAndFit: t._centerAndFit, isSmallWidth: n })
                );
              }),
              ...
              (t._handleKeyDown = function (e) {
                if (!e.defaultPrevented)
                  switch ((t.props.onKeyDown && t.props.onKeyDown(e), Object(s.hashFromEvent)(e))) {
                    case 27:
                      if (e.defaultPrevented) return;
                      if (t.props.forceCloseOnEsc && t.props.forceCloseOnEsc()) return void t._handleClose();
                      var n = document.activeElement,
                        o = Object(a.ensureNotNull)(t._reference);
                      if (null !== n) {
                        if ((e.preventDefault(), N(n))) return void t._handleClose();
          ...
          return (
            Object(o.__extends)(t, e),
            (t.prototype.componentDidMount = function () {
              p.subscribe(b.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null);
            }),
            (t.prototype.componentWillUnmount = function () {
              p.unsubscribe(b.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null);
            }),
            ...
            (t.prototype.render = function () {
              var e = this,
                ...
                F = 'after' !== s ? u : void 0,
                M = 'after' === s ? u : void 0;
              return i.a.createElement(v.a, { rule: m.a.SmallHeight }, function (t) {
                return i.a.createElement(v.a, { rule: m.a.TabletSmall }, function (s) {
                  return i.a.createElement(
                    d.a,
                    {
                    ...
                    i.a.createElement(
                      ...
                      O && i.a.createElement(f.a, { className: E.separator }),
      ...
      function N(e) {
        return 'true' === e.getAttribute('data-haspopup') && 'true' !== e.getAttribute('data-expanded');
      }
    },
    hYdZ: function (e, t) {
      e.exports =
    ...
    'i/MG': function (e, t, n) {
      ...
      function u(e) {
        var t = e.className,
          ...
          h = Object(o.__rest)(e, ['className', 'isActive', 'onClick', 'title', 'hidden', 'data-name']);
        return r.createElement(
          a.Icon,
          Object(o.__assign)({}, h, {
            'data-name': v,
            className: i(l.button, 'apply-common-tooltip', n && l.active, f && l.hidden, t),
            icon: c,
            onClick: u,
            title: d || s.remove,
          }),
    ...
    ntBy: function (e, t, n) {
      e.exports = { overlapScrollWrap: 'overlapScrollWrap-236iNA0w', scrollContainer: 'scrollContainer-1OsLRrZC' };
    },
    pr86: function (e, t, n) {
      'use strict';
      n.d(t, 'a', function () {
      ...
      function d(e) {
        var t = e.className,
          ...
          d = e.isActive,
          f = e.onClick,
          m = Object(o.__rest)(e, ['className', 'isFilled', 'isActive', 'onClick']);
        return r.createElement(
          a.Icon,
          Object(o.__assign)({}, m, {
            className: i(s.favorite, 'apply-common-tooltip', n && s.checked, d && s.active, t),
            icon: n ? c : l,
            onClick: f,
            ...
            function (e) {
              t && (t.current = e),
                l.CheckMobile.iOS() &&
                  ...
                  (s.current = e),
                  null !== s.current && Object(a.disableBodyScroll)(s.current, { allowTouchMove: u(s) }));
            },
            [t],
          );
