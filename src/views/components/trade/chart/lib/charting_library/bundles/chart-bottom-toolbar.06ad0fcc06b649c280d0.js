  ...
  ['chart-bottom-toolbar'],
  {
    ...
    '02pg': function (e, t, n) {
      ...
      var a = n('q1tI'),
        ...
        o = n('XiJV');
      function r(e) {
        return a.createElement('div', { className: i(o.separator, e.className) });
      }
    },
    '20PO': function (e, t) {
      e.exports =
    ...
    J3OW: function (e, t, n) {
      e.exports = { button: 'button-1VVj8kLG', separator: 'separator-2I6DZkMH' };
    },
    K3s3: function (e, t, n) {
      'use strict';
      n.d(t, 'a', function () {
          ...
          return (
            ...
            (n.prototype.render = function () {
              ...
              return i.createElement(
                'div',
                { className: o(n, s.tabs), 'data-name': this.props['data-name'] },
                a,
                i.createElement(e, {
      ...
      u(function (e) {
        return i.createElement('div', { className: s.slider, ref: e.reference });
      });
    },
    MfqI: function (e, t, n) {
      'use strict';
            ...
            (e.prototype.destroy = function () {
              ...
              t.withModel(null, function () {
                ...
                a.onStatusChanged().unsubscribe(e, e._updateAvailableRanges),
                  ...
                  n.appliedTimeFrame().unsubscribe(e._rangeChangedListenerBound);
              }),
            ...
            function n(e, n) {
              ...
              (a._handleUpdate = function (e) {
                ...
                (a._handleSelectRange = function (e) {
                  Object(_.trackEvent)('GUI', 'Chart Bottom Toolbar', 'range ' + e.value), a._binding.selectRange(e);
                }),
                Object(C.c)(n, {
              ...
              var i = (a._binding = Object(v.ensureDefined)(N.get(n.chartWidget)));
          ...
          (function (e) {
            function t(t, n) {
              ...
              return (
                ...
                (i._handleRangeSelect = function (e) {
                  e && i.props.onSelectRange && i.props.onSelectRange(e), Object(m.b)();
                }),
                (i._renderChildren = function (e) {
                  ...
                  return e
                    ? a.createElement(
                        a.Fragment,
                        null,
                        a.createElement(j, { ranges: n, activeRange: o, onSelectRange: i._handleRangeSelect }),
                        r && a.createElement(A, { onGoToDateClick: i._handleGoToDateClick }),
                      )
                    : a.createElement(
                        a.Fragment,
                        null,
                        ...
                        r && a.createElement(b.b, { label: B.goToDate, onClick: i._handleGoToDateClick }),
                      );
                }),
            ...
            return (
              ...
              (t.prototype.render = function () {
                var e = this;
                return a.createElement(g.a, { rule: 'screen and (max-width: 419px)' }, function (t) {
      ...
      function F(e) {
        var t,
          n = l(
            e.className,
            L.item,
            (((t = {})[L.isActive] = e.isActive), (t[L.isFirst] = e.isFirst), (t[L.isLast] = e.isLast), t),
          );
          ...
          return a.createElement(
            ...
            n.map(function (e, t) {
              return a.createElement(
                ...
                a.createElement('div', { title: e.description || e.text, className: 'apply-common-tooltip' }, e.text),
              );
            }),
          );
        }),
            ...
            function t(t, n) {
              ...
              return (
                (a._handleClick = function () {
                  ...
                  Object(_.trackEvent)('GUI', 'Chart Bottom Toolbar', 'go to'), Object(k.showGoToDateDialog)(e.model());
                }),
                Object(C.c)(n, { chartWidget: c.any.isRequired }),
                a
              );
      ...
      var le = Object(C.b)(),
              ...
              (a._getActions = function () {
                return a.props.withMenu
                  ? (function (e) {
                      e.updateActions();
                      var t = e.actions();
                      return t && t.applyTimeZone instanceof ie.Action ? t.applyTimeZone.getSubItems() : [];
                    })(a.context.chartWidget)
                  : [];
              }),
              Object(C.c)(n, { chartWidget: c.any.isRequired, chartApiInstance: c.any.isRequired }),
          ...
          return (
            ...
            (t.prototype.updateTimezonesButton = function () {
              ...
              if (e.model() && null !== e.model().mainSeries().symbolInfo()) {
                ...
                if ('exchange' === t) {
                  var n = Object(v.ensureNotNull)(e.model().mainSeries().symbolInfo()).timezone;
                  n && (t = n);
                }
                var a = Object(ne.a)(t);
        ...
        de = n('z6ID');
      function he(e) {
        return a.createElement('span', { className: l(de.separator, e.className) });
      }
      var pe = n('tU7i'),
        me = Object(C.b)();
      var ge = Object(C.b)();
      ...
      var Oe,
            ...
            ((t = (function (t) {
              function n(e, n) {
                ...
                (a._handleClick = function (e) {
                  ...
                  Object(C.c)(n, { chartWidgetCollection: c.any.isRequired, resizerDetacher: c.any.isRequired });
                var i = n.resizerDetacher;
                return (
                  (a.state = { isFullscreen: i.fullscreen.value(), isChangeLayoutButton: a._isChangeLayoutButton() }), a
                );
              }
              return (
                Object(r.__extends)(n, t),
                ...
                (n.prototype.render = function () {
                  ...
                  return a.createElement(e, { className: t, isFullscreen: i, onClick: this._handleClick });
                }),
        ...
        Be = (((ve = {}).properties = !0), (ve.fullscreen = !0), (ve.preventPhoneLayout = !0), ve),
        De =
        ...
        Pe = (function (e) {
                ...
                function (e, t, n) {
                  if (a.isValidElement(e) && 'string' != typeof e.type) {
                    ...
                    if ('string' == typeof o.className) {
                      var s = { className: l(o.className, 0 === t && Ne.first, t === n.length - 1 && Ne.last) },
                        c = i(),
                ...
                null === s._raf &&
                  (s._raf = requestAnimationFrame(function () {
                    var e,
                      ...
                      h = c.offsetWidth,
                      p = !Boolean(c.textContent) || u - d - h <= 0 ? 'collapsed' : 'expanded';
                    if ((Object.assign(i, { dateRangeMode: p }), 'expanded' !== p)) {
                      for (
                        var m = u - Object(v.ensureNotNull)(s._rangeCollapsed).offsetWidth - 0,
                          g = 0,
                          b = 0,
                          f = 0,
                          _ = l;
                        ...
                        (g += C.width),
                          C.name in Be
                            ? ((b += C.width), Object.assign(i, (((e = {})[C.name] = !1), e)))
                            : Object.assign(i, (((t = {})[C.name] = m <= g), t));
                      }
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return a.createElement(
                'div',
                { className: Ne.toolbar, ref: this._handleToolbarRef, onContextMenu: xe.a },
                this.props.timeFramesWidgetEnabled &&
                  a.createElement(
                    ...
                    a.createElement(
                      'div',
                      {
                        className: l(Ne.dateRangeWrapper, 'collapsed' !== e.dateRangeMode && Ne.collapsed),
                        ref: this._handleRangeCollapsedRef,
                      },
                      a.createElement(
                        'div',
                        { className: l(Ne.dateRangeCollapsed) },
                        a.createElement(z, { goToDateButton: this.props.goToDateEnabled }),
                      ),
                    ),
                    a.createElement(
                      u,
                      ...
                      a.createElement(
                        'div',
                        {
                          className: l(Ne.dateRangeWrapper, 'expanded' !== e.dateRangeMode && Ne.collapsed),
                        ...
                        a.createElement(
                          ...
                          this.props.goToDateEnabled && a.createElement(he, null),
                          this.props.goToDateEnabled && a.createElement($, null),
                        ),
                      ),
                    ),
                  ),
                a.createElement(
                  ...
                  this.props.timeWidgetEnabled &&
                    a.createElement(
                      ...
                      a.createElement(
                        'div',
                        { className: l(Ne.inline, e.timeZones && Ne.collapsed), ref: this._handleTimeZonesRef },
                        a.createElement(
                          'div',
                        ...
                        a.createElement('div', { className: Ne.inline }, a.createElement(he, null)),
                      ),
                    ),
                  a.createElement(
                    Ee.a,
                    ...
                    this.props.logScaleButtonEnabled && a.createElement(We, { className: Ne.item }),
                    this.props.autoScaleButtonEnabled && a.createElement(Me, { className: Ne.item }),
            ...
            (t.prototype._applyResizing = function () {
              ...
              this._rangeExpanded && this._rangeExpanded.classList.toggle(Ne.collapsed, 'expanded' !== n),
                this._rangeCollapsed && this._rangeCollapsed.classList.toggle(Ne.collapsed, 'collapsed' !== n),
      ...
      var Ue = (function () {
        ...
        return (
          (e.prototype.destroy = function () {
            o.unmountComponentAtNode(this._container), this._container.removeAttribute('data-initialized');
          }),
          e
        );
      })();
    ...
    c7H2: function (e, t, n) {
      e.exports = { button: 'button-2gir_Bbb', hover: 'hover-SrAyrKlT', icon: 'icon-MwaAItz1' };
    },
    l4ku: function (e, t, n) {
      'use strict';
      n.d(t, 'a', function () {
      ...
      function m(e) {
        var t = e.isTitle,
          ...
          W = !!S.length;
        return n
          ? i.a.createElement('li', { className: o(p.item, p.loading) }, i.a.createElement(s.Loader, { color: 'gray' }))
          : i.a.createElement(
              'li',
              {
                className: o(
              ...
              i.a.createElement('span', { className: o(p.label, N && p.fullWidth) }, E),
              !!R &&
                i.a.createElement(r.Icon, {
                  onClick: function () {
                    R && R.action();
              ...
              !W && y && i.a.createElement(l.a, { className: p.shortcut, text: y }),
