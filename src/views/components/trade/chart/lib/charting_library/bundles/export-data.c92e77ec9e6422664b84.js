    ...
    SIoL: function (e, t, i) {
      ...
      function o(e, t) {
        ...
        var l = Object.assign({}, a, t),
          ...
          v = (function (e, t, i, l) {
            for (
              var a = Object(n.ensureNotNull)(void 0 !== i ? e.indexOf(i, !0) : e.firstIndex()),
                o = Object(n.ensureNotNull)(void 0 !== l ? e.indexOf(l, !0) : e.lastIndex()),
                c = o,
                u = a,
                d = 0,
                f = t;
            ...
            return Object(n.assert)(c <= u, 'Range must contain at least 1 time point'), new r.BarsRange(c, u);
        ...
        l.includeSeries &&
          (o.schema.push(d('open')), o.schema.push(d('high')), o.schema.push(d('low')), o.schema.push(d('close')));
        ...
        if (l.includeTime) for (j = w; j <= m; ++j) o.data[j - w][0] = Object(n.ensureNotNull)(u.valueAt(j));
        l.includeSeries &&
          h
            .bars()
            .range(w, m)
            .each(function (e, t) {
              var i = o.data[e - w];
              return (i[b] = f(t[1])), (i[b + 1] = f(t[2])), (i[b + 2] = f(t[3])), (i[b + 3] = f(t[4])), !1;
            });
      ...
      function c(e) {
        for (
          ...
          if (void 0 !== c && !c.isHidden && void 0 !== c.title) {
            var f = '' + c.title + d;
            i.fields.push(u(r, s, f)), i.fieldToPlotIndex.push(a + 1), i.fieldPlotOffsets.push(e.offset(o.id));
          }
        }
        return i;
      }
