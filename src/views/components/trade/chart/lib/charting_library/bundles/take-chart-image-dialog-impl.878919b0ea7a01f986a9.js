  ...
  ['take-chart-image-dialog-impl'],
  {
          ...
          return (
            ...
            (t.prototype.render = function () {
              var e = this.props,
                ...
                f = e.className,
                v = e.backdrop,
                _ = i(f, l.dialog, n && l.rounded, d && l.shadowed, u && l.fullscreen, m && l.darker),
                w = Object(c.a)(this.props),
                g = this.props.style
                  ? Object(o.__assign)(Object(o.__assign)({}, this._createStyles()), this.props.style)
                  : this._createStyles();
              return r.createElement(
                ...
                r.createElement(
                  s.b.Provider,
                  { value: this._manager },
                  v && r.createElement('div', { onClick: this.props.onClickBackdrop, className: l.backdrop }),
                  r.createElement(
                    'div',
                    Object(o.__assign)({}, w, {
                      className: _,
    ...
    fMMV: function (e, t, n) {
                    ...
                    return Object(r.__generator)(this, function (r) {
                      switch (r.label) {
                        ...
                        case 1:
                          return (
                            r.trys.push([1, 4, , 5]),
                            [4, Object(s.fetch)(a, { body: e, method: 'POST', credentials: 'same-origin' })]
                          );
                        case 2:
              ...
              return d.createElement(
                ...
                d.createElement(
                  ...
                  d.createElement(
                    ...
                    d.createElement(f.a, { mouseDown: !0, touchStart: !0, handler: o }, function (t) {
                      return d.createElement(
                        'div',
                        { className: v.modal, ref: t },
                        d.createElement(h.a, Object(r.__assign)({}, e.props, { className: u(s, v.dialog) }), i),
                      );
                    }),
                  ),
                ),
      ...
      !(function (e) {
        ...
        function n(e, t) {
          void 0 === e && (e = 'about:blank'), void 0 === t && (t = 'snapshot_tweet');
      ...
      var C = n('ycI/'),
        ...
        M = (function (e) {
          function t(t) {
            ...
            return (
              ...
              (n._shareTwitter = function () {
                c.shareSnapshotInstantly(n.props.symbol || '', n.props.imageUrl || '');
              }),
              (n._onClose = function () {
          ...
          return (
            Object(r.__extends)(t, e),
            (t.prototype.componentDidMount = function () {
              S.subscribe(I.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._onClose, null);
            }),
            (t.prototype.componentWillUnmount = function () {
              S.unsubscribe(I.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._onClose, null);
            }),
            ...
            (t.prototype.render = function () {
              ...
              return d.createElement(
                ...
                d.createElement(g.b, { onClose: this._onClose }, window.t('Image URL')),
                o && d.createElement(g.c, { text: o, isError: !1, onClickOutside: this._hideMessages }),
                r && d.createElement(g.c, { text: r, isError: !0, onClickOutside: this._hideMessages }),
                d.createElement(
                  g.a,
                  null,
                  ...
                  d.createElement(
                    ...
                    d.createElement(
                      'div',
                      { className: k.form, style: { visibility: t ? 'visible' : 'hidden' } },
                      d.createElement(
                        'div',
                        ...
                        d.createElement(b.b, {
                          ...
                          style: Object(x.isRtl)() ? { paddingLeft: 84 } : void 0,
                        }),
                        d.createElement(
                          'div',
                          {
                          ...
                          d.createElement(E.a, { type: 'primary', theme: 'ghost' }, window.t('Copy')),
                        ),
                      ),
                      d.createElement(
                        'div',
                        ...
                        d.createElement(
                          ...
                          d.createElement(y.Icon, { className: k.icon, icon: N }),
                          d.createElement('span', { className: k.socialsText }, window.t('Tweet')),
                        ),
                      ),
                    ),
                  ),
      ...
      function U(e, t, n) {
        var r;
        function s(e) {
          r || ((r = document.createElement('div')), document.body.appendChild(r)), p.render(d.createElement(M, e), r);
        }
        function c() {
          s({ isOpened: !1 });
        }
            ...
            function (r) {
              ...
              s({
                ...
                imageUrl: i.enabled('charting_library_base')
                  ...
                  : window.location.protocol + '//' + window.location.host + '/x/' + r + '/',
                symbol: e.activeChartWidget.value().symbolProperty().value(),
              });
            },
            function () {
              s({ isOpened: !0, onClose: c, error: window.t('URL cannot be received') });
            },
            { onWidget: e.onWidget, snapshotUrl: t.snapshotUrl, onInvalidSnapshotImage: c },
          ),
    ...
    jPOK: function (e, t, n) {
      ...
      n('SzKR');
      function s(e) {
        var t = r('tv-spinner', 'tv-spinner--shown', 'tv-spinner--size_' + (e.size || i.a));
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement('div', { className: 'tv-spinner__background tv-spinner__width_element' }),
            o.createElement('div', {
          ...
          return (
            ...
            (n.prototype.render = function () {
              var t = this.props,
                ...
                s = t.root;
              if (!n) return null;
              var a = r.createElement(e, Object(o.__assign)({}, this.props, { zIndex: 150 }));
